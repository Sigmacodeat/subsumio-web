---
title: >-
  Verfassungsblog — The Digital Services Act and the Reproduction of Old
  Confusions
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/dsa-confusions/
license: >-
...
- The DSA maintains the E-Commerce Directive’s general prohibition of the imposition of general monitoring obligations (Article 7).

- Platforms may be obliged to establish and implement content moderation policies in order to deal with illegal and certain types of objectionable content (developed and overseen by national regulatory bodies in coordination with the Commission) (Articles 26 and 27).
