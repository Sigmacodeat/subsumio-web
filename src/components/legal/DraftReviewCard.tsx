...
export function DraftReviewCard({ draft, onSign, onCopy, className }: DraftReviewCardProps) {
  ...
  return (
    <div
      className={cn(
        "rounded-xl border border-[color:var(--ds-border)] bg-[color:var(--ds-surface)] p-4 transition-[background-color,border-color,color,box-shadow,opacity,transform] duration-[var(--ds-duration-normal)] ease-[cubic-bezier(0.32,0.72,0,1)] motion-reduce:transition-none",
        className
      )}
    >
