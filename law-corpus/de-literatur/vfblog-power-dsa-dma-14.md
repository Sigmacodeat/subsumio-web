---
title: >-
  Verfassungsblog — Platform research access in Article 31 of the Digital
  Services Act
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/power-dsa-dma-14/
license: >-
...
Of course, scraping can also be abused. Amelie Heldt, Matthias Ketteman and I have argued in an earlier blog post that platforms should still be able to take action against unlawful and unethical scraping. Matthias Vermeulen has argued for a GPDR Code of Conduct that clarifies the application of data protection law to independent scraping, which should help to distinguish the good from the bad and minimize any chilling effects on legitimate research.
