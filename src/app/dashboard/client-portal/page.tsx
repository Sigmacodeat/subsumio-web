      ...
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="w-full max-w-md space-y-6">
          <div className="text-center space-y-2">
            <div className="w-16 h-16 rounded-2xl brand-soft border brand-border flex items-center justify-center mx-auto" aria-hidden="true">
          ...
          <Button
            variant="primary"
            className="w-full brand-bg brand-bg text-white"
