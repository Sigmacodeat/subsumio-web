...
export const D = {
  ...
  "deadlines.fristenbuch_window_today": {
    ...
    en: "Today's control list (incl. overdue)",
  },
  "deadlines.fristenbuch_window_7": { de: "Nächste 7 Tage", en: "Next 7 days" },
  "deadlines.fristenbuch_window_14": { de: "Nächste 14 Tage", en: "Next 14 days" },
  "deadlines.fristenbuch_completed": { de: "Erledigt", en: "Completed" },
  ...
  "cases.detail_dl_title_ph": { de: "z. B. Klagebeantwortung", en: "e.g. statement of defense" },
  ...
  "analyze.mode_slug": { de: "Aus der Dokumentablage", en: "From the vault" },
  "analyze.mode_text": { de: "Direkter Text", en: "Direct text" },
  "analyze.slug_label": { de: "Dokumentkennung", en: "Document ID" },
  "analyze.slug_placeholder": {
    de: "z. B. mietvertrag-mueller-2026",
    en: "e.g. lease-agreement-mueller-2026",
  },
  "analyze.slug_hint": {
    de: "Das Dokument muss in der Dokumentablage liegen. Die Analyse wird mit verifizierten Normen aus dem Law-Corpus grounded.",
  ...
  "monitoring.settings_cron_sources": {
    de: "Quelle: RIS (OGH, OLG, VwGH, VfGH) — geteilt mit {code}.",
  ...
  "whatsapp.phone_placeholder": { de: "0664 1234567", en: "0664 1234567" },
  "whatsapp.role_member": { de: "Kanzleimitglied", en: "Firm member" },
  "whatsapp.member": { de: "Benutzerkonto", en: "User account" },
  "whatsapp.member_select": { de: "Konto wählen…", en: "Select account…" },
  "whatsapp.member_unlinked": {
    de: "Kein Benutzerkonto verknüpft — keine Kanzlei-Befehle. Nummer mit Konto neu anlegen.",
    en: "No user account linked — no firm commands. Add the number again with an account.",
  },
  "whatsapp.member_hint": {
    de: "Die Nummer arbeitet mit Rolle und Aktenrechten dieses Kontos. Wird das Konto deaktiviert, endet auch der WhatsApp-Zugang.",
    en: "The number works with this account's role and matter access. Deactivating the account also ends WhatsApp access.",
  },
  ...
  "intake.link_register": { de: "Posteingangsbuch", en: "Inbound register" },
  ...
  "translate.label_doc_slug": { de: "Dokumentkennung", en: "Document ID" },
  "translate.placeholder_doc_slug": {
    de: "Dokumentkennung aus der Dokumentablage",
  ...
  "drafting.tpl.klageerwiderung": { de: "Klagebeantwortung", en: "Statement of defense" },
  ...
  "workspace.rsv.case": { de: "Aktenkennung", en: "Case ID" },
  ...
  "aiact.oversight.citation.desc": {
    de: "Alle Legal-AI-Outputs enthalten zwingend Quellenangaben mit Zitaten aus dem Kanzleiwissen — keine unkontrollierten Halluzinationen",
  ...
  "portal.tab_invoices": { de: "Rechnungen", en: "Invoices" },
  "portal.invoices_title": { de: "Ihre Rechnungen", en: "Your invoices" },
  "portal.invoices_empty": {
    de: "Derzeit liegen keine Rechnungen vor.",
    en: "There are no invoices at the moment.",
  },
  "portal.invoices_loading": { de: "Rechnungen werden geladen…", en: "Loading invoices…" },
  "portal.invoices_error": {
    de: "Rechnungen konnten nicht geladen werden.",
    en: "Invoices could not be loaded.",
  },
  "portal.invoice_due": { de: "fällig am", en: "due" },
  "portal.invoice_status_sent": { de: "Offen", en: "Open" },
  "portal.invoice_status_overdue": { de: "Überfällig", en: "Overdue" },
  "portal.invoice_status_paid": { de: "Bezahlt", en: "Paid" },
  "portal.invoice_pay_hint": {
    de: "QR-Code mit Ihrer Banking-App scannen, um zu bezahlen.",
    en: "Scan the QR code with your banking app to pay.",
  },
  "portal.qn_open": { de: "Ausstehend", en: "Open" },
  "portal.qn_answered": { de: "Beantwortet", en: "Answered" },
  "portal.qn_submit": { de: "Antworten senden", en: "Submit answers" },
  "portal.qn_yes": { de: "Ja", en: "Yes" },
  "portal.qn_required": {
    de: "Bitte füllen Sie alle Pflichtfelder aus.",
    en: "Please fill in all required fields.",
  },
  "portal.qn_error": {
    de: "Der Fragebogen konnte nicht gesendet werden.",
    en: "The questionnaire could not be submitted.",
  },
  ...
  "claim.case_slug": { de: "Aktenkennung", en: "Case ID" },
  ...
  "claim.record_rate": { de: "Rate verbuchen", en: "Record installment" },
  "claim.mahnklage_at": { de: "Mahnklage vorbereiten", en: "Prepare dunning action" },
  "claim.mahnbescheid_de": { de: "Mahnbescheid vorbereiten", en: "Prepare dunning notice" },
  "claim.zahlungsbefehl_at": {
    de: "Zahlungsbefehl rechtskräftig",
    en: "Payment order final",
  },
  "claim.vollstreckungsbescheid_de": {
    de: "Vollstreckungsbescheid",
    en: "Enforcement order",
  },
  "claim.exekution_at": { de: "Exekutionsantrag vorbereiten", en: "Prepare enforcement" },
  "claim.zv_de": { de: "Zwangsvollstreckung vorbereiten", en: "Prepare enforcement" },
  "claim.antrag_view": { de: "Antrag ansehen", en: "View application" },
  "claim.antrag_title": { de: "Antragsdaten", en: "Application data" },
  "claim.antrag_create": { de: "Antrag erstellen", en: "Create application" },
  "claim.antrag_copy": { de: "Text kopieren", en: "Copy text" },
  "claim.antrag_copied": { de: "Antragstext kopiert.", en: "Application text copied." },
  "claim.rechtsgrundlage": { de: "Rechtsgrundlage", en: "Legal basis" },
  "claim.gericht_label": { de: "Gericht / Stelle", en: "Court / Authority" },
  "claim.titel_label": { de: "Vollstreckbarer Titel", en: "Enforceable title" },
  "claim.measure_label": { de: "Exekutionsmittel", en: "Enforcement measure" },
  "claim.target_label": { de: "Gegenstand / Drittschuldner", en: "Object / third party" },
  "claim.plan_new": { de: "Ratenvereinbarung", en: "Installment plan" },
  "claim.plan_title": { de: "Ratenplan", en: "Installment schedule" },
  "claim.plan_over": { de: "über", en: "over" },
  "claim.plan_count": { de: "Raten", en: "Installments" },
  "claim.plan_start": { de: "Erste Rate am", en: "First installment" },
  "claim.plan_grace": { de: "Toleranz (Tage)", en: "Grace days" },
  "claim.plan_hint": {
    de: "Verfallsklausel: Verzögert sich eine Rate über die Toleranz hinaus, wird der Gesamtbetrag fällig.",
    en: "Acceleration clause: if an installment is overdue beyond the grace period, the full amount becomes due.",
  },
  "claim.plan_create": { de: "Vereinbarung anlegen", en: "Create plan" },
  "claim.plan_defaulted": {
    de: "Verfallsklausel eingetreten — Gesamtbetrag fällig",
    en: "Acceleration triggered — full amount due",
  },
  "claim.err_action": {
    de: "Aktion fehlgeschlagen. Bitte prüfen Sie die Eingaben.",
    en: "Action failed. Please check the inputs.",
  },
  "claim.ok_mahn": {
    de: "Antragsdaten erstellt — bitte anwaltlich prüfen.",
    en: "Application data created — please review.",
  },
  "claim.ok_vollstreckung": {
    de: "Status aktualisiert.",
    en: "Status updated.",
  },
  "claim.ok_exekution": {
    de: "Exekutionsantrag erstellt — bitte anwaltlich prüfen.",
    en: "Enforcement application created — please review.",
  },
  "claim.ok_plan": { de: "Ratenvereinbarung angelegt.", en: "Installment plan created." },
  "claim.close": { de: "Schließen", en: "Close" },
  ...
  "redteam.case_slug": { de: "Aktenkennung", en: "Case ID" },
  ...
  "interview.template_slug": { de: "Vorlagenkennung", en: "Template ID" },
