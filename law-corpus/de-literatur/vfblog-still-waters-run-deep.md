---
title: Verfassungsblog — Still Waters Run Deep
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/still-waters-run-deep/
license: >-
...
## Dismantling the Hungarian asylum system step-by-step 
...
- a barbed-wire fence was erected along the country’s southern border with Serbia and Croatia; 

- the crossing of the border fence became a criminal act; 

- two de facto detention centres, called transit zones, were set up on the border with Serbia, where at first  border procedures as defined by the recast Asylum Procedures Directive (rAPD) were conducted to decide if an application is inadmissible or if the Dublin regulation could be applied. Vulnerable applicants were transferred to proper reception centres soon after arrival, while single adult males were kept in the transit zones for a maximum of 28 days without a detention order; 

- the right to an effective remedy for asylum seekers as well as judges’ decision making were restricted, e.g. ending courts’ reformatory powers in judicial review proceeding in asylum cases. 

In 2016,

- integration assistance for persons recognised as in need of international protection were ended;

- a new push-back policy instructed the police to send to Serbia all foreigners without valid documents who were found within 8 kilometres of the border. Such push-backs were carried out without an individualised return procedure or decision, and people did not have the right to lodge an asylum application. Police simply caught people, drove them to the fence, and pushed them back to the Serbian side within a span of a few hours.

From March 2017,

- asylum applications could only be submitted in the transit zones by all foreigners  who had no right to stay in Hungary (e.g. no valid visa or a residence permit); 

- all applicants, except for unaccompanied children under the age of fourteen, had to remain in the transit zones for the full duration of the asylum procedure; 

- the push-back rule was extended to the entire territory of the country: all foreigners without the right to stay were pushed back to Serbia in accordance with law and without any documentation or identification or access to asylum.

From July 2018, 

- all asylum applications were automatically declared inadmissible if the applicant had transited Serbia;

- organising assistance to asylum-seekers became a criminal act punishable by up to one year in prison (under the ‘Stop Soros’ laws).
...
- limiting the lodging of asylum applications to the two transit zones; 

- unlimited placement without a detention order in the transit zones where not only inadmissibility procedures were conducted; 

- the legalisation of push-backs; 

- the lack of an automatic suspensive effect of judicial review requests against the asylum authority’s decisions. 
...
## The judgment in CJEU case C-808/18
...
## The faster road to protection: preliminary rulings, interim measures and NGO action
