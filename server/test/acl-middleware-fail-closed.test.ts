...
function makeRes(): Partial<Response> & { statusCode?: number; body?: unknown; headers: Record<string, string> } {
...
describe('aclGroupsMiddleware', () => {
  const originalApiKey = process.env.SUBSUMIO_WEB_API_KEY;
  ...
  afterEach(() => {
    if (originalApiKey === undefined) {
      ...
      process.env.SUBSUMIO_WEB_API_KEY = originalApiKey;
    }
  });
