...
export const DASHBOARD_PAGES: AuditPage[] = [
  ...
  {
    path: "/dashboard/kollisionspruefung",
    category: "dashboard",
    requires_auth: true,
    description: "Konfliktsprüfung",
  },
  {
...
export const DEFAULT_WCAG_TAGS: WcagTag[] = ["wcag2a", "wcag2aa", "wcag21aa", "wcag22aa"];
...
export const AUDIT_RULES: AuditRule[] = [
  ...
  },
  {
    ...
    tag: "wcag2a",
    impact: "critical",
    description: "Elements must only use allowed ARIA roles",
    enabled: true,
  },
  {
    id: "button-name",
  ...
  },
  {
    ...
    tag: "wcag2a",
    impact: "critical",
    description: "Form buttons must have discernible text",
    enabled: true,
  },
  {
    id: "label",
  ...
  },
  {
    ...
    tag: "wcag2a",
    impact: "serious",
    description: "<ul> and <ol> must only directly contain <li> elements",
    enabled: true,
  },
  {
    id: "listitem",
  ...
  },
  {
    ...
    tag: "wcag2a",
    impact: "moderate",
    description: "Tables should use caption instead of cells with 'caption' role",
    enabled: true,
  },
  {
    id: "td-headers",
    tag: "wcag2a",
    impact: "serious",
    description: "Table cells should use headers attribute",
    enabled: true,
  },
  {
    id: "valid-lang",
  ...
  },
  {
    ...
    tag: "wcag2aa",
    impact: "moderate",
    description: "Focus order should follow visual order",
    enabled: true,
  },
  {
    id: "heading-order",
...
export function isKnownIssue(
  ...
  return knownIssues.some((k) => k.page === violation.page && k.rule_id === violation.rule_id);
}
...
export function evaluateCIGate(
  report: A11yBaselineReport,
  config: A11yCIGateConfig = DEFAULT_CI_GATE_CONFIG
): {
  passed: boolean;
  reasons: string[];
} {
