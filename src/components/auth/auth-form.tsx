...
const COPY = {
  en: {
    ...
    errors: {
      ...
      invalid_token: "The code is not valid. Please try again.",
      invalid_challenge: "The sign-in session expired. Please sign in again.",
      generic: "Something went wrong. Please try again.",
    } as Record<string, string>,
    twoFactor: {
      title: "Two-factor authentication",
      sub: "Enter the 6-digit code from your authenticator app or a backup code.",
      label: "Security code",
      cta: "Confirm",
      back: "Back",
    },
