        ...
        <div className="flex flex-wrap gap-1">
          {plans.map((p) => (
            <button
              ...
              className={cn(
                "rounded border px-2 py-1 text-[11px] transition-[background-color,border-color,color] active:scale-[0.97] motion-reduce:transition-none",
                activePlan?.id === p.id
        ...
        <div className="space-y-2">
          ...
          <div>
            ...
            <div className="mt-1 h-1 overflow-hidden rounded-full bg-[color:var(--ds-border)]">
              <div
                className="h-full rounded-full bg-[color:var(--ds-success-solid)] transition-[background-color,border-color,color,box-shadow,transform,opacity] duration-300 motion-reduce:transition-none"
