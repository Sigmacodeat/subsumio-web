  ...
  return (
    <div className="mt-2 overflow-hidden rounded-lg border border-[color:var(--ds-control-border)] bg-[color:var(--ds-surface)] text-xs text-[color:var(--ds-text)]">
      ...
      <button
        ...
        className="flex w-full cursor-pointer items-center gap-2 px-3 py-2 text-left text-[color:var(--ds-text-muted)] transition-[background-color,border-color,color] hover:bg-[color:var(--ds-hover)] focus-visible:outline-2 focus-visible:outline-offset-[-2px] focus-visible:outline-[color:var(--ds-ring)] active:scale-[0.99] motion-reduce:transition-none"
