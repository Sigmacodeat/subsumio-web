---
title: Verfassungsblog — From Gaza to Manhattan and Back
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/from-gaza-to-manhattan-and-back/
license: >-
...
HOLGER P. HESTERMEYER and ALEXANDER HORNE argue that the procedure for Parliament’s involvement in treaty-making is no longer fit for purpose. As the UK-Rwanda and CPTPPP Agreements show, the UK Parliament’s role in treaty-making must be reformed. In particular, the House of Commons must obtain the power to have a formal vote on international agreements before they can become binding on the UK.

In July, Hungary is set to take over the rotating Presidency of the Council of the European Union, despite Orban’s continued and brazen cozying up to Putin. MARLENE WIND with a wake-up call for Western politicians who continue to ignore the clear security risk that Orban is posing to the EU and Ukraine.
...
Since 2010, the beginning of the populist takeover and the authoritarian transition, Hungary has gathered a lot of experience on how to dismantle academic freedom. This knowledge can be useful for other autocrats as well. But even if we don’t want to give them tips on how to repeat what happened and is happening in this country, it might still be worth reconstructing how it all took place. ZOLTÁN SZENTE reconstructs and summarises these steps in ten commandments how to stifle academic freedom – a useful guidebook for other autocrats as well.

Keyword takeover: PHILIPP KOEPSELL shows how authoritarian populists could abuse §172 VwGO as a free licence for executive disobedience. Fortunately, effective solutions to this problem are already on the table.

JUSTUS DUHNKRACK focuses on public cultural funding. In a scenario analysis for the Thuringia project, he shows how art and culture are used to build bridges of legitimacy between right-wing populism and neo-Nazism. The bad news is that the “cultural war from the right” has already started.

The third of May was Press Freedom Day. A welcome occasion to demand better and uniform access to information for journalists. Europe has very different freedom of information regimes. However, transparency and public control by a free press are more important today than ever. VIKTORIA KRAETZIG and NEUS VIDAL MARTÍ with a plea.

Our Tech section this week was all about artificial intelligence. According to the current state of the art, there are two main things behind this (rather endless) term: data and computing power. The more data and the greater the computing power, the better the AI model becomes. As a result, large companies such as Google, Microsoft and OpenAI already have a huge head start. They are trying to build on this through strategic takeovers of smaller AI companies. JACOB SCHAAL and TEKLA EMBORG are therefore calling for the EU to take a more robust approach.

The European elections are just a few weeks away. AI will also be an issue here. This is because the recently developed AI-driven text and image generators have rapidly increased the possibilities for influencing public opinion. Influencing the 2016 US Presidential Eelection election required a &#8216;troll farm' in a St. Petersburg sububrg; today, ChatGPT (and a few trolls) are enough. LENNART LAUDE and ANDREAS DAUM therefore look at the extent to which the risk-based regulatory approach of the Artificial Intelligence Act also covers such political risks.
...
German lawmakers must regulate the use of web crawlers like PimEyes by the police. LUKAS LANDERER outlines what they should and should not consider: the European Court of Justice's case law on data retention. While PimEyes may raise security concerns, he argues, it is not a form of data retention. Instead, it is an event-driven, law-enforcement based access to privately held, unregulated, existing bulk data.

How much health demands the constitution? The statistical basket used to calculate the minimum subsistence level has been empty for years. In order to ensure that the minimum subsistence level also allows for a healthy diet, it should be better filled in the future. SARAH LINCOLN and ULRIKE MÜLLER have analyzed current nutritional research and the constitutional situation.
