---
title: Verfassungsblog — Electoral Quotas for Women
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/electoral-quotas-for-women/
license: >-
  CC BY-SA 4.0 (Standard-Lizenz des Verfassungsblogs; einzelne Beiträge können
  abweichen). Namensnennung + Share-Alike erforderlich.
content_hash: "c670a221a11dde4e"
---
...
## Difficulties: are EQW constitutional?
...
Behind the political representation claim supporting EQW, there is the notion of mirror or descriptive representation, i.e., the representative relationship arises from a common feature between the representative and the represented (gender). EQW may also involve an expectation of some degree of substantive representation (women representatives are supposed to be responsive to women and their interests).
...
Finally, EQW interfere with at least three fundamental rights: active voting (restriction of voters’ freedom), passive voting (disqualification to be a candidate) and freedom of association (interference with political parties’ autonomy). 
...
With regards to the possible extension of EQW to other groups, most courts’ decisions on EQW do not provide much guidance. They do not distinguish between the constitutionality of electoral quotas in general and the constitutionality of EQW, and no comparison is undertaken between the women’s claim and those of other groups.

## From ‘Are EQW constitutional?’ to ‘When are EQW constitutional?
...
A remaining question is whether the theoretical framework for assessing the constitutionality of EQW is extendable to other groups, and if so, what kind of adjustments should be necessary.
