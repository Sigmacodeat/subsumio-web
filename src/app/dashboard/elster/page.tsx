...
function SubmissionRow({
  ...
  return (
    <div
      ...
      className="flex cursor-pointer items-center gap-3 rounded-lg border border-[color:var(--ds-border)] bg-[color:var(--ds-surface)] px-4 py-3 transition-[background-color,border-color,color] hover:bg-[color:var(--ds-surface-2)] motion-reduce:transition-none"
    >
