---
title: Verfassungsblog — Sancta Corona, ora pro nobis
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/sancta-corona-ora-pro-nobis-2/
license: >-
  CC BY-SA 4.0 (Standard-Lizenz des Verfassungsblogs; einzelne Beiträge können
  abweichen). Namensnennung + Share-Alike erforderlich.
content_hash: "58e3ab03156150b3"
---

# Sancta Corona, ora pro nobis

I'm slightly embarrassed to bother you with this every time, but you can see for yourself what's going on here. Please support us with a subscription via Steady or a one-time payment (paypal@verfassungsblog.de or IBAN DE41 1001 0010 0923 7441 03). Thanks!

The full blast of the crisis hasn't quite arrived yet in Germany. Most of us are sitting in our apartments, grounded, sedentary and netflix-numbed, the spring outside agleam like a polished object in a glass case. Some mother of a friend of a sister-in-law is said to have symptoms. Everything is the same and everything is different. No triage in Germany, unlike in Alsace, yet. We can still go out jogging. We have not yet run out of toilet paper. We are not yet sick ourselves.
...
What the authorities are allowed to do in the fight against the pandemic and what compensation claims exist, is the subject of comparative online symposium under the title “Fighting COVID 19”, which we held this week with contributions from ANIKA KLAFKI and ANDREA KIESSLING (Germany), PAUL F. SCOTT (UK), WEN-CHEN CHANG (Taiwan), LEILA BARRAZA and SARAH A. WETTER (USA), YUXUE FANG (China), FELIX UHLMANN (Switzerland), DILETTA TEGA and MICHELE MASSA (Italy), TOON MOONEN and JONAS RIEMSLAGH (Belgium), SEOKMIN LEE (South Korea) and possibly more in the next days.
...
All the best to you, and stay home and healthy!
