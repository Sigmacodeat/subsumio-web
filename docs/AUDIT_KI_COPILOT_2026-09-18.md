...
| --- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------- | ----------------------------------------------------------------------------- |
| A1a | **Erledigt 18.09.:** Entscheidung der Inhaber: zuerst Qualität, Datenschutz/Verschlüsselung folgt, Anbieter bleibt austauschbar. Engine-Stufen umgestellt: utility und subagent → Claude Sonnet 5, reasoning → Claude Opus 5, deep → Claude Fable 5.1 (OpenRouter und nativ). DeepSeek und Grok sind raus. Preise in `model-pricing.ts`; Mindest-Ausgabelimit von 16k für Modelle, die standardmäßig denken (`effectiveMaxOutputTokens` in `gateway.ts`). Hinweis für später: Fable 5.1 verlangt 30 Tage Datenaufbewahrung beim Anbieter (kein ZDR). | S              | Tests grün; Prod-Config `models.tier.*` darf die Defaults nicht überschreiben |
