---
title: Verfassungsblog — Seven Months in the Freezing Forest
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/seven-months-in-the-freezing-forest/
license: >-
...
The quality and independence of the investigation is highly questionable – not only because the investigators have failed to interview my informants, but also because the IDB is silent about any actions of other state agents deployed at the border. My interviewees have consistently underlined that those being violent towards them were not regular border guards but unidentified masked men in dark uniforms. Further, whilst only referring to alleged physical violence, the IDB has chosen to ignore that people were forced to remain in the forest for months in inhuman conditions. The latter approach, however, is hardly surprising, given that pushbacks have been legalised in the Latvian domestic law.

## Latest developments

Following the decision of Rezekne district administrative court in March 2022, non-EU nationals have been allowed to submit asylum claims at official border crossing points and the Daugavpils centre. The amendments, however, do not go far enough, as intermediaries normally bring people to places outside border crossing points. The Ministry of Interior statistics suggests that pushbacks still remain systematic practice. In September 2022, for instance, the border guards report having stopped around 300 attempts to cross the green border, with similar numbers being recorded in October. It is most likely that behind these figures is a much smaller number of people who, like previously, are pushed back and forth multiple times.

 References[+]

 References  

 &#8593;1 While  Kurdish-ethnic Iraqi nationals make up the majority of those who attempted to cross into Latvia from Belarus, people trapped at the border also included Iraqi nationals of other backgrounds, as well as nationals of Afghanistan, Syria, Guinea, Pakistan, Sri Lanka, Eritrea and Turkey.
