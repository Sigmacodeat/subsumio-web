...
export const D = {
  ...
  "strategy.error_load_cases": {
    de: "Akten konnten nicht geladen werden. Bitte versuchen Sie es später erneut.",
  ...
  "casesnew.quick_desc": {
    de: "Schnell eine Akte anlegen. Details ergänzen Sie später auf der Akten-Seite.",
  ...
  "litigation.empty": {
    de: "Noch keine Verfahren angelegt. Erstellen Sie Ihr erstes Verfahren, um die prozessuale Phasenführung zu starten.",
  ...
  "analytics.description": {
    de: "Gerichts-, Richter- und Outcome-Analytics für Ihre Kanzlei",
