---
title: >-
  Verfassungsblog — Werner Heun lässt vom Karlsruher OMT-Beschluss nur einen
  feuchten Fleck übrig
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: >-
  https://verfassungsblog.de/werner-heun-laesst-vom-karlsruher-omt-beschluss-nur-einen-feuchten-fleck-uebrig/
license: >-
  CC BY-SA 4.0 (Standard-Lizenz des Verfassungsblogs; einzelne Beiträge können
  abweichen). Namensnennung + Share-Alike erforderlich.
content_hash: "ce4f40a7ac371b72"
---
...
Angesichts der Bedeutung der Entscheidung sollte man erwarten, dass das BVerfG um eine besonders sorgfältige und abgesicherte Argumentation bemüht ist. Leider ist das Gegenteil der Fall.
...
fortgesetzt steile Thesen ohne nähere Begründung apodiktisch verkündet.”)
...
die Frage, wem die Organe der Europäischen Union und die deutschen  Verfassungsorgane folgen werden, da sie nur entweder Unions- oder Verfassungsrecht befolgen können. Das ist eine Macht-, keine Rechtsfrage. Hier hat sich das BVerfG in eine höchst ungünstige Lage manövriert.
