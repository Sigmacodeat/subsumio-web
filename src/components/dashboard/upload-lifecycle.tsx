        ...
        return (
          <Fragment key={s.key}>
            {i > 0 && (
              <div
                aria-hidden
                className={`h-px w-3 shrink-0 transition-[background-color,border-color,color] motion-reduce:transition-none ${
            ...
            >
              <span
                ...
                className={`flex h-4 w-4 shrink-0 items-center justify-center rounded-full border transition-[background-color,border-color,color] motion-reduce:transition-none ${
                  state === "done"
              ...
              <span
                className={`hidden text-[0.6875rem] whitespace-nowrap transition-[background-color,border-color,color] motion-reduce:transition-none sm:inline ${
