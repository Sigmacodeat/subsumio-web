---
title: Verfassungsblog — The Trump Administration’s Attack on Knowledge Institutions
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/education-democracy-america/
license: >-
  CC BY-SA 4.0 (Standard-Lizenz des Verfassungsblogs; einzelne Beiträge können
  abweichen). Namensnennung + Share-Alike erforderlich.
content_hash: "c00074917480038c"
---
...
- punishing press outlets that don’t comply with Trump’s view of the world, e.g. suspending the AP’s participation in press briefings because it refused to go along with Trump’s renaming of the Gulf of Mexico – an episode that reflects not just an authoritarian but a totalitarian view of knowledge as whatever comes out of the mouth of the “leader”; in a free society, knowledge is not determined by Executive Order;

- ousting NBC, Politico, NYTimes, and NPR from office space at the Pentagon, to be replaced by One America News, Breitbart News, the New York Post, and HuffPost, and threatening to cancel subscriptions (depriving news media of financial support);

- launching investigations of or reinstating complaints about NPR, PBS, Comcast/NBC, ABC, and CBS, threatening their licenses;

- threatening to defund public news sources;

- accepting gifts and settlements from major media companies for the President’s benefit (e.g., in a defamation suit involving ABC), reflecting a relationship that’s often a feature of authoritarian governments.
...
- implied that “teach[ing] students that certain racial groups bear unique moral burdens that others do not” could be a Title VI violation, threatening intrusion on a core academic freedom (e.g., freedom to discuss group vs individual responsibility concepts);

- used the threat of fund withdrawal to force Columbia University to act against one of its own academic departments and modify its internal disciplinary procedures (with the apparent goal of more aggressively sanctioning protesters, in possible tension with university obligations to provide neutral decisionmaking in student disciplinary processes);

- terminated research grants (in science, on DEI-related subjects) and suspended Fulbright grants abruptly;

- attacked future grant-making at auxiliary knowledge institutions, like the NSF and NIH (including for vital medical research);

- misinterpreted the Supreme Court’s decision in SSFA v. Harvard to prohibit even race-neutral academic decisions, e.g. “eliminat[ing] standardized testing to achieve a desired racial balance or to increase racial diversity”.
