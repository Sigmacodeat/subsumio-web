  ...
  const t =
    language === "en"
      ? {
          ...
          d: "Conclusion",
          e: "Statutes",
          note: "AI draft — attorney review and approval required (EU AI Act Art. 50).",
        }
      : {
          h: "Rechtsgutachten",
          a: "Sachverhalt",
          ...
          d: "Ergebnis",
          e: "Einschlägige Normen",
          note: "KI-Entwurf — anwaltlich zu prüfen und freizugeben (EU AI Act Art. 50).",
        };
  const lines = [
    `# ${t.h}`,
    `> ${t.note}`,
