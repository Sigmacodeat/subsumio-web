  ...
  return (
    <Card className="overflow-hidden">
      <button
        ...
        className="flex w-full items-center gap-3 p-4 text-left transition-[background-color] duration-200 hover:bg-[color:var(--ds-hover)] focus-visible:ring-2 focus-visible:ring-[var(--brand-primary)] focus-visible:outline-none active:scale-[0.97] motion-reduce:transition-none"
