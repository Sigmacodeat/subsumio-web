---
title: 'Verfassungsblog — How just is the EU, or:  is there a ‘new’ European deficit?'
type: literatur
genre: aufsatz
jurisdiction: de
...
It is clear that much thinking is required in order to build the concerns of justice into the existing EU edifice, but it is imperative that we rise to this challenge.
