---
title: Verfassungsblog — State building in Greece
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/state-building-in-greece/
license: >-
  CC BY-SA 4.0 (Standard-Lizenz des Verfassungsblogs; einzelne Beiträge können
  abweichen). Namensnennung + Share-Alike erforderlich.
content_hash: "7b91877162469dad"
---
...
Second, the reform measures will be challenged either in courts, or through guidelines. A main factor that makes the reform legislation vulnerable in courts is the opaqueness, fragmentation, and complexity of the Greek legislation. Reforms are also blocked or suspended through administrative guidelines, which purportedly interpret and implement legislation, but in fact neutralize some of the reform measures contra legem.
