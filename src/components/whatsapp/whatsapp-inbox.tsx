      ...
      <div className="flex h-full flex-col">
        ...
        <div className="flex items-center gap-3 border-b border-[color:var(--ds-border)] px-4 py-3">
          <button
            ...
            className="text-[color:var(--ds-text-muted)] transition-[background-color,border-color,color] hover:text-[color:var(--ds-text)] focus-visible:ring-2 focus-visible:ring-[color:var(--brand-primary)] focus-visible:outline-none active:scale-[0.97] motion-reduce:transition-none"
          >
            <ArrowLeft size={18} />
          </button>
        ...
        {filteredConversations.map((conv) => {
          ...
          return (
            <button
              ...
              className="flex w-full items-center gap-3 px-4 py-3 text-left transition-[background-color,border-color,color] hover:bg-[color:var(--ds-surface-2)] focus-visible:ring-2 focus-visible:ring-[color:var(--brand-primary)] focus-visible:outline-none active:scale-[0.97] motion-reduce:transition-none"
            >
