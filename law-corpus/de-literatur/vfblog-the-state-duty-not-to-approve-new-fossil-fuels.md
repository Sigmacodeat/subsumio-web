---
title: Verfassungsblog — The State Duty Not to Approve New Fossil Fuels
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/the-state-duty-not-to-approve-new-fossil-fuels/
license: >-
...
## New fossil fuel projects are incompatible with limiting global temperatures to 1.5ºC (or 2ºC)

The 1.5ºC temperature limit grounds the due diligence standard in the climate context. The ICJ described this limit as the “primary” goal of the climate treaties, in line with the best available science. (ICJ AO, paras. 197, 224) The 1.5°C limit also informs the conduct required of States in fulfilling their other obligations, consistent with the interpretative principle of systemic integration.

With every increment of warming beyond 1.5ºC, risks to the climate system compound and accelerate unpredictably, including the risk that foundational sub-components of the climate system will pass tipping points and irreversibly unravel. (IPCC, B)

New fossil fuels are incompatible with limiting global temperatures to 1.5ºC. That’s because, globally, there are vast reserves contained in projects that are already developed or under-construction—so vast, that if we burned them all we would exceed the “budget” of carbon dioxide that we can globally emit while keeping temperatures to even 2ºC (IPCC, B.5.3). The global 1.5ºC carbon budget is almost depleted: at current rates of emissions, there is a 1-in-2 chance it will be gone within three years. Researchers estimate that, to stay below 1.5ºC, approximately 60% of fossil fuels in existing projects must therefore remain in the ground.
...
Recent social and political science research indicates that new fossil fuel projects are not necessary—instead, a ban would yield economic and social benefits. First, new fossil fuel projects are not required to meet global energy needs. This is supported by analysis of the most recent IPCC scenarios modelling feasible pathways consistent with limiting future warming to 1.5ºC and with thresholds for CDR feasibility and sustainability, under which global energy needs are met – the vast majority of these do not require new fossil fuel projects.
...
The blog has been amended to clarify that the subset of IPCC scenarios analysed by Green et al. includes C1 scenarios that comply with IPCC feasibility and sustainability thresholds for CDR and that, among those scenarios, the ‘vast majority’ do not require new fossil fuel projects. The blog originally described this subset as including &#8216;feasible' C1 pathways, and stated that none included new developments.
