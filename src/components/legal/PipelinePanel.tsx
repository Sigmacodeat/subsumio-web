    ...
    <div className="space-y-4">
              ...
              return (
                <div key={layer.num}>
                  <button
                    ...
                    className={cn(
                      "flex w-full items-center gap-2 rounded-lg border px-3 py-2 text-left transition-[background-color,border-color,color] active:scale-[0.99] motion-reduce:transition-none",
      ...
      {isError && !loading && (
        <div className="rounded-xl border border-[color:var(--ds-danger)] bg-[color:var(--ds-surface)] p-6 text-center">
          ...
          <button
            onClick={() => refetch()}
            className="mt-3 inline-flex items-center gap-2 rounded-lg bg-[color:var(--brand-solid)] px-4 py-2 text-sm font-medium text-white transition-[background-color,border-color,color] hover:bg-[color:var(--brand-solid-hover)] focus-visible:ring-2 focus-visible:ring-[var(--brand-primary)] focus-visible:ring-offset-1 focus-visible:outline-none active:scale-[0.99] motion-reduce:transition-none"
          >
            <RefreshCw size={14} />
            Erneut versuchen
          </button>
