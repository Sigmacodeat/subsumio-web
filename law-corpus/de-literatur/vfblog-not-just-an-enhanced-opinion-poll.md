---
title: Verfassungsblog — Not Just an Enhanced Opinion Poll
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/not-just-an-enhanced-opinion-poll/
license: >-
...
Under the current settlement, a lawful and legally binding referendum on independence requires the consent of the UK government to a s30 order under the Scotland Act. Efforts on the part of the Scottish government to secure such an order have proven fruitless: partially, but not exclusively, due to the exceptionally high turnover rate of UK Prime Ministers. In response, the Scottish government has set out an ambitious roadmap for a second referendum on independence. A cornerstone of the roadmap is the draft Scottish Independence Referendum Bill that would provide for a consultative referendum on independence, the idea being that a consultative referendum sidesteps the politically unobtainable s30 order. 
