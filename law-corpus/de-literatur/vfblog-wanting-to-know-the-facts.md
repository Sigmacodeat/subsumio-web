---
title: Verfassungsblog — Wanting to Know the Facts
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/wanting-to-know-the-facts/
license: >-
  CC BY-SA 4.0 (Standard-Lizenz des Verfassungsblogs; einzelne Beiträge können
  abweichen). Namensnennung + Share-Alike erforderlich.
content_hash: "ccd8af9c8d3c6436"
---
...
This week, the German Federal Constitutional Court held a hearing on the „Eigenmittelbeschluss-Ratifizierungsgesetz” (ERatG). The political decisions, which codified the “Next Generation EU” reconstruction fund, encountered old legal issues. RUTH WEBER reports.

Following the US Supreme Court's ruling ending the constitutionally guaranteed right to abortion, Facebook and Instagram almost immediately began removing posts informing people about access to abortion pills. ALEKSANDRA KUCZERAWY and LIDIA DUTKIEWICZ take a look at how the EU Digital Services Act can prevent censorship by social media platforms.
