---
title: Verfassungsblog — The Dangers of Freezing and Seizing
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/the-dangers-of-freezing-and-seizing/
license: >-
  CC BY-SA 4.0 (Standard-Lizenz des Verfassungsblogs; einzelne Beiträge können
  abweichen). Namensnennung + Share-Alike erforderlich.
content_hash: "072bcf098da36f56"
---
...
Under the current Polish constitutional provisions, the overall rule specifies that the Polish state protects the right of ownership and inheritance (Article 21(1) of the Polish Constitution). Factual seizure of assets and/or property by the state can however occur in two situations: One option, namely expropriation, remains irrelevant to the case of the assets of Russian oligarchs because it can occur only due to a public cause and with adequate compensation (Article 21(2) of the Polish Constitution). The second realm of possibility of effective seizure of assets by the state requires a final judgment by a court of law declaring such punitive measures to be applied (Article 46 of the Polish Constitution).
