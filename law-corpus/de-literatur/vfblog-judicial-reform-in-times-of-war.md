---
title: Verfassungsblog — Judicial Reform in Times of War
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/judicial-reform-in-times-of-war/
license: >-
  CC BY-SA 4.0 (Standard-Lizenz des Verfassungsblogs; einzelne Beiträge können
  abweichen). Namensnennung + Share-Alike erforderlich.
content_hash: "039800532b917a24"
---
...
## Civil society and international experts as Ukrainian solution for judicial reform
...
Ukrainian solutions are bold and effective and they are already working not only in Ukraine but also in Moldova which is implementing judicial governance reforms following Ukrainian approach. It is time for Europe to reconsider some old models and ideas.
