          ...
          {connectors.map((c) => {
            ...
            return (
              <div
                key={c.service}
                className={cn(
                  "flex items-center gap-4 rounded-xl border px-4 py-3 transition-[background-color,border-color,color,box-shadow,opacity,transform] duration-200 ease-[cubic-bezier(0.32,0.72,0,1)] motion-reduce:transition-none",
                  isLegal
