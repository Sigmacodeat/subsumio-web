---
title: 'Verfassungsblog — Panama Lessons: Less Privacy, More Tax Justice'
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/panama-lessons-less-privacy-more-tax-justice/
license: >-
...
## … but avoid redundant reporting duties …

Today, international tax information law has more and more adopted rules of traditional tax (money) law. Like the duty to pay taxes, obligations to provide tax-relevant information touches fundamental rights of taxpayers. Where states aim at avoiding double taxation as well as double non-taxation, they should do the same for information. The future international tax information framework needs to clarify in how far (and where) taxpayers can be obliged to provide the same piece of information twice, i.e. to the fiscal authorities of different countries. In the context of proportionality of a duty to provide information, courts may apply a test of necessity – arguing that in an EU or even international administrative network, horizontal delivery of information takes precedence over the imposition of a double burden upon taxpayers.
