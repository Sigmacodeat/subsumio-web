---
title: >-
  Verfassungsblog — Serbia and Covid-19: State of Emergency in a State in
  Disarray
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: >-
  https://verfassungsblog.de/serbia-and-covid-19-state-of-emergency-in-a-state-in-disarray/
license: >-
...
According to the Serbian Constitution, however, the SoE should normally be proclaimed by the National Assembly, with a majority vote of all deputies (Art 105). Although Article 200(5) leaves a possibility that the SoE is proclaimed by the President of the Republic together with the President of the National Assembly and the Prime Minister, this is only possible if the National Assembly is not in a position to convene. The rationale of this provision is clear: it is imaginable that in extreme situations when “the survival of the state or its citizens is threatened by a public danger”, the National Assembly might not be in a position to physically convene, at least not in a timely manner. However, it seems that this possibility of bypassing the National Assembly was interpreted rather extensively in the context of Covid-19, as it is doubtful whether one could claim that the National Assembly was not in a position to convene as a result of the ongoing epidemic – especially when keeping in mind the sequence of events that led to the bypassing of the National Assembly: the Serbian Government on 11 March 2020 (i.e. four days before the SoE was proclaimed) passed a decision preventing indoor public gatherings of over 100 people in enclosed spaces. Based on this decision, the authorities reasoned that the National Assembly is not in a position to convene since a gathering of 250 deputies would be in violation of the decision. This is how the Government concluded that it would be justified to declare the SoE without the National Assembly.
...
## (In)activity of the Judiciary

If the above examples are mostly indicative of the conduct of the Government (and the regrettably limited role of the highest legislative organ, the National Assembly), there are also far more distressing instances of the conduct of the Serbian judiciary. Two brief examples:
