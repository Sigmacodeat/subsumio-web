...
See also: [Acme](companies/acme.md), [Bob](people/bob.md), [Charlie](people/charlie.md).`,
      timeline:
        "- **2026-04-18** | Met Alice [Source: meeting, 2026-04-18]\n- **2026-03-15** | Event",
      frontmatter: {
        role: "CEO",
        company: "Acme",
...
describe("scorePage — company / concept / source / media defaults", () => {
  ...
  test("recency_score decays with age", () => {
    ...
    expect(freshScore.dimensionScores.recency_score).toBeGreaterThan(
      oldScore.dimensionScores.recency_score
    );
  });
  ...
  test("non_redundancy penalizes repeated-line pages", () => {
    ...
    const page: Page = {
      id: 1,
      slug: "people/repetitive",
      type: "person",
      title: "x",
      compiled_truth: repeated,
      timeline: "",
      frontmatter: {},
      created_at: new Date(),
      updated_at: new Date(),
