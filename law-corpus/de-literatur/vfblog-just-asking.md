---
title: Verfassungsblog — Just Asking
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/just-asking/
license: >-
...
Whatever it is you tease out should not be psychologized or scrutinized in some form of crooked remote diagnosis. People are complicated. They have various, conflicting motives, and it is impossible to clearly tie simplistic projections of what the interviewer perceives to be the motives of the interviewee to the latter’s concrete actions. Yet, if one conducts enough interviews, one can get a general impression of prevailing arguments, perceptions, and communicated goals, which may help to make some sense of individual or group behavior.
