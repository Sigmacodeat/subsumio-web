...
| D0-b | Fehlerbehandlung           | #71 | a98a5140c5   | 🔄 PR   | Engine-Writes mit Statusprüfung (`engineWriteOrThrow`), OPOS-Import idempotent, Listen-Routen 503 statt Leerzustand, `readApiError`, CI-Guard `check-unchecked-engine-writes`    |
