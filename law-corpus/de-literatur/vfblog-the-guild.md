---
title: Verfassungsblog — The Guild
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/the-guild/
license: >-
  CC BY-SA 4.0 (Standard-Lizenz des Verfassungsblogs; einzelne Beiträge können
  abweichen). Namensnennung + Share-Alike erforderlich.
content_hash: "30e1a6e79cad9a0f"
---
...
The Polish government demands war reparations from Germany. Andreas Buser shows how complicated the situation is under international law.

Tímea Drinóczi thinks, the Hungarian government’s replies and remedial measures to the Rule of Law conditionality mechanism are nothing but a sham.

Gábor Mészáros & Kim Lane Scheppele analyze the “Integrity Authority”, the centerpiece of the Hungariangovernment’s program.

On Election Day in Bosnia & Herzegovina, High Representative Christian Schmidt once again used his &#8216;Bonn powers' to impose changes to the state's Election Law. Jens Woelk & Maja Sahadžić analyze the impact of this intervention.
...
Silvia Steininger closes our blog debate on Coping Strategies of Domestic and International Courts in Times of Backlash.
