...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/subsumio/sicherheit", languages: { en: "/subsumio/sicherheit", de: "/de/subsumio/sicherheit" } },
};
...
export default function Page() {
  return (
    <>
      ...
      <JsonLd data={breadcrumbLd([{ name: "Subsumio", url: "/subsumio" }, { name: "Security & GDPR", url: "/subsumio/sicherheit" }])} />
      <SicherheitPage lang="en" />
    </>
  );
}
