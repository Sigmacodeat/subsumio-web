      ...
      <CardContent className="grid gap-3 p-4 sm:grid-cols-2 lg:grid-cols-5">
        {actions.map(({ href, label, count, icon: Icon }) => (
          <Link
            key={href}
            href={href}
            className="group rounded-lg border border-[color:var(--ds-border)] bg-[color:var(--ds-surface-2)] p-3 transition-[background-color,border-color,color,box-shadow,transform,opacity] hover:-translate-y-0.5 hover:border-[color:var(--ds-border-strong)] hover:shadow-sm focus-visible:ring-2 focus-visible:ring-[color:var(--ds-ring)] focus-visible:outline-none active:scale-[0.99] motion-reduce:transition-none"
          >
