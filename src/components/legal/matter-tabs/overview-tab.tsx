      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <div className="relative ml-auto" ref={moreActionsRef}>
          <button
            ...
            className={cn(
              "flex items-center gap-1.5 rounded-lg px-2.5 py-1.5 text-xs font-medium transition-[background-color,border-color,color] active:scale-[0.99] motion-reduce:transition-none md:text-sm",
              moreActionsOpen
            ...
            <div className="absolute top-full right-0 z-20 mt-1 min-w-[220px] rounded-lg border border-[color:var(--ds-border)] bg-[color:var(--ds-surface)] py-1 shadow-[var(--ds-shadow-2)]">
              ...
              {(ctx.userRole === "admin" || ctx.userRole === "lawyer") && (
                <button
                  ...
                  className={cn(
                    "flex w-full items-center gap-2 px-3 py-1.5 text-xs font-medium transition-[background-color,border-color,color] active:scale-[0.99] motion-reduce:transition-none md:text-sm",
            ...
            {getAllowedTransitions(caseData.status as CaseStatus).map((target) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "flex items-center gap-1.5 rounded-lg border px-3 py-2 text-xs font-medium transition-[background-color,border-color,color,box-shadow,opacity,transform] duration-[var(--ds-duration-normal)] ease-[cubic-bezier(0.32,0.72,0,1)] active:scale-[0.99] motion-reduce:transition-none",
            ...
            <div className="space-y-1.5">
              {caseData.relatedCaseSlugs.map((slug) => (
                <Link
                  ...
                  className="flex items-center gap-2 rounded-lg border border-[color:var(--ds-border)] bg-[color:var(--ds-hover)] px-3 py-2 text-sm transition-[background-color,border-color,color] hover:border-[color:var(--ds-border-strong)] hover:bg-[color:var(--ds-active)] motion-reduce:transition-none"
                >
