...
export const LANDING = {
  ...
  es: applyReplacements(JSON.parse(JSON.stringify(_landingEn)), {
    ...
    "Every matter,": "Cada asunto,",
    "one cited answer.": "una respuesta citada.",
  ...
  pl: applyReplacements(JSON.parse(JSON.stringify(_landingEn)), {
    ...
    "Every matter,": "Każda sprawa,",
    "one cited answer.": "jedna cytowana odpowiedź.",
  ...
  fr: applyReplacements(JSON.parse(JSON.stringify(_landingEn)), {
    ...
    "Every matter,": "Chaque dossier,",
    "one cited answer.": "une réponse citée.",
  ...
  nl: applyReplacements(JSON.parse(JSON.stringify(_landingEn)), {
    ...
    "Every matter,": "Elke zaak,",
    "one cited answer.": "één geciteerd antwoord.",
