        ...
        <div className="border-b [border-color:var(--mk-border)] p-3">
          <div className="relative">
            ...
            <input
              ...
              placeholder="Suchen…"
              className="w-full rounded-lg border [border-color:var(--mk-border)] py-2 pr-3 pl-9 text-sm [color:var(--mk-text)] [background:var(--mk-surface-2)] placeholder:[color:var(--mk-text-subtle)] focus:border-[color:var(--brand-primary)] focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--brand-primary)] focus-visible:ring-offset-1"
            />
            {search && (
              <button
                onClick={() => setSearch("")}
      ...
      >
        <div className="flex items-center justify-between">
          <h2
            ...
            className="flex items-center gap-1.5 text-sm font-semibold [color:var(--mk-text)]"
          >
  ...
  return (
    <div className="space-y-3 border-t [border-color:var(--mk-border)] px-5 py-4 [background:var(--mk-surface-2)]">
      <textarea
        ...
        autoFocus
        className="w-full rounded-lg border [border-color:var(--mk-border)] px-3 py-2 text-sm [color:var(--mk-text)] [background:var(--mk-surface-2)] placeholder:[color:var(--mk-text-subtle)] focus:border-[color:var(--brand-primary)] focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--brand-primary)] focus-visible:ring-offset-1"
      />
