---
title: Verfassungsblog — Climate Law as a ‘Living Tree’
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/climate-law-as-a-living-tree/
license: >-
  CC BY-SA 4.0 (Standard-Lizenz des Verfassungsblogs; einzelne Beiträge können
  abweichen). Namensnennung + Share-Alike erforderlich.
content_hash: "a1526832bd794252"
---
...
Beach J also rejected the novel duty of care. His Honour started by characterising Sharma as a case where exercising a statutory power has created or exacerbated a risk of harm (to be distinguished from cases where there has been a failure to exercise a statutory power, or the exercise of a statutory power has not gone far enough). In these types of cases, Beach J noted that policy and incoherency questions may assume lesser relevance as the duty concerns a positive act giving rise to the risk of harm, rather than a failure to exercise or sufficiently exercise any statutory power.

Nevertheless, Beach J held that there was insufficient closeness and directness between the Minister’s exercise of statutory power and the potential effects on the children to find a duty of care. More specifically, there was no temporal closeness between the Minister’s decision and the potential effects on the children, no geographic closeness as the children were all over Australia, no causal closeness as there were many links in the causal chain, and no relationship between the Minister and the children in the Act or otherwise. In addition, his Honour found that the posited duty would result in indeterminate liability. It was not possible to determine today the likely number of children who would be likely to suffer loss and there was no meaningful limit on the nature and extent to which the children would suffer harm.
