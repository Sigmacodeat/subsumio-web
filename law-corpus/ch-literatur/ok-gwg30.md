---
title: Onlinekommentar — Art. 30 GwG
type: literatur
genre: kommentar
jurisdiction: ch
...
authors:
  ...
  - Simon Zaugg
citation: >-
  Nathalie Kläy/Simon Zaugg, Kommentierung zu Art. 30 GwG in: Damian K.
...
source_url: https://onlinekommentar.ch/de/kommentare/gwg30
license: >-
...
12 Damit gewährleistet wird, dass sich der Informationsaustausch zwischen Meldestellen trotz des – im Gegensatz zu Rechtshilfeersuchen – informelleren Charakters sicher und regelbasiert gestaltet, wurde 1995 die Egmont Group gegründet. Die MROS ist seit dem Anfang ihres Bestehens, also seit 1998, Mitglied. Im August 2024 waren insgesamt 177 FIUs Mitglied der Egmont Group – Tendenz steigend. Dabei decken diese 177 Mitglieder alle Regionen der Welt ab, wobei aber gerade in Asien und Afrika noch einige Lücken auf der Karte zu finden sind. FIUs, die Mitglieder der Egmont Group sind, können über das Egmont Secure Web, ein elektronisches Kommunikationssystem, Informationen austauschen. Dabei ist zu erwähnen, dass weder Art. 30 GwG noch ein anderer Gesetzesartikel die MROS darauf limitiert, lediglich mit Mitgliedern der Egmont Group Informationen auszutauschen. Die Botschaft zur Änderung des Geldwäschereigesetzes vom 27. Juni 2012 präzisiert vielmehr, dass Art. 30 GwG sowohl für den Informationsaustausch mit Meldestellen der Egmont Group als auch mit den FIUs aller übrigen Staaten Gültigkeit hat.Botschaft GwG 2012, S. 6960. In der Praxis tauscht die Schweizer Meldestelle aber grundsätzlich nur Informationen mit den Mitgliedern der Egmont Group aus. Die Hauptgründe dafür sind einerseits ein gewisses «Gütesiegel» der ausländischen Meldestelle durch ihre Mitgliedschaft bei der Egmont Group und andererseits der zur Verfügung stehende Kommunikationskanal mittels Egmont Secure Web. Abhängig vom Sachverhalt und von den Merkmalen der ausländischen Meldestelle (bspw. Unabhängigkeit von anderen Behörden, interne Organisation oder Einhalten des Datenschutzes) wird eine Beantwortung der Anfrage einer FIU, welche nicht Mitglied der Egmont Group ist, in Betracht gezogen, sofern dies den Interessen der MROS dient.BSK-Berger, Art. 30 GwG N. 13.

13 Die Grundsätze für den Informationsaustausch zwischen Meldestellen, die für die Mitglieder der Egmont Group verbindlichEgmont Group Charta sowie die Egmont Group of Financial Intelligence Units Principles for Information Exchange Between Financial Intelligence Units.">Verbindliche Dokumente der Egmont Group sind die Egmont Group Charta sowie die Egmont Group of Financial Intelligence Units Principles for Information Exchange Between Financial Intelligence Units. sind, stellen sicher, dass die FIUs Informationen zur Bekämpfung der Geldwäscherei, der damit verbundenen Vortaten sowie der organisierten Kriminalität und der Terrorismusfinanzierung auf eine schnelle, konstruktive und effektive Weise austauschen. Dabei kann das Nichteinhalten der verbindlichen Grundsätze im schlimmsten Fall zum Ausschluss einer Meldestelle aus der Egmont Group führen.Botschaft GwG 2012, S. 6949.
...
19 Bei der Zusammenarbeit zwischen FIUs werden Informationen grundsätzlich nur zu Analysezwecken ausgetauscht. Das bedeutet, die Informationen dürfen für Analysen, Ermittlungen und/oder zur Erlangung von Ermittlungshinweisen, jedoch nicht als Beweismittel oder zur Unterstützung von Beweismitteln verwendet werden.Egmont Group of Financial Intelligence Units, Principles for Information Exchange Between Financial Intelligence Units, 2013, S. 8. Für Letzteres ist stets der Rechtshilfeweg zu beschreiten. Durch den Austausch zwischen Meldestellen darf nie die Rechtshilfe umgangen werden (Grund dafür ist die Wahrung der Rechte von Personen, welche Subjekt eines Rechtshilfeersuchens sind IRSG ff.">Vgl. Art. 11b IRSG ff.) und ein Doppelkanal (gleichzeitiger Austausch derselben Informationen via FIU- und Rechtshilfe-Kanal) gilt es aus Effizienzgründen stets zu verhindern.

#### 2. Geldwäscherei-Bezug

20 Die zweite Bedingung in lit. a ist vielschichtiger. Grundsätzlich bedeutet sie, dass die FIU-Anfrage Informationen enthalten muss, die explizit oder implizit Geldwäschereihandlungen beschreiben bzw. auf eine Vortat zur Geldwäscherei, organisierte Kriminalität oder Terrorismusfinanzierung hinweisen. Dabei ist zu betonen, dass beim Informationsaustausch zwischen FIUs die ausdrückliche Bedingung, dass es sich um eine Vortat «nach schweizerischem Recht» handeln muss, vom Gesetzgeber nicht vorausgesetzt wird. Im Art. 30 Abs. 4 lit. b GwG – erst wenn es um die Weitergabe von MROS-Informationen durch die Partner-FIU an ausländische Drittbehörden geht – wird dies eine Voraussetzung. In der Praxis interpretiert man jedoch die Teilbedingung «im Rahmen der Bekämpfung der Geldwäscherei und von deren Vortaten, der organisierten Kriminalität oder der Terrorismusfinanzierung» nach Schweizer Recht. Als Vortaten für Geldwäscherei gelten in der Schweiz gemäss Art. 305bis Abs. 1 StGB alle Handlungen in Bezug auf Vermögenswerte, die aus einem Verbrechen nach Art. 10 Abs. 2 StGB oder aus einem qualifizierten Steuervergehen nach Art. 305bis Abs. 1bis StGB herrühren. Jedoch muss in einer FIU-Anfrage die Vortat von der Partner-FIU nicht explizit genannt werden – es reicht, wenn mögliche Geldwäschereihandlungen aus dem Sachverhalt des Informationsschreiben ersichtlich werden.SHK-Beuret, Art. 30 GwG N. 68. Die Partner-FIUs mit ihrer Kernkompetenz, begründete Verdachtsfälle an Strafverfolgungsbehörden weiterzuleiten, befinden sich oft in einem frühen Stadium der Analyse und haben selbst noch keine gesicherten Anhaltspunkte, um die Vortat definitiv bestimmen zu können. Als Indikatoren für Geldwäschereihandlungen gelten im Prinzip per Analogie die im Anhang der GwV-FINMAGeldwäschereiverordnung-FINMA. enthaltenen Anhaltspunkte für Geldwäscherei. Wird in einer FIU-Anfrage also keine explizite Vortat erwähnt, kann die MROS zu Analysezwecken (ggf. auch zum Eruieren der Vortat) Informationen mit einer Partner-FIU austauschen.BSK-Berger, Art. 30 GwG N. 15. Erwähnt die Partner-FIU jedoch explizit eine Vortat, die nach Schweizer Gesetz keine Vortat für Geldwäscherei ist, und kann auch sonst keine Verbindung zu einem Verbrechen hergestellt werden (beispielsweise durch das Vorhandensein einer Meldung eines Schweizer Finanzintermediärs), gibt die MROS keine Informationen diesbezüglich an die anfragende Partner-FIU weiter.

21 Jede Jurisdiktion hat selbstverständlich eigene Gesetze und somit auch andere Vortaten für Geldwäscherei. Mehrheitlich herrscht jedoch auch auf internationaler Ebene eine ähnliche Auffassung von Geldwäscherei und deren Vortaten. Die FATF führt im Anhang ihres Recommendation-Dokumentes eine Liste von Straftaten auf, welche Mindestanforderungen an Vortaten zur Geldwäscherei vorgibt («Designated categories of offences»). In der Praxis nimmt die MROS bei zwei Delikten vertiefte Abklärungen vor, bevor sie Informationen an eine ausländische Meldestelle liefert bzw. ihr die Erlaubnis zur Weitergabe an ausländische Drittbehörden erteilt: Steuervergehen und Sanktionsumgehung. Bei einem solchen Verdacht klärt die Schweizer Meldestelle grundsätzlich vorgängig ab, ob der im Ausland analysierte Fall in der Schweiz tatsächlich unter eine Geldwäscherei-Vortat fällt oder nicht.Meldestelle für Geldwäscherei (MROS), Jahresbericht 2022, 2023, S. 10 f.

### D. Gegenrechtsprinzip (lit. b)

22 Der FIU-Austausch ist stets ein Geben und Nehmen. Von einer Meldestelle wird erwartet, dass sie mit ihren ausländischen Partnern jene Informationen, die sie nach dem in ihrem Land geltenden Recht erlangen kann, austauscht.Egmont Group of Financial Intelligence Units, Principles for Information Exchange Between Financial Intelligence Units, 2013, S. 5. Gesetzlich verankert ist dies im Gegenrechtsprinzip des lit. b. Als allgemeiner Grundsatz des Völkerrechts und Grundprinzip sowohl der FATF (Recommendation 40) als auch der Egmont Group (Principles for Information Exchange between Financial Intelligence Units) ist es einem Staat erlaubt, sein Verhalten gegenüber einem anderen Staat von dessen Verhalten in einer analogen Situation abhängig zu machen.SHK-Beuret, Art. 30 GwG N. 30. Eine FIU könnte die Zusammenarbeit folglich verweigern, zum Beispiel aufgrund mangelnder Gegenseitigkeit oder wiederholter unzureichender Zusammenarbeit.Egmont Group of Financial Intelligence Units, Principles for Information Exchange Between Financial Intelligence Units, 2013, S. 6. Die MROS kann sich dabei einzig an ihrer Erwartungshaltung und den bis dahin gemachten Erfahrungen mit einer Partner-FIU orientieren.Botschaft GwG 2012, S. 6978. In der Praxis ist dies aufgrund der verschiedenen Arten von FIUs (polizeilich, juristisch, administrativ) und den damit verbundenen unterschiedlichen Kompetenzen (z.B. können einige FIUs Vermögenswerte sperren, andere nicht) nicht immer so einfach. Schlussendlich ist und bleibt das gemeinsame Ziel aller FIUs aber die Bekämpfung der Geldwäscherei und deren Vortaten, der organisierten Kriminalität und der Terrorismusfinanzierung. Dies hat auch zur Folge, dass FIUs gewisse Informationen liefern, selbst wenn sie wissen, dass ihre Partner-FIU dies aufgrund fehlender Kompetenzen in diesem Bereich nicht kann. Lit. b schafft jedoch die Möglichkeit für die MROS, ihr Verhalten gegenüber einer ausländischen Meldestelle anpassen zu können bzw. gewisse Informationen nicht austauschen zu müssen, sofern sie feststellt, dass die Partner-FIU absichtlich und systematisch Informationen, welche sie unter ihrem gesetzlichen Rahmen einholen könnte, nicht liefert. Damit die FIUs der Egmont Group einen Überblick über die Art der FIU sowie die vorhandenen Kompetenzen ihrer Partner-FIUs haben, existiert der sogenannte «Egmont Biennial Census», der von allen FIUs alle zwei Jahre ausgefüllt bzw. aktualisiert wird.Egmont Group of Financial Intelligence Units, Annual Report 2020/2021, 2022, S. 22.

### E. Amts- oder Berufsgeheimnis (lit. c)

23 Lit. c stellt ebenfalls ein Grundprinzip der FATF und der Egmont Group (Principles for Information Exchange between Financial Intelligence Units) dar.SHK-Beuret, Art. 30 GwG N. 32. Diese Bestimmung besagt, dass sich alle Mitarbeitenden einer FIU rechtlich zur Wahrung des Amts- und Berufsgeheimnisses verpflichtet haben und ausreichend über die damit verbundenen Pflichten instruiert worden sein müssen.Botschaft GwG 2012, S. 6978.

### F. Weitergabeverbot ohne ausdrückliche Zustimmung (lit. d)

24 In lit. d wird festgehalten, dass eine FIU erhaltene Informationen nicht ohne ausdrückliche Zustimmung von der MROS an Dritte weitergeben darf. Die Grundlage für diese Bestimmung findet sich ebenfalls in den von der Egmont Group vorgegebenen Grundsätzen für den Informationsaustausch zwischen FIUs (Principles for Information Exchange between Financial Intelligence Units).BSK-Berger, Art. 30 GwG N. 20. Die Voraussetzungen für eine Weiterleitung der von der MROS an eine Partner-FIU übermittelten Informationen an ausländische Drittbehörden werden in Art. 30 Abs. 4 und 5 GwG geregelt. Lit. d ist deshalb so wichtig, weil der FIU-Informationsaustausch immer nur zu Analysezwecken dient und verhindert werden soll, dass diese Informationen an Behörden weitergegeben werden, welche sie als Beweismittel missbrauchen könnten. So wird sichergestellt, dass die Quelle der Informationen, also die übermittelnde FIU, die Kontrolle über die Weiterleitung und Verwendung der Informationen hat, nachdem sie einer Partner-Meldestelle übermittelt wurden. In der Praxis erfordert dies dennoch ein gewisses Mass an Vertrauen, welches zwischen den Mitgliedern der Egmont Group generell gegeben ist (und für einen effizienten FIU-Informationsaustausch gegeben sein muss).BSK-Berger, Art. 30 GwG N. 3. Auch die Kontrolle der Einhaltung dieser Bestimmung wird durch die Egmont Group bzw. durch ihre repressiven Massnahmen im Falle eines Verstosses (durch die Einleitung eines Nicht-Konformitäts-Verfahrens gemäss des Egmont Group Support and Compliance-Prozesses) gewährleistet.Egmont Group of Financial Intelligence Units, Egmont Group of Financial Intelligence Unit Charter, 2013, S. 5. Ausserdem müsste die ausländische FIU die Konsequenz eines Vertrauensbruchs tragen und würde vorerst keine Informationen von der MROS mehr erhalten – eine Folge, welche, unter Berücksichtigung der Wichtigkeit des Schweizer Finanzplatzes, nicht zu unterschätzen ist. Eine Wiederaufnahme des Informationsaustausches zwischen der Schweizer Meldestelle und der betroffenen FIU wäre erst wieder möglich, wenn eine befriedigende Erklärung für das Verfehlen der Einhaltung dieser Bestimmung abgegeben wurde und entsprechende Massnahmen, die einen solchen Verstoss in Zukunft verhindern sollen, getroffen wurden.

### G. Möglichkeit der MROS zur Erteilung von weiteren Auflagen und Verwendungsbeschränkungen (lit. e)

25 Lit. e bezweckt klarzustellen, dass die Bestimmungen in lit. a–d nicht abschliessende Voraussetzungen sind, sondern die Schweizer Meldestelle einer Partner-FIU weitere Auflagen und Verwendungsbeschränkungen auferlegen kann, und zwar sowohl in Einzelfällen als auch standardmässig.Botschaft GwG 2012, S. 6978. Dies aber nur insofern, als die Einhaltung aller rechtlichen Vorgaben (internationale Standards, Amtshilfeprinzipien, Egmont Principles etc.) durch die MROS gewährleistet ist. Dank dieser Bestimmung ist keine gesetzliche Anpassung notwendig, sollte der Disclaimer der Schweizer Meldestelle modifiziert werden müssen.SHK-Beuret, Art. 30 GwG N. 39.
...
27 Abs. 2 führt nicht abschliessende Beispiele («namentlich») verschiedener möglicher Inhalte auf, welche die MROS ausländischen Partnerbehörden übermitteln kann. Gleichzeitig bildet er die gesetzliche Grundlage für den Austausch von Finanzinformationen mit ausländischen FIUs, was Abs. 2 zum zentralen Bestandteil des am 1. November 2013 in Kraft getretenen Art. 30 GwG macht.Botschaft GwG 2012, S. 6978. Dieser Austausch von Finanzinformationen stellt grundsätzlich den grössten Mehrwert des FIU-Informationsaustausches dar, da diese Informationen meistens nur bei den FIUs vorliegen bzw. oft nur von ihnen (insbesondere auf so schnelle Art und Weise) eingeholt werden können. Die Tatsache, dass sich ein Absatz (Art. 30 Abs. 2 GwG) explizit und ausschliesslich dem Austausch von Finanzinformationen widmet, verdeutlicht seine Wichtigkeit (so werden die Personendaten, auf welchen der FIU-Austausch seitens der MROS vor der Einführung des Art. 30 GwG hauptsächlich basierte, lediglich in Abs. 1 des Art. 30 GwG kurz erwähnt).

28 Lit. a–d sind Beispiele von Finanzinformationen, die unter diesem Gesetz ausgetauscht werden können. Der Katalog solcher Finanzinformationen wurde vom Gesetzgeber bewusst offengehalten. Art. 30 Abs. 1 GwG sieht bereits vor, dass die MROS alle verfügbaren Informationen an ihre ausländischen Partnerbehörden übermitteln kann. Eine Beschränkung auf bestimmte Kategorien von Finanzinformationen würde in der Analysephase dem Ziel einer möglichst umfassenden Nutzung aller verfügbaren Informationen zuwiderlaufen.Botschaft GwG 2012, S. 6979. Zusätzlich zu den aufgeführten Inhalten unter Art. 30 Abs. 2 lit. a–d GwG gibt es weitere Finanzinformationen, welche von der MROS unter diesem Gesetz an eine ausländische Partner-FIU weitergegeben werden können. Die in der Praxis am häufigsten vorkommenden ergänzenden Finanzinformationen stellen Informationen zu Zeichnungsberechtigten, Bevollmächtigten, Kontrollinhabern, zum Saldo involvierter Vermögenswerte sowie KYC- (Know Your Customer-) Informationen dar.Botschaft GwG 2012, S. 6979.
...
42 Art. 30 Abs. 4 lit. b GwG besagt, dass die MROS einer ausländischen Meldestelle keine Genehmigung zur Weiterleitung an eine Drittbehörde erteilen darf, falls die Verdachtsmomente offensichtlich keine Vortat zur Geldwäscherei nach Schweizer Recht erkennen lassen. Die beidseitige Strafbarkeit wird eine definitive Voraussetzung.BSK-Berger, Art. 30 GwG N. 37. Dabei müssen die jeweiligen gesetzlichen Bestimmungen nicht identisch sein – es reicht aus, wenn die im Informationsschreiben beschriebenen Handlungen nach geltendem Recht beider Länder strafbar sind (nach Schweizer Recht muss es sich um ein Verbrechen oder qualifiziertes Steuervergehen handeln, da sonst die Einstufung als Vortat zur Geldwäscherei nicht gegeben ist). Zudem muss die Vortat von der ausländischen FIU nicht ausdrücklich erwähnt werden (auch wenn dies in der Praxis präferiert wird) – es genügt, wenn sie aus dem Sachverhalt des Informationsschreibens ersichtlich wird.SHK-Beuret, Art. 30 GwG N. 68. Im Zweifelsfall hat die MROS immer die Möglichkeit, weitere Informationen bezüglich der vermuteten Vortat bei der ausländischen Partnerbehörde einzuholen.
...
45 Art. 30 Abs. 4 lit. d GwG ist das Äquivalent zu Art. 30 Abs. 1 lit. c GwG und besagt, dass auch die ausländische Drittbehörde das Amts- und Berufsgeheimnis zu wahren hat bzw. deren Personal diesem unterstellt sein muss.Vgl. Ausführungen zu Art. 30 Abs. 1 lit. c GwG.
...
47 Die Idee des Gesetzgebers bei diesem Absatz war es, Schweizer Strafverfahren gegenüber ausländischen den Vorrang zu geben, um zu verhindern, dass die von der MROS an eine ausländische FIU übermittelten und anschliessend an eine Drittbehörde weitergeleiteten Informationen ein in der Schweiz laufendes Strafverfahren beeinträchtigen.Botschaft GwG 2012, S. 6983. Eine solche Situation ist basierend auf dem rechtlichen Grundsatz «ne bis in idem» denkbar.Art. 66 Abs. 1 IRSG zeigt exemplarisch auf, wie sich der Grundsatz «ne bis in idem» auf die Rechtshilfe auswirken kann. Würde eine ausländische Strafverfolgungsbehörde wesentliche Informationen zu einem Sachverhalt erhalten, der bereits in der Schweiz Gegenstand eines Strafverfahrens ist, und würde die ausländische Strafverfolgungsbehörde schneller zu einem Verfahrensabschluss gelangen als die schweizerische, wäre die Arbeit der Schweizer Staatsanwaltschaft aufgrund des Verbots der Mehrfachbestrafung unter Umständen vergebens gewesen. Ein weiteres denkbares Szenario, in dem Art. 30 Abs. 5 GwG einem Schweizer Strafverfahren in der Regel Vorrang einräumt, ist jenes, bei dem das Strafverfahren noch nicht parteiöffentlich ist und Zwangsmassnahmen geplant sind. Eine Weiterleitung der Informationen an eine ausländische Drittbehörde könnte dazu führen, dass die verdächtige Person Kenntnis vom Schweizer Strafverfahren erlangt, was zu dessen Beeinträchtigung führen könnte.
