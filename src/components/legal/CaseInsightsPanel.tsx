            ...
            {activeInsights.slice(0, 6).map((insight) => {
              ...
              return (
                <div
                  key={insight.id}
                  className={cn(
                    "group relative flex items-start gap-3 rounded-lg border px-3 py-2.5 transition-[background-color,border-color,color] hover:bg-[color:var(--ds-hover)] motion-reduce:transition-none",
                    styles.border,
                    styles.bg
                  )}
                >
