...
function WorkflowLink({
  ...
  return (
    <Link
      href={href}
      className="group rounded-xl border border-[color:var(--ds-border)] bg-[color:var(--ds-surface)] p-4 transition-[background-color,border-color,color] hover:bg-[color:var(--ds-surface-hover)] motion-reduce:transition-none"
    >
          ...
          <div className="w-1/2 space-y-1 overflow-y-auto" style={{ maxHeight: "400px" }}>
            {threads.map((thread) => (
              <button
                ...
                className={`w-full rounded-lg border px-3 py-2 text-left transition-[background-color,border-color,transform] duration-[var(--ds-duration-fast)] focus-visible:ring-2 focus-visible:ring-[color:var(--brand-primary)] focus-visible:outline-none active:scale-[0.99] motion-reduce:transition-none ${
