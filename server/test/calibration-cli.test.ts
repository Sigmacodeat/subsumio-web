...
function buildProfile(
  opts: Partial<CalibrationProfileRow> & { holder: string }
  ...
  return {
    ...
    pattern_statements: opts.pattern_statements ?? [
...
describe("parseArgs", () => {
  ...
  test("--holder <id>", () => {
    expect(parseArgs(["--holder", "people/charlie-example"]).opts.holder).toBe(
