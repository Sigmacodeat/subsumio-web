...
export const LEGAL_FRONTMATTER_SCHEMAS: Record<string, FrontmatterFieldSpec[]> = {
  ...
  // ── Pipeline Page Types (v2.2.0) ────────────────────────────────────
  on_index: [
    { key: "case_ref", type: "string", required: true, description: "Aktenreferenz" },
    { key: "total_on", type: "number", required: true, description: "Gesamtanzahl ON-Einträge" },
    { key: "total_pages", type: "number", required: true, description: "Gesamtanzahl Seiten" },
    {
      key: "aktenzeichen",
      type: "string",
      required: false,
      description: "Aktenzeichen des Gerichts",
    },
    { key: "source_document", type: "string", required: false, description: "Quell-Dokument-Slug" },
  ],
  forensic_report: [
    { key: "case_ref", type: "string", required: true, description: "Aktenreferenz" },
    {
      ...
      type: "enum",
      required: true,
      enum_values: ["draft", "review", "final"],
      description: "Bearbeitungsstatus",
    },
    { key: "critic_score", type: "number", required: true, description: "Critic-Score (0-100)" },
    { key: "focus", type: "string", required: false, description: "Fokus der Analyse" },
    { key: "model", type: "string", required: false, description: "Verwendetes KI-Modell" },
    {
      key: "generated_at",
      type: "datetime",
      required: false,
      description: "Generierungszeitpunkt",
    },
  ],
  damage_table: [
    { key: "case_ref", type: "string", required: true, description: "Aktenreferenz" },
    { key: "total_pots", type: "number", required: true, description: "Anzahl Schadenstöpfe" },
    { key: "currency", type: "string", required: true, description: "Währung (ISO 4217)" },
    {
      key: "total_amount_conservative",
      type: "number",
      required: false,
      description: "Konservativer Schadensgesamtwert",
    },
    {
      key: "total_amount_optimistic",
      type: "number",
      required: false,
      description: "Optimistischer Schadensgesamtwert",
    },
  ],
  deadline_calendar: [
    { key: "case_ref", type: "string", required: true, description: "Aktenreferenz" },
    {
      ...
      type: "number",
      required: true,
      description: "Anzahl kritischer Fristen (rot)",
    },
    {
      key: "warning_count",
      type: "number",
      required: false,
      description: "Anzahl Warnfristen (gelb)",
    },
    {
      key: "info_count",
      type: "number",
      required: false,
      description: "Anzahl Infofristen (grün)",
    },
  ],
  legal_draft: [
    { key: "case_ref", type: "string", required: true, description: "Aktenreferenz" },
    {
      ...
      description: "Art des Schriftsatzes",
    },
    {
      key: "status",
      type: "enum",
      required: true,
      enum_values: ["draft", "review", "approved", "filed"],
      description: "Status",
    },
    {
      key: "attorney_review_required",
      type: "boolean",
      required: true,
      description: "Anwaltsprüfung erforderlich",
    },
    {
      key: "recipient",
      type: "string",
      required: false,
      description: "Empfänger (Gericht/Behörde)",
    },
    { key: "model", type: "string", required: false, description: "Verwendetes KI-Modell" },
    {
      key: "generated_at",
    ...
    { key: "streitwert", type: "number", required: false, description: "Streitwert" },
  ],
  quality_audit: [
    { key: "case_ref", type: "string", required: true, description: "Aktenreferenz" },
    { key: "total_score", type: "number", required: true, description: "Gesamtscore (0-100)" },
    {
      key: "recommendation",
      type: "enum",
      required: true,
      enum_values: ["approve", "revise", "reject"],
    ...
    },
    {
      ...
      type: "string",
      required: false,
      description: "Auditierte Pipeline-Layer",
    },
    {
      key: "issues_found",
      type: "number",
      required: false,
      description: "Anzahl gefundener Issues",
    },
    { key: "model", type: "string", required: false, description: "Verwendetes KI-Modell" },
  ],
  pipeline_state: [
    { key: "case_ref", type: "string", required: true, description: "Aktenreferenz" },
    {
      ...
      type: "enum",
      required: true,
      enum_values: ["idle", "running", "paused", "completed", "error"],
      description: "Pipeline-Status",
    },
    { key: "current_layer", type: "string", required: false, description: "Aktuelle Layer" },
    { key: "layers", type: "string", required: false, description: "Layer-Historie (JSON)" },
    {
      key: "manual_overrides",
      type: "string",
      required: false,
      description: "Manuelle Overrides (JSON)",
    },
    { key: "total_duration_ms", type: "number", required: false, description: "Gesamtdauer in ms" },
  ],
};
