# DSG — Datenschutzgesetz (CH)

> **Stand:** Konsolidierte Fassung 2026 (revDSG)  
> **Fundstelle:** SR 235.1  
> **Typ:** Bundesgesetz über den Datenschutz
...
- **Jurisdiktion:** CH
- **Rechtsgebiet:** Datenschutz / Grundrechte
- **Instanz:** Bundesversammlung
- **In-Kraft-Treten:** 01.09.2023 (Totalrevision)
- **Letzte Änderung:** 15.09.2023 (revDSG)

## Anwendungsbereich

Das revidierte DSG regelt den Schutz personenbezogener Daten bei der
Bearbeitung durch private Personen und Bundesorgane. Es setzt die
entsprechenden internationalen Standards (insbesondere GDPR) teilweise um,
...
(2) Es gilt nicht für:
a. die Bearbeitung durch Kantone (kantonales Datenschutzrecht);
b. ausschliesslich persönliche und familiäre Tätigkeiten;
...
(2) **Bearbeitung** ist jeder Umgang mit personenbezogenen Daten, unabhängig
der angewandten Mittel und der Form (insbesondere Beschaffung, Aufbewahrung,
Verwendung, Weitergabe, Archivierung, Löschung).
...
e. Daten über Administrativ- und Strafverfolgungen;
...
c. zweckbestimmt sein;
d. auf dem aktuellen Stand sein.
...
c. die Bearbeitung für die Erfüllung eines Vertrags erforderlich ist;
...
c. die Kategorien von Empfängern;
d. die Aufbewahrungsdauer;
e. die Rechte der betroffenen Person
informieren.

(2) Die Informationspflicht entfällt, wenn die betroffene Person bereits
...
(2) Die Auskunft ist in der Regel kostenlos und innerhalb von 30 Tagen
zu erteilen.
...
a. die Bearbeitung unrechtmässig ist;
b. der Bearbeitungszweck entfallen ist;
...
a. freiwillig sein;
b. informiert sein;
c. für den konkreten Fall erfolgen;
d. nachweisbar sein.
...
d. ein Gesetz die Bearbeitung vorsieht.
...
(2) Die Meldepflicht entfällt für private Personen, die weniger als
50 Datenbearbeitungstätigkeiten ausüben und keine besonders schützenswerten
Daten bearbeiten.
...
b. die zuständige Behörde melden.

(2) Die Meldung hat unverzüglich, spätestens innerhalb von 72 Stunden
nach Kenntniserlangung zu erfolgen.

## Verweisstruktur

- Siehe auch: **OR** (Obligationenrecht) — Vertragsrechtliche Ansprüche
- Siehe auch: **ZGB** (Zivilgesetzbuch) — Persönlichkeitsrecht (Art. 28)
- Siehe auch: **StGB** (Strafgesetzbuch) — Strafbare Handlungen gegen die Privatsphäre
- Siehe auch: **UWG** (Bundesgesetz gegen den unlauteren Wettbewerb)
- EU-Bezug: DSGVO (EU) 2016/679 — vergleichbar, aber nicht identisch
- International: Konvention 108+ des Europarats

## Relevanz für Subsumio

- **Datenschutz:** Kernrecht für Kanzleien mit Datenschutz-Mandaten
- **Fristen:** 30 Tage Auskunftsfrist (Art. 7), 72 Stunden Meldefrist (Art. 13)
- **Compliance:** Verzeichnis der Bearbeitungstätigkeiten (Art. 12)
- **Datenresidenz:** Ausland-Übermittlung (Art. 11) — Angemessenheitsbeschluss
- **Berufsgeheimnis:** Anwältte unterliegen zusätzlich dem Berufsgeheimnis (StGB Art. 321)
