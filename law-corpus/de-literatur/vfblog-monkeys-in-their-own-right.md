---
title: Verfassungsblog — Monkeys in Their Own Right
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/monkeys-in-their-own-right/
license: >-
...
## A monkey unlawfully detained

RoN have been enshrined in the Ecuadorian constitution since 2008, making it the only country in the world to constitutionally explicitly guarantee RoN (at length Gutmann). Article 71 of the Ecuadorian Constitution (CRE for short) states:
...
This research was funded by the German Research Foundation (DFG), 421427080 – Die Natur als Rechtsperson, Andreas Fischer Lescano.
