---
title: Verfassungsblog — Resisting Membership Fatalism
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/resisting-membership-fatalism/
license: >-
...
Since it is the substance of EU membership that matters, it is important for democratic (Article 2 TEU abiding) Member States to understand the leverage they have beyond attempting to tighten the purse strings. We want to emphasize two points which show this considerable leverage, building on some embryonic arguments which we developed earlier (see here and here). Both boil down to the network effect of EU membership. Simply put, the value of EU membership is a function of the number of Member States. If one state leaves, the value of EU membership is reduced for those Member States that remain. In concrete terms then, the value for Poland of its EU membership could be significantly reduced even disregarding the suspension of  EU subsidies.
...
In our opinion a bolder approach is politically warranted, legally possible and credible. The stakes are simply too high for fatalism about EU membership.
