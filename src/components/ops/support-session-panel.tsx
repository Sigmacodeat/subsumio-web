  ...
  return (
    <section className="rounded-xl border border-[color:var(--ds-border)] bg-[color:var(--ds-surface)] p-5">
      ...
      <p className="mb-4 text-xs text-[color:var(--ds-text-muted)]">
        Direkter, protokollierter Zugriff auf die Kanzlei-Daten — jederzeit, ohne Freigabe durch
        die Kanzlei, aber mit Pflicht-Grund, für die Kanzlei sichtbar im Audit-Log und auf 60
        Minuten begrenzt.
      </p>
