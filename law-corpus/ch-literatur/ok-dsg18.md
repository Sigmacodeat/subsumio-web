---
title: Onlinekommentar — Art. 18 DSG
type: literatur
genre: kommentar
jurisdiction: ch
...
authors:
  - Apollo Dauag
citation: >-
  Apollo Dauag, Kommentierung zu Art. 18 DSG, in: Thomas Steiner/Anne-Sophie
...
source_url: https://onlinekommentar.ch/de/kommentare/dsg18
license: >-
...
3 Es handelt sich dabei um eine RechtsvermutungZK-Jungo, Art. 8 ZGB N. 286., sie ist unwiderlegbar: Erfüllt die Bekanntgabe die in Art. 18 aufgestellten Voraussetzungen (Fiktionsbasis), gilt sie als nicht tatbestandsmässig für die Bekanntgabe ins Ausland gemäss Art. 16 und 17 (Fiktionsfolge).
...
6 Die «Veröffentlichung in elektronischer Form» (vormals Art. 5 VDSG) wurde mit drei redaktionellen PräzisierungenDie Marginale wurde mit «von Personendaten» ergänzt. Vorher «zwecks Information», neu «zur Information». Vorher «Übermittlung ins Ausland», neu «Bekanntgabe ins Ausland, auch wenn die Daten vom Ausland aus zugänglich sind». in Art. 18 überführt. Im Entwurf und in der Botschafthttps://www.fedlex.admin.ch/eli/fga/2017/2057/de.">BBl 2017 6941, 7043; https://www.fedlex.admin.ch/eli/fga/2017/2057/de. war sie als Art. 15 referenziert, im Vorentwurf war sie noch nicht enthalten. Darüber hinaus war diese Bestimmung im Gesetzgebungsprozess unauffällig.
...
8 Das Internet kennt keine Ländergrenzen. Die Veröffentlichung von Personendaten im Internet hat unweigerlich deren globale Abrufbarkeit zur Folge – auch in Ländern ohne angemessenen Datenschutz. Weil der Empfängerkreis global und unbestimmt ist, kann die verantwortliche Person in der Schweiz die Voraussetzungen für eine zulässige Bekanntgabe ins Ausland nicht erfüllen. Das damit einhergehende Risko von Persönlichkeitsverletzungen nimmt der Gesetzgeber vermutungsweise als «Konzession an die zunehmende Digitalisierung»SHK-Husi-Stämpfli, Vorbemerkungen zu Art. 16–18 DSG N. 4. in Kauf.
...
15 In technologieneutraler Formulierung nennt Art. 18 «automatisierte Informations- und Kommunikationsdienste». In den Kommentierungen ist die Rede von «Internet bzw. internetbasierten Diensten» und «Webseiten, Blogs oder auch Nachrichtendienste wie Twitter etc.».SHK-Husi-Stämpfli, Art. 18 DSG N. 2. Auch «die Publikation via Apps, Streamingdienste, Video-on-Demand-Portale und vergleichbare Dienste» gehört dazu.BSK-Dal Molin, Art. 18 DSG N. 10. Erfasst wird jede Form der Veröffentlichung in elektronischer Form, die eine globale Abrufbarkeit ermöglicht. Dies gilt auch für E-Mail-Newsletter.BSK-Dal Molin, Art. 18 DSG N. 10 m.w.H.

16 Nach der vorliegenden Meinung ist der Serverstandort irrelevant:Gl.M.: BSK-Dal Molin, Art. 18 DSG N. 15; a.M.: Nach OFK-Kunz, Art. 18 DSG N. 2, sind Fälle, wo «Daten auf einen ausländischen Server hochgeladen werden» von Art. 18 ausgenommen.">Gl.M.: BSK-Dal Molin, Art. 18 DSG N. 15; a.M.: Nach OFK-Kunz, Art. 18 DSG N. 2, sind Fälle, wo «Daten auf einen ausländischen Server hochgeladen werden» von Art. 18 ausgenommen. Erstens besteht das Risiko der Abrufbarkeit aus Ländern ohne angemessenen Datenschutz (ohne Ländersperren, siehe oben N. 9) ungeachtet des Serverstandorts. Zweitens kann selbst bei einer initialen Speicherung in der Schweiz eine Vervielfältigung auf Server mit Standorten im Ausland nicht verhindert werden.Nach Husi-Stämpfli ist die Bekanntgabe ins Ausland «ein Nebeneffekt der durch die Digitalisierung bedingten Auflösung der Grenzen»: SHK-Husi-Stämpfli, Vorbemerkungen zu Art. 16–18 DSG N. 4. Drittens gilt das DSG auch für Sachverhalte, die sich in der Schweiz auswirken, auch wenn sie im Ausland veranlasst werden. Die Unterscheidung zwischen Servern mit Standort in der Schweiz und Servern mit Standort im Ausland erscheint hier nicht zielführend.
