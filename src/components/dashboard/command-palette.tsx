                              ...
                              .map((cmd) => {
                                ...
                                return (
                                  <button
                                    ...
                                    className={cn(
                                      "flex w-full items-center gap-3 rounded-lg px-4 py-2.5 text-left transition-[background-color,border-color,color] active:scale-[0.97] motion-reduce:transition-none",
                                      isActive
                      ...
                      {recentItems.map((cmd) => {
                        ...
                        return (
                          <button
                            ...
                            onMouseEnter={() => setActiveIndex(idx)}
                            className={cn(
                              "mx-0 flex w-full items-center gap-3 rounded-lg px-4 py-2.5 text-left transition-[background-color,border-color,color] active:scale-[0.97] motion-reduce:transition-none",
                              isActive
                                ? "brand-soft brand-text"
                                : "text-[color:var(--ds-text-muted)] hover:bg-[color:var(--ds-hover)]"
                            )}
