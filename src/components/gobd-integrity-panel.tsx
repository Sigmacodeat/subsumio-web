      ...
      <div className="space-y-3">
        {isInvoice ? (
          <button
            ...
            className="brand-soft brand-text brand-border hover:brand-soft-strong inline-flex items-center gap-2 rounded-lg border px-3 py-2 text-xs font-medium transition-[background-color,border-color,color,box-shadow,opacity,transform] duration-200 ease-[cubic-bezier(0.32,0.72,0,1)] disabled:opacity-50 motion-reduce:transition-none"
          >
            {state.kind === "checking" ? (
