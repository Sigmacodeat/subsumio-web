---
title: 'Verfassungsblog — Freedom of Assembly in Poland: Next in Line?'
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/freedom-of-assembly-in-poland-next-in-line/
license: >-
...
- FREDERIK FERREAU offers an in-depth analysis of the “state-owned corporations as right-holders” question raised by the nuclear plant case before the German Constitutional Court (in German),

- KONRAD LACHMAYER gives an overview of the mind-boggling chain of events in the run-up to the latest Presidential Elections in Austria, and JAN RYBAK argues that the far-right's defeat is no reason to relax,

- former UK Lord Speaker Baroness FRANCES D'SOUZA picks up MEG RUSSEL's demand to contain the number of peers to keep the House of Lords from growing out of proportion,

- MANUEL MÜLLER finds much to like about the plan to offer British citizens a post-Brexit EU citizenship perspective if they so wish (in German),
...
- STIJN SMETS observes a worrying trend at the ECtHR to condone the silencing of whistle-blowing civil servants,

- THERESA RICHARZ and FRANZISKA BRACHTHÄUSER call for legislative action against genital operations on intersexual children (in German),

- ROSELINE LETTERON strikes alarm about the latest weakening of judicial independence in France by the outgoing Prime Minister Manuel Valls (in French),
...
- JACK BALKIN lists five techniques of undermining democracy he expects President Trump to make use of, and a direct clamp-down on free speech is not one of them,

- DAVID BERNSTEIN asks progressives (i.e. the other guys) to stop worshipping Franklin D. Roosevelt.
