...
const res = await fetch(
  "https://www.bger.ch/index/juridiction/jurisdiction-inherit-template/jurisdiction-recht/jurisdiction-recht-urteile2000.htm",
  {
...
const detailLinks = [
  ...html.matchAll(/href="([^"]*(?:detail|urteil|entscheid)[^"]*\.htm[^"]*)"/gi),
];
