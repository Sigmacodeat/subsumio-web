---
title: Verfassungsblog — “Not only legally dubious but also ineffective”
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/not-only-legally-dubious-but-also-ineffective/
license: >-
...
by MAXIMLIAN STEINBEIS

“It’s hard for me when I don’t have an effect; I have no strategies for dealing with feelings of ineffectiveness. Maybe I’ll learn to cope without despairing or resigning. The key might be to keep going when you believe you’re doing the right thing, despite the lack of effect.”

Arno Geiger, Das glückliche Geheimnis, Carl Hanser Verlag 2023, 237 S., 25 Euros (S. 206).
...
Defending the liberal democratic constitution is not something we can, should, or want to leave to the security apparatus alone. Civil society must take up this task.
