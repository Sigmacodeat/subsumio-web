---
title: >-
  Verfassungsblog — Shared powers: the elephant in the room in the division of
  powers-debate
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: >-
  https://verfassungsblog.de/shared-powers-the-elephant-in-the-room-in-the-division-of-powers-debate/
license: >-
...
However, how is one to square this understanding of ‘shared’ as ‘joint’ powers with what common lawyers might refer to as the ‘plain meaning’ of Article 2(2) TFEU, according to which ‘[w]hen the Treaties confer on the Union a power shared with the Member States in a specific area … [t]he Member States shall exercise their power to the extent that the Union has not exercised its power’ and ‘[they] shall again exercise their power to the extent that the Union has decided to cease exercising its power’?
...
## A modest proposal: taking Article 2(2) TFEU seriously
