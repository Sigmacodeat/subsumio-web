        ...
        <div className="space-y-2">
          {filtered.map((c) => {
            ...
            return (
              <div
                key={c.case_id}
                className="flex items-center gap-4 rounded-xl border border-[color:var(--ds-border)] bg-[color:var(--ds-surface)] px-4 py-3 transition-[background-color,border-color,color,box-shadow,opacity,transform] duration-[var(--ds-duration-normal)] ease-[cubic-bezier(0.32,0.72,0,1)] motion-reduce:transition-none"
              >
                <div
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="mt-2 h-1.5 w-full overflow-hidden rounded-full bg-[color:var(--ds-hover)]">
                    <div
                      className="h-full rounded-full transition-[background-color,border-color,color,box-shadow,transform,opacity] duration-[var(--ds-duration-slow)] motion-reduce:transition-none"
