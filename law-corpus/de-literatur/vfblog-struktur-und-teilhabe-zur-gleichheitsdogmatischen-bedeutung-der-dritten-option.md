---
title: >-
  Verfassungsblog — Struktur und Teilhabe: zur gleichheitsdogmatischen Bedeutung
  der „dritten Option“
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: >-
  https://verfassungsblog.de/struktur-und-teilhabe-zur-gleichheitsdogmatischen-bedeutung-der-dritten-option/
license: >-
  CC BY-SA 4.0 (Standard-Lizenz des Verfassungsblogs; einzelne Beiträge können
  abweichen). Namensnennung + Share-Alike erforderlich.
content_hash: "6dcb3a8344449c7a"
---
...
Dass die mittelbare Diskriminierung auch in Abs. 3 S. 1 Raum hat, ergibt sich allerdings bereits aus einer Kammerentscheidung aus dem Zweiten Senat von 2004 zur Übernahme von Dolmetscherkosten für der deutschen Sprache nicht mächtige Beschuldigte auch im Ermittlungsverfahren: „Art. 3 Abs. 3 Satz 1 GG verbietet jede Diskriminierung wegen der Sprache oder anderer dort aufgeführter Kriterien. … Die in Art. 3 Abs. 3 Satz 1 GG genannten Merkmale dürfen grundsätzlich weder unmittelbar noch mittelbar als Anknüpfungspunkt für eine rechtliche Ungleichbehandlung herangezogen werden“ (Rn. 17, Herv. NM) – übrigens ebenfalls unter Berufung auf die Nachtarbeitsentscheidung! Dass die Kosten für die Übersetzung regelmäßig nicht von den Beschuldigten zu tragen sind, sei „geeignet, einer Diskriminierung der Betroffenen im Sinne von Art. 3 Abs. 3 Satz 1 GG entgegenzuwirken“ (Rn. 22).

Dogmatisch konsequent erscheint es in der Tat, das Diskriminierungsmerkmal Geschlecht nicht anders zu behandeln als andere Diskriminierungsgründe – auch hier kann es, wie das Beispiel Sprache zeigt, zu strukturellen Ausgrenzungen kommen, die in ihrer Wirkung genauso schwer wiegen wie eine direkte Diskriminierung.

Auf dieser Grundlage wird sich der Gesetzgeber stärker als bisher mit der faktischen Diversität der Gesellschaft auseinandersetzen müssen – denn wo gesellschaftliche und rechtliche Strukturen Exklusionswirkung entlang der Diskriminierungsmerkmale des Art. 3 Abs. 3 S. 1 GG entfalten, müssen nun noch wesentlich genauer Rechtfertigungsgründe geprüft oder eben angemessene Vorkehrungen zur Diskriminierungsvermeidung getroffen werden. Das BVerfG hat damit nicht nur Rechte auf Vielfalt und gegen Anpassungsdruck gestärkt. Es hat damit zugleich zentrale verfassungsrechtliche Voraussetzungen für eine wahrhaft gleiche Teilhabe in einer pluralen Gesellschaft formuliert.
