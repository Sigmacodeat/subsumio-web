---
title: Verfassungsblog — “Marg bar Khamenei”
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/marg-bar-khamenei/
license: >-
...
At EU level, the recently adopted Digital Services Act (DSA) even brings the fundamental rights dimension of content moderation into secondary law. Art. 14(4) DSA provides for an unprecedented obligation, which requires social media platforms to act in a proportionate manner in applying and enforcing their terms and conditions, with due regard to the rights and legitimate interests of all parties involved, including the fundamental rights of their users as enshrined in the EU Charter of Fundamental Rights.
