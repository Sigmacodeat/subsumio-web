---
title: >-
  Verfassungsblog — From Kosovo to Syria – Why R2P is of no use if the UN
  Security Council is unable to act together
type: literatur
genre: aufsatz
jurisdiction: de
work: Verfassungsblog
content_scope: full
version_date: '2013-09-07'
retrieved_at: '2026-07-18'
source: verfassungsblog-wp
source_url: >-
  https://verfassungsblog.de/from-kosovo-to-syria-why-r2p-is-of-no-use-if-the-un-security-council-is-unable-to-act-together/
license: >-
  CC BY-SA 4.0 (Standard-Lizenz des Verfassungsblogs; einzelne Beiträge können
  abweichen). Namensnennung + Share-Alike erforderlich.
---

# From Kosovo to Syria – Why R2P is of no use if the UN Security Council is unable to act together
