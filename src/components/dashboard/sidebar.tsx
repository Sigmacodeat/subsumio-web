  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        keywords: "berichte reports statistik auswertung kanzlei",
      },
      {
...
export function navForIndustry(_industry: string | null | undefined): IndustryNavConfig {
  return LEGAL_NAV;
}
...
interface SidebarProps {
  ...
  /** Retained for backwards-compatible callers; navigation is Legal-only. */
