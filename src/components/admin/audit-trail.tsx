  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <button
          onClick={loadEntries}
          className="brand-bg brand-bg rounded-lg px-3 py-2 text-sm text-white transition-[background-color,border-color,color] active:scale-[0.97] motion-reduce:transition-none"
        >
          Laden
        </button>
        <button
