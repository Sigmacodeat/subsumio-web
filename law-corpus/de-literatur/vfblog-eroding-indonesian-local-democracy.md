---
title: Verfassungsblog — Eroding Indonesian Local Democracy
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/eroding-indonesian-local-democracy/
license: >-
...
## Strong Local Governments Are Bulwarks Against Authoritarianism
...
In a recent development, the Ministry did respond to the information query. But interestingly, it refused to provide the information and documents regarding how the selection process was performed – apparently on the grounds that those information are exempt from the “public information” category, according to the Information Openness Act. This blatantly contradicts the government’s claim that the selection process was transparent and open to the public.
...
## Preserving Corruption, Accelerating Natural Destruction
...
One of the authors works for Indonesia Corruption Watch (ICW).
