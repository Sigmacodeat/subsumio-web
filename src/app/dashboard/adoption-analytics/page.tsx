                ...
                {data.usage_trends
                  ...
                  .map((t, i) => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className="bg-brand hover:bg-brand/80 w-full rounded-t transition-[background-color,border-color,color,box-shadow,transform,opacity] motion-reduce:transition-none"
