---
title: Verfassungsblog — Blogs in den Sozialwissenschaften
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/blogs-den-sozialwissenschaften/
license: >-
  CC BY-SA 4.0 (Standard-Lizenz des Verfassungsblogs; einzelne Beiträge können
  abweichen). Namensnennung + Share-Alike erforderlich.
content_hash: "64ffd084a430d52f"
---
...
Zur Systematisierung kann eine Typologie beitragen, die Cord Schmelzle und Daniel Voelsen (beide Theorieblog) anhand von Blogs in der Politischen Theorie vorstellten. Sie unterscheiden drei Idealtypen von Wissenschaftsblogs – 1) Wissenschaftliches Feuilleton (à la Crooked Timber), 2) Dienstleistungsblog (à la Tea Soup), 3) „bewusst persönlich gehaltenes“ Tagebuch (à la The Philosophy Smoker). Der Theorieblog selbst stellt hierbei eine Mischform dar, wie Cord weiter ausführte.
...
Dieser Text ist parallel auf dem Theorieblog, blog.sicherheitskultur.org, Blogmacherei.de erschienen.
