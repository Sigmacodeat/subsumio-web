...
describe('formatNLResponse', () => {
  test('formats brain status', () => {
    const text = formatNLResponse('brain_status', { pages: 42, sources: 2, chunks: 120, embedding_coverage_pct: 95, links_current: 30, links_historical: 5 });
  ...
  test('formats links', () => {
    const text = formatNLResponse('page_links', [{ to_slug: 'companies/acme', link_type: 'works_at' }]);
