---
title: Verfassungsblog — A Bolsonarist Cat Among the Pigeons
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/a-bolsonarist-cat-among-the-pigeons/
license: >-
...
## Jair Bolsonaro versus the Supreme Federal Tribunal
...
## Justice Kassio Nunes Marques and his ‘Jurisprudence’

In a recent case before the STF concerning the re-election of the presidents of the legislative branches, it was narrowly decided that the constitutional provision should be applied, in contrast to the established political practice of the last decades that ignored that clause. In Nunes Marques’ dissenting vote, he stated that if the president of the republic can be re-elected once, then for reasons of symmetry and integration, the same limit should apply to the presidents of the Câmara (house) and the Senado (Senate). This is at best a questionable argument, as there is no particular reason why an institutional parallel must exist between the president and the presidents of the legislative chambers.
