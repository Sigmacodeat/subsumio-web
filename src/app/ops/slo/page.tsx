...
function statusIcon(status: string) {
  switch (status) {
    ...
    default:
      return <Activity className="h-4 w-4 text-[color:var(--ds-text-muted)]" />;
  }
}
  ...
  return (
    <div className="mx-0 w-full space-y-6 p-4 md:p-6 lg:p-8">
      <PageHeader
        ...
        breadcrumbs={[{ label: "Betreiber-Konsole", href: "/ops" }, { label: "SLO" }]}
      />
        ...
        <Card>
          <CardContent className="flex items-center gap-3 p-4">
            ...
            <div>
              ...
              <p className="text-xs text-[color:var(--ds-text-muted)]">SLOs gesamt</p>
            </div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="flex items-center gap-3 p-4">
            ...
            <div>
              ...
              <p className="text-xs text-[color:var(--ds-text-muted)]">Erfüllt</p>
            </div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="flex items-center gap-3 p-4">
            ...
            <div>
              ...
              <p className="text-xs text-[color:var(--ds-text-muted)]">Verletzt</p>
            </div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="flex items-center gap-3 p-4">
            ...
            <div>
              ...
              <p className="text-xs text-[color:var(--ds-text-muted)]">Kritische Verletzungen</p>
            </div>
          </CardContent>
        </Card>
      </div>
                ...
                <div key={i} className="flex items-center justify-between rounded-md border p-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-[color:var(--ds-text-muted)]">{alert.message}</p>
                    </div>
                  </div>
