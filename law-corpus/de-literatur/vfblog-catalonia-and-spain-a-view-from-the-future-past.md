---
title: 'Verfassungsblog — Catalonia and Spain: A View from the Future Past'
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/catalonia-and-spain-a-view-from-the-future-past/
license: >-
...
Yet, while there are good reasons to believe that the Yugoslav scenario will not materialize in Spain, there are also reasons to believe that further escalation of moves on both sides would increase the probability of unrest. In light of the events of October 1, we should not discount the possibility of renewed violence.
