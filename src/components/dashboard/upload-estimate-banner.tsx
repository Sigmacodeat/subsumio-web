...
export function UploadEstimateBanner({
  ...
  return (
    <div
      ...
      aria-live="polite"
      className={cn(
        "flex flex-wrap items-center gap-x-3 gap-y-1 rounded-md border px-3 py-2 text-xs transition-[background-color,border-color] duration-200 motion-reduce:transition-none",
        insufficient
