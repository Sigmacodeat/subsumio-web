---
title: 'Verfassungsblog — Introduction: In search for conciliation'
type: literatur
genre: aufsatz
jurisdiction: de
...
For these purposes, great attention will be devoted to grant a maximum diffusion to the colloquium’s conclusions and final proposals, both during and after the event. The conference seeks to deliver outputs which might meaningfully contribute to the academic and civic debate on the issue and eventually an edited volume resulting from the colloquium.
