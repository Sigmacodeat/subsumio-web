...
const content = SOLUTIONS.ch["mid-sized"];

export const metadata: Metadata = {
  title: content.metaTitle,
  description: content.metaDesc,
  alternates: {
    canonical: "/ch/solutions/mid-sized",
    languages: {
    ...
    <>
      ...
      <JsonLd
        data={breadcrumbLd([
          ...
          { name: "Lösungen", url: "/ch/solutions/mid-sized" },
          { name: "Mittelständische", url: "/ch/solutions/mid-sized" },
        ])}
      />
