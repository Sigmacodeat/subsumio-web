---
title: Onlinekommentar — Art. 10 DSG
type: literatur
genre: kommentar
jurisdiction: ch
...
authors:
  - Michèle Balthasar
citation: >-
  Michèle Balthasar, Kommentierung zu Art. 10 DSG, in: Thomas
...
source_url: https://onlinekommentar.ch/de/kommentare/dsg10
license: >-
...
- 
            A. Ernennung der Datenschutzberaterin oder des Datenschutzberaters  (Art. 10 Abs. 1 DSG)
...
7 Weiter schreibt Art. 37 Abs. 1 DSGVO in lit. b eine Benennungspflicht vor, wenn die Kerntätigkeit des Verantwortlichen oder des Auftragsverarbeiters in der Durchführung von Verarbeitungsvorgängen liegt, welche aufgrund ihrer Art, ihres Umfangs und/oder ihrer Zwecke eine umfangreiche regelmässige und systematische Überwachung von Personen erfordern. In Erwägungsgrund 97 zur DSGVO wird erläutert, dass sich die Kerntätigkeit eines Verantwortlichen auf „seine Haupttätigkeiten und nicht auf die Verarbeitung personenbezogener Daten als Nebentätigkeit“ bezieht. Die Artikel-29-Datenschutzgruppe der Europäischen Kommission hatte zu diesem Thema mit den WP 243 Leitlinien in Bezug auf Datenschutzbeauftragte („DSB“) veröffentlicht.Der Europäische Datenschutzausschuss (= European Data Protection Board, kurz: EDPB), seit Inkrafttreten der DSGVO der Nachfolger der Artikel-29-Datenschutzgruppe, bestätigte die mit der DSGVO zusammenhängenden Leitlinien der Artikel-29-Datenschutzgruppe bei seiner ersten Plenarsitzung). Die Leitlinie ist abrufbar unter: https://ec.europa.eu/newsroom/article29/items/612048 (zuletzt besucht am 18.7.2023).„Kerntätigkeit“ sind demnach die wichtigsten Arbeitsabläufe, die zur Erreichung der Ziele des Verantwortlichen oder des Auftragsverarbeiters nötig sind.WP 243, S. 8. „Regelmässig“ ist eine Überwachung, wenn sie fortlaufend oder periodisch stattfindet, und „systematisch“, wenn sie einem methodischen oder organisierten Ansatz folgt oder Teil einer umfassenderen Strategie ist.WP 243, S. 10. Beispiele hierfür sind etwa private Sicherheitsunternehmen, die private Einkaufszentren und öffentliche Plätze überwachen, oder Apps, deren Kernfunktionalität die Analyse von Standortdaten erfordert (z. B. Sport- oder Navigations-Apps).
...
9 Länderspezifische Vorschriften können weitergehende Bestimmungen vorsehen, unter welchen ein Datenschutzbeauftragter zu benennen ist. So sieht etwa das deutsche Bundesdatenschutzgesetz (BDSG)Gesetz zur Anpassung des Datenschutzrechts an die Verordnung (EU) 2016/679 und zur Umsetzung der Richtlinie (EU) 2016/680 (Datenschutz-Anpassungs- und -Umsetzungsgesetz EU – DSAnpUG-EU) vom 30. Juni 2017, Bundesgesetzblatt Jahrgang 2017 Teil I Nr. 44. eine Pflicht zur Benennung eines Datenschutzbeauftragten vor, wenn mindestens 20 Mitarbeitende ständig mit der automatisierten Verarbeitung personenbezogener Daten beschäftigt sind (§ 38 Abs. 1 Satz 1 BDSG). Daneben nennt das BDSG in § 38 Abs. 1 Satz 2 zwei weitere Szenarien, in denen Unternehmen ungeachtet der Anzahl der mit der Verarbeitung befassten Personen einen Datenschutzbeauftragten benennen müssen: Einerseits in Fällen, in denen eine DSFA nach Art. 35 DSGVO notwendig ist, und andererseits in Konstellationen, in denen sie personenbezogene Daten geschäftsmässig zum Zweck der anonymisierten Übermittlung oder für Zwecke der Markt- oder Meinungsforschung verarbeiten.

### C. Begrifflichkeit

10 Das frühere DSG verwendete auf Deutsch den Begriff des „Datenschutzverantwortlichen“ und auf Italienisch den des „responsabile per la protezione dei dati“, während es in der französischen Version „conseiller à la protection des données“, also „Datenschutzberater“, heisst (Art. 11a Abs. 5 lit. e aDSG). Damit es nicht zu Verwechslungen mit dem „Verantwortlichen“ nach Art. 5 lit. i DSG bzw. mit dem „responsabile“ kommt, wurde mit der Revision des DSG auf Deutsch der Begriff „Datenschutzberaterin und Datenschutzberater“ bzw. auf Italienisch „consulente per la protezione dei dati“ eingeführt. Dadurch ist die Terminologie von Art. 10 DSG in allen drei Sprachen vereinheitlicht worden.Botschaft zum DSG, S. 7032 f.

11  Gleichzeitig wurde damit auch klargestellt, dass die Verantwortung für die datenschutzkonforme Bearbeitung von Personendaten nicht bei der Datenschutzberaterin bzw. dem Datenschutzberater liegt, sondern beim verantwortlichen Unternehmen, dem „Verantwortlichen“.Botschaft zum DSG, S. 7033; BK-Jennifer Ehrensberger/Urs Bersler, Art. 11a altes DSG, N. 16b ff; siehe hierzu auch hinten, N. 29 ff.
...
13  Unternehmen, welche international tätig sind, müssen allerdings die Vorgaben der DSGVO einhalten und sind daher oftmals verpflichtet, einen Datenschutzbeauftragten nach Art. 37 DSGVO zu benennen.Siehe hierzu vorne, N. 5 ff.

14  Ferner liegt es im Interesse jedes Unternehmen, innerhalb seiner Organisation einen effizienten und wirksamen Datenschutz im Sinne einer angemessenen Compliance zu gewährleisten. Es empfiehlt sich deshalb oftmals zumindest intern eine Datenschutzstelle zu benennen und sie mit Aufgaben zum Datenschutz zu betrauen. Diese Person muss die Anforderungen nach Art. 10 Abs. 3 DSG nicht erfüllen.So auch Rosenthal, Jusletter 2020, N. 171. Erfüllt sie die Anforderungen nach Art. 10 Abs. 3 allerdings nicht, kann das Unternehmen auch nicht von den Erleichterungen von Art. 24 Abs. 3 DSG profitieren.

15  Im Falle der Benennung einer solchen Person oder Stelle sollten Unklarheiten hinsichtlich ihrer Funktionsbezeichnung, ihres Status, ihrer Stellung und ihres Aufgabenfelds vermieden werden. Bereits an der Funktionsbezeichnung innerhalb des Unternehmens sowie gegenüber dem EDÖB und den betroffenen Personen sollte deshalb deutlich werden, dass es sich nicht um eine Datenschutzberaterin bzw. einen Datenschutzberater nach Art. 10 Abs. 3 DSG handelt.Vgl. hierzu zur DSGVO, WP 243, S. 6 und N. 14. Es empfiehlt sich für diese Funktion eine andere Bezeichnung zu wählen, etwa Datenschutzstelle, Ansprechperson zum Datenschutz, Datenschutzkoordinatorin bzw. Datenschutzkoordinators oder Privacy Officer. Hinsichtlich der Aufgabenerteilung ist das verantwortliche Unternehmen frei. Die Aufgaben sollten dennoch in einem Pflichtenheft klar festgelegt werden.
...
18  Externe Datenschutzberaterinnen bzw. -berater sind dagegen natürliche oder juristische Personen, die die Dienstleistung Datenschutz (Data Protection as a Service) anbieten und auf Grundlage eines Auftragsverhältnisses agieren.SHK DSG-Frey, N. 12. Regelmässig wird aber auch in diesen Fällen unternehmensintern eine Ansprechperson zu benennen sein, welche sowohl ihr bzw. ihm als auch den Mitarbeitenden als Ansprechpartner/-in bei Datenschutzthemen im Unternehmen dient.
...
20  Für eine Unternehmensgruppe besteht die Möglichkeit, eine gemeinsame Datenschutzberaterin bzw. einen gemeinsamen Datenschutzberater zu bestimmen.Rosenthal, Jusletter 2020, N. 170. Diese bzw. dieser muss für die betroffenen Personen und für den EDÖB aber als organisationsinterne Ansprechperson über geeignete Kommunikationskanäle leicht erreichbar sein. Vgl. WP 243, S. 12; SHK DSG-Frey, N. 13. Sie bzw. er muss in der Lage sein, mit Betroffenen wirksam zu kommunizieren und mit den zuständigen Aufsichtsbehörden effektiv zusammenzuarbeiten. Eine Pflicht, in der Schweiz ansässig zu sein, besteht jedoch nicht, solange die Datenschutzberaterin bzw. der Datenschutzberater ihre bzw. seine Aufgaben effektiv ausüben kann.Rosenthal, Jusletter 2020, N. 170. Dennoch dürfte die Kenntnis einer Landesprache erforderlich sein.

### B. Aufgaben der Datenschutzberaterin oder des Datenschutzberaters (Art. 10 Abs. 2)

#### 1. Anlaufstelle für den EDÖB und weitere Behörden, die in der Schweiz für den Datenschutz zuständig sind, sowie für die betroffenen Personen

21  Die Datenschutzberaterin bzw. der Datenschutzberater ist eine wichtige Ansprechstelle in Bezug auf die Datenbearbeitungen, welche das verantwortliche Unternehmen vornimmt. Sie bzw. er ist in die Prozesse des Unternehmens zur Einhaltung des Datenschutzes eingebunden.Rosenthal, Jusletter 2020, N. 170. Eine fachliche Ansprechperson kann damit unmittelbar ausfindig gemacht werden, was dem EDÖB oder betroffenen Personen die Ausübung seiner bzw. ihrer Rechte erleichtert.

22  Bei Fragen im Zusammenhang mit der Bearbeitung von Personendaten im Unternehmen dient er oder sie dem EDÖB und weiteren Behörden, die in der Schweiz für den Datenschutz zuständig sind (etwa die FINMA oder die kantonalen Datenschutzbehörden), deshalb als Anlaufstelle. Ebenfalls als Anlaufstelle dient sie oder er den betroffenen Personen, beispielsweise im Falle eines Auskunftsgesuches nach Art. 25ff. DSG.Siehe auch SHK DSG-Frey, N. 29.

#### 2. Schulung und Beratung des privaten Verantwortlichen in Fragen des Datenschutzes (Abs. 2 lit. a)

23  Damit im jeweiligen Unternehmen ein effektiver Datenschutz gewährleistet werden kann, hat die Datenschutzberaterin bzw. der Datenschutzberater den privaten Verantwortlichen bzw. seine Mitarbeitenden entsprechend zu schulen, auszubilden und zu sensibilisieren. Hier sind zumindest sämtliche Mitarbeitende einzubeziehen, welche mit Personendaten in Kontakt kommen. Der Fokus sollte dabei auf den datenschutzrechtlichen Grundsätzen (Art. 6 DSG) liegen. Weitere Schulungsthemen sind etwa die Vorgaben zur Auslandbekanntgabe sowie der Umgang mit besonders schützenswerten Personendaten im Unternehmen. Darüber hinaus sind die Mitarbeitenden auch hinsichtlich der Anforderungen an die Datensicherheit zu schulen (Art. 8 DSG).Siehe auch SHK DSG-Frey, N. 18 ff; Jennifer Ehrensberger/Urs Bersler, Art. 11a altes DSG, N. 16 f.
...
26  Eine weitere Aufgabe der Datenschutzberaterin bzw. des Datenschutzberaters ist ihre bzw. seine Mitwirkung bei der Anwendung der Datenschutzvorschriften. Dies beinhaltet insbesondere, das Mitwirken beim Erlass von Nutzungsbedingungen und Datenschutzvorschriften.Siehe hierzu zum Datenschutzberater: https://www.edoeb.admin.ch/edoeb/de/home/datenschutz/grundlagen/datenschutzberaterin-berater.html, zuletzt abgerufen am 18.7.2023. Ferner, dass sie oder er die Bearbeitung von Personendaten prüft und Korrekturmassnahmen empfiehlt, wenn eine Verletzung der Datenschutzbestimmungen festgestellt wird. Darüber hinaus soll sie bzw. er den privaten Verantwortlichen bei der Erstellung von DSFA mitwirken und deren Ausführung prüfen.SHK DSG-Frey, N. 24. Überdies ist es wichtig, dass die Datenschutzberaterin bzw. der Datenschutzberater innerhalb der Einrichtung als Gesprächspartner/-in wahrgenommen wird und dass sie bzw. er den massgeblichen Arbeitsgruppen angehört, die mit Datenbearbeitungstätigkeiten innerhalb dem Unternehmen befasst sind. Nicht zu den Aufgaben der Datenschutzberaterin oder des Datenschutzberaters des privaten Verantwortliche gehört es jedoch, dem EDÖB oder betroffenen Personen Verletzungen der Datensicherheit zu melden. Obwohl es bei Verletzungen der Datensicherheit häufig sinnvoll sein dürfte, die Datenschutzberaterin bzw. den Datenschutzberater einzubeziehen, ist dies gesetzlich nicht vorgeschrieben.

27  Die Datenschutzberaterin bzw. der Datenschutzberater ist als unterstützende Stelle zu verstehen, nicht aber als Überwachungsorgan. In Bezug auf die Prüfung von Datenbearbeitungen und die Empfehlung von Korrekturmassnahmen geht es deshalb nicht darum, eine aktive Prüfpflicht einzuführen, beziehungsweise systematische Kontrollen aller Datenbearbeitungen vorzuschreiben. Vielmehr ist es ausreichend, wenn sie oder er aktiv wird, falls beispielsweise der Verantwortliche die Prüfung einer Datenbearbeitung anfragt oder ihr bzw. ihm Hinweise zugetragen werden, dass Datenschutzvorschriften verletzt worden sind.So auch SHK DSG-Frey, N. 23. Selbstverständlich bleibt es dem Verantwortlichen aber unbenommen zu verlangen, dass die Datenschutzberaterin oder der Datenschutzberater Datenbearbeitungen proaktiv prüft. Denkbar und in der Praxis häufig ist, dass sie bzw. er einmal jährlich einen Datenschutz-Audit durchführt.
...
- Durchführung von Risikobeurteilungen (z. B. Risiko einer unbeabsichtigten/unberechtigten Datenweitergabe, -löschung oder -bearbeitung, eines Datenverlustes oder technischen Fehlers etc.) etwa im Rahmen einer DSFA;Siehe Art. 23 Abs. 4 DSG.

- Erstellen von Jahresberichten über die Tätigkeiten zuhanden des Verantwortlichen.

#### 4. Exkurs: Keine Verantwortlichkeit der Datenschutzberaterin bzw. des Datenschutzberaters

29  Häufig wird angenommen, dass die Datenschutzberaterin bzw. der Datenschutzberater für den Datenschutz und dessen Einhaltung im Unternehmen verantwortlich ist. Die Datenschutzberaterin bzw. der Datenschutzberater hat allerdings über seine Schulungs-, Beratungs- und Mitwirkungsfunktion hinaus keinerlei Handlungskompetenzen, die sich aus dem DSG selbst ergeben. Die alleinige Entscheidungsgewalt – und damit auch die alleinige Verantwortung für die datenschutzkonforme Bearbeitung von Personendaten – liegt beim verantwortlichen Unternehmen.Botschaft zum DSG, S. 7033; so auch der EDÖB: https://www.edoeb.admin.ch/edoeb/de/home/datenschutz/grundlagen/datenschutzberaterin-berater.html, zuletzt abgerufen am 18.7.2023; HK-Rosenthal/Jöhri, Art. 11a altes DSG, N. 94. Die Datenschutzberaterin bzw. der Datenschutzberater sollte der höchsten Managementebene des betreffenden Unternehmens unterstehen.Botschaft zum DSG, S. 7033; siehe auch EDÖB: https://www.edoeb.admin.ch/edoeb/de/home/datenschutz/grundlagen/datenschutzberaterinberater.html, zuletzt abgerufen am 18.7.2023. Anders wäre die Situation lediglich, wenn der Datenschutzberater als faktischen Organ agieren und so die Willensbildung des Verantwortlichen massgebend mitbestimmen würde, in dem er über Mittel und Zweck der Bearbeitungen entscheidet.BGE 128 III 29 E. 3a S. 30 mit Hinweisen. Aufgrund der nach Art. 10 Abs. 3 DSG geforderten fachlichen Unabhängigkeit und Weisungsungebundenheit, wäre dies aber nicht zulässig.Siehe hierzu, lit. C. Entscheidet eine Datenschutzberaterin oder Datenschutzberater dennoch über Zweck und Mittel einer Datenbearbeitung, wäre eine Verantwortlichkeit (obligatorischer und/oder strafrechtlicher Natur), möglich.

30  Gibt die Datenschutzberaterin bzw. der Datenschutzberater Empfehlungen ab, sollte das Unternehmen dafür sorgen, dass die Empfehlungen umgesetzt werden. Tut es dies nicht und war die Empfehlung berechtigt, kann – falls ein solcher Vorfall publik werden sollte – für das Unternehmen zu einem nicht unerheblichen Imageschaden führen. Allenfalls kann dies sogar zu Sanktionen gegenüber einem einzelnen Mitarbeitenden führen.Siehe auch EDÖB zum Datenschutzberater: https://www.edoeb.admin.ch/edoeb/de/home/datenschutz/grundlagen/datenschutzberaterin-berater.html, zuletzt abgerufen am 18.7.2023. War die Empfehlung allerdings falsch bzw. unrichtig, haftet die Datenschutzberaterin bzw. der Datenschutzberater im Rahmen seines bestehenden Arbeits- oder Auftragsverhältnisses.

### C. Anforderungen an die Datenschutzberaterin bzw. den Datenschutzberater (Abs. 3)

31  Damit ein Unternehmen von der Konsultation des EDÖB entbunden wird, wenn trotz erfolgter DSFA noch ein hohes Risiko besteht (Art. 23 Abs. 4 DSG), muss die Datenschutzberaterin bzw. der Datenschutzberater die Voraussetzungen von Art. 10 Abs. 3 DSG erfüllen.Dabei übernimmt das neue DSG weitgehend das frühere Recht (vgl. Art. 11a f. aVDSG); Botschaft zum DSG, S. 7032f.

#### 1. Fachlich unabhängig und weisungsungebunden (lit. a)

32  Die Datenschutzberaterin bzw. der Datenschutzberater muss in ihrer bzw. seiner Tätigkeit soweit unabhängig sein, dass die Aufgaben weisungsunabhängig wahrgenommen und nicht aufgrund ihrer bzw. seiner Tätigkeit vom Unternehmen sanktioniert werden kann. Das heisst, dass ihr oder ihm bei der Aufgabenerfüllung keine Anweisungen erteilt werden dürfen, wie sie bzw. er bei einem gegebenen Sachverhalt zu verfahren hat, also beispielsweise, welches Ergebnis erzielt werden soll, wie einer Beschwerde nachzugehen ist oder ob der EDÖB zurate gezogen werden soll oder nicht. Des Weiteren darf sie bzw. er nicht angewiesen werden, in einer datenschutzrechtlichen Frage (beispielsweise in Bezug auf die Auslegung eines Gesetzes) einen bestimmten Standpunkt zu vertreten.Botschaft zum DSG, S. 7033; BK-Jennifer Ehrensberger/Urs Bersler, Art. 11a altes DSG, N. 16c ff; HK-Rosenthal/Jöhri, Art. 11a altes DSG, N. 80 ff.

33  Ausserdem muss gewährleistet sein, dass die Datenschutzberaterin bzw. der Datenschutzberater ihre bzw. seine Empfehlungen – auch wenn sie teilweise unliebsam sein können – ohne Sorge vor Nachteilen frei aussprechen kann. Diese Unabhängigkeit beinhaltet auch, dass sich die Datenschutzberaterin bzw. der Datenschutzberater in wichtigen Belangen an die oberste Leitung (etwa der Verwaltungsrat bei einer Aktiengesellschaft) werden kann (Art. 23 lit. c DSV). Grundsätzlich sollte sie bzw. er deshalb auch direkt der Geschäftsleitung oder sogar dem Verwaltungsrat des Verantwortlichen unterstellt sein.Botschaft zum DSG, S. 7033, siehe hierzu auch den Entscheid der luxemburgischen Datenschutzbehörde hinsichtlich mangelnder Einbindung und Unabhängigkeit und fachlicher Kenntnisse des Datenschutzbeauftragten sowie fehlende Möglichkeit, direkt an die höchste Managementebene zu berichten in Anwendung der DSGVO (https://cnpd.public.lu/content/dam/cnpd/fr/decisions-fr/2021/Decision-22FR-2021-sous-forme-anonymisee.pdf), zuletzt abgerufen am 18.7.2023.

#### 2. Keine Unvereinbarkeit mit anderen Aufgaben (lit. b)

34  Damit die Datenschutzberaterin bzw. der Datenschutzberater innerhalb des Unternehmens ihre bzw. seine Aufgaben wahrnehmen kann, darf sie bzw. er keine anderen Tätigkeiten ausüben, die sich mit ihren bzw. seinen Aufgaben nicht vereinbaren lassen. Die Datenschutzberatung sollte getrennt von den Aufgaben des Unternehmens wahrgenommen werden.https://www.edoeb.admin.ch/edoeb/de/home/datenschutz/grundlagen/datenschutzberaterin-berater.html, zuletzt abgerufen am 18.7.2023. Ein Interessenkonflikt ist zu vermeiden. Ein solcher könnte beispielsweise dann vorliegen, wenn die Datenschutzberaterin oder der Datenschutzberater Mitglied der Geschäftsleitung, Leiter des operativen Geschäftsbereichs oder Leiter der IT-Abteilung ist oder aber Funktionen im Bereich der Personalführung oder der Informationssystemverwaltung (etwa IT-Manager) ausübt. Die Datenschutzberaterin bzw. der Datenschutzberater darf nicht gleichzeitig eine Funktion innehaben, in denen sie oder er selbst über Mittel und Zweck der Datenbearbeitungen des Verantwortlichen entscheidet oder an diesen ein Interesse hat.SHK DSG-Frey, N. 34; Rosenthal, Jusletter, N. 170. Empfehlenswert ist es auch die Datenschutzberatung nicht mit jenen der übrigen Rechtsberatung und -vertretung zu vermischen.Siehe auch EDÖB: https://www.edoeb.admin.ch/edoeb/de/home/datenschutz/grundlagen/datenschutzberaterinberater.html, zuletzt abgerufen am 18.7.2023.

35  Ein möglicher Interessenkonflikt muss deshalb bereits im Vorfeld durch die organisatorische Stellung der Datenschutzberaterin bzw. des Datenschutzberaters vermieden werden. Es sollte vom Grundsatz her darauf geachtet werden, dass keine Linienverantwortlichkeit mit der Stelle der Datenschutzberaterin bzw. des Datenschutzberaters verbunden ist. Es empfiehlt sich damit für ein Unternehmen, die Funktion der Datenschutzberaterin bzw. des Datenschutzberaters z. B. als Stabstelle anzusiedeln. Wichtig ist dabei, dass damit keine Exekutivfunktion in einem Businessbereich einhergeht. Eine weitere Möglichkeit wäre, die Aufgabe der Datenschutzberaterin oder des Datenschutzberaters mit derjenigen des Informationssicherheitsbeauftragten zusammenzuführen.Botschaft zum DSG, S. 7034, zum Ganzen siehe auch die Stellungnahme des EDÖB zum Datenschutzberat www.edoeb.admin.ch/edoeb/de/home/datenschutz/grundlagen/datenschutzberaterin-berater.html, zuletzt abgerufen am 18.7.2023.

36  Weil Interessenkonflikte in der Praxis sonst kaum vermeidbar sind, dürfte die Datenschutzberaterin bzw. der Datenschutzberater – ausser bei grösseren Unternehmen mit eigenen Datenschutzabteilungen – in der Regel ein externer Dienstleister sein.Rosenthal, Jusletter 2020, N. 170.
...
53 Art. 27 Abs. 1 lit. a DSV ist damit identisch mit der Regelung bei den privaten Verantwortlichen in Art. 23 lit. b DSV. Es kann sinngemäss auf die dortigen Ausführungen verwiesen werden.Siehe vorne, N. 22. Diese Pflicht gilt im Übrigen für alle Verletzungen der Datensicherheit, nicht nur für solche, die dem EDÖB gemäss Art. 24 DSG gemeldet werden müssen. Die Information über die Verletzung der Datensicherheit nach Art. 27 Abs. 1 lit. b DSV kann z. B. dadurch sichergestellt werden, dass das Bundesorgan die Mitarbeitenden mittels Weisung dazu verpflichtet, bei einer Verletzung der Datensicherheit die Datenschutzberaterin bzw. den Datenschutzberater zu informieren. Die Datenschutzberaterin bzw. der Datenschutzberater berät den Verantwortlichen bei der Frage, ob die Verletzung einer Meldepflicht im Sinne von Art. 24 DSG unterliegt. Das Bundesorgan sorgt dafür, dass sie oder er über eine Verletzung der Datensicherheit informiert wird. Die Meldung selbst obliegt aber dem Bundesorgan. Es entscheidet, ob und welche Verletzungen dem EDÖB gemeldet werden. Erläuterungen zur DSV, S. 52.
