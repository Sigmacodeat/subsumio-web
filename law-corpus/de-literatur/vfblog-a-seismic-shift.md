---
title: Verfassungsblog — A Seismic Shift
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/a-seismic-shift/
license: >-
...
- the failure to take into account relevant considerations; and

- the failure to comply with applicable legal prescripts.
...
3. Failure to comply with applicable legal prescripts
...
“[p]romotion of development requires the protection of the environment. Yet the environment cannot be protected if development does not pay attention to the costs of environmental destruction. The environment and development are thus inexorably linked” (par. 44).
