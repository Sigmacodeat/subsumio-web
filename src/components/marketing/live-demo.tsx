  ...
  return (
    ...
    >
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="focus-within:brand-border-strong flex flex-1 items-end gap-2 rounded-xl border [border-color:var(--mk-border)] px-3 py-2 transition-[background-color,border-color,color] [background:var(--mk-bg)] motion-reduce:transition-none">
            ...
            <button
              ...
              aria-label={t.ask}
              className="brand-bg inline-flex shrink-0 items-center gap-1.5 rounded-lg px-4 py-2.5 text-sm font-medium text-white transition-[background-color,border-color,color] active:scale-[0.97] disabled:opacity-40 motion-reduce:transition-none"
            >
      ...
      <div className="flex min-h-[40px] flex-wrap items-center gap-2 border-t [border-color:var(--mk-border)] px-5 py-3 [background:var(--mk-bg)]">
        {note ? (
          <span className="text-sm [color:var(--ds-warning-text)]">{note}</span>
        ) : !live ? (
          <>
