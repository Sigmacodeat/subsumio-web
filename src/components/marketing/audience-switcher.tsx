      ...
      {items.map(({ id, icon: Icon }) => {
        ...
        return (
          <Link
            ...
            className={`group rounded-2xl border p-5 transition-[background-color,border-color,color,box-shadow,transform,opacity] hover:-translate-y-0.5 hover:shadow-lg motion-reduce:transition-none ${
              selected
