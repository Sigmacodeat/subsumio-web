---
title: Verfassungsblog — Nothing like before
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/nothing-like-before/
license: >-
...
## Fellowships in the Critical Thinking Program at Freie Universität Berlin
...
Therefore: if you are not yet a supporter of Verfassungsblog, then please become one. Preferably with a volunteer subscription on Steady, so that we can plan. Or else by a one-off payment to paypal@verfassungsblog.de or by bank transfer (IBAN DE41 1001 0010 0923 7441 03, BIC PBNKDEFF).
...
Am Lehrstuhl für Öffentliches Recht und Informationsrecht, insbes. Datenschutzrecht an der Johannes Gutenberg-Universität Mainz (Prof. Dr. Matthias Bäcker) ist zum 01.07.2020 die  Stelle (75%) einer/eines wissenschaftlichen Mitarbeiters/in (m/w/d) (EG 13 TV-L) befristet für die Dauer von drei Jahren zu besetzen.

Vorgesehen ist die Mitarbeit an einem praxisorientierten interdisziplinären Verbundforschungsprojekt zum sicherheitsbehördlichen Einsatz von Methoden der Künstlichen Intelligenz. Zur Ausschreibung.
