---
title: Verfassungsblog — The Italian “No Jab, No Job” Law
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/the-italian-no-jab-no-job-law/
license: >-
  CC BY-SA 4.0 (Standard-Lizenz des Verfassungsblogs; einzelne Beiträge können
  abweichen). Namensnennung + Share-Alike erforderlich.
content_hash: "208d1c95d961d110"
---
...
- for the exceptional and unforeseeable cases in which the treatment might cause further injury, an equitable compensation is provided, apart from any damages which the injured party may claim under general tort law.
...
Nonetheless, a preliminary positive assessment of the new measure seems already possible, for three reasons.
