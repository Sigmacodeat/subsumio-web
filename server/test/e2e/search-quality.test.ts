...
beforeAll(async () => {
  ...
  await engine.putPage("people/pedro", {
    ...
    compiled_truth:
      "Pedro is the co-founder of Brex. Expert in fintech and payments infrastructure.",
  ...
  const aiChunks: ChunkInput[] = [
    {
      chunk_index: 0,
      chunk_text:
        "AI democratizes building. The marginal cost of creation approaches zero. This changes who gets to build.",
      chunk_source: "compiled_truth",
