      ...
      <div className="space-y-4 rounded-xl border border-[color:var(--ds-border)] bg-[color:var(--ds-surface)] p-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="brand-bg brand-text-on-primary inline-flex items-center gap-2 rounded-lg px-4 py-2 text-sm font-medium transition-[opacity,transform] duration-200 ease-[cubic-bezier(0.32,0.72,0,1)] hover:opacity-90 active:scale-95 disabled:cursor-not-allowed disabled:opacity-40 motion-reduce:transition-none"
          >
