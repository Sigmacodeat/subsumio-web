---
title: Verfassungsblog — Avian Flu Shows the Need for Transformative Meat Governance
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/avian-flu-and-meat-governance/
license: >-
...
Third, we need lawmakers with enough fortitude to go beyond mere patchwork regulations of these animal industries to engage in true transformative meat governance. The industries we know today will look very different as a result of this transformation; that will be not only a positive development but an essential one.
 ...
 &#8593;1 H5N1 refers to the specifics of the surface proteins in the virus.

 &#8593;2 I will use the abbreviation “HPAI” in this contribution, although it is not the only kind of avian influenza that can be highly pathogenic and thus be considered HPAI.
