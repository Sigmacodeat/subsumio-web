            ...
            <span className="ml-auto flex items-center gap-2">
              ...
              {latest.result && (
                <button
                  ...
                  className="flex h-6 w-6 items-center justify-center rounded-md text-[color:var(--ds-text-muted)] transition-[background-color,border-color,color] hover:bg-[color:var(--ds-hover)] hover:text-[color:var(--ds-text)] motion-reduce:transition-none"
    ...
    <div className="grid grid-cols-[auto_minmax(0,1fr)_auto_auto_auto] items-center gap-3 border-b border-[color:var(--ds-border)] px-4 py-3 last:border-b-0 hover:bg-[color:var(--ds-hover)]">
      ...
      <div className="flex items-center gap-1">
        {job.result && (
          <button
            onClick={() => onView(job)}
            className="flex h-7 w-7 items-center justify-center rounded-md text-[color:var(--ds-text-muted)] transition-[background-color,border-color,color] hover:bg-[color:var(--ds-hover)] hover:text-[color:var(--ds-text)] motion-reduce:transition-none"
            title={t("reports.btn_view")}
          >
            <Eye size={12} />
          </button>
        ...
        {(job.status === "completed" ||
          ...
          <button
            ...
            disabled={replaying}
            className="flex h-7 w-7 items-center justify-center rounded-md text-[color:var(--ds-text-muted)] transition-[background-color,border-color,color] hover:bg-[color:var(--ds-hover)] hover:text-[color:var(--ds-text)] disabled:opacity-50 motion-reduce:transition-none"
        ...
        {tabs.map((tabItem) => {
          ...
          return (
            <button
              ...
              className={cn(
                "flex items-center gap-2 border-b-2 px-3 py-2.5 text-sm font-medium transition-[border-color,color] duration-150 motion-reduce:transition-none",
                tab === tabItem.id
