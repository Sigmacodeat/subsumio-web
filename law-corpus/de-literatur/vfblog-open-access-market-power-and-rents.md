---
title: Verfassungsblog — Open Access, Market Power, and Rents
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/open-access-market-power-and-rents/
license: >-
...
This is one example, but there are many. The question then is what value such publishers add?
...
To me, this fulfills the aspirations of “pure open access”. The existing models of “gold” or “hybrid” seem like pale imitations of it where publishers simply use their market power to extract rents from different sides of the market, but nothing fundamentally changes.
