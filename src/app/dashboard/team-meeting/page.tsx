                  ...
                  {meeting.items.map((item) => (
                    <div key={item.id} className="flex items-center gap-2">
                      <button
                        ...
                        className={`flex h-4 w-4 shrink-0 items-center justify-center rounded border transition-[background-color,border-color,color] motion-reduce:transition-none ${
                          item.status === "done"
