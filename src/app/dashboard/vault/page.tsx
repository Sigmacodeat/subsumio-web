    ...
    <div className="ds-page space-y-6 p-4 md:p-6 lg:p-8">
      ...
      {selectedSlugs.size > 0 && (
        <div className="flex items-center gap-3 text-xs text-[color:var(--ds-text-muted)]">
          ...
          <button
            onClick={selectAll}
            className="brand-text rounded-sm text-sm transition-[color,transform] duration-[var(--ds-duration-fast)] hover:underline focus-visible:ring-2 focus-visible:ring-[color:var(--brand-primary)] focus-visible:outline-none active:scale-[0.97] motion-reduce:transition-none"
          >
            {t("vault.select_all")}
          </button>
          <button
        ...
        <>
          <div className="grid grid-cols-1 gap-3 md:grid-cols-2 md:gap-4 lg:grid-cols-3">
            {paginatedDocs.map((doc) => (
              <div
                key={doc.slug}
                className="group space-y-2.5 rounded-xl border border-[color:var(--ds-border)] bg-[color:var(--ds-surface)] p-4 transition-[background-color,border-color,color] focus-within:border-[color:var(--ds-border-strong)] hover:border-[color:var(--ds-border-strong)] motion-reduce:transition-none"
              >
                ...
                <Link
                  ...
                  className="block truncate rounded-sm text-sm font-medium text-[color:var(--ds-text)] transition-[color,transform] duration-[var(--ds-duration-fast)] hover:text-[color:var(--brand-primary)] focus-visible:text-[color:var(--brand-primary)] focus-visible:ring-2 focus-visible:ring-[color:var(--brand-primary)] focus-visible:outline-none active:scale-[0.99] motion-reduce:transition-none"
                  title={doc.title}
                >
                  {doc.title}
                </Link>
