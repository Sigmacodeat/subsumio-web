...
> = {
    ...
    tiers: [
      {
        ...
        features: [
          ...
          "2,000 AI queries/seat/mo included",
          "Fair-use WhatsApp & document import",
      ...
      },
      {
        ...
        features: [
          ...
          "10,000 AI queries/seat/mo included",
          "250 GB cloud storage per seat",
      ...
      },
      {
        ...
        features: [
          "Unlimited AI queries & storage (Fair Use)",
  ...
  de: {
    ...
    tiers: [
      {
        ...
        features: [
          ...
          "2.000 KI-Anfragen/Seat/Mon. inklusive",
    ...
    footnote:
      "Jahreszahlung −20 %. KI-Anfragen und Speicher-Kontingente je Plan inklusive. Mehrverbrauch wird zu transparenten Einheitspreisen am Monatsende abgerechnet — keine Überraschungsrechnung, kein stilles Drosseln.",
  },
};
