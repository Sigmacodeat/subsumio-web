          ...
          {attachments.map((att) => (
            ...
            >
              ...
              <button
                ...
                className="flex h-8 w-8 items-center justify-center rounded text-[color:var(--ds-text-subtle)] transition-[background-color,border-color,color] hover:bg-[color:var(--ds-hover)] hover:text-red-500 sm:h-5 sm:w-5"
          ...
          <div className="flex items-center gap-0.5 px-1.5 pb-1.5">
            ...
            <div ref={templateRef} className="relative">
              <button
                ...
                className="flex h-11 w-11 shrink-0 items-center justify-center rounded-lg text-[color:var(--ds-text-muted)] transition-[background-color,color] duration-200 hover:bg-[color:var(--ds-hover)] hover:text-[color:var(--ds-text)] active:scale-95 disabled:opacity-50 sm:h-7 sm:w-7"
                    ...
                    <div className="max-h-64 overflow-y-auto p-1">
                      {templates.map((tpl: ChatTemplate) => (
                        <button
                          ...
                          className="flex w-full flex-col items-start gap-0.5 rounded-lg px-3 py-2 text-left transition-[background-color,border-color,color] hover:bg-[color:var(--ds-hover)]"
                        >
            ...
            {isStreaming ? (
              <button
                onClick={() => onStop?.()}
                className="flex h-11 w-11 shrink-0 items-center justify-center rounded-lg bg-red-500/10 text-red-500 transition-[background-color,transform] duration-200 hover:bg-red-500/20 active:scale-95 sm:h-7 sm:w-7"
              ...
              <button
                ...
                disabled={!canSend}
                className={cn(
                  "flex h-11 w-11 shrink-0 items-center justify-center rounded-lg bg-[color:var(--brand-primary)] text-white transition-[background-color,transform,opacity] duration-200 hover:bg-[color:var(--brand-primary-hover)] active:scale-95 disabled:cursor-not-allowed disabled:opacity-30 sm:h-7 sm:w-7",
