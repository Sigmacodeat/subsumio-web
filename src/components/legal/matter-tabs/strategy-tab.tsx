          ...
          <div className="brand-border brand-soft space-y-3 rounded-xl border p-4">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="text-[color:var(--ds-text-muted)] transition-[background-color,border-color,color] hover:text-[color:var(--ds-text-muted)] active:scale-[0.99] motion-reduce:transition-none"
              >
                {ctx.copied ? (
