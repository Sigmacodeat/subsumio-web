  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="flex w-full items-center justify-between gap-3 px-4 py-3 text-left transition-[background-color,border-color,color] hover:bg-[color:var(--ds-hover)] focus-visible:ring-2 focus-visible:ring-[color:var(--brand-primary)] focus-visible:outline-none active:scale-[0.97] motion-reduce:transition-none"
      >
      ...
      <AnimatePresence initial={false}>
        {open && (
          ...
          >
            {loading && !bundle && (
              <div
                className="flex items-center justify-center gap-2 py-12 text-sm text-[color:var(--ds-text-muted)]"
                role="status"
                aria-live="polite"
              >
