        ...
        <div className="flex items-center gap-2">
          ...
          {(["verjaehrung", "score", "updated", "status"] as SortKey[]).map((key) => (
            <button
              ...
              className={cn(
                "rounded-md px-3 py-1 text-sm font-medium transition-[background-color,border-color,color] focus-visible:ring-2 focus-visible:ring-[color:var(--brand-primary)] focus-visible:outline-none active:scale-[0.97] motion-reduce:transition-none",
                sortKey === key
