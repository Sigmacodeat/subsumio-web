---
title: Verfassungsblog — Bad Tandem
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/bad-tandem/
license: >-
  CC BY-SA 4.0 (Standard-Lizenz des Verfassungsblogs; einzelne Beiträge können
  abweichen). Namensnennung + Share-Alike erforderlich.
content_hash: "e6941d7ab2eb5b1b"
---
...
PiS wants to have their candidate elected at any price, either in the regular procedure or as a provisional incumbent. The Constitutional Court has now offered a solution. It suggests that the current constitutional provisions allow the Parliament to appoint a temporary Ombudsman by law. This would mean that the interim Ombudsman would be elected outside the regular procedure, virtually contrary the regulations of the Constitution. The result of the Constitutional Court’s logic is perplexing: provisional extension of the term of the incumbent? No. A new provisional Ombudsman? Yes. So right-wing conservatives now have a whip, confirmed by the Constitutional Court: accept our candidate in the regular procedure or we appoint him anyway and if, in the meantime, citizens are deprived of a sound legal protection body – we don’t care.

## Second dimension

But there is another negative consequence of the ruling: once again, as with the abortion issue in October 2020, the parliamentary majority handed its “own” Constitutional Court a hot potato. It now seems that the Constitutional Court acts as an adjunct, a backup to the political process. When the parliamentary majority feels unable to get something passed, it calls the Constitutional Court and gets a solution.
...
The task of the Constitutional Court, however, is not to pave the way for new ideas by the ruling party. Petitions to the Constitutional Court are not meant to be a supplementary legislative initiative, a “negative” legislative initiative that can be quickly converted into statutory language. In the case of the election of the Ombudsman, if Parliament cannot agree, then it is not the role of the negative lawmaker to offer a solution. As Sławomira Wronkowska-Jaśkiewicz correctly writes: “In shaping the political majority in the two chambers as a result of elections, voters demand that they be willing and able to find a solution to this problem, however difficult it may be.” The task of politics is to look for compromises and not to impose its own will at all costs with the help of the Constitutional Court. 

The Court can rule a provision either unconstitutional or constitutional – there are no compromises and the decision is final. If the Constitutional Court is to be used as a substitute for the political process, this renders the parliamentary process obsolete. If the Constitutional Court is to be seen as an adjunct to the legislative process, then we have a problem with the finality of the judgment. For the judgment cannot be changed, whereas a law can always be changed if the political will exists. Thus, a compliant Constitutional Court cements the legal order and closes it to compromise, which in the case of Poland will continue to be a problem. The new parliamentary majority after PiS, and it will come, will inherit a politicized Constitutional Court, which will then be used by the PiS minority to block any changes. But this problem needs a separate analysis.
