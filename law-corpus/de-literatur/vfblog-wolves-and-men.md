---
title: Verfassungsblog — Wolves and Men
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/wolves-and-men/
license: >-
...
But actually I already know, don't I?

But first:

## This week on Verfassungsblog

In the spring of 2020, together with Joelle Grogan, we launched an online symposium that actually went under that name for form's sake only: we published country reports from all over the world to gather knowledge on how different countries deal with the emergency pandemic. Now, one year later, we want to take another look: How has the situation evolved? How do countries find their way out of the emergency? “Power and the Covid-19 Pandemic” is the title of the online symposium, supported by Democracy Reporting International and the Horizon2020-funded RECONNECT research project, and it will end up with more than 60 reports. We kicked off this week with reports from Australia, Brazil, Finland, Greece, India, Mexico, Singapore, Spain, Sweden, and Thailand, as well as a live-streamed discussion event with MARTIN SCHEININ, THULASI K. RAJ, JAKUB JARACZEWICZ, TOMAS BUSTAMANTE and moderated by JOELLE GROGAN.

Also live this week on Verfassungsblog: ADAM BODNAR, ARMIN VON BOGDANDY, PIOTR BOGDANOWICZ, ANDRÁS JAKAB, JUSTYNA ŁACNY, JOSEPH WEILER and others discuss, on the initiative of the Max Planck Institute in Heidelberg, the newly published book “Defending Checks and Balances in EU Member States. Taking Stock of Europe's Actions“.
...
That's all for this week. Have you already enjoyed your coffee from your Verfassungsblog cup? Yes or no: Hold on to the Constitution! 
