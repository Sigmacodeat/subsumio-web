---
title: Verfassungsblog — The Memory Machine
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/the-memory-machine/
license: >-
  CC BY-SA 4.0 (Standard-Lizenz des Verfassungsblogs; einzelne Beiträge können
  abweichen). Namensnennung + Share-Alike erforderlich.
content_hash: "9af3cf3d29e721f5"
---
...
Since LLMs generate responses based on the most probable word sequences, they tend to reflect dominant narratives present in their training data. This can lead to the marginalization of minority viewpoints or alternative perspectives that are underrepresented in the data. This would be in stark contrast to the promise of Web 2.0 and crowd-based information repositories such as Wikipedia.
...
Establishing legal frameworks to govern the development and deployment of LLMs is vital. Policies should require companies to address biases and ensure their models do not perpetuate misinformation. Regulations might include mandates for regular bias assessments, transparency reports, and mechanisms for individuals to contest and correct erroneous outputs. These requirements are not met in the current regulations, such as the EU AI act.
