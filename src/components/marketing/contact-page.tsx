...
const CONTENT = {
  ...
  de: {
    ...
    sub: "Fragen zu Subsumio, Self-Hosting, Enterprise-Plänen oder Partnerschaften? Erreichen Sie uns — wir antworten innerhalb eines Werktages.",
    ...
    channels: [
      ...
      },
      {
        ...
        title: "WhatsApp",
        value: "+43 …",
        desc: "Kurze Fragen? Schreiben Sie uns auf WhatsApp — wir sind während der Geschäftszeiten da.",
        href: "https://wa.me/43",
      },
      {
        icon: "FileText",
    ...
    ctaSub: "Starten Sie einen 14-Tage-Reverse-Trial — voller Zugriff, keine Kreditkarte.",
