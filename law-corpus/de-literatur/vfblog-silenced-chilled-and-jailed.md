---
title: Verfassungsblog — Silenced, Chilled, and Jailed
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/silenced-chilled-and-jailed/
license: >-
  CC BY-SA 4.0 (Standard-Lizenz des Verfassungsblogs; einzelne Beiträge können
  abweichen). Namensnennung + Share-Alike erforderlich.
content_hash: "db5175eeff395318"
---
...
## The Law Does Not Comply with the Three Criteria Test Under the European Convention on Human Rights
...
While disinformation is an overly exhausted and hyped phenomenon in the digital age, there is actually no agreed-upon international definition that is uniformly accepted. For example, the UN Special Rapporteur defines disinformation as “false information that is created and spread, deliberately or otherwise, to harm people, institutions, and interests.”; while the European Commission defines it as “verifiably false or misleading information that, cumulatively, is created, presented and disseminated for economic gain or to intentionally deceive the public and that may cause public harm.” Additionally, the Council of Europe defines the concept of disinformation disorder in three types. Accordingly, misinformation is when false information is shared, but no harm is meant, while disinformation is when false information is knowingly shared to cause harm. More interestingly, the third type focuses on a term called “malinformation”, which is when genuine information is shared to cause harm, often by moving information designed to stay private into the public sphere.
...
The provision defines the specific intent of the crime as “with the motive exclusively to create distress, fear, and panic among public and in a manner conducive to disturb public peace.” However, it provides no definition of what would cause such distress, fear, and panic among the public. Without any clarification, any acts that would induce the above-mentioned responses would be considered within the scope of the crime. Therefore, there is a risk of interpreting and prosecuting the specific intent too broadly, to a point where a simple parody could be deemed as creating distress, fear, and panic.
...
The author has no affiliation to any political party, nor does this blog represent a particular political view. This blog post is intended to provide a purely legal and policy analysis.

 References[+]

 References  

 &#8593;1 Hasen, Richard L., ‘Cheap Speech and What It Has Done (to American Democracy)’ First Amendment Law Review, Vol. 16, Symposium Issue, 2018.

 &#8593;2 Andrejevic, M., ‘Infoglut: How too much information is changing the way we think and know’, (1st ed.) Routledge, 2013; Pariser, E., ‘The filter bubble: what the Internet is hiding from you’, London: Viking/Penguin Press, 2011.
