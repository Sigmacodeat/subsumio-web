          ...
          {filtered.map((template) => {
            ...
            return (
              <div
                key={template.slug}
                className={cn(
                  "group relative flex flex-col rounded-xl border border-[color:var(--ds-border)] bg-[color:var(--ds-surface)] p-4 transition-[background-color,border-color,color,box-shadow,transform,opacity] hover:border-[color:var(--brand-primary)]/30 hover:shadow-md motion-reduce:transition-none",
