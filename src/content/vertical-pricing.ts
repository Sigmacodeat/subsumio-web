...
export const VERTICAL_PRICING: Record<Lang, Partial<Record<string, VerticalPricing>>> = {
  en: {
    legal: {
      ...
      tiers: [
        {
          id: "starter", name: "Starter", price: "€299", period: "/seat/mo",
          blurb: "Solo practitioners exploring AI-assisted case work. Monthly billing, cancel any time. Up to 2 seats.",
          features: [
          ...
          cta: "Try Starter", href: "/signup",
        },
        {
          id: "solo", name: "Professional", price: "€690", period: "/seat/mo",
          ...
          cta: "Start Professional", href: "/signup",
        },
        {
          id: "kanzlei", name: "Kanzlei", price: "€990", period: "/seat/mo",
        ...
        {
          id: "ent", name: "Enterprise", price: "from €1,490", period: "/seat/mo",
  ...
  de: {
    legal: {
      ...
      sub: "Pro Seat, jährliche Abrechnung. Akten-Synthese, WhatsApp-Copilot und Compliance-Infrastruktur — auf EU-Infrastruktur, die ihr kontrolliert.",
      tiers: [
        {
          id: "starter", name: "Starter", price: "299 €", period: "/Seat/Mon.",
          blurb: "Für Einzelanwälte, die KI-gestützte Aktenarbeit erkunden. Monatlich kündbar. Bis 2 Seats.",
          features: [
          ...
          cta: "Starter testen", href: "/signup",
        },
        {
          id: "solo", name: "Professional", price: "690 €", period: "/Seat/Mon.",
          ...
          cta: "Professional starten", href: "/signup",
        },
        {
          id: "kanzlei", name: "Kanzlei", price: "990 €", period: "/Seat/Mon.",
        ...
        {
          id: "ent", name: "Enterprise", price: "ab 1.490 €", period: "/Seat/Mon.",
