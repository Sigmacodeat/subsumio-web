---
title: Verfassungsblog — To Vote or Not to Vote?
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/to-vote-or-not-to-vote/
license: >-
  CC BY-SA 4.0 (Standard-Lizenz des Verfassungsblogs; einzelne Beiträge können
  abweichen). Namensnennung + Share-Alike erforderlich.
content_hash: "5764ccd10f451057"
---
...
Indeed, also in the absence of a specific derogation, states may seek to justify interferences with the right to political participation. The right to political participation is a relative right, whose enjoyment can be restricted under certain conditions: restrictions need to be provided for by law, pursue a legitimate aim and be based on objective and reasonable criteria – i.e. they must be proportionate (see e.g. HRC, General Comment No 25, para 4; Labita v Italy [2000]; Dicle and Sadak v Turkey [2015]). Accordingly, limitations of the right to political participation to contain the pandemic may thus be permissible if these conditions are met. This opens room for states to adopt according mitigation measures or to rely on remote voting, as we discuss next.

## Mitigating measures and remote voting methods
