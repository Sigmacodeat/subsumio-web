---
title: >-
  Verfassungsblog — Letters from Brussels with Love and the Issue of Mutual
  Trust in Nationality Matters
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/letters-from-brussels-with-love/
license: >-
...
The recognition of nationality for the purpose of EU law is, however, complicated by the fact that nationality and Union citizenship are (more or less) one, and Union citizenship in itself is a single status that ought to be the same everywhere in the EU. A functional approach to nationality and Union citizenship by extension would however create a bifurcated fundamental status. Very much like Schrödinger’s cat, one is and is not a Union citizen. This may be a compelling outcome at the quantum level of things for cats, but it is a most undesirable outcome for the individual at the European Union’s level.
...
Nevertheless, in light of the current events, we may find out rather sooner than later what mutual trust in nationality matters amounts to. And who knows, those high-flying cases before the Court in Luxembourg might depart from rather unexpected places.
