...
const DE: ConceptMapping[] = [
  // BGB
  {
    terms: ["sittenwidrig", "sittenwidrigkeit", "gute sitten"],
    law: "BGB",
    jurisdiction: "de",
    sections: [138],
  },
  {
    terms: ["geschäftsfähigkeit", "geschäftsfähig"],
    law: "BGB",
    jurisdiction: "de",
    sections: [104, 106],
  },
  ...
  {
    terms: ["verjährung", "verjährt", "verjährungsfrist"],
    law: "BGB",
    jurisdiction: "de",
    sections: [195, 199],
  },
  ...
  {
    terms: ["kaufvertrag", "kauf", "gewährleistung"],
    law: "BGB",
    jurisdiction: "de",
    sections: [433, 434],
  },
  ...
  {
    terms: ["mietvertrag", "miete", "mieter", "vermieter"],
    law: "BGB",
    jurisdiction: "de",
    sections: [535, 573],
  },
  ...
  {
    terms: ["unerlaubte handlung", "delikt"],
    law: "BGB",
    jurisdiction: "de",
    sections: [823, 826],
  },
  ...
  {
    terms: ["erbrecht", "erbfolge", "testament"],
    law: "BGB",
    jurisdiction: "de",
    sections: [1922, 1937],
  },
  ...
  {
    terms: ["unterhalt", "unterhaltspflicht"],
    law: "BGB",
    jurisdiction: "de",
    sections: [1601, 1603],
  },
  ...
  {
    terms: ["bestechung", "bestechlichkeit"],
    law: "StGB",
    jurisdiction: "de",
    sections: [331, 332],
  },
  ...
  {
    terms: ["schuldunfähigkeit", "schuldunfähig"],
    law: "StGB",
    jurisdiction: "de",
    sections: [19, 20],
  },
  ...
  // ZPO
  {
    terms: ["gerichtsstand", "zuständigkeit"],
    law: "ZPO",
    jurisdiction: "de",
    sections: [12, 13, 32],
  },
  ...
  {
    terms: ["gerichtsstand der unerlaubten handlung"],
    law: "ZPO",
    jurisdiction: "de",
    sections: [32],
  },
  ...
  {
    terms: ["klage", "klageschrift", "klageerhebung"],
    law: "ZPO",
    jurisdiction: "de",
    sections: [253],
  },
  ...
  {
    terms: ["beweis", "beweisaufnahme", "beweislast"],
    law: "ZPO",
    jurisdiction: "de",
    sections: [355, 420],
  },
  ...
  {
    terms: ["einstweilige verfügung", "einstweiliger rechtsschutz"],
    law: "ZPO",
    jurisdiction: "de",
    sections: [935, 940],
  },
  ...
  {
    terms: ["zwangsvollstreckung", "vollstreckung"],
    law: "ZPO",
    jurisdiction: "de",
    sections: [704, 802],
  },
  ...
  {
    terms: ["beschwerde", "sofortige beschwerde"],
    law: "ZPO",
    jurisdiction: "de",
    sections: [567, 570],
  },
  ...
  {
    terms: ["wiedereinsetzung in den vorigen stand"],
    law: "ZPO",
    jurisdiction: "de",
    sections: [233, 236],
  },
  {
    terms: ["mahnverfahren", "mahnbescheid"],
    law: "ZPO",
    jurisdiction: "de",
    sections: [688, 694],
  },
  ...
  // HGB
  {
    terms: ["kaufmann", "kaufmannseigenschaft"],
    law: "HGB",
    jurisdiction: "de",
    sections: [1, 2, 6],
  },
  ...
  {
    terms: ["ohg", "offene handelsgesellschaft"],
    law: "HGB",
    jurisdiction: "de",
    sections: [105, 124],
  },
  ...
  {
    terms: ["festsetzungsverjährung", "festsetzungsfrist"],
    law: "AO",
    jurisdiction: "de",
    sections: [169, 171],
  },
  ...
  {
    terms: ["außenprüfung", "betriebsprüfung"],
    law: "AO",
    jurisdiction: "de",
    sections: [193, 200],
  },
  ...
  // StPO
  {
    terms: ["ermittlungsverfahren", "ermittlungen"],
    law: "StPO",
    jurisdiction: "de",
    sections: [160, 163],
  },
  {
    terms: ["staatsanwaltschaft", "staatsanwalt"],
    law: "StPO",
    jurisdiction: "de",
    sections: [152, 160],
  },
  {
    terms: ["untersuchungshaft", "haftbefehl"],
    law: "StPO",
    jurisdiction: "de",
    sections: [112, 114],
  },
  ...
  {
    terms: ["durchsuchung", "durchsuchungsbeschluss"],
    law: "StPO",
    jurisdiction: "de",
    sections: [102, 105],
  },
  {
    terms: ["beschlagnahme", "sicherstellung"],
    law: "StPO",
    jurisdiction: "de",
    sections: [94, 98],
  },
  ...
  {
    terms: ["körperliche untersuchung", "blutprobe"],
    law: "StPO",
    jurisdiction: "de",
    sections: [81, 81],
  },
  // InsO
  {
    terms: ["insolvenz", "insolvenzverfahren"],
    law: "InsO",
    jurisdiction: "de",
    sections: [1, 11, 21],
  },
  ...
  // RVG
  {
    terms: ["anwaltsvergütung", "rechtsanwaltsvergütung"],
    law: "RVG",
    jurisdiction: "de",
    sections: [1, 13, 23],
  },
  ...
  // VwGO
  {
    terms: ["verwaltungsgericht", "verwaltungsgerichtsbarkeit"],
    law: "VwGO",
    jurisdiction: "de",
    sections: [1, 40, 42],
  },
  ...
  {
    terms: ["vorläufiger rechtsschutz", "einstweiliger rechtsschutz"],
    law: "VwGO",
    jurisdiction: "de",
    sections: [80],
  },
  ...
  {
    terms: ["unlauterer wettbewerb", "wettbewerbsverstoß"],
    law: "UWG",
    jurisdiction: "de",
    sections: [3],
  },
  ...
  {
    terms: ["bundesverfassungsgericht", "verfassungsgericht"],
    law: "GG",
    jurisdiction: "de",
    sections: [93, 94],
  },
  ...
  // EStG
  {
    terms: ["einkommensteuer", "einkommensteuerpflicht"],
    law: "EStG",
    jurisdiction: "de",
    sections: [1, 2],
  },
  {
    terms: ["betriebsausgaben", "betriebsausgabe"],
    law: "EStG",
    jurisdiction: "de",
    sections: [4],
  },
  {
    terms: ["werbungskosten", "werbungskostenpauschale"],
    law: "EStG",
    jurisdiction: "de",
    sections: [9],
  },
  ...
  {
    terms: ["außergewöhnliche belastung", "außergewöhnliche belastungen"],
    law: "EStG",
    jurisdiction: "de",
    sections: [33],
  },
  {
    terms: ["steuertarif", "einkommensteuertarif", "splittingtarif"],
    law: "EStG",
    jurisdiction: "de",
    sections: ["32a"],
  },
  ...
  {
    terms: ["kapitalerträge", "kapitalertragsteuer", "abgeltungsteuer"],
    law: "EStG",
    jurisdiction: "de",
    sections: [20, 43],
  },
  ...
  {
    terms: ["afa", "abschreibung", "absetzung für abnutzung"],
    law: "EStG",
    jurisdiction: "de",
    sections: [7],
  },
  ...
  {
    terms: ["abfindung", "abfindungsbesteuerung"],
    law: "EStG",
    jurisdiction: "de",
    sections: [3, 24],
  },
  {
    terms: ["entschädigung", "entschädigungsbesteuerung"],
    law: "EStG",
    jurisdiction: "de",
    sections: [24],
  },
  {
    terms: ["schmerzensgeld", "schmerzensersatz"],
    law: "EStG",
    jurisdiction: "de",
    sections: [25],
  },
  // UStG
  {
    terms: ["umsatzsteuer", "umsatzsteuerpflicht"],
    law: "UStG",
    jurisdiction: "de",
    sections: [1],
  },
  ...
  {
    terms: ["reverse charge", "übergang der steuerschuld"],
    law: "UStG",
    jurisdiction: "de",
    sections: ["13b"],
  },
  {
    terms: ["innergemeinschaftliche lieferung", "igl"],
    law: "UStG",
    jurisdiction: "de",
    sections: [4, "6a"],
  },
  {
    terms: ["umsatzsteuervoranmeldung", "voranmeldung"],
    law: "UStG",
    jurisdiction: "de",
    sections: [18],
  },
  // KStG
  {
    terms: ["körperschaftsteuer", "körperschaftsteuerpflicht"],
    law: "KStG",
    jurisdiction: "de",
    sections: [1],
  },
  {
    terms: ["verdeckte gewinnausschüttung", "vga"],
    law: "KStG",
    jurisdiction: "de",
    sections: [8],
  },
  // GewStG
  {
    terms: ["gewerbesteuer", "gewerbeertrag"],
    law: "GewStG",
    jurisdiction: "de",
    sections: [2, 11],
  },
  // ErbStG
  {
    terms: ["erbschaftsteuer", "schenkungsteuer", "erbschaftssteuer"],
    law: "ErbStG",
    jurisdiction: "de",
    sections: [1, 2],
  },
  {
    terms: ["freibetrag", "freibeträge erbschaftsteuer"],
    law: "ErbStG",
    jurisdiction: "de",
    sections: [16],
  },
  ...
  {
    terms: ["einspruch", "einspruch gegen bescheid"],
    law: "AO",
    jurisdiction: "de",
    sections: [355],
  },
  {
    terms: ["verjährung", "festsetzungsverjährung"],
    law: "AO",
    jurisdiction: "de",
    sections: [169],
  },
  ...
  {
    terms: ["selbstanzeige", "strafbefreiende selbstanzeige"],
    law: "AO",
    jurisdiction: "de",
    sections: [371],
  },
  ...
  // AStG
  {
    terms: ["außensteuergesetz", "doppelbesteuerung", "dba"],
    law: "AStG",
    jurisdiction: "de",
    sections: [1],
  },
...
const AT: ConceptMapping[] = [
  ...
  {
    terms: ["minderjähriger", "minderjährige"],
    law: "ABGB",
    jurisdiction: "at",
    sections: [21, 151],
  },
  ...
  {
    terms: ["täuschung", "arglistige täuschung"],
    law: "ABGB",
    jurisdiction: "at",
    sections: [870, 871],
  },
  ...
  {
    terms: ["stellvertretung", "vollmacht"],
    law: "ABGB",
    jurisdiction: "at",
    sections: [1002, 1009],
  },
  ...
  {
    terms: ["mängel", "sache mangel", "mangelhaft"],
    law: "ABGB",
    jurisdiction: "at",
    sections: [922, 932],
  },
  {
    terms: ["rücktritt", "rücktrittsrecht"],
    law: "ABGB",
    jurisdiction: "at",
    sections: [918, 920],
  },
  ...
  {
    terms: ["ungerechtfertigte bereicherung"],
    law: "ABGB",
    jurisdiction: "at",
    sections: [1431, 1437],
  },
  {
    terms: ["eigentum", "eigentumsübertragung"],
    law: "ABGB",
    jurisdiction: "at",
    sections: [353, 361],
  },
  ...
  {
    terms: ["herausgabe", "eigentumsschutz"],
    law: "ABGB",
    jurisdiction: "at",
    sections: [366, 372],
  },
  ...
  {
    terms: ["sorgerecht", "elterliche sorge"],
    law: "ABGB",
    jurisdiction: "at",
    sections: [144, 151],
  },
  ...
  // AT UGB
  {
    terms: ["kaufmann", "kaufmannseigenschaft", "unternehmer"],
    law: "UGB",
    jurisdiction: "at",
    sections: [1, 2],
  },
  ...
  {
    terms: ["offene handelsgesellschaft", "og"],
    law: "UGB",
    jurisdiction: "at",
    sections: [105, 106],
  },
  ...
  // AT AVG
  {
    terms: ["verwaltungsverfahren", "verwaltungsgericht"],
    law: "AVG",
    jurisdiction: "at",
    sections: [1, 2],
  },
  ...
  // AT GewO
  {
    terms: ["gewerbe", "gewerbeberechtigung", "gewerbeausübung"],
    law: "GewO",
    jurisdiction: "at",
    sections: [1, 2],
  },
  {
    terms: ["gewerbeanmeldung", "gewerbeantrag"],
    law: "GewO",
    jurisdiction: "at",
    sections: [64, 65],
  },
  {
    terms: ["gewerbeentzug", "gewerbeuntersagung"],
    law: "GewO",
    jurisdiction: "at",
    sections: [87],
  },
  ...
  {
    terms: ["pension", "pensionsversicherung"],
    law: "ASVG",
    jurisdiction: "at",
    sections: [246, 247],
  },
  ...
  // AT JN
  {
    terms: ["jurisdiktion", "gerichtsorganisation"],
    law: "JN",
    jurisdiction: "at",
    sections: [1, 2],
  },
  ...
  // AT VStG
  {
    terms: ["verwaltungsstrafe", "verwaltungsübertretung"],
    law: "VStG",
    jurisdiction: "at",
    sections: [1, 2],
  },
  ...
  {
    terms: ["steuertarif", "einkommensteuertarif"],
    law: "EStG",
    jurisdiction: "at",
    sections: [33],
  },
  {
    terms: ["kapitalerträge", "kapitalertragsteuer"],
    law: "EStG",
    jurisdiction: "at",
    sections: [27],
  },
  ...
  // BAO
  {
    terms: ["abgabenordnung", "bundesabgabenordnung"],
    law: "BAO",
    jurisdiction: "at",
    sections: [1],
  },
  {
    terms: ["berufung", "berufung gegen bescheid"],
    law: "BAO",
    jurisdiction: "at",
    sections: [245],
  },
  ...
  {
    terms: ["steuerhinterziehung", "abgabenhinterziehung"],
    law: "BAO",
    jurisdiction: "at",
    sections: [207],
  },
...
const CH_TAX: ConceptMapping[] = [
  // DBG
  {
    terms: ["direkte bundessteuer", "einkommensteuer schweiz"],
    law: "DBG",
    jurisdiction: "ch",
    sections: [1],
  },
  ...
  {
    terms: ["kapitalgewinne", "kapitalgewinn"],
    law: "DBG",
    jurisdiction: "ch",
    sections: [16, 18],
  },
  ...
  {
    terms: ["veranlagung", "steuererklärung schweiz"],
    law: "DBG",
    jurisdiction: "ch",
    sections: [63],
  },
  {
    terms: ["einspruch", "einspruch veranlagung"],
    law: "DBG",
    jurisdiction: "ch",
    sections: [108],
  },
  {
    terms: ["verjährung", "veranlagungsverjährung"],
    law: "DBG",
    jurisdiction: "ch",
    sections: [121],
  },
  // MWSTG
  {
    terms: ["mehrwertsteuer", "mwst", "umsatzsteuer schweiz"],
    law: "MWSTG",
    jurisdiction: "ch",
    sections: [1],
  },
  ...
  // StHG
  {
    terms: ["steuerharmonisierung", "harmonisierung"],
    law: "StHG",
    jurisdiction: "ch",
    sections: [1],
  },
 ...
 */
export function expandConceptQuery(query: string, jurisdiction?: "de" | "at" | "ch"): string {
