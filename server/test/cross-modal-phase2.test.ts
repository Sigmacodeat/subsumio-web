...
import { ImageLoadError, loadImageInput } from "../src/core/search/image-loader.ts";
...
const PNG_BYTES = Buffer.from([
  ...
  0, 0, 0, 13, 73, 72, 68, 82, 0, 0, 0, 1, 0, 0, 0, 1, 8, 6, 0, 0, 0, 31, 21, 196, 137, 0, 0, 0, 12,
  73, 68, 65, 84, 8, 87, 99, 248, 207, 192, 0, 0, 0, 3, 0, 1, 90, 12, 105, 240, 0, 0, 0, 0, 73, 69,
  78, 68, 174, 66, 96, 130,
]);
