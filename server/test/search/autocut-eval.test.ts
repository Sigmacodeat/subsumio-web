...
const FIXTURE: EvalQuery[] = [
  ...
  ...Array.from(
    ...
    (_, i): EvalQuery => ({
      ...
      candidates: [
        ...
        { rerank_score: 0.3, relevant: false },
        { rerank_score: 0.25, relevant: false },
        { rerank_score: 0.2, relevant: false },
        { rerank_score: 0.15, relevant: false },
        { rerank_score: 0.1, relevant: false },
  ...
  ...Array.from(
    ...
    (_, i): EvalQuery => ({
      ...
      kind: "cluster",
      candidates: [
        { rerank_score: 0.9, relevant: true },
  ...
  ...Array.from(
    ...
    (_, i): EvalQuery => ({
      ...
      kind: "enumeration",
      candidates: [
        { rerank_score: 0.6, relevant: true },
        ...
        { rerank_score: 0.5, relevant: false },
  ...
  // way autocut can hurt recall. Kept rare to match real distributions.
  {
    ...
    candidates: [
      { rerank_score: 0.9, relevant: true },
      { rerank_score: 0.5, relevant: true }, // relevant but mis-scored below the cliff
      { rerank_score: 0.48, relevant: false },
