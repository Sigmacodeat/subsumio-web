  ...
  return (
    <>
      <button
        ...
        className="flex items-center gap-2 rounded-xl border [border-color:var(--mk-border)] px-3 py-2 text-xs [color:var(--mk-text-muted)] transition-[background-color,border-color,color,box-shadow,opacity,transform] duration-[var(--ds-duration-normal)] ease-[cubic-bezier(0.32,0.72,0,1)] [background:var(--mk-surface)] hover:[border-color:var(--mk-border-strong)] hover:[color:var(--mk-text)] active:scale-[0.99] motion-reduce:transition-none"
      >
        <Scale size={14} />
        RVG-Rechner
      </button>
      ...
      <AnimatePresence initial={false}>
        {open && (
          ...
          >
            <motion.div
              className="w-full max-w-md space-y-4 rounded-2xl border [border-color:var(--mk-border)] p-5 shadow-xl [background:var(--mk-surface)]"
