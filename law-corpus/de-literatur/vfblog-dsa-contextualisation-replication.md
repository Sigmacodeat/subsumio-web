---
title: Verfassungsblog — Contextualisation over Replication
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/dsa-contextualisation-replication/
license: >-
...
Using the GDPR as an example, the EU was able to set some data protection standards globally. Companies operating in the EU had to conform with the GDPR. As a result, a company’s compliance measure meant for the EU could consequently become a measure applied across the globe, i.e., separate compliance measures are not developed for Europeans, rather, the measures are applied globally. This is a de facto impact of the GDPR. On the other hand, de jure effects involve the adoption of some aspects of the GDPR as data protection standards in non-EU countries, including in African countries. These effects are majorly motivated by economic and trade interests.
