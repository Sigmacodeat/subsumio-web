...
export const D = {
  ...
  "mattertab.client_meeting_empty": { de: "Keine Gespräche dokumentiert", en: "No meetings documented" },
  ...
  "fao.specialist_placeholder": { de: "Fachanwalt für Familienrecht", en: "Specialist Lawyer for Family Law" },
  ...
  "practice.followup.description": { de: "Interne Erinnerung ohne gesetzliche Frist anlegen.", en: "Create an internal reminder without a statutory deadline." },
  "practice.followup.page_description": { de: "Interne Erinnerungen getrennt von gesetzlichen Fristen verwalten.", en: "Manage internal reminders separately from statutory deadlines." },
  ...
  "practice.phone.description": { de: "Gespräch, Ergebnis und Folgeaktion strukturiert dokumentieren.", en: "Document the call, outcome and follow-up action." },
  ...
  "today.error": { de: "Die Heute-Ansicht konnte nicht geladen werden.", en: "The today view could not be loaded." },
  "weekly.title": { de: "Wöchentlicher Review ausstehend", en: "Weekly review pending" },
  "weekly.description": { de: "Schließen Sie die Kanzleiwoche mit diesen Prüfpunkten ab.", en: "Close the firm week with these checks." },
