...
describe("slugifyPath", () => {
  ...
  test("Apple Notes example 1", () => {
    expect(slugifyPath("Apple Notes/2017-05-03 ohmygreen.md")).toBe(
      "apple-notes/2017-05-03-ohmygreen"
    );
  });

  test("Apple Notes example 2", () => {
    expect(slugifyPath("Apple Notes/2018-12-14 Team Photo.md")).toBe(
      "apple-notes/2018-12-14-team-photo"
    );
  });

  test("Apple Notes example 3 (parens and ellipsis)", () => {
    const input =
      "Apple Notes/2017-05-05 Today I had a touch base with Kavita for the meeting on Monday. (she\u2026.md";
    const result = slugifyPath(input);
    expect(result).toBe(
      "apple-notes/2017-05-05-today-i-had-a-touch-base-with-kavita-for-the-meeting-on-monday.-she"
    );
  });
  ...
  test("meetings transcript example", () => {
    expect(
      slugifyPath(
        "meetings/transcripts/2026-01-21 maria - california c4 collaboration discussion.md"
      )
