---
title: Verfassungsblog — A Letter from Minneapolis
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/a-letter-from-minneapolis/
license: >-
  CC BY-SA 4.0 (Standard-Lizenz des Verfassungsblogs; einzelne Beiträge können
  abweichen). Namensnennung + Share-Alike erforderlich.
content_hash: "7ed3986d493110f0"
---
...
Formal democracy and state control most visibly conflict during demonstrations. In Germany, the famous Brokdorf decision from 1985 strengthened the right to protest; since then, freedom of assembly has been regarded as “one of the most important human rights of all.” TRISTAN WIẞGOTT (GER) worries that this paradigm might now reach its limits and shows that the very principles that once made Brokdorf strong are failing today.
