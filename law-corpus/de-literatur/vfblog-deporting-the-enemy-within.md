---
title: Verfassungsblog — Deporting the Enemy Within
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/deporting-the-enemy-within/
license: >-
  CC BY-SA 4.0 (Standard-Lizenz des Verfassungsblogs; einzelne Beiträge können
  abweichen). Namensnennung + Share-Alike erforderlich.
content_hash: "f90922568ee96078"
---
...
To seek to justify this move in the name of security rests on a perverted conception thereof, one that posits that our security is only achievable if we erode theirs. It suggests that all that seemingly stands in the way of us being safe are the rights and territorial presence of those we can easily identify – that we just know – are mistaken citizens. These minority citizens’ status is constructed as temporary in a way that the majority’s is not. To achieve security, this reasoning goes, we must first strip them of their rights, their citizenship, and then deport them, those they have associated with and finally all those who look like them.
