      ...
      <div className="flex items-center gap-2 border-b border-white/10 bg-[color:var(--ds-surface)] px-4 py-3">
        ...
        {numPages > 1 && (
          <div className="flex items-center gap-1">
            <button
              ...
              disabled={pageNum <= 1}
              className="rounded p-1 text-[color:var(--ds-text-muted)] transition-[background-color,border-color,color] hover:bg-[color:var(--ds-surface-2)] focus-visible:ring-2 focus-visible:ring-[color:var(--brand-primary)] focus-visible:outline-none active:scale-[0.97] disabled:opacity-30 motion-reduce:transition-none"
            >
              <ChevronLeft size={18} />
            </button>
        ...
        <div className="flex items-center gap-1">
          <button
            ...
            className="rounded p-1 text-[color:var(--ds-text-muted)] transition-[background-color,border-color,color] hover:bg-[color:var(--ds-surface-2)] focus-visible:ring-2 focus-visible:ring-[color:var(--brand-primary)] focus-visible:outline-none active:scale-[0.97] motion-reduce:transition-none"
        ...
        {error && (
          <div className="flex h-full flex-col items-center justify-center gap-3">
            ...
            <a
              href={url}
              download={filename}
              className="flex items-center gap-2 rounded-lg border border-[color:var(--ds-border)] px-4 py-2 text-sm text-[color:var(--ds-text)] transition-[background-color,border-color,color] hover:bg-[color:var(--ds-surface-2)] motion-reduce:transition-none"
            >
              <Download size={16} />
