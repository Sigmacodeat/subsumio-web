...
**Subsumio** is the AI operating system for law firms (DACH-first): a knowledge-graph-powered
...
deadline-aware retrieval, conflict checks, and contradiction detection. The active
product is **Legal-only** (law firms / in-house legal); the former Tax vertical (Taxumio) is
archived per `docs/archive/TAXUMIO_ARCHIVE_MANIFEST.md`.
