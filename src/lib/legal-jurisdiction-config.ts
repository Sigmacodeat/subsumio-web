...
export const JURISDICTION_CONFIGS: Record<JurisdictionCode, JurisdictionConfig> = {
  DE: {
    ...
    lawSourceIds: ["law-de", "law-de-judikatur", "law-eu", "law-eu-directives", "law-eu-judikatur"],
  ...
  AT: {
    ...
    lawSourceIds: ["law-at", "law-at-judikatur", "law-eu", "law-eu-directives", "law-eu-judikatur"],
  ...
  EU: {
    ...
    lawSourceIds: ["law-eu", "law-eu-directives", "law-eu-judikatur"],
