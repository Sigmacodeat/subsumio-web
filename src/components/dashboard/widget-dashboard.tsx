      ...
      <div className="flex flex-wrap gap-2">
        {orderedSlugs.map((slug) => {
          ...
          return (
            <div
              key={slug}
              className="group flex items-center gap-1 rounded-full border border-[color:var(--ds-border)] bg-[color:var(--ds-surface-2)] pr-1 pl-1 transition-[background-color,border-color,color] hover:border-[color:var(--ds-border-strong)] motion-reduce:transition-none"
            >
              <Link
              ...
              <button
                ...
                className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full text-[color:var(--ds-text-subtle)] transition-[background-color,border-color,color] hover:bg-[color:var(--ds-hover)] hover:text-[color:var(--ds-text)] active:scale-[0.99] motion-reduce:transition-none"
              >
                {pinnedNow ? (
        ...
        <div className="flex flex-wrap items-center gap-x-4 gap-y-1.5">
          {items.map((item, _i) => (
            <Link
              key={item.href}
              href={item.href}
              className="inline-flex items-center gap-1.5 text-[13px] transition-[background-color,border-color,color] hover:underline motion-reduce:transition-none"
            >
              <span
        ...
        <div className="mt-3 flex min-w-0 items-center gap-2 border-t border-[color:var(--ds-border)] pt-3">
          ...
          <p className="min-w-0 truncate text-[13px] text-[color:var(--ds-text-muted)]">
            ...
            <Link
              ...
              className="text-[color:var(--ds-text)] transition-[background-color,border-color,color] hover:underline motion-reduce:transition-none"
            >
        ...
        >
          <div className="space-y-2 p-4">
            {data.unassignedDocs.length > 0 && (
              <Link
                href="/dashboard/vault"
                className="flex items-center justify-between rounded-lg border border-[color:var(--ds-warning-border)] bg-[color:var(--ds-warning-bg)] px-3 py-2.5 transition-[background-color,border-color,color] hover:opacity-80 motion-reduce:transition-none"
              >
            ...
            {data.reviewGaps.length > 0 && (
              <Link
                href="/dashboard/review-queue"
                className="flex items-center justify-between rounded-lg border border-[color:var(--ds-danger-border)] bg-[color:var(--ds-danger-bg)] px-3 py-2.5 transition-[background-color,border-color,color] hover:opacity-80 motion-reduce:transition-none"
              >
                <div className="flex min-w-0 items-center gap-3">
                  <AlertTriangle
                    size={15}
