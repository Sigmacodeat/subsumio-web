  ...
  return (
    <div className="relative shrink-0" ref={containerRef}>
      <button
        ...
        className={cn(
          "flex h-9 items-center gap-1.5 rounded-lg border px-2.5 text-[13px] font-medium transition-[background-color,border-color,color] active:scale-[0.99] motion-reduce:transition-none",
          open
        ...
        <div className="card-shadow-elevated absolute top-full left-0 z-50 mt-1 w-80 max-w-[calc(100vw-2rem)] overflow-hidden rounded-xl border border-[color:var(--ds-border)] bg-[color:var(--ds-surface)]">
          ...
          <div className="border-b border-[color:var(--ds-border)] p-2">
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-lg border border-[color:var(--ds-border)] bg-[color:var(--ds-surface-2)] py-2 pr-3 pl-8 text-[13px] text-[color:var(--ds-text)] placeholder:text-[color:var(--ds-text-subtle)] focus:border-[color:var(--brand-primary)] focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--brand-primary)] focus-visible:ring-offset-1"
              />
            </div>
          </div>
          ...
          <div className="border-t border-[color:var(--ds-border)] p-1.5">
            <Link
              ...
              className="flex w-full items-center gap-2 rounded-lg px-2.5 py-2 text-[13px] font-medium text-[color:var(--ds-text-muted)] transition-[background-color,border-color,color] hover:bg-[color:var(--ds-hover)] hover:text-[color:var(--ds-text)] motion-reduce:transition-none"
            >
...
function MatterSwitcherItem({
  ...
  return (
    <div
      className={cn(
        "group flex items-center gap-2 rounded-lg px-2.5 py-2 transition-[background-color,border-color,color] motion-reduce:transition-none",
        isActive
    ...
    >
      ...
      <button
        ...
        className={cn(
          "flex h-6 w-6 shrink-0 items-center justify-center rounded transition-[background-color,border-color,color] active:scale-[0.99] motion-reduce:transition-none",
          isPinned
            ? "brand-text"
