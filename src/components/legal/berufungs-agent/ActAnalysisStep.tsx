...
const RISK_COLORS = {
  high: "bg-[color:var(--ds-danger-bg)]/10 text-[color:var(--ds-danger-text)] border-[color:var(--ds-danger-border)]/30",
  medium:
    "bg-[color:var(--ds-warning-bg)]/10 text-[color:var(--ds-warning-text)] border-[color:var(--ds-warning-border)]/30",
  low: "bg-[color:var(--ds-success-bg)] text-[color:var(--ds-success-text)] border-[color:var(--ds-success-border)]/30",
} as const;
