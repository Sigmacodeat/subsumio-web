  ...
  test("guarantee works across multiple pages", () => {
    const results = [
      ...
      makeResult({
        ...
        score: 0.95,
        chunk_source: "timeline",
        chunk_text: "a timeline high score",
      }),
      makeResult({
        slug: "a",
        chunk_id: 2,
        score: 0.9,
        chunk_source: "timeline",
        chunk_text: "a timeline medium score",
      }),
      makeResult({
        slug: "a",
        chunk_id: 3,
        score: 0.2,
        chunk_source: "compiled_truth",
        chunk_text: "a compiled truth low score",
      }),
      ...
      makeResult({
        ...
        score: 0.85,
        chunk_source: "compiled_truth",
        chunk_text: "b compiled truth content",
      }),
      ...
      makeResult({
        ...
        score: 0.8,
        chunk_source: "timeline",
        chunk_text: "c timeline only entry",
      }),
    ];
  ...
  test("same slug + same source DOES collapse to maxPerPage", () => {
    ...
    const results = [
      makeResult({
        ...
        chunk_id: 1,
        score: 0.9,
        chunk_text: "chunk one distinct content here",
      }),
      makeResult({
        slug: "topics/ai",
        source_id: "wiki",
        chunk_id: 2,
        score: 0.8,
        chunk_text: "chunk two also distinct words",
      }),
      makeResult({
        slug: "topics/ai",
        source_id: "wiki",
        chunk_id: 3,
        score: 0.7,
        chunk_text: "chunk three different terms again",
      }),
    ];
    const deduped = dedupResults(results);
