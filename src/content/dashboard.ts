...
export const D = {
  ...
  "copilot.quick_create.case": { de: "Neue Akte", en: "New case" },
  "copilot.quick_create.deadline": { de: "Neue Frist", en: "New deadline" },
  "copilot.quick_create.contract": { de: "Neuer Vertrag", en: "New contract" },
  ...
  "copilot.qa.whatsapp_intakes": { de: "WhatsApp-Intakes öffnen", en: "Open WhatsApp intakes" },
  "copilot.qa.whatsapp_summarize": {
    de: "WhatsApp-Konversationen zusammenfassen",
    en: "Summarize WhatsApp conversations",
  },
  "copilot.qa.docs_unanalyzed": {
    de: "Unanalysierte Dokumente finden",
    en: "Find unanalyzed documents",
  },
  "copilot.qa.docs_upload": { de: "Dokument hochladen", en: "Upload document" },
  "copilot.qa.graph_explain": {
    de: "Entitäts-Beziehungen erklären",
    en: "Explain entity relationships",
  },
  "copilot.qa.sources_connected": {
    de: "Verbundene Quellen anzeigen",
    en: "Which sources are connected?",
  },
  "copilot.qa.approvals_pending": { de: "Offene Freigaben", en: "Pending approvals" },
  "copilot.qa.doc_requests_open": {
    de: "Offene Dokumentenanforderungen",
    en: "Open document requests",
  },
  "copilot.qa.litigation_active": { de: "Aktive Litigation-Flows", en: "Active litigation flows" },
  "copilot.qa.review_set_progress": { de: "Review-Set-Fortschritt", en: "Review set progress" },
  "copilot.qa.trust_balances": { de: "Trust-Kontostände", en: "Trust account balances" },
  "copilot.qa.win_loss_stats": { de: "Gewinn/Verlust-Statistiken", en: "Win/loss statistics" },
  "copilot.ctx.whatsapp": { de: "WhatsApp", en: "WhatsApp" },
  "copilot.ctx.documents": { de: "Dokumente", en: "Documents" },
  "copilot.ctx.graph": { de: "Graph", en: "Graph" },
  "copilot.ctx.sources": { de: "Quellen", en: "Sources" },
  "copilot.ctx.approvals": { de: "Freigaben", en: "Approvals" },
  "copilot.ctx.document_requests": { de: "Dokumentenanforderungen", en: "Document Requests" },
  "copilot.ctx.litigation": { de: "Prozessführung", en: "Litigation" },
  "copilot.ctx.review_sets": { de: "Review-Sets", en: "Review Sets" },
  "copilot.ctx.trust_accounting": { de: "Treuhandkonto", en: "Trust Accounting" },
  "copilot.ctx.litigation_analytics": { de: "Verfahrensanalytics", en: "Litigation Analytics" },
  "copilot.ctx.directory": { de: "Alle Funktionen", en: "All Features" },
  "copilot.ctx.settings": { de: "Einstellungen", en: "Settings" },
  "copilot.ctx.team": { de: "Team", en: "Team" },
  "copilot.ctx.audit": { de: "Audit-Log", en: "Audit Log" },
  "copilot.ctx.tax_returns": { de: "Steuererklärungen", en: "Tax Returns" },
  "copilot.ctx.tax_deadlines": { de: "Steuerfristen", en: "Tax Deadlines" },
  "copilot.ctx.elster": { de: "ELSTER", en: "ELSTER" },
  "copilot.ctx.tabular_review": { de: "Tabellarischer Review", en: "Tabular Review" },
  "copilot.ctx.upload": { de: "Dokumente hochladen", en: "Upload Documents" },
  "copilot.ctx.translate": { de: "Übersetzung", en: "Translation" },
  "copilot.ctx.anonymize": { de: "Anonymisierung", en: "Anonymization" },
  "copilot.ctx.case_scanner": { de: "Akten-Scanner", en: "Case Scanner" },
  "copilot.ctx.process_strategy": { de: "Prozessstrategie", en: "Litigation Strategy" },
  "copilot.ctx.controlling": { de: "Kanzlei-Kennzahlen", en: "Firm Analytics" },
  ...
  "copilot.qa.tax_deadlines_urgent": {
    de: "Welche Steuerfristen sind am dringendsten?",
    en: "Which tax deadlines are most urgent?",
  },
  "copilot.qa.elster_status": {
    de: "Was ist der Status der letzten ELSTER-Übermittlungen?",
    en: "What's the status of recent ELSTER submissions?",
  },
  "copilot.qa.tabular_review_progress": {
    de: "Wie weit ist der tabellarische Review fortgeschritten?",
    en: "How far along is the tabular review?",
  },
  "copilot.qa.upload_ocr": {
    de: "Welche hochgeladenen Dokumente wurden noch nicht per OCR erfasst?",
    en: "Which uploaded documents haven't been OCR-processed yet?",
  },
  "copilot.qa.translate_help": {
    de: "Hilf mir, ein juristisches Dokument zu übersetzen.",
    en: "Help me translate a legal document.",
  },
  "copilot.qa.anonymize_help": {
    de: "Welche Dokumente enthalten personenbezogene Daten, die anonymisiert werden sollten?",
    en: "Which documents contain personal data that should be anonymized?",
  },
  "copilot.qa.case_scanner_risks": {
    de: "Welche Akten haben die höchsten Risiken laut Scanner?",
    en: "Which cases have the highest risks according to the scanner?",
  },
  "copilot.qa.strategy_recommend": {
    de: "Empfiehl eine Prozessstrategie für den aktuellen Fall.",
    en: "Recommend a litigation strategy for the current case.",
  },
  "copilot.qa.controlling_kpi": {
    de: "Zeige mir die wichtigsten KPIs für dieses Quartal.",
    en: "Show me the key KPIs for this quarter.",
  },
  "copilot.qa.workflows_active": {
    de: "Welche Workflows sind aktuell aktiv und wo gibt es Engpässe?",
    en: "Which workflows are currently active and where are bottlenecks?",
  },
