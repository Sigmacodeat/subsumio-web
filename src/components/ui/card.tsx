...
function Card({ className, glass, glow, ...props }: CardProps) {
  return (
    <div
      className={cn(
        "card-shadow hover:card-shadow-hover rounded-xl border border-[color:var(--ds-border)] bg-[color:var(--ds-surface)] transition-[border-color,box-shadow] duration-[var(--ds-duration-normal)] hover:border-[color:var(--ds-border-strong)] motion-reduce:transition-none",
