---
title: Verfassungsblog — Delhi’s Disempowerment
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/delhis-disempowerment/
license: >-
  CC BY-SA 4.0 (Standard-Lizenz des Verfassungsblogs; einzelne Beiträge können
  abweichen). Namensnennung + Share-Alike erforderlich.
content_hash: "bcbf2e90d8ba232b"
---
...
Article 239 of the Constitution provides for the administration of Union Territories by the President through the appointment of an administrator with a designation that may be specified (the designation of the administrator is that of the LG in Delhi). Thus, Union Territories are controlled by the Centre.
...
Further, the proviso to Article 239AA (4) says:
...
Weak reasoning and unsettled conflict
