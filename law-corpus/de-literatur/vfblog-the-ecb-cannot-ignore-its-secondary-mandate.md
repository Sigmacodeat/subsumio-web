---
title: Verfassungsblog — The ECB Cannot Ignore its Secondary Mandate
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/the-ecb-cannot-ignore-its-secondary-mandate/
license: >-
  CC BY-SA 4.0 (Standard-Lizenz des Verfassungsblogs; einzelne Beiträge können
  abweichen). Namensnennung + Share-Alike erforderlich.
content_hash: "fe987ccb739189ca"
---
...
The secondary mandate is just as legally binding as the ECB's primary objective for price stability. The ECB must support general economic policy in the EU, as long as this does not run counter to the objective of price stability. In the words of ECB Executive Board member Frank Elderson: the secondary objective “stipulates a duty, not an option”.
...
## Legally binding, yet indeterminate
...
The result is what we describe as a paradox: the ECB’s secondary mandate is legally binding, yet indeterminate, while it only gives the ECB the power to support economic policies developed by other institutions and the Member States. Specifying the indeterminate content of the secondary mandate, however, would require the ECB precisely to make contested choices of economic policy. The ECB’s reluctance to do so has led it to consistently ignore the secondary mandate for most of its existence.
...
The secondary mandate will be pivotal in allowing the ECB to play its role in navigating the 21st century. The time has come for the ECB to take it seriously.
