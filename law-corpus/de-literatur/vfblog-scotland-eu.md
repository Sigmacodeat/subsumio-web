---
title: Verfassungsblog — Fast-tracking Scotland’s re-entry to the EU
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/scotland-eu/
license: >-
...
- Administrative and institutional capacity to effectively implement the acquis – the accumulated body of EU treaties, laws, decisions, international agreements (including FTAs) and judgments of the European Court of Justice (ECJ) – and ability to take on the obligations of membership
...
It is through these domestic choices that an independent Scotland could most effectively accelerate the accession process.
