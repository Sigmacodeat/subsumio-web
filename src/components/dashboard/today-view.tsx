                  ...
                  return (
                    <li key={item.slug}>
                      <Link
                        ...
                        className={cn(
                          "group/item block rounded-lg p-2.5 text-sm transition-[background-color,border-color,color] focus-visible:ring-2 focus-visible:ring-[color:var(--brand-primary)] focus-visible:outline-none motion-reduce:transition-none",
                          isOverdue
