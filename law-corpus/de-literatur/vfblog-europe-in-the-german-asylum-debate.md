---
title: Verfassungsblog — Flying Blind
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/europe-in-the-german-asylum-debate/
license: >-
...
Here, however, a national response taking into account European considerations is precisely not to ignore the law. In the European community of law, the Rechtsgemeinschaft, it is precisely the civilizational progress, that the conflicts of interest between nation states, which still exist and will exist, are channeled into legal proceedings instead of triggering reciprocal escalation and reaction cascades. Just to give a hint: Not only the Commission, but also Member States can initiate infringement proceedings against other Member States, as Austria did against Germany regarding the case of the car toll mentioned earlier. If Member States sabotage the Dublin system, this should be scrutinized by the ECJ, with a view to a violation of the principle of loyal cooperation (Art. 4 para. 3 TEU). And there are also possibilities for the opposition to avoid any suspicion of merely paying lip service to Europe, for example by coordinating and jointly presenting initiatives with partners in other Member States from their respective European political party family.

Instead, the additional German border controls, the comments from other EU countries on this and the entire current debate emphasize national antagonisms. A random sample of media reactions: A German panic reaction due to far-right electoral successes is being diagnosed, there is the observation that reliability and trust in German EU policy are increasingly missing. It speaks for itself when applause for the German government comes from Hungarian Prime Minister Orbán of all people, who does not even feign any interest in European solidarity when it comes to refugees.

Of course, all of this is also about the relationship between law and politics. A merely legal view therefore falls short. In German politics – as probably elsewhere –, despite all the juridification of the political process, the political calculation for one's own political advantage typically takes precedence over legal concerns. And that is certainly also currently a driving motive for the opposition. But make no mistake: putting political calculation over legal concerns can be indisputably found in all political camps. Legal concerns are then primarily understood as legal risks and pure cost aspects, which are offset by a possible, sometimes only hypothetical and hoped-for political benefit.

However, in the present case, such a political cost-benefit analysis has either not been carried out at all or has failed completely. In any event, there has apparently not been a sober assessment of the consequences in terms of European law. The potentially serious fallout for German interests in the EU, the stability of the community of Law and the asylum policy options at the European level have not played a significant role in the German debate so far.

It is quite obvious that there can only be viable answers to these cross-border issues with a joint European effort. In one form or another, the European states are dependent on finding compromises on their conflicting interests and reaching agreements sooner or later. Constructive and differentiated solutions do exist. Nevertheless, they require a differentiated, sober and objective, fact-based analysis of the problem and time – there is no simple magic formula. The already agreed reform of the Common European Asylum System (CEAS) will not be the final word either.

## Responsible communication instead of simplification

Anyone who instead promises simple and quick solutions, possibly even as a unilateral national measure, will not be able to fulfil such promises and will end up playing into the hands of the national populist simplifiers. Experience elsewhere, for example in France, shows that attempts to weaken extreme political forces by means of mimicking their populist and simple solutions often lead to the election of the “original”. The decline of the conservative party as a significant political force in France should be a warning to everyone.

In the asylum debate in particular, communicating and explaining the details of confused and complex legal and factual interrelationships in an understandable and comprehensible way is essential. And this without giving in to the temptation of populist oversimplification. A fine line. Politicians – in government and opposition – and the media have a duty to handle these findings responsibly.

 References[+]

 References  

 &#8593;1 Official English press release, proof once more that the term “Heimat” is impossible to translate.
