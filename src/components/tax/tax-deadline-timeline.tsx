      ...
      {sorted.map((d) => {
        ...
        return (
          <button
            ...
            onClick={() => onSelect?.(d)}
            className={cn(
              "flex w-full items-center gap-3 rounded-lg border px-4 py-3 text-left transition-[background-color,border-color,color] hover:border-[color:var(--ds-border-strong)]",
              colorClass
            )}
          >
