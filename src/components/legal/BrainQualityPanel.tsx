        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="h-2.5 overflow-hidden rounded-full bg-[color:var(--ds-surface-2)]">
              <div
                className={cn(
                  "h-full rounded-full transition-[background-color,border-color,color,box-shadow,opacity,transform] duration-[var(--ds-duration-normal)] duration-[var(--ds-duration-slow)] ease-[cubic-bezier(0.32,0.72,0,1)] motion-reduce:transition-none",
                  scoreBg
                )}
                style={{ width: `${score}%` }}
              />
