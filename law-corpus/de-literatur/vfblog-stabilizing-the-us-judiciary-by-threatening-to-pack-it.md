---
title: Verfassungsblog — Stabilizing the US Judiciary by Threatening to Pack It
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: >-
  https://verfassungsblog.de/stabilizing-the-us-judiciary-by-threatening-to-pack-it/
license: >-
...
In an influential law review article, Professor Mark Tushnet coined the term “constitutional hardball”:
...
- The new seats would not be open until (say) September 1, 2022 (while the Democrats still control the White House and Senate).

- The new seats would never be open (i.e., the bill would have no effect) if a stabilizing constitutional Amendment was passed by that date.
...
- Fixes the number of Supreme Court vacancies at some odd number ≥9; and

- Limits the tenure of Justices to between 9 and 20 years.
...
- Escalatory option: Cede their hard-won SCOTUS majority to the Democrats in two years by allowing President Biden to appoint four new Justices.

- Stabilizing option: Work with the Democrats to pass the Amendment and temporarily preserve their 2/3 SCOTUS majority.
