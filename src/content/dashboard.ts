...
export const D = {
  ...
  "nav.section.admin_system": { de: "System", en: "System" },
  "nav.section.admin_users": { de: "Benutzerverwaltung", en: "User Management" },
  "nav.section.admin_integrations": { de: "Integrationen", en: "Integrations" },
  ...
  "nav.section.billing_ops": {
    de: "Abrechnung, Compliance & Betrieb",
    en: "Billing, Compliance & Operations",
  },
  "nav.section.contracts": { de: "Verträge", en: "Contracts" },
  "nav.section.firm_ops": { de: "Kanzlei-Betrieb", en: "Operations" },
  ...
  "nav.section.desc.litigation": {
    de: "Prozessführung, Strategie und Gerichts-Analytics",
    en: "Litigation, strategy and court analytics",
  },
  ...
  "nav.section.desc.admin": {
    ...
    en: "Team, plan, API keys and system settings",
  },
  "nav.section.desc.tax_litigation": {
    de: "Finanzgerichtsbarkeit, Prozessstrategie und Gerichts-Analytics",
    en: "Fiscal court litigation, process strategy and court analytics",
  },
  "nav.section.desc.tax_returns": {
    de: "Steuererklärungen, Bescheide und Finanzamt-Übermittlung",
    en: "Tax returns, assessments and tax office submission",
  },
  ...
  "nav.fristenbuch": { de: "Fristenbuch", en: "Deadline Register" },
  "nav.calendar": { de: "Kalender", en: "Calendar" },
  "nav.tasks": { de: "Aufgaben", en: "Tasks" },
  "nav.wiedervorlagen": { de: "Wiedervorlagen", en: "Follow-ups" },
  "nav.time_tracking": { de: "Zeiterfassung", en: "Time Tracking" },
  "nav.time": { de: "Zeiten", en: "Times" },
  ...
  "nav.tooltip.bea": {
    de: "beA-Entwürfe verwalten und Filing-Pakete erstellen (österreichischer elektronischer anwaltlicher Austausch)",
    en: "Manage beA drafts and create filing packages (Austrian electronic legal communication)",
  },
  ...
  "nav.tooltip.deep_analysis": {
    ...
    en: "AI-powered cross-document analysis: detect themes, risks and patterns across multiple documents",
  },
  "nav.tooltip.translate": {
  ...
  "nav.tooltip.contacts": {
    de: "Mandanten und Kontaktpersonen verwalten",
    en: "Manage clients and contact persons",
  },
  "nav.tooltip.cases": {
    de: "Akten und Rechtssachen verwalten",
    en: "Manage cases and legal matters",
  },
  "nav.tooltip.deadlines": {
    de: "Fristen und Termine im Überblick",
    en: "Track deadlines and appointments",
  },
  "nav.tooltip.brain": {
    de: "Kanzleiwissen durchsuchen und verwalten",
    en: "Search and manage firm knowledge base",
  },
  "nav.tooltip.vault": {
    de: "Dokumente speichern, durchsuchen und analysieren",
    en: "Store, search and analyze documents",
  },
  "nav.tooltip.drafting": {
    de: "Juristische Dokumente mit KI-Unterstützung entwerfen",
    en: "Draft legal documents with AI assistance",
  },
  ...
  "nav.tooltip.settings": {
    ...
    en: "Manage personal and firm settings",
  },
  "nav.tooltip.litigation": {
    de: "Prozessfluss mit Phasen und Schritten verwalten",
  ...
  "nav.tooltip.trust_accounting": {
    de: "Treuhandkonten und Klientengelder verwalten",
  ...
  "nav.tooltip.controlling": {
    ...
    en: "Firm KPIs: revenue, utilization, productivity and AI usage",
  },
  "nav.tooltip.calendar": {
    de: "Termine und Fristen im Kalender verwalten",
    en: "Manage appointments and deadlines in calendar",
  },
  "nav.tooltip.tasks": {
    de: "Aufgaben und To-Dos verwalten",
    en: "Manage tasks and to-dos",
  },
  "nav.tooltip.graph": {
    de: "Wissensgraph: Entitäten und Beziehungen visualisieren",
    en: "Knowledge graph: visualize entities and relationships",
  },
  "nav.tooltip.sources": {
    de: "Datenquellen und Connectors verwalten",
  ...
  "nav.tooltip.import_kanzlei": {
    ...
    en: "Import existing firm data from another system — only relevant during migration",
  },
  "nav.tooltip.whatsapp_templates": {
    de: "Vorlagen für WhatsApp-Mandantenkommunikation verwalten — nur relevant bei WhatsApp-Nutzung",
    en: "Manage WhatsApp templates for client communication — only relevant when using WhatsApp",
  },
  "nav.tooltip.calendar_export": {
  ...
  "nav.tooltip.audit_log": {
    ...
    en: "Complete audit trail of all system actions (read-only) — transparency & compliance",
  },
  ...
  // ── Sidebar: nav items (tax industry) ──
  "nav.section.clients": { de: "Mandanten", en: "Clients" },
  "nav.section.tax_returns": {
    de: "Steuererklaerungen & Bescheide",
    en: "Tax Returns & Assessments",
  },
  "nav.section.documents": { de: "Dokumente", en: "Documents" },
  ...
  "nav.tax_stbvv": { de: "StBVV-Gebühren", en: "StBVV Fees" },
  "nav.elster": { de: "ELSTER", en: "ELSTER" },
  "nav.tax_clients": { de: "Steuermandanten", en: "Tax Clients" },
  "nav.clients": { de: "Mandanten", en: "Clients" },

  // ── Tax Returns page ──
  "tax.returns.title": { de: "Steuererklaerungen", en: "Tax Returns" },
  "tax.returns.desc": {
    de: "Steuererklaerungen verwalten und Status verfolgen",
    en: "Manage tax returns and track status",
  },
  "tax.returns.new": { de: "Neue Erklaerung", en: "New Return" },
  "tax.returns.search": { de: "Mandant suchen...", en: "Search client..." },
  "tax.returns.all_types": { de: "Alle Typen", en: "All Types" },
  "tax.returns.all_status": { de: "Alle Status", en: "All Status" },
  "tax.returns.col_client": { de: "Mandant", en: "Client" },
  "tax.returns.col_type": { de: "Typ", en: "Type" },
  "tax.returns.col_year": { de: "Jahr", en: "Year" },
  "tax.returns.col_status": { de: "Status", en: "Status" },
  "tax.returns.col_due": { de: "Faellig", en: "Due" },
  "tax.returns.col_amount": { de: "Betrag", en: "Amount" },
  "tax.returns.empty_title": {
    de: "Keine Steuererklaerungen vorhanden",
    en: "No tax returns yet",
  },
  "tax.returns.empty_hint": {
    de: "Erstelle eine neue Erklärung, um zu beginnen.",
    en: "Create a new return to get started.",
  },
  "tax.returns.empty_filtered": {
    de: "Keine Erklaerungen entsprechen den Filterkriterien.",
    en: "No returns match your filters.",
  },
  "tax.returns.error_load": {
    de: "Fehler beim Laden der Steuererklaerungen",
    en: "Failed to load tax returns",
  },
  "tax.returns.retry": { de: "Erneut versuchen", en: "Retry" },
  "tax.returns.stat_total": { de: "Erklärungen gesamt", en: "Total Returns" },
  "tax.returns.stat_pending": { de: "In Bearbeitung", en: "In Progress" },
  "tax.returns.stat_submitted": { de: "Eingereicht", en: "Submitted" },
  "tax.returns.stat_assessed": { de: "Veranlagt", en: "Assessed" },
  "tax.returns.toast_created": {
    de: "Steuererklaerung erstellt",
    en: "Tax return created",
  },
  "tax.returns.toast_create_fail": {
    de: "Fehler beim Erstellen",
    en: "Failed to create",
  },
  "tax.returns.modal_title": { de: "Neue Steuererklaerung", en: "New Tax Return" },
  "tax.returns.modal_desc": {
    de: "Erfasse eine neue Steuererklärung für einen Mandanten.",
    en: "Create a new tax return for a client.",
  },
  "tax.returns.label_client": { de: "Mandant", en: "Client" },
  "tax.returns.label_type": { de: "Steuerart", en: "Tax Type" },
  "tax.returns.label_year": { de: "Jahr", en: "Year" },
  "tax.returns.label_status": { de: "Status", en: "Status" },
  "tax.returns.label_due": { de: "Faelligkeit", en: "Due Date" },
  "tax.returns.label_notes": { de: "Notizen", en: "Notes" },
  "tax.returns.btn_cancel": { de: "Abbrechen", en: "Cancel" },
  "tax.returns.btn_create": { de: "Erstellen", en: "Create" },
  "tax.returns.btn_creating": { de: "Wird erstellt...", en: "Creating..." },

  // ── Tax Assessments page ──
  "tax.assessments.title": { de: "Steuerbescheide", en: "Tax Assessments" },
  "tax.assessments.desc": {
    de: "Steuerbescheide und Festsetzungen verwalten",
    en: "Manage tax assessments and notices",
  },
  "tax.assessments.new": { de: "Bescheid erfassen", en: "New Assessment" },
  "tax.assessments.search": {
    de: "Mandant oder Bescheidnummer suchen...",
    en: "Search client or notice number...",
  },
  "tax.assessments.col_client": { de: "Mandant", en: "Client" },
  "tax.assessments.col_type": { de: "Typ", en: "Type" },
  "tax.assessments.col_notice_no": { de: "Bescheid-Nr.", en: "Notice No." },
  "tax.assessments.col_date": { de: "Datum", en: "Date" },
  "tax.assessments.col_due": { de: "Faellig", en: "Due" },
  "tax.assessments.col_amount": { de: "Betrag", en: "Amount" },
  "tax.assessments.col_status": { de: "Status", en: "Status" },
  "tax.assessments.empty_title": {
    de: "Keine Bescheide vorhanden",
    en: "No assessments yet",
  },
  "tax.assessments.empty_hint": {
    de: "Erfasse einen neuen Bescheid, um zu beginnen.",
    en: "Create a new assessment to get started.",
  },
  "tax.assessments.empty_filtered": {
    de: "Keine Bescheide entsprechen den Filterkriterien.",
    en: "No assessments match your filters.",
  },
  "tax.assessments.error_load": {
    de: "Fehler beim Laden der Bescheide",
    en: "Failed to load assessments",
  },
  "tax.assessments.retry": { de: "Erneut versuchen", en: "Retry" },
  "tax.assessments.stat_total": { de: "Bescheide gesamt", en: "Total Assessments" },
  "tax.assessments.stat_open": { de: "Offen", en: "Open" },
  "tax.assessments.stat_contested": { de: "Angefochten", en: "Contested" },
  "tax.assessments.status_paid": { de: "Bezahlt", en: "Paid" },
  "tax.assessments.stat_amount": { de: "Gesamtbetrag", en: "Total Amount" },
  "tax.assessments.all_types": { de: "Alle Arten", en: "All Types" },
  "tax.assessments.all_tax_types": { de: "Alle Steuerarten", en: "All Tax Types" },
  "tax.assessments.col_tax_type": { de: "Steuerart", en: "Tax Type" },
  "tax.assessments.toast_created": {
    de: "Bescheid erfasst",
    en: "Assessment created",
  },
  "tax.assessments.toast_create_fail": {
    de: "Fehler beim Erfassen",
    en: "Failed to create",
  },
  "tax.assessments.modal_title": { de: "Neuer Steuerbescheid", en: "New Tax Assessment" },
  "tax.assessments.modal_desc": {
    de: "Erfasse einen neuen Steuerbescheid für einen Mandanten.",
    en: "Create a new tax assessment for a client.",
  },
  "tax.assessments.label_client": { de: "Mandant", en: "Client" },
  "tax.assessments.label_type": { de: "Art", en: "Type" },
  "tax.assessments.label_tax_type": { de: "Steuerart", en: "Tax Type" },
  "tax.assessments.label_year": { de: "Jahr", en: "Year" },
  "tax.assessments.label_notice_no": { de: "Bescheid-Nr.", en: "Notice No." },
  "tax.assessments.label_notice_date": { de: "Bescheid-Datum", en: "Notice Date" },
  "tax.assessments.label_due": { de: "Faelligkeit", en: "Due Date" },
  "tax.assessments.label_amount": { de: "Betrag (EUR)", en: "Amount (EUR)" },
  "tax.assessments.label_notes": { de: "Notizen", en: "Notes" },
  "tax.assessments.btn_cancel": { de: "Abbrechen", en: "Cancel" },
  "tax.assessments.btn_create": { de: "Erfassen", en: "Create" },
  "tax.assessments.btn_creating": { de: "Wird erfasst...", en: "Creating..." },

  // ── Tax Audit page ──
  "tax.audit.title": { de: "Betriebspruefungen", en: "Tax Audits" },
  "tax.audit.desc": {
    de: "Betriebs- und Aussenpruefungen verwalten",
    en: "Manage field and office audits",
  },
  "tax.audit.new": { de: "Neue Pruefung", en: "New Audit" },
  "tax.audit.search": { de: "Mandant suchen...", en: "Search client..." },
  "tax.audit.empty_title": {
    de: "Keine Betriebspruefungen vorhanden",
    en: "No audits yet",
  },
  "tax.audit.empty_hint": {
    de: "Erfasse eine neue Prüfung, um zu beginnen.",
    en: "Create a new audit to get started.",
  },
  "tax.audit.empty_filtered": {
    de: "Keine Pruefungen entsprechen den Filterkriterien.",
    en: "No audits match your filters.",
  },
  "tax.audit.error_load": {
    de: "Fehler beim Laden der Pruefungen",
    en: "Failed to load audits",
  },
  "tax.audit.retry": { de: "Erneut versuchen", en: "Retry" },
  "tax.audit.toast_created": {
    de: "Pruefung erstellt",
    en: "Audit created",
  },
  "tax.audit.toast_create_fail": {
    de: "Fehler beim Erstellen",
    en: "Failed to create",
  },
  "tax.audit.modal_title": { de: "Neue Betriebspruefung", en: "New Tax Audit" },
  "tax.audit.modal_desc": {
    de: "Erfasse eine neue Betriebs- oder Außenprüfung.",
    en: "Create a new field or office audit.",
  },
  "tax.audit.label_client": { de: "Mandant", en: "Client" },
  "tax.audit.label_type": { de: "Pruefungsart", en: "Audit Type" },
  "tax.audit.label_year": { de: "Jahr", en: "Year" },
  "tax.audit.label_phase": { de: "Phase", en: "Phase" },
  "tax.audit.label_auditor": { de: "Pruefer", en: "Auditor" },
  "tax.audit.label_start": { de: "Beginn", en: "Start Date" },
  "tax.audit.label_end": { de: "Ende", en: "End Date" },
  "tax.audit.label_notes": { de: "Notizen", en: "Notes" },
  "tax.audit.btn_cancel": { de: "Abbrechen", en: "Cancel" },
  "tax.audit.btn_create": { de: "Erstellen", en: "Create" },
  "tax.audit.btn_creating": { de: "Wird erstellt...", en: "Creating..." },
  "tax.audit.findings": { de: "Pruefungsfeststellungen", en: "Audit Findings" },
  "tax.audit.total_additional": { de: "Nachzahlung gesamt", en: "Total Additional Tax" },
  "tax.audit.stat_total": { de: "Prüfungen gesamt", en: "Total Audits" },
  "tax.audit.stat_active": { de: "Aktiv", en: "Active" },
  "tax.audit.stat_findings": { de: "Feststellungen", en: "Findings" },
  "tax.audit.stat_additional_tax": { de: "Nachzahlungen", en: "Additional Tax" },
  "tax.audit.all_types": { de: "Alle Arten", en: "All Types" },
  "tax.audit.all_phases": { de: "Alle Phasen", en: "All Phases" },
  "tax.audit.col_client": { de: "Mandant", en: "Client" },

  // ── Tax StBVV page ──
  "tax.stbvv.title": { de: "StBVV-Gebührenrechner", en: "StBVV Fee Calculator" },
  "tax.stbvv.desc": {
    de: "Gebührenberechnung nach Steuerberatervergütungsverordnung (StBVV) mit Faktor, Auslagenpauschale und MwSt.",
    en: "Fee calculation under the German Tax Adviser Remuneration Ordinance (StBVV) including factor, expense allowance and VAT.",
  },
  "tax.stbvv.label_value": { de: "Gegenstandswert (€)", en: "Value of Matter (€)" },
  "tax.stbvv.label_activity": { de: "Tätigkeit", en: "Activity" },
  "tax.stbvv.label_factor": { de: "Gebührenfaktor", en: "Fee Factor" },
  "tax.stbvv.result_title": { de: "Berechnung", en: "Calculation" },
  "tax.stbvv.basis_fee": { de: "Basisgebühr (1,0)", en: "Base Fee (1.0)" },
  "tax.stbvv.fee": { de: "Gebühr netto", en: "Fee Net" },
  "tax.stbvv.min_fee": { de: "Mindestgebühr", en: "Minimum Fee" },
  "tax.stbvv.max_fee": { de: "Höchstgebühr", en: "Maximum Fee" },
  "tax.stbvv.expense": { de: "Auslagenpauschale", en: "Expense Allowance" },
  "tax.stbvv.net_total": { de: "Summe netto", en: "Net Total" },
  "tax.stbvv.vat": { de: "MwSt (19%)", en: "VAT (19%)" },
  "tax.stbvv.gross_total": { de: "Summe brutto", en: "Gross Total" },
  "tax.stbvv.vv": { de: "VV-Nr.", en: "VV No." },
  "tax.stbvv.range_hint": {
    de: "Faktor zwischen {min} und {max} einstellbar.",
    en: "Factor adjustable between {min} and {max}.",
  },
  ...
  "tax.triage.error": {
    de: "Triage konnte nicht durchgeführt werden",
    en: "Triage analysis failed",
  },
  "tax.triage.empty": {
  ...
  "tax.deadlines.desc": {
    de: "Steuerfristen und Abgabetermine — automatisch berechnet nach AO",
    en: "Tax deadlines and due dates — automatically calculated per AO",
  },
  "tax.deadlines.overdue": { de: "Ueberfaellige Fristen", en: "Overdue Deadlines" },
  "tax.deadlines.urgent": { de: "Dringende Fristen", en: "Urgent Deadlines" },
  "tax.deadlines.upcoming": { de: "Kommende Fristen", en: "Upcoming Deadlines" },
  "tax.deadlines.empty": {
    de: "Keine anstehenden Fristen in den naechsten 90 Tagen.",
    en: "No upcoming deadlines in the next 90 days.",
  },
  "tax.deadlines.days_overdue": { de: "Tage ueberfaellig", en: "days overdue" },
  "tax.deadlines.in_days": { de: "in Tagen", en: "in days" },
  "tax.deadlines.general": { de: "Allgemein", en: "General" },
  "tax.deadlines.from_data": { de: "Mandantenfristen", en: "Client Deadlines" },
  "tax.deadlines.recurring": { de: "Wiederkehrende Fristen", en: "Recurring Deadlines" },
  "tax.deadlines.calculator": { de: "Frist-Rechner", en: "Deadline Calculator" },
  "tax.deadlines.calc_type": { de: "Fristart", en: "Deadline Type" },
  "tax.deadlines.calc_date": { de: "Ausgangsdatum", en: "Base Date" },
  "tax.deadlines.calc_result": { de: "Berechnetes Datum", en: "Calculated Date" },
  "tax.deadlines.calc_einspruch": {
    de: "Einspruchsfrist (§ 109 AO)",
    en: "Objection Deadline (§ 109 AO)",
  },
  "tax.deadlines.calc_zahlung": {
    de: "Zahlungsfrist (§ 226 AO)",
    en: "Payment Deadline (§ 226 AO)",
  },
  "tax.deadlines.calc_begruendung": {
    de: "Einspruchsbegründung (§ 355 AO)",
    en: "Objection Reasoning (§ 355 AO)",
  },
  "tax.deadlines.calc_berichtigung": {
    de: "Berichtigungsfrist (§ 153 AO)",
    en: "Correction Deadline (§ 153 AO)",
  },
  "tax.deadlines.calc_elster": {
    de: "ELSTER-Verlängerung (§ 168 AO)",
    en: "ELSTER Extension (§ 168 AO)",
  },
  "tax.deadlines.calc_verjaehrung": {
    de: "Festsetzungsverjährung (§ 477 AO)",
    en: "Assessment Limitation (§ 477 AO)",
  },
  "tax.deadlines.error_load": {
    de: "Fristen konnten nicht geladen werden",
    en: "Could not load deadlines",
  },
  "tax.deadlines.retry": { de: "Erneut laden", en: "Reload" },
  "tax.deadlines.loading": { de: "Fristen werden geladen...", en: "Loading deadlines..." },
  "tax.deadlines.notes": { de: "Hinweis", en: "Note" },

  // ── ELSTER page ──
  "elster.title": { de: "ELSTER", en: "ELSTER" },
  "elster.desc": {
    de: "Elektronische Steuererklärungen vorbereiten, validieren und an ELSTER übermitteln.",
    en: "Prepare, validate, and submit electronic tax declarations to ELSTER.",
  },
  "elster.error_load": {
    de: "ELSTER-Status konnte nicht geladen werden",
    en: "Could not load ELSTER status",
  },
  "elster.retry": { de: "Erneut laden", en: "Reload" },
  "elster.connected": { de: "ELSTER verbunden", en: "ELSTER connected" },
  "elster.disconnected": { de: "ELSTER nicht verbunden", en: "ELSTER not connected" },
  "elster.mode": { de: "Modus", en: "Mode" },
  "elster.new_submission": { de: "Neue Übermittlung", en: "New Submission" },
  "elster.client_name": { de: "Mandant", en: "Client" },
  "elster.client_name_placeholder": { de: "Mandantenname", en: "Client name" },
  "elster.form_type": { de: "Formular", en: "Form Type" },
  "elster.period": { de: "Zeitraum", en: "Period" },
  "elster.period_placeholder": { de: "z.B. 2025-06 oder 2025-Q2", en: "e.g. 2025-06 or 2025-Q2" },
  "elster.year": { de: "Jahr", en: "Year" },
  "elster.tax_amount": { de: "Steuerbetrag", en: "Tax Amount" },
  "elster.refund_amount": { de: "Erstattungsbetrag", en: "Refund Amount" },
  "elster.submit": { de: "Übermitteln", en: "Submit" },
  "elster.submitting": { de: "Wird übermittelt...", en: "Submitting..." },
  "elster.submit_success": { de: "Übermittelt. Referenz:", en: "Submitted. Reference:" },
  "elster.submit_error": { de: "Übermittlung fehlgeschlagen", en: "Submission failed" },
  "elster.info_title": { de: "Hinweis", en: "Note" },
  "elster.info_text": {
    de: "Diese Seite bereitet die Daten für ELSTER vor. Eine reale Übermittlung erfordert den offiziellen ERiC-SDK-Connector oder einen zertifizierten Vermittler im Backend.",
    en: "This page prepares data for ELSTER. Real submission requires the official ERiC SDK connector or a certified intermediary in the backend.",
  },
  "elster.history": { de: "Übermittlungsverlauf", en: "Submission History" },
  "elster.empty": { de: "Noch keine ELSTER-Übermittlungen.", en: "No ELSTER submissions yet." },
  "elster.reference": { de: "Referenz", en: "Reference" },
  "elster.submitted_at": { de: "Übermittelt am", en: "Submitted at" },
  "elster.status": { de: "Status", en: "Status" },
  "elster.xml_preview": { de: "XML-Vorschau", en: "XML Preview" },
  "elster.copy_xml": { de: "XML kopieren", en: "Copy XML" },
  "elster.copied": { de: "Kopiert", en: "Copied" },
  "elster.error_title": {
  ...
  "tax.cockpit.stat_returns": { de: "Steuererklärungen", en: "Tax Returns" },
  "tax.cockpit.stat_assessments": { de: "Bescheide", en: "Assessments" },
  "tax.cockpit.stat_audits": { de: "Betriebsprüfungen", en: "Tax Audits" },
  "tax.cockpit.stat_pending": { de: "in Bearbeitung", en: "in progress" },
  "tax.cockpit.stat_open": { de: "offen", en: "open" },
  "tax.cockpit.stat_active": { de: "aktiv", en: "active" },
  "tax.cockpit.deadlines_title": { de: "Anstehende Steuerfristen", en: "Upcoming Tax Deadlines" },
  "tax.cockpit.recent_title": { de: "Aktuelle Steuerpositionen", en: "Recent Tax Items" },
  "tax.cockpit.quick_actions": { de: "Schnellaktionen", en: "Quick Actions" },
  "tax.cockpit.new_return": { de: "Steuererklärung", en: "Tax Return" },
  "tax.cockpit.new_assessment": { de: "Bescheid", en: "Assessment" },
  "tax.cockpit.new_audit": { de: "Betriebsprüfung", en: "Tax Audit" },
  "tax.cockpit.new_elster": { de: "ELSTER-Übermittlung", en: "ELSTER Submission" },
  "tax.cockpit.empty": { de: "Noch keine Steuerpositionen vorhanden.", en: "No tax items yet." },
  "tax.cockpit.error": {
    de: "Cockpit-Daten konnten nicht geladen werden.",
    en: "Could not load cockpit data.",
  },
  "tax.cockpit.retry": { de: "Erneut laden", en: "Reload" },

  // ── Tax Detail pages ──
  "tax.detail.back": { de: "Zurueck", en: "Back" },
  "tax.detail.back_overview": { de: "Zurueck zur Uebersicht", en: "Back to overview" },
  "tax.detail.not_found": { de: "Eintrag nicht gefunden.", en: "Entry not found." },
  "tax.detail.label_client": { de: "Mandant", en: "Client" },
  "tax.detail.label_type": { de: "Art", en: "Type" },
  "tax.detail.label_year": { de: "Jahr", en: "Year" },
  "tax.detail.label_status": { de: "Status", en: "Status" },
  "tax.detail.label_due": { de: "Faelligkeit", en: "Due Date" },
  "tax.detail.label_notes": { de: "Notizen", en: "Notes" },
  "tax.detail.label_description": { de: "Beschreibung", en: "Description" },
  "tax.detail.label_notice_no": { de: "Bescheid-Nr.", en: "Notice No." },
  "tax.detail.label_notice_date": { de: "Bescheid-Datum", en: "Notice Date" },
  "tax.detail.label_amount": { de: "Betrag", en: "Amount" },
  "tax.detail.label_auditor": { de: "Pruefer", en: "Auditor" },
  "tax.detail.label_phase": { de: "Phase", en: "Phase" },
  "tax.detail.label_start": { de: "Beginn", en: "Start" },
  "tax.detail.label_end": { de: "Ende", en: "End" },
  "tax.detail.label_findings": { de: "Feststellungen", en: "Findings" },
  "tax.detail.label_additional_tax": { de: "Nachzahlung", en: "Additional Tax" },
  "tax.detail.contested": { de: "Einspruch eingelegt", en: "Objection filed" },
  "tax.detail.edit": { de: "Bearbeiten", en: "Edit" },
  "tax.detail.delete": { de: "Löschen", en: "Delete" },
  "tax.detail.cancel": { de: "Abbrechen", en: "Cancel" },
  "tax.detail.save": { de: "Speichern", en: "Save" },
  "tax.detail.saving": { de: "Speichern…", en: "Saving…" },
  "tax.detail.saved": { de: "Gespeichert", en: "Saved" },
  "tax.detail.save_failed": { de: "Speichern fehlgeschlagen", en: "Save failed" },
  "tax.detail.deleted": { de: "Gelöscht", en: "Deleted" },
  "tax.detail.delete_failed": { de: "Löschen fehlgeschlagen", en: "Delete failed" },
  "tax.detail.delete_title": { de: "Eintrag löschen?", en: "Delete entry?" },
  "tax.detail.delete_desc": {
    de: "Dieser Eintrag wird unwiderruflich gelöscht.",
    en: "This entry will be permanently deleted.",
  },
  "tax.detail.label_tax_type": { de: "Steuerart", en: "Tax Type" },
  "tax.detail.label_tax_amount": { de: "Festgesetzte Steuer", en: "Assessed Tax" },
  "tax.detail.label_submitted_date": { de: "Eingereicht am", en: "Submitted on" },
  "tax.detail.label_assessed_date": { de: "Veranlagt am", en: "Assessed on" },
  "tax.detail.label_assigned_to": { de: "Bearbeiter", en: "Assigned to" },
  "tax.detail.label_assigned_to_ph": { de: "Name des Bearbeiters", en: "Name of assignee" },
  "tax.detail.label_refund_amount": { de: "Erstattungsbetrag", en: "Refund Amount" },
  "tax.detail.label_paid_date": { de: "Bezahlt am", en: "Paid on" },
  "tax.detail.label_contest_deadline": { de: "Einspruchsfrist", en: "Objection Deadline" },
  "tax.detail.add_finding": { de: "Feststellung hinzufügen", en: "Add Finding" },
  "tax.detail.finding_placeholder": { de: "Feststellung beschreiben…", en: "Describe finding…" },
  "tax.detail.no_findings": { de: "Keine Feststellungen", en: "No findings" },

  // ── Tax Clients page ──
  "tax.clients.title": { de: "Steuermandanten", en: "Tax Clients" },
  "tax.clients.desc": { de: "Mandantenstammdaten verwalten", en: "Manage client master data" },
  "tax.clients.breadcrumb": { de: "Steuermandanten", en: "Tax Clients" },
  "tax.clients.create": { de: "Neuer Mandant", en: "New Client" },
  "tax.clients.edit": { de: "Mandant bearbeiten", en: "Edit Client" },
  "tax.clients.form_desc": {
    de: "Mandantenstammdaten erfassen oder aktualisieren",
    en: "Enter or update client master data",
  },
  "tax.clients.search_placeholder": {
    de: "Name oder Steuernummer suchen…",
    en: "Search name or tax ID…",
  },
  "tax.clients.empty": { de: "Noch keine Steuermandanten angelegt.", en: "No tax clients yet." },
  "tax.clients.created": { de: "Mandant angelegt", en: "Client created" },
  "tax.clients.error_required": {
    de: "Name und Steuernummer sind erforderlich",
    en: "Name and tax ID are required",
  },
  "tax.clients.label_name": { de: "Name", en: "Name" },
  "tax.clients.label_type": { de: "Typ", en: "Type" },
  "tax.clients.label_tax_id": { de: "Steuernummer", en: "Tax ID" },
  "tax.clients.label_vat_id": { de: "USt-IdNr.", en: "VAT ID" },
  "tax.clients.label_email": { de: "E-Mail", en: "Email" },
  "tax.clients.label_phone": { de: "Telefon", en: "Phone" },
  "tax.clients.label_street": { de: "Straße", en: "Street" },
  "tax.clients.label_city": { de: "Stadt", en: "City" },
  "tax.clients.label_country": { de: "Land", en: "Country" },
  ...
  "mobile.sync_error": { de: "Sync-Fehler", en: "Sync error" },
  "mobile.sync_complete": { de: "Alle Änderungen synchronisiert", en: "All changes synced" },
  "mobile.changes_offline": {
    de: "Änderung(en) offline gespeichert",
    en: "change(s) saved offline",
  },
  "mobile.changes_pending": {
  ...
  "mobile.close": { de: "Schließen", en: "Close" },
  "mobile.more": { de: "Mehr", en: "More" },
  "mobile.more_actions": { de: "Mehr Aktionen", en: "More actions" },
  "mobile.light": { de: "Hell", en: "Light" },
  "mobile.dark": { de: "Dunkel", en: "Dark" },
  "mobile.guide": { de: "Guide", en: "Guide" },
  "mobile.menu": { de: "Menü", en: "Menu" },
  "mobile.navigation": { de: "Mobile Navigation", en: "Mobile navigation" },
  "mobile.all_matters": { de: "Alle Akten", en: "All matters" },
  "mobile.searching": { de: "Suche…", en: "Searching…" },
  "mobile.pdf_error": {
    de: "PDF konnte nicht geladen werden",
    en: "PDF could not be loaded",
  },
  "mobile.pdf_not_supported": {
    de: "Ihr Browser unterstützt keine eingebettete PDF-Anzeige.",
    en: "Your browser does not support embedded PDF viewing.",
  },
  "mobile.download_fallback": { de: "PDF herunterladen", en: "Download PDF" },
  ...
  "sidebar.dream_next_scheduled": {
    de: "Nächster planmäßiger Lauf: täglich um 03:00 Uhr",
    en: "Next scheduled run: daily at 3:00 AM",
  },
  ...
  "sidebar.recent_functions": { de: "Zuletzt verwendet", en: "Recently used" },
  "sidebar.resize": { de: "Sidebar-Breite ändern", en: "Resize sidebar" },
  "sidebar.quick_create": { de: "Neu erstellen", en: "Create new" },
  "sidebar.create_case": { de: "Neue Akte", en: "New case" },
  "sidebar.create_deadline": { de: "Neue Frist", en: "New deadline" },
  "sidebar.create_contact": { de: "Neuer Kontakt", en: "New contact" },
  "sidebar.create_document": { de: "Neues Dokument", en: "New document" },
  ...
  "topbar.filter_all": { de: "Alle", en: "All" },
  "topbar.filter_deadlines": { de: "Fristen", en: "Deadlines" },
  "topbar.filter_mentions": { de: "Erwähnungen", en: "Mentions" },
  ...
  "topbar.create_deadline": { de: "Neue Frist", en: "New Deadline" },
  "topbar.create_invoice": { de: "Neue Rechnung", en: "New Invoice" },
  "topbar.create_signature": { de: "Signatur anfordern", en: "Request Signature" },
  "topbar.create_contract": { de: "Neuer Vertrag", en: "New Contract" },
  "topbar.create_clause": { de: "Neue Klausel", en: "New Clause" },
  ...
  "dashboard.welcome_tax": {
    de: "Willkommen im Steuerberater-OS.",
    en: "Welcome to your tax advisory OS.",
  },
  "dashboard.welcome_tax_desc": {
    de: "Starte mit einer Steuererklärung, importiere Mandantendaten oder verbinde DATEV. Der Assistent arbeitet im Hintergrund, das Cockpit steuert den Arbeitstag.",
    en: "Start with a tax return, import client data, or connect DATEV. The assistant works in the background while the cockpit runs the day.",
  },
  "dashboard.welcome_tax_action": { de: "Neue Steuererklärung", en: "New Tax Return" },
  ...
  "cockpit.stat_reviews": { de: "Prüfungen", en: "Reviews" },
  ...
  "cockpit.triage": { de: "Eingang prüfen", en: "Triage" },
  "cockpit.review": { de: "Prüfen", en: "Review" },
  "cockpit.check": { de: "Prüfen", en: "Check" },
  ...
  "quickcreate.add_task": { de: "Aufgabe hinzufügen", en: "Add Task" },
  "quickcreate.upload_document": { de: "Dokument hochladen", en: "Upload Document" },
  "quickcreate.log_time": { de: "Zeit erfassen", en: "Log Time" },
  "quickcreate.create_invoice": { de: "Rechnung erstellen", en: "Create Invoice" },
  "quickcreate.request_signature": { de: "Signatur anfordern", en: "Request Signature" },
  "quickcreate.create_contract": { de: "Vertrag erstellen", en: "Create Contract" },
  "quickcreate.add_clause": { de: "Klausel hinzufügen", en: "Add Clause" },
  "quickcreate.add_contact": { de: "Kontakt hinzufügen", en: "Add Contact" },
  "quickcreate.add_communication": { de: "Kommunikation hinzufügen", en: "Add Communication" },

  // ── Widget customization ──
  "widget.customize": { de: "Anpassen", en: "Customize" },
  "widget.done": { de: "Fertig", en: "Done" },
  "widget.reset": { de: "Zurücksetzen", en: "Reset" },
  "widget.reset_confirm": {
    de: "Layout auf Standard zurücksetzen?",
    en: "Reset layout to default?",
  },
  "widget.drag_hint": {
    de: "Widgets per Drag verschieben",
    en: "Drag widgets to rearrange",
  },
  "widget.show": { de: "Anzeigen", en: "Show" },
  ...
  "widget.rundown_desc": {
    de: "Automatische Zusammenfassung der Kanzlei-Aktivitäten",
    en: "Automated summary of firm activities",
  },
  "widget.heute": { de: "Heute zu steuern", en: "Today to Manage" },
  "widget.heute_desc": {
    de: "Kritische Fristen, Eingang und offene Freigaben",
    en: "Critical deadlines, inbox and pending approvals",
  },
  "widget.secondary_stats": { de: "Kennzahlen", en: "Key Metrics" },
  "widget.secondary_stats_desc": {
    de: "Akten, Eingang, Reviews und Abrechnung auf einen Blick",
    en: "Cases, inbox, reviews and billing at a glance",
  },
  "widget.pinned": { de: "Schnellzugriff Akten", en: "Quick-access Matters" },
  "widget.pinned_desc": {
    de: "Angeheftete & zuletzt geöffnete Akten",
    en: "Pinned & recently opened matters",
  },
  "widget.deadlines": { de: "Fristen & Termine", en: "Deadlines & Events" },
  "widget.deadlines_desc": {
    de: "Anstehende Fristen sortiert nach Dringlichkeit",
    en: "Upcoming deadlines sorted by urgency",
  },
  ...
  "widget.quick_actions": { de: "Sofortaktionen", en: "Quick Actions" },
  "widget.quick_actions_desc": {
    de: "Häufigste Kanzlei-Schritte ohne Umweg",
    en: "Most common firm actions without detours",
  },
  "widget.active_cases": { de: "Aktive Akten", en: "Active Cases" },
  "widget.active_cases_desc": {
    de: "Offene Mandate mit Status und Rechtsgebiet",
    en: "Open matters with status and legal area",
  },
  ...
  "widget.recent_queries": { de: "Letzte Anfragen", en: "Recent Queries" },
  "widget.recent_queries_desc": {
    de: "Zuletzt gestellte Fragen an den Assistenten",
    en: "Recently asked queries to the assistant",
  },
  ...
  "cases.close_checklist_desc": {
    de: "Vor dem Archivieren müssen folgende Punkte geklärt sein:",
    en: "The following items must be resolved before archiving:",
  },
  "cases.close_checklist_has_blockers": {
    de: "Archivierung blockiert — offene Punkte müssen zuerst geklärt werden.",
    en: "Archive blocked — open items must be resolved first.",
  },
  "cases.close_checklist_warnings": {
    de: "Warnungen — bitte vor dem Archivieren prüfen.",
    en: "Warnings — please review before archiving.",
  },
  "cases.close_checklist_all_passed": {
    de: "Alle Prüfungen bestanden — die Akte kann archiviert werden.",
    en: "All checks passed — the case can be archived.",
  },
  "cases.close_checklist_force": {
    de: "Trotzdem archivieren",
    en: "Archive anyway",
  },
  "checklist.unbilled_time_label": { de: "Offene Zeiteinträge", en: "Unbilled time entries" },
  "checklist.unbilled_time_desc": {
    de: "Alle abrechenbaren Zeiteinträge müssen abgerechnet sein.",
    en: "All billable time entries must be billed.",
  },
  "checklist.unbilled_expenses_label": { de: "Offene Auslagen", en: "Unbilled expenses" },
  "checklist.unbilled_expenses_desc": {
    de: "Alle abrechenbaren Auslagen müssen abgerechnet sein.",
    en: "All billable expenses must be billed.",
  },
  "checklist.open_deadlines_label": { de: "Offene Fristen", en: "Open deadlines" },
  "checklist.open_deadlines_desc": {
    de: "Keine offenen, überfälligen oder kritischen Fristen.",
    en: "No open, overdue, or critical deadlines.",
  },
  "checklist.open_doc_requests_label": {
    de: "Offene Dokumentenanfragen",
    en: "Open document requests",
  },
  "checklist.open_doc_requests_desc": {
    de: "Alle Dokumentenanfragen sollten erfüllt oder abgelaufen sein.",
    en: "All document requests should be fulfilled or expired.",
  },
  "checklist.unpaid_invoices_label": { de: "Offene Rechnungen", en: "Unpaid invoices" },
  "checklist.unpaid_invoices_desc": {
    de: "Alle Rechnungen müssen bezahlt oder storniert sein.",
    en: "All invoices must be paid or cancelled.",
  },
  ...
  "calendar.description": {
    de: "Fristen, Termine und Aufgaben im Zeitverlauf",
    en: "Deadlines, appointments and tasks over time",
  },
  ...
  "calendar.empty_desc": {
    ...
    en: "No deadlines or tasks are scheduled for this period.",
  },
  "calendar.deadline": { de: "Frist", en: "Deadline" },
  "calendar.task": { de: "Aufgabe", en: "Task" },
  "calendar.new": { de: "Neuer Termin", en: "New Appointment" },
  "calendar.edit": { de: "Termin bearbeiten", en: "Edit Appointment" },
  "calendar.save": { de: "Speichern", en: "Save" },
  "calendar.cancel": { de: "Abbrechen", en: "Cancel" },
  "calendar.create": { de: "Erstellen", en: "Create" },
  "calendar.delete": { de: "Löschen", en: "Delete" },
  "calendar.title_label": { de: "Titel", en: "Title" },
  "calendar.title_placeholder": { de: "Termin-Titel", en: "Appointment title" },
  "calendar.date": { de: "Datum", en: "Date" },
  "calendar.time": { de: "Uhrzeit", en: "Time" },
  "calendar.duration": { de: "Dauer", en: "Duration" },
  "calendar.type": { de: "Typ", en: "Type" },
  "calendar.type_meeting": { de: "Besprechung", en: "Meeting" },
  "calendar.type_hearing": { de: "Verhandlung", en: "Hearing" },
  "calendar.type_consultation": { de: "Beratung", en: "Consultation" },
  "calendar.type_internal": { de: "Intern", en: "Internal" },
  "calendar.location": { de: "Ort", en: "Location" },
  "calendar.location_placeholder": { de: "Gericht, Büro, Video…", en: "Court, office, video…" },
  "calendar.case": { de: "Akte", en: "Case" },
  "calendar.no_case": { de: "Keine Akte", en: "No case" },
  "calendar.description_label": { de: "Beschreibung", en: "Description" },
  "calendar.description_placeholder": { de: "Agenda, Notizen…", en: "Agenda, notes…" },
  "calendar.save_error": { de: "Speichern fehlgeschlagen", en: "Save failed" },
  "calendar.delete_error": { de: "Löschen fehlgeschlagen", en: "Delete failed" },
  "calendar.created": { de: "Termin erstellt", en: "Appointment created" },
  "calendar.outlook_created": { de: "Outlook-Termin erstellt", en: "Outlook appointment created" },
  "calendar.create_error": { de: "Fehler beim Erstellen", en: "Failed to create" },
  "calendar.outlook_title": { de: "Outlook-Termin erstellen", en: "Create Outlook appointment" },
  "calendar.subject": { de: "Betreff", en: "Subject" },
  "calendar.subject_placeholder": {
    de: "Termin mit Mandant Müller",
    en: "Appointment with client Müller",
  },
  "calendar.start": { de: "Start", en: "Start" },
  "calendar.end": { de: "Ende", en: "End" },
  "calendar.desc_optional": { de: "Beschreibung (optional)", en: "Description (optional)" },
  "calendar.updated": { de: "Termin aktualisiert", en: "Appointment updated" },
  "calendar.deleted": { de: "Termin gelöscht", en: "Appointment deleted" },
  "calendar.more": { de: "weitere", en: "more" },
  "calendar.upcoming": { de: "Anstehende Termine", en: "Upcoming appointments" },
  "calendar.no_appointments": { de: "Keine anstehenden Termine", en: "No upcoming appointments" },
  ...
  "tasks.case": { de: "Akte", en: "Case" },
  "tasks.no_due": { de: "Kein Fälligkeitsdatum", en: "No due date" },
  "tasks.empty_title": { de: "Keine Aufgaben", en: "No tasks" },
  "tasks.empty_desc": {
    de: "Aktuell gibt es keine offenen Aufgaben.",
    en: "There are currently no open tasks.",
  },
  "tasks.mark_done": { de: "Erledigen", en: "Mark done" },
  "tasks.loading": { de: "Aufgaben werden geladen...", en: "Loading tasks..." },
  "tasks.untitled": { de: "Unbenannte Aufgabe", en: "Untitled task" },

  // ── Time Tracking page ──
  "time_tracking.title": { de: "Zeiterfassung", en: "Time Tracking" },
  "time_tracking.description": {
    de: "Erfasste Zeit, Leistungsarten und Abrechnungsstatus",
    en: "Recorded time, activities and billing status",
  },
  "time_tracking.add": { de: "Zeit erfassen", en: "Add time" },
  "time_tracking.description_label": { de: "Beschreibung", en: "Description" },
  "time_tracking.minutes": { de: "Minuten", en: "Minutes" },
  "time_tracking.case": { de: "Akte", en: "Case" },
  "time_tracking.date": { de: "Datum", en: "Date" },
  "time_tracking.rate": { de: "Stundensatz", en: "Hourly rate" },
  "time_tracking.billable": { de: "Abrechenbar", en: "Billable" },
  "time_tracking.billed": { de: "Bereits abgerechnet", en: "Billed" },
  "time_tracking.unbilled": { de: "Noch nicht abgerechnet", en: "Unbilled" },
  "time_tracking.total_hours": { de: "Gesamtstunden", en: "Total hours" },
  "time_tracking.total_amount": { de: "Gesamtbetrag", en: "Total amount" },
  "time_tracking.empty_title": { de: "Keine Zeiteinträge", en: "No time entries" },
  "time_tracking.empty_desc": {
    de: "In diesem Zeitraum wurden noch keine Zeiten erfasst.",
    en: "No time entries recorded for this period.",
  },
  "time_tracking.activity": { de: "Tätigkeit", en: "Activity" },
  "time_tracking.research": { de: "Recherche", en: "Research" },
  "time_tracking.drafting": { de: "Schriftverkehr", en: "Drafting" },
  "time_tracking.court": { de: "Gericht", en: "Court" },
  "time_tracking.meeting": { de: "Besprechung", en: "Meeting" },
  "time_tracking.other": { de: "Sonstiges", en: "Other" },
  "time_tracking.save": { de: "Speichern", en: "Save" },
  "time_tracking.cancel": { de: "Abbrechen", en: "Cancel" },
  "time_tracking.saved": { de: "Zeiteintrag gespeichert", en: "Time entry saved" },
  "time_tracking.save_failed": {
    de: "Zeiteintrag konnte nicht gespeichert werden",
    en: "Time entry could not be saved",
  },
  ...
  "deadlines.fristenbuch_loading": {
    de: "Fristenbuch wird geladen …",
    en: "Loading deadline register …",
  },
  "deadlines.fristenbuch_gesamt": { de: "Gesamt", en: "Total" },
  "deadlines.fristenbuch_ok": { de: "In Ordnung", en: "OK" },
  "deadlines.fristenbuch_vorfrist": { de: "Vorfrist", en: "Pre-deadline" },
  "deadlines.fristenbuch_folge": { de: "Folge bei Versäumnis", en: "Consequence if missed" },
  ...
  "deadlines.fristenbuch_kritisch_hint": {
    de: "kritische Fristen (≤ 2 Werktage)",
    en: "critical deadlines (≤ 2 workdays)",
  },
  "deadlines.fristenbuch_print_footer": { de: "Erstellt am", en: "Generated on" },
  "deadlines.col_status": { de: "Status", en: "Status" },
  ...
  "inv.quick_title": { de: "Rechnung schnell erstellen", en: "Quick create invoice" },
  "inv.quick_desc": {
    de: "Rechnung aus Akte mit offenen Leistungen und Auslagen erstellen.",
  ...
  "inv.e_invoice_auto_generated": {
    de: "E-Rechnung automatisch generiert",
    en: "E-invoice automatically generated",
  },
  "inv.e_invoice_auto_failed": {
    de: "E-Rechnung Generierung fehlgeschlagen",
    en: "E-invoice generation failed",
  },
  ...
  "settings.hub_desc": {
    de: "Verwalten Sie Ihr Konto, Ihre Kanzlei und Ihre Sicherheitseinstellungen",
  ...
  "settings.tile_kanzlei_desc": {
    de: "Verrechnung, Stundensatz & Abrechnung",
    en: "Billing, hourly rate & invoicing",
  },
  "settings.tile_e_invoice_desc": {
    de: "XRechnung / ZUGFeRD / Kleinunternehmer",
  ...
  "settings.tile_team_desc": {
    de: "Kanzlei-Mitarbeiter und Rollen",
    en: "Firm staff and roles",
  },
  "settings.tile_api_desc": {
  ...
  "settings.tile_scim_desc": {
    de: "Automatische Benutzerbereitstellung über Identity Provider",
    en: "Automated user provisioning via Identity Provider",
  },
  "settings.tile_security_desc": {
    de: "2FA, Passwort-Richtlinien und Sitzungsverwaltung",
  ...
  "settings.hub_all_settings": {
    de: "Alle Einstellungen",
    en: "All Settings",
  },
  "settings.hub_no_results": {
    de: "Keine Einstellungen gefunden",
    en: "No settings found",
  },
  "settings.tile_billing_desc": {
    de: "Abo, Zahlungsmethode und Rechnungen verwalten",
    en: "Manage subscription, payment method and invoices",
  },
  "settings.tile_team_mgmt_desc": {
    de: "Mitarbeiter, Rollen und Berechtigungen verwalten",
    en: "Manage staff, roles and permissions",
  },
  "settings.tile_onboarding_desc": {
    de: "Geführte Ersteinrichtung der Kanzlei",
    en: "Guided initial setup of your firm",
  },
  "settings.tile_api_keys_desc": {
    de: "API-Schlüssel für externe Integrationen",
    en: "API keys for external integrations",
  },
  "settings.tile_security_desc_full": {
    de: "2FA, Passwort-Richtlinien und Sitzungsverwaltung",
    en: "2FA, password policies and session management",
  },
  "settings.tile_directory_desc": {
    de: "Alle Funktionen und Seiten im Überblick",
    en: "Overview of all features and pages",
  },
  "settings.tile_connectors_desc": {
    de: "Externe Integrationen und Schnittstellen konfigurieren",
  ...
  "settings.tile_scim_desc_full": {
    de: "Automatische Benutzerbereitstellung über SAML/SCIM",
    en: "Automated user provisioning via SAML/SCIM",
  },
  ...
  "settings.tile_chat_analytics_desc": {
    ...
    en: "Usage statistics for AI chat features",
  },
  "settings.tile_chat_compare_desc": {
    de: "Modellvergleich und Benchmarks",
    en: "Model comparison and benchmarks",
  },
  "settings.tile_reports_desc": {
    de: "Berichte und Statistiken exportieren",
    en: "Export reports and statistics",
  },
  "settings.tile_adoption_analytics_desc": {
    de: "Nutzungs- und Adoptionskennzahlen",
    en: "Usage and adoption metrics",
  },
  "settings.tile_shared_spaces_desc": {
    de: "Gemeinsame Arbeitsbereiche für Teams",
    en: "Shared workspaces for teams",
  },
  "settings.tile_mobile_desc": {
    de: "Mobile App installieren und konfigurieren",
    en: "Install and configure mobile app",
  },
  "settings.tile_experience_desc": {
    de: "Berufserfahrung und Experten-Profil",
    en: "Professional experience and expert profile",
  },
  "settings.tile_portfolio_insights_desc": {
    de: "Portfolio-Analyse und Akten-Kennzahlen",
    en: "Portfolio analysis and case metrics",
  },
  "settings.tile_process_strategy_desc": {
    de: "Prozessstrategie und Fall-Analyse",
    en: "Litigation strategy and case analysis",
  },
  "settings.tile_client_portal_desc": {
    de: "Mandantenportal für externen Zugriff",
    en: "Client portal for external access",
  },
  "settings.tile_version_history_desc": {
    de: "Dokumentversionen und Änderungsverlauf",
    en: "Document versions and change history",
  },
  "settings.tile_signature_desc": {
    de: "Elektronische Unterschriften und DocuSign",
    en: "Electronic signatures and DocuSign",
  },
  "settings.tile_vault_desc": {
  ...
  "settings.tile_data_export_desc": {
    ...
    en: "Complete data export for GDPR/client handover",
  },
  "settings.tile_import_kanzlei_desc": {
    de: "Kanzlei-Daten importieren — nur relevant bei Migration von anderem System",
    en: "Import firm data — only relevant when migrating from another system",
  },
  "settings.tile_whatsapp_templates_desc": {
    de: "WhatsApp-Vorlagen für Mandantenkommunikation — nur relevant bei WhatsApp-Nutzung",
    en: "WhatsApp templates for client communication — only relevant when using WhatsApp",
  },
  "settings.tile_calendar_export_desc": {
    de: "Kalender-Export (ICS) für Outlook/Google — nur relevant bei externem Kalender",
  ...
  "settings.tile_rciid_desc": {
    ...
    en: "Configure crypto forensics integration with RCIID",
  },

  // ── Crypto Forensics (RCIID) ─────────────────────────────────────────
  "crypto_forensics.title": { de: "Krypto-Forensik", en: "Crypto Forensics" },
  "crypto_forensics.breadcrumb": { de: "Krypto-Forensik", en: "Crypto Forensics" },
  "crypto_forensics.description": {
    de: "Krypto-Wallet-Adressen an RCIID übermitteln und Untersuchungen verfolgen",
    en: "Submit crypto wallet addresses to RCIID and track investigations",
  },
  "crypto_forensics.refresh": { de: "Aktualisieren", en: "Refresh" },
  "crypto_forensics.detect_wallets": { de: "Wallets erkennen", en: "Detect Wallets" },
  "crypto_forensics.new_case": { de: "Neuer Fall", en: "New Case" },
  "crypto_forensics.stat_total": { de: "Gesamte Fälle", en: "Total Cases" },
  "crypto_forensics.stat_active": { de: "Aktiv", en: "Active" },
  "crypto_forensics.stat_completed": { de: "Abgeschlossen", en: "Completed" },
  "crypto_forensics.stat_total_cost": { de: "Gesamtkosten", en: "Total Cost" },
  "crypto_forensics.search_placeholder": {
    de: "Case-ID oder Phase suchen...",
    en: "Search case ID or phase...",
  },
  "crypto_forensics.filter_all": { de: "Alle", en: "All" },
  "crypto_forensics.filter_active": { de: "Aktiv", en: "Active" },
  "crypto_forensics.filter_completed": { de: "Abgeschlossen", en: "Completed" },
  "crypto_forensics.filter_rejected": { de: "Abgelehnt", en: "Rejected" },
  "crypto_forensics.empty": {
    de: "Noch keine RCIID-Fälle. Übermitteln Sie Krypto-Wallets zur forensischen Untersuchung.",
    en: "No RCIID cases yet. Submit crypto wallets for forensic investigation.",
  },
  "crypto_forensics.report": { de: "Bericht", en: "Report" },
  "crypto_forensics.submit_title": { de: "Fall an RCIID übermitteln", en: "Submit Case to RCIID" },
  "crypto_forensics.submit_description": {
  ...
  "crypto_forensics.description_label": { de: "Beschreibung", en: "Description" },
  "crypto_forensics.wallets": { de: "Wallet-Adressen", en: "Wallet Addresses" },
  "crypto_forensics.cancel": { de: "Abbrechen", en: "Cancel" },
  "crypto_forensics.submit_to_rciid": { de: "An RCIID senden", en: "Submit to RCIID" },
  "crypto_forensics.detect_title": { de: "Wallets erkennen", en: "Detect Wallets" },
  "crypto_forensics.detect_description": {
    de: "Text nach Krypto-Wallet-Adressen durchsuchen",
    en: "Scan text for crypto wallet addresses",
  },
  "crypto_forensics.detect_text_label": { de: "Text zum Scannen", en: "Text to Scan" },
  "crypto_forensics.wallets_found": { de: "Wallets gefunden", en: "wallets found" },
  "crypto_forensics.close": { de: "Schließen", en: "Close" },
  "crypto_forensics.scan": { de: "Scannen", en: "Scan" },
  "crypto_forensics.settings_title": {
    de: "RCIID Forensik-Einstellungen",
    en: "RCIID Forensics Settings",
  },
  "crypto_forensics.settings_api_key": { de: "API-Key", en: "API Key" },
  "crypto_forensics.settings_api_url": { de: "API-URL", en: "API URL" },
  "crypto_forensics.settings_webhook_secret": { de: "Webhook-Secret", en: "Webhook Secret" },
  "crypto_forensics.settings_test_connection": { de: "Verbindung testen", en: "Test Connection" },
  "crypto_forensics.settings_billing_mode": { de: "Abrechnungsmodus", en: "Billing Mode" },
  "crypto_forensics.settings_auto_detect": { de: "Auto-Detect", en: "Auto-Detect" },
  "crypto_forensics.settings_saved": { de: "Einstellungen gespeichert", en: "Settings saved" },
  "crypto_forensics.settings_not_configured": {
    de: "RCIID ist nicht konfiguriert. Bitte API-Key setzen.",
    en: "RCIID is not configured. Please set API key.",
  },
  "crypto_forensics.case_context": { de: "Fallkontext", en: "Case Context" },
  "crypto_forensics.case_context_desc": {
    de: "Strukturierte Falldaten für RCIID übermitteln",
    en: "Submit structured case data to RCIID",
  },
  "crypto_forensics.quality_score": { de: "Datenqualität", en: "Data Quality" },
  "crypto_forensics.quality_score_low": {
    de: "Niedrig — Daten ergänzen für bessere Automatisierung",
    en: "Low — supplement data for better automation",
  },
  "crypto_forensics.improve_data": { de: "Daten ergänzen", en: "Improve Data" },
  "crypto_forensics.scan_case": { de: "Fall scannen", en: "Scan Case" },
  "crypto_forensics.scan_case_desc": {
    de: "Alle Dokumente nach Krypto-Adressen durchsuchen",
    en: "Search all documents for crypto addresses",
  },
  "crypto_forensics.scan_results": { de: "Scan-Ergebnisse", en: "Scan Results" },
  "crypto_forensics.accept_suggestion": {
    de: "Für Analyse übernehmen",
    en: "Accept for Analysis",
  },
  "crypto_forensics.checksum_valid": { de: "Prüfsumme gültig", en: "Checksum Valid" },
  "crypto_forensics.checksum_invalid": { de: "Prüfsumme ungültig", en: "Checksum Invalid" },
  "crypto_forensics.target_addresses": { de: "Target-Adressen", en: "Target Addresses" },
  "crypto_forensics.victim_deposits": { de: "Opfer-Einzahlungen", en: "Victim Deposits" },
  "crypto_forensics.known_recipients": { de: "Bekannte Empfänger", en: "Known Recipients" },
  "crypto_forensics.exchange_links": { de: "Exchange-Konten", en: "Exchange Links" },
  ...
  "settings.aria_email": { de: "E-Mail", en: "Email" },
  "settings.aria_phone": { de: "Telefon", en: "Phone" },
  "settings.aria_chamber": { de: "Kammer", en: "Bar association / chamber" },
  "settings.aria_bank": { de: "Bank", en: "Bank" },
  "settings.aria_iban": { de: "IBAN", en: "IBAN" },
  "settings.aria_bic": { de: "BIC", en: "BIC" },
  "settings.aria_smtp_host": { de: "SMTP-Host", en: "SMTP host" },
  "settings.aria_smtp_port": { de: "SMTP-Port", en: "SMTP port" },
  ...
  "settings.accessibility_desc": {
    de: "Anpassung der Tastaturbedienung nach WCAG 2.1.4",
  ...
  "directory.description": {
    de: "Vollständiges Verzeichnis aller verfügbaren Seiten und Werkzeuge",
    en: "Complete directory of all available pages and tools",
  },
  ...
  "cmd.shortcuts.new_case": { de: "Neue Akte", en: "New Case" },
  "cmd.shortcuts.new_deadline": { de: "Neue Frist", en: "New Deadline" },
  "cmd.shortcuts.new_invoice": { de: "Neue Rechnung", en: "New Invoice" },
  "cmd.shortcuts.new_signature": { de: "Signatur anfordern", en: "Request Signature" },
  "cmd.shortcuts.new_contract": { de: "Neuer Vertrag", en: "New Contract" },
  "cmd.shortcuts.single_key_hint": {
    de: "Einzeltasten-Shortcuts können in den Einstellungen deaktiviert werden (WCAG 2.1.4).",
    en: "Single-key shortcuts can be disabled in Settings (WCAG 2.1.4).",
  },
  "cmd.shortcuts.single_key_toggle": {
    de: "Einzeltasten-Shortcuts aktivieren",
    en: "Enable single-key shortcuts",
  },
  ...
  "guide.route.cases_desc": {
    de: "Jede Akte sollte Mandant, Gegner, Fristen, Dokumente und nächste Aufgabe enthalten.",
    en: "Every matter should include the client, opposing parties, deadlines, documents, and the next task.",
  },
  ...
  "guide.route.contracts_title": {
    de: "Verträge strukturiert prüfen",
  ...
  "guide.route.research_title": {
    de: "Rechtsfragen belastbar recherchieren",
  ...
  "guide.route.litigation_title": {
    de: "Verfahren strategisch steuern",
  ...
  "guide.route.compliance_title": {
    de: "Compliance nachweisbar machen",
  ...
  "guide.route.workflows_title": {
    de: "Abläufe zuverlässig automatisieren",
  ...
  "guide.route.settings_title": {
    de: "Arbeitsumgebung konfigurieren",
  ...
  "guide.route.team_title": {
    de: "Zusammenarbeit klar organisieren",
  ...
  "guide.route.review_queue_title": {
    de: "Prüfungen priorisiert abarbeiten",
  ...
  "guide.route.signature_title": {
    de: "Unterschriften sicher einholen",
  ...
  "guide.route.contacts_title": {
    de: "Kontakte vollständig pflegen",
  ...
  "guide.route.opponents_title": {
    de: "Gegnerdaten konsistent führen",
  ...
  "tour.progress_label": { de: "Tour-Fortschritt", en: "Tour progress" },
  "tour.step_label": { de: "Schritt {current}", en: "Step {current}" },
  "tour.progress": { de: "Schritt {current} von {total}", en: "Step {current} of {total}" },
  "tour.back": { de: "Zurück", en: "Back" },
  "tour.next": { de: "Weiter", en: "Next" },
  "tour.finish": { de: "Fertig", en: "Finish" },
  ...
  "tour.step8.body": {
    ...
    en: "Workflows connect recurring firm tasks such as document analysis, deadline recording, delivery, and billing. High-risk actions require approval.",
  },
  ...
  "error.ai_quality_title": {
    de: "KI-Qualitätsmonitoring konnte nicht geladen werden",
    en: "AI quality monitoring could not be loaded",
  },
  ...
  "error.tax-returns_title": {
    de: "Steuererklaerungen konnten nicht geladen werden",
    en: "Tax returns could not be loaded",
  },
  "error.tax-assessments_title": {
    de: "Steuerbescheide konnten nicht geladen werden",
    en: "Tax assessments could not be loaded",
  },
  "error.tax-audit_title": {
    de: "Betriebspruefungen konnten nicht geladen werden",
    en: "Tax audits could not be loaded",
  },
  "error.tax-deadlines_title": {
    de: "Steuerfristen konnten nicht geladen werden",
    en: "Tax deadlines could not be loaded",
  },
  ...
  "widget.activity_feed_desc": {
    de: "Chronologischer Verlauf der heutigen Kanzlei-Aktivitäten",
    en: "Chronological timeline of today's firm activities",
  },
  "widget.cross_timeline": { de: "Nächste 7 Tage", en: "Next 7 Days" },
  "widget.cross_timeline_desc": {
    de: "Alle anstehenden Ereignisse über alle Akten — Fristen, Reviews, Signaturen",
    en: "All upcoming events across all cases — deadlines, reviews, signatures",
  },
  "widget.cross_timeline_empty": {
    de: "Keine anstehenden Ereignisse in den nächsten 7 Tagen.",
    en: "No upcoming events in the next 7 days.",
  },
  "widget.cross_timeline_today": { de: "Heute", en: "Today" },
  "widget.cross_tomorrow": { de: "Morgen", en: "Tomorrow" },
  "widget.cross_in_days": { de: "in {n} Tagen", en: "in {n} days" },
  "widget.cross_overdue": { de: "überfällig", en: "overdue" },
  "widget.confidence_score": { de: "KI-Analyse-Qualität", en: "AI Analysis Quality" },
  "widget.confidence_score_desc": {
    de: "Wie verlässlich die KI-Analysen pro Akte sind — je höher, desto sicherer",
    en: "How reliable the AI analyses are per case — higher means more confident",
  },
  "widget.silent_failures": { de: "Fehler & Warnungen", en: "Errors & Warnings" },
  "widget.silent_failures_desc": {
    de: "Analyse-Fehler, Warnungen und hängende Verarbeitungen über alle Akten hinweg",
    en: "Analysis errors, warnings, and stuck processing across all cases",
  },
  ...
  "widget.activity_today": { de: "heute", en: "today" },
  "widget.activity_empty": {
    de: "Heute noch keine Aktivität. Neue Einträge erscheinen hier automatisch.",
    en: "No activity today yet. New items will appear here as they happen.",
  },
  ...
  "onboarding.role_tax_advisor": { de: "Steuerberater/in", en: "Tax advisor" },
  ...
  "onboarding.tax_firm_placeholder": { de: "Steuerberatung Muster", en: "Tax Advisory Muster" },
  "onboarding.tax_owner_placeholder": { de: "StB Muster", en: "Tax Advisor Muster" },
  "onboarding.tax_email_placeholder": {
    de: "office@steuerberatung.at",
    en: "office@taxadvisory.at",
  },
  "onboarding.tax_focus_placeholder": {
    de: "ESt, USt, GewSt, KSt, ErbSt",
    en: "CIT, VAT, trade tax, corp tax, inheritance tax",
  },
  ...
  "agents.seed_step_1": {
    de: "Vorlage wählen oder Aufgabe beschreiben",
    en: "Pick a template or describe your task",
  },
  "agents.seed_step_2": {
    de: "Agent plant und führt Schritte autonom aus",
    en: "Agent plans and executes steps autonomously",
  },
  ...
  "onboarding.industry_tax": {
    de: "Steuerberatung / Buchhaltung",
    en: "Tax advisory / accounting",
  },
  ...
  "chat.agent_auto": { de: "Auto", en: "Auto" },
  "chat.agent_fast": { de: "Schnell", en: "Fast" },
  "chat.agent_deep": { de: "Tief", en: "Deep" },
  ...
  "billing.buy": { de: "Kaufen", en: "Buy" },
  "billing.credit_costs": { de: "Kosten pro Operation", en: "Cost per operation" },
  "billing.auto_reload": { de: "Automatisch aufladen", en: "Auto reload" },
  "billing.auto_reload_desc": {
    de: "Automatisch Credits kaufen, wenn der Saldo unter den Schwellwert fällt",
    en: "Automatically buy credits when the balance falls below the threshold",
  },
  "billing.save": { de: "Speichern", en: "Save" },
  ...
  "client_portal.coming_soon": { de: "Bald", en: "Soon" },
  ...
  // ── AI Quality page ──
  "ai_quality.title": { de: "KI-Qualitätsmonitoring", en: "AI Quality Monitoring" },
  "ai_quality.desc": {
    de: "Halluzinations-Metriken, Guardrail-Stats, ECE-Kalibrierung und Reasoning Traces",
  ...
  "bea.no_send_title": { de: "beA-Versand via Middleware", en: "beA sending via middleware" },
  "bea.no_send_desc": {
  ...
  "bea.approved_send_hint": {
    de: "Freigegeben — jetzt versendebereit.",
    en: "Approved — ready to send.",
  },
  "bea.send_via_middleware": { de: "Versenden", en: "Send" },
  "bea.retry_send": { de: "Erneut versenden", en: "Retry send" },
  "bea.confirm_receipt": { de: "Empfangsbestätigung", en: "Confirm receipt" },
  ...
  "vault.deep_analysis_docs_analyzed": { de: "Dokumente analysiert", en: "documents analyzed" },
  "vault.deep_analysis_summary": { de: "Zusammenfassung", en: "Executive Summary" },
  "vault.deep_analysis_findings": { de: "Ergebnisse", en: "Findings" },
  "vault.deep_analysis_patterns": { de: "Übergreifende Muster", en: "Cross-Document Patterns" },
  "vault.status_all": { de: "Alle Status", en: "All statuses" },
  ...
  "whatsapp.inbox_tab": { de: "Posteingang", en: "Inbox" },
  "whatsapp.inbox_empty": {
    de: "Noch keine WhatsApp-Nachrichten empfangen.",
    en: "No WhatsApp messages received yet.",
  },
  "whatsapp.reply_placeholder": { de: "Antwort schreiben…", en: "Type a reply…" },
  "whatsapp.search_conversations": {
    de: "Konversationen durchsuchen…",
  ...
  "copilot.activity_open": { de: "öffnen", en: "open" },
  ...
  "copilot.alert.intake": { de: "Neue Mandatsanfrage", en: "New intake" },
  ...
  "copilot.matter_context": { de: "Aktenkontext", en: "Matter Context" },
  "copilot.matter_deadlines": { de: "Fr.", en: "DL" },
  "copilot.matter_tasks": { de: "Aufg.", en: "Tasks" },
  "copilot.matter_docs": { de: "Doku", en: "Docs" },
  "copilot.matter_next_deadline": { de: "Nächste Frist:", en: "Next deadline:" },
  "copilot.open_fullscreen": { de: "Im Vollbild öffnen", en: "Open fullscreen" },
  ...
  "strategy.error_load_cases": {
    de: "Akten konnten nicht geladen werden. Bitte versuch es später erneut.",
    en: "Cases could not be loaded. Please try again later.",
  },
  ...
  // ── Tabular Review: async run flow (start / polling / retry) ──
  "tabular.source_label": { de: "Dokumentauswahl", en: "Document selection" },
  "tabular.source_type": { de: "Nach Dokumenttyp", en: "By document type" },
  "tabular.source_case": { de: "Akte", en: "Case" },
  "tabular.case_select_placeholder": { de: "Akte wählen…", en: "Select case…" },
  "tabular.cases_loading": { de: "Akten werden geladen…", en: "Loading cases…" },
  "tabular.error_no_case": { de: "Bitte eine Akte auswählen.", en: "Please select a case." },
  "tabular.title_label": { de: "Titel (optional)", en: "Title (optional)" },
  "tabular.title_placeholder": {
    de: "z. B. Zeugenfragen Q3-Bericht",
  ...
  "tabular.run_error_load": { de: "Run konnte nicht geladen werden.", en: "Could not load run." },
  "tabular.run_clear": { de: "Ansicht schließen", en: "Close view" },
  "tabular.new_run": { de: "Neuer Run", en: "New run" },
  "tabular.last_run_title": { de: "Letzten Run fortsetzen", en: "Resume last run" },
  "tabular.last_run_open": { de: "Öffnen", en: "Open" },
  "tabular.last_run_dismiss": { de: "Verwerfen", en: "Dismiss" },
  "tabular.run_created": { de: "Erstellt: {{date}}", en: "Created: {{date}}" },
  "tabular.status_queued": { de: "In Warteschlange", en: "Queued" },
  "tabular.status_running": { de: "Läuft", en: "Running" },
  "tabular.status_done": { de: "Abgeschlossen", en: "Done" },
  "tabular.status_partial": { de: "Teilweise abgeschlossen", en: "Partially done" },
  "tabular.status_failed": { de: "Fehlgeschlagen", en: "Failed" },
  "tabular.progress_label": { de: "Fortschritt", en: "Progress" },
  "tabular.progress_summary": {
    de: "{{done}} von {{total}} Dokumenten analysiert",
    en: "{{done}} of {{total}} documents analyzed",
  },
  "tabular.progress_failed": { de: "{{count}} fehlgeschlagen", en: "{{count}} failed" },
  "tabular.elapsed": { de: "Laufzeit {{time}}", en: "Elapsed {{time}}" },
  ...
  "tabular.retry_row": { de: "Erneut versuchen", en: "Retry" },
  ...
  "tabular.failed_banner": {
    de: "Der Run ist fehlgeschlagen: {{error}}",
    en: "The run failed: {{error}}",
  },
  "tabular.filter_doc_placeholder": { de: "Dokument filtern…", en: "Filter documents…" },
  "tabular.filter_errors_only": { de: "Nur Fehler", en: "Errors only" },
  "tabular.filters_reset": { de: "Filter zurücksetzen", en: "Reset filters" },
  "tabular.rows_shown": { de: "{{shown}} von {{total}} Zeilen", en: "{{shown}} of {{total}} rows" },
  "tabular.no_rows_match": {
    de: "Keine Zeilen entsprechen den Filtern.",
    en: "No rows match the filters.",
  },
  "tabular.filter_col_label": { de: "Filter: {{question}}", en: "Filter: {{question}}" },
  "tabular.filter_col_all": { de: "Alle", en: "All" },
  "tabular.filter_col_found": { de: "Gefunden", en: "Found" },
  "tabular.filter_col_not_found": { de: "Nicht gefunden", en: "Not found" },
  "tabular.row_pending": { de: "Wartet auf Analyse…", en: "Waiting for analysis…" },
  "tabular.row_error_label": { de: "Fehler", en: "Error" },
  "tabular.col_status": { de: "Status", en: "Status" },
  "tabular.cell_not_found_chip": { de: "nicht im Dokument", en: "not in document" },
  "tabular.cell_no_quote_chip": { de: "ohne Zitat", en: "no quote" },
  "tabular.cell_citations_count": { de: "{{count}} Zitat(e)", en: "{{count}} citation(s)" },
  "tabular.cell_answer_label": { de: "Antwort", en: "Answer" },
  "tabular.cell_quotes_label": {
    de: "Verifizierte Zitate aus dem Dokument",
    en: "Verified quotes from the document",
  },
  "tabular.cell_no_quotes": {
    de: "Keine Zitate verfügbar — Antwort ohne wörtlichen Beleg, bitte besonders prüfen.",
    en: "No quotes available — answer without verbatim evidence, please review carefully.",
  },
  ...
  "clauses.cat_nda": { de: "NDA", en: "NDA" },
  "clauses.cat_employment": { de: "Arbeitsrecht", en: "Employment" },
  "clauses.cat_service": { de: "Dienstleistung", en: "Service" },
  "clauses.cat_sale": { de: "Kaufvertrag", en: "Sale" },
  "clauses.cat_lease": { de: "Mietvertrag", en: "Lease" },
  "clauses.cat_partnership": { de: "Partnerschaft", en: "Partnership" },
  "clauses.cat_licensing": { de: "Lizenz", en: "Licensing" },
  "clauses.cat_settlement": { de: "Vergleich", en: "Settlement" },
  ...
  // ── Global Search ──
  "search.title": { de: "Globale Suche", en: "Global Search" },
  "search.description": {
    de: "Volltextsuche über alle Akten, Dokumente, Fristen und Notizen",
    en: "Full-text search across all cases, documents, deadlines and notes",
  },
  "search.placeholder": { de: "Suchbegriff eingeben…", en: "Enter search term…" },
  "search.hint": {
    de: "Suchen Sie nach Akten, Dokumenten, Fristen, Rechnungen und mehr.",
    en: "Search across cases, documents, deadlines, invoices and more.",
  },
  "search.no_results": { de: "Keine Treffer.", en: "No results found." },
  "search.results_count": { de: "Treffer", en: "results" },
  "search.scope_all": { de: "Alle", en: "All" },
  "search.scope_cases": { de: "Akten", en: "Cases" },
  "search.scope_documents": { de: "Dokumente", en: "Documents" },
  "search.scope_deadlines": { de: "Fristen", en: "Deadlines" },
  "search.scope_notes": { de: "Notizen", en: "Notes" },
  "search.scope_invoices": { de: "Rechnungen", en: "Invoices" },
  "search.scope_chats": { de: "Chats", en: "Chats" },
  "search.scope_contacts": { de: "Kontakte", en: "Contacts" },
  ...
  "casesnew.quick_title_placeholder": {
    de: "z.B. Mietrückstand Müller vs. Vermieter GmbH",
    en: "e.g. Rent arrears Müller vs. Landlord GmbH",
  },
  "casesnew.quick_client_placeholder": { de: "Mandant auswählen…", en: "Select client…" },
  "casesnew.quick_client_none": { de: "Kein Mandant", en: "No client" },
  ...
  "casesnew.quick_full_form_link": { de: "Vollständiges Formular", en: "Full form" },
  "casesnew.btn_cancel": { de: "Abbrechen", en: "Cancel" },
  "casesnew.create_another": { de: "Weitere anlegen", en: "Create another" },
  ...
  "casesnew.prio.high": { de: "Hoch", en: "High" },
  "casesnew.prio.critical": { de: "Kritisch", en: "Critical" },
  "casesnew.template.rental": { de: "Mietrecht", en: "Rental" },
  "casesnew.template.rental_desc": { de: "Wohnraummiete", en: "Residential lease" },
  "casesnew.template.employment": { de: "Arbeitsrecht", en: "Employment" },
  "casesnew.template.employment_desc": { de: "Kündigungsschutz", en: "Wrongful dismissal" },
  "casesnew.template.contract": { de: "Vertrag", en: "Contract" },
  "casesnew.template.contract_desc": { de: "Vertragsrecht", en: "Contract law" },
  "casesnew.template.family": { de: "Familie", en: "Family" },
  "casesnew.template.family_desc": { de: "Familienrecht", en: "Family law" },
  "casesnew.template.inheritance": { de: "Erbrecht", en: "Inheritance" },
  "casesnew.template.inheritance_desc": { de: "Testamentsvollstreckung", en: "Probate" },
  "casesnew.template.insolvency": { de: "Insolvenz", en: "Insolvency" },
  "casesnew.template.insolvency_desc": { de: "Insolvenzeröffnung", en: "Bankruptcy filing" },
  "casesnew.template.criminal": { de: "Strafrecht", en: "Criminal" },
  ...
  "casesnew.step_basics": { de: "Basisdaten", en: "Basics" },
  "casesnew.step_parties": { de: "Parteien", en: "Parties" },
  "casesnew.step_details": { de: "Details", en: "Details" },
  "casesnew.btn_next": { de: "Weiter", en: "Next" },
  "casesnew.btn_back": { de: "Zurück", en: "Back" },
  "casesnew.step_of": { de: "Schritt", en: "Step" },
  "casesnew.review_title": { de: "Übersicht", en: "Review" },

  // ── Case detail widgets ──
  "cases.widget.status": { de: "Status", en: "Status" },
  "cases.widget.status_ok": { de: "Keine Blocker", en: "No blockers" },
  "cases.widget.next_deadline": { de: "Nächste Frist", en: "Next deadline" },
  "cases.widget.no_blockers": { de: "Akte ist auf Kurs", en: "Case is on track" },
  "cases.widget.unnamed_deadline": { de: "Unbenannte Frist", en: "Unnamed deadline" },
  "cases.widget.due_today": { de: "Heute fällig", en: "Due today" },
  "cases.widget.due_in": { de: "fällig in", en: "due in" },
  "cases.widget.parties": { de: "Beteiligte", en: "Parties" },
  "cases.widget.no_parties": { de: "Noch keine Beteiligten", en: "No parties yet" },
  "cases.widget.deadlines": { de: "Fristen & Tasks", en: "Deadlines & tasks" },
  "cases.widget.open_deadlines": { de: "offene Fristen", en: "open deadlines" },
  "cases.widget.critical": { de: "kritisch", en: "critical" },
  "cases.widget.no_critical": { de: "Keine kritischen Fristen", en: "No critical deadlines" },
  "cases.widget.open_tasks": { de: "offene Tasks", en: "open tasks" },
  ...
  "contracts.quick_save": { de: "Speichern", en: "Save" },
  "contracts.quick_created": { de: "Vertrag erstellt", en: "Contract created" },
  "contracts.quick_label_title": { de: "Bezeichnung", en: "Title" },
  "contracts.quick_label_parties": { de: "Parteien", en: "Parties" },
  "contracts.quick_label_type": { de: "Vertragstyp", en: "Contract type" },
  "contracts.quick_label_content": { de: "Vertragstext", en: "Contract text" },
  "contracts.quick_type_kauf": { de: "Kaufvertrag", en: "Purchase agreement" },
  "contracts.quick_type_dienst": { de: "Dienstvertrag", en: "Service contract" },
  "contracts.quick_type_werk": { de: "Werkvertrag", en: "Work contract" },
  "contracts.quick_type_miete": { de: "Mietvertrag", en: "Lease agreement" },
  "contracts.quick_type_nda": { de: "NDA / Geheimhaltung", en: "NDA / Confidentiality" },
  "contracts.quick_type_arbeit": { de: "Arbeitsvertrag", en: "Employment contract" },
  "contracts.quick_type_lizenz": { de: "Lizenzvertrag", en: "Licensing agreement" },
  ...
  "connectors.coverage_matrix": {
    de: "Connector-Coverage-Matrix",
    en: "Connector Coverage Matrix",
  },
  "connectors.status_available": { de: "Verfügbar", en: "Available" },
  "connectors.status_planned": { de: "Geplant", en: "Planned" },
  "connectors.status_na": { de: "N/A", en: "N/A" },
  "connectors.total": { de: "Gesamt", en: "Total" },
  "connectors.coverage_gaps": { de: "Coverage-Lücken", en: "Coverage Gaps" },
  "connectors.col_connector": { de: "Konnektor", en: "Connector" },
  "connectors.col_matter": { de: "Akten", en: "Matter" },
  "connectors.never_synced": { de: "Noch nie synchronisiert", en: "Never synced" },
  "connectors.last_sync": { de: "Letzter Sync", en: "Last sync" },
  "connectors.hide": { de: "Ausblenden", en: "Hide" },
  "connectors.show": { de: "Anzeigen", en: "Show" },
  ...
  "drafting.no_case": { de: "Keine Akte", en: "No case" },
  "drafting.cases_load_error": {
    de: "Akten konnten nicht geladen werden",
    en: "Cases could not be loaded",
  },
  ...
  "drafting.placeholder_title": {
    de: "z.B. Vertragsbruch Muster GmbH",
    en: "e.g. Breach of contract Example Ltd.",
  },
  ...
  // ── Litigation Flow ──────────────────────────────────────────────────
  "litigation.title": { de: "Prozessführung", en: "Litigation" },
  "litigation.description": {
    de: "Strukturierte prozessuale Phasenführung für Gerichtsverfahren",
    en: "Structured procedural phase management for court proceedings",
  },
  ...
  "litigation.filter_phase": { de: "Phase filtern", en: "Filter phase" },
  "litigation.all_phases": { de: "Alle Phasen", en: "All phases" },
  "litigation.case": { de: "Akte", en: "Case" },
  "litigation.court": { de: "Gericht", en: "Court" },
  "litigation.file_number": { de: "Aktenzeichen", en: "File number" },
  "litigation.instance": { de: "Instanz", en: "Instance" },
  "litigation.phase": { de: "Phase", en: "Phase" },
  "litigation.progress": { de: "Fortschritt", en: "Progress" },
  "litigation.steps": { de: "Schritte", en: "Steps" },
  "litigation.settlement": { de: "Vergleich", en: "Settlement" },
  "litigation.judgment": { de: "Urteil", en: "Judgment" },
  "litigation.advance_phase": { de: "Phase wechseln", en: "Advance phase" },
  "litigation.add_step": { de: "Schritt hinzufügen", en: "Add step" },
  "litigation.step_title": { de: "Titel", en: "Title" },
  "litigation.step_type": { de: "Typ", en: "Type" },
  "litigation.step_status": { de: "Status", en: "Status" },
  "litigation.step_due": { de: "Fällig", en: "Due" },
  "litigation.step_assigned": { de: "Zugewiesen", en: "Assigned" },
  "litigation.no_steps": { de: "Keine Schritte in dieser Phase", en: "No steps in this phase" },
  ...
  "litigation.enter_file_number": { de: "Aktenzeichen eingeben", en: "Enter file number" },
  "litigation.enter_court": { de: "Gericht eingeben", en: "Enter court" },
  "litigation.save": { de: "Speichern", en: "Save" },
  "litigation.cancel": { de: "Abbrechen", en: "Cancel" },
  "litigation.delete": { de: "Löschen", en: "Delete" },
  "litigation.delete_confirm": {
    de: "Verfahren wirklich löschen?",
    en: "Really delete this matter?",
  },
  "litigation.settlement_status": { de: "Vergleichsstatus", en: "Settlement status" },
  "litigation.settlement_amount": { de: "Vergleichssumme", en: "Settlement amount" },
  "litigation.judgment_outcome": { de: "Urteilsausgang", en: "Judgment outcome" },
  "litigation.judgment_date": { de: "Urteilsdatum", en: "Judgment date" },
  "litigation.judgment_appealable": { de: "Berufbar", en: "Appealable" },
  "litigation.phase_history": { de: "Phasenverlauf", en: "Phase history" },
  "litigation.error_load": { de: "Fehler beim Laden der Verfahren", en: "Error loading matters" },
  "litigation.error_save": { de: "Fehler beim Speichern", en: "Error saving" },
  "litigation.success_saved": { de: "Erfolgreich gespeichert", en: "Saved successfully" },
  "litigation.success_created": { de: "Verfahren erstellt", en: "Matter created" },
  "litigation.success_deleted": { de: "Verfahren gelöscht", en: "Matter deleted" },
  "litigation.phase_pre_filing": { de: "Vorbereitung", en: "Pre-Filing" },
  "litigation.phase_filing": { de: "Klageerhebung", en: "Filing" },
  "litigation.phase_discovery": { de: "Beweisaufnahme", en: "Discovery" },
  "litigation.phase_pre_trial": { de: "Terminsvorbereitung", en: "Pre-Trial" },
  "litigation.phase_trial": { de: "Hauptverhandlung", en: "Trial" },
  "litigation.phase_post_trial": { de: "Urteil & Nachbereitung", en: "Post-Trial" },
  "litigation.phase_appeal": { de: "Berufung / Revision", en: "Appeal" },
  "litigation.phase_enforcement": { de: "Vollstreckung", en: "Enforcement" },
  "litigation.phase_closed": { de: "Abgeschlossen", en: "Closed" },
  "litigation.step_task": { de: "Aufgabe", en: "Task" },
  "litigation.step_filing": { de: "Schriftsatz", en: "Filing" },
  "litigation.step_motion": { de: "Antrag", en: "Motion" },
  "litigation.step_hearing": { de: "Termin", en: "Hearing" },
  "litigation.step_deadline": { de: "Frist", en: "Deadline" },
  "litigation.step_document": { de: "Dokument", en: "Document" },
  "litigation.step_communication": { de: "Kommunikation", en: "Communication" },
  "litigation.step_evidence": { de: "Beweis", en: "Evidence" },
  "litigation.step_settlement": { de: "Vergleich", en: "Settlement" },
  "litigation.step_enforcement": { de: "Vollstreckung", en: "Enforcement" },
  "litigation.status_pending": { de: "Offen", en: "Pending" },
  "litigation.status_in_progress": { de: "In Bearbeitung", en: "In Progress" },
  "litigation.status_completed": { de: "Erledigt", en: "Completed" },
  "litigation.status_blocked": { de: "Blockiert", en: "Blocked" },
  "litigation.status_skipped": { de: "Übersprungen", en: "Skipped" },
  "litigation.settlement_none": { de: "Kein Vergleich", en: "None" },
  "litigation.settlement_offered": { de: "Angeboten", en: "Offered" },
  "litigation.settlement_negotiating": { de: "Verhandlung", en: "Negotiating" },
  "litigation.settlement_agreed": { de: "Vereinbart", en: "Agreed" },
  "litigation.settlement_failed": { de: "Gescheitert", en: "Failed" },
  "litigation.judgment_favorable": { de: "Günstig", en: "Favorable" },
  "litigation.judgment_unfavorable": { de: "Ungünstig", en: "Unfavorable" },
  "litigation.judgment_partial": { de: "Teilweise", en: "Partial" },
  "litigation.judgment_pending": { de: "Ausstehend", en: "Pending" },
  ...
  "review_sets.save": { de: "Speichern", en: "Save" },
  ...
  "review_sets.add_docs": { de: "Dokumente hinzufügen", en: "Add documents" },
  "review_sets.no_docs": { de: "Keine Dokumente in diesem Set", en: "No documents in this set" },
  "review_sets.decision": { de: "Entscheidung", en: "Decision" },
  "review_sets.decision_responsive": { de: "Relevant", en: "Responsive" },
  "review_sets.decision_non_responsive": { de: "Nicht relevant", en: "Non-responsive" },
  "review_sets.decision_privileged": { de: "Privilegiert", en: "Privileged" },
  "review_sets.decision_redact": { de: "Geschwärzt", en: "Redact" },
  "review_sets.decision_withhold": { de: "Zurückbehalten", en: "Withhold" },
  "review_sets.privilege_type": { de: "Privileg-Typ", en: "Privilege type" },
  "review_sets.privilege_none": { de: "Kein Privileg", en: "None" },
  "review_sets.privilege_attorney_client": { de: "Mandatsgeheimnis", en: "Attorney-Client" },
  "review_sets.privilege_work_product": { de: "Arbeitsprodukt", en: "Work Product" },
  "review_sets.privilege_joint_defense": { de: "Joint Defense", en: "Joint Defense" },
  "review_sets.privilege_settlement": { de: "Vergleichsprivileg", en: "Settlement" },
  "review_sets.privilege_basis": { de: "Grundlage", en: "Basis" },
  "review_sets.redaction_code": { de: "Schwärzungscode", en: "Redaction code" },
  "review_sets.redaction_notes": { de: "Schwärzungsnotiz", en: "Redaction notes" },
  "review_sets.bates_number": { de: "Bates-Nummer", en: "Bates number" },
  "review_sets.bates_prefix": { de: "Bates-Präfix", en: "Bates prefix" },
  "review_sets.bates_start": { de: "Bates-Startnummer", en: "Bates start number" },
  "review_sets.production_format": { de: "Produktionsformat", en: "Production format" },
  "review_sets.produce": { de: "Produzieren", en: "Produce" },
  "review_sets.export_privilege_log": {
    de: "Privilege Log exportieren",
    en: "Export privilege log",
  },
  "review_sets.stats_total": { de: "Gesamt", en: "Total" },
  "review_sets.stats_responsive": { de: "Relevant", en: "Responsive" },
  "review_sets.stats_privileged": { de: "Privilegiert", en: "Privileged" },
  ...
  // ── Trust Accounting ─────────────────────────────────────────────────
  "nav.trust_accounting": { de: "Treuhandkonto", en: "Trust Accounting" },
  ...
  "workspace.rsv.description": {
    de: "Deckungsanfragen für drebis oder strukturierten E-Mail-Versand vorbereiten",
    en: "Prepare coverage requests for drebis or structured email delivery",
  },
  "workspace.rsv.new": { de: "Neue Deckungsanfrage", en: "New coverage request" },
  "workspace.rsv.case": { de: "Akten-Slug", en: "Case slug" },
  "workspace.rsv.client": { de: "Mandant", en: "Client" },
  "workspace.rsv.insurer": { de: "Versicherer", en: "Insurer" },
  "workspace.rsv.number": { de: "Versicherungsnummer", en: "Policy number" },
  "workspace.rsv.area": { de: "Rechtsgebiet", en: "Practice area" },
  "workspace.rsv.value": { de: "Streitwert", en: "Dispute value" },
  "workspace.rsv.matter": { de: "Gegenstand", en: "Matter" },
  "workspace.rsv.create": { de: "Anfrage erzeugen", en: "Create request" },
  "workspace.rsv.ready": { de: "Versandfertige Anfrage", en: "Ready-to-send request" },
  "workspace.rsv.status": { de: "Deckungsstatus", en: "Coverage status" },
  "workspace.rsv.empty": { de: "Noch keine Anfragen.", en: "No requests yet." },
  "workspace.benchmark.title": { de: "Peer-Benchmark", en: "Peer benchmark" },
  "workspace.benchmark.description": {
    de: "Anonymisierter Kanzleivergleich mit k-Anonymität",
    en: "Anonymous firm comparison with k-anonymity",
  },
  "workspace.benchmark.contribute": { de: "Anonymisiert beitragen", en: "Contribute anonymously" },
  "workspace.benchmark.firm": { de: "Interne Kanzlei-ID", en: "Internal firm ID" },
  "workspace.benchmark.area": { de: "Rechtsgebiet", en: "Practice area" },
  "workspace.benchmark.total": { de: "Fälle gesamt", en: "Total cases" },
  "workspace.benchmark.won": { de: "Gewonnene Fälle", en: "Cases won" },
  "workspace.benchmark.durations": {
    de: "Dauern in Tagen, kommasepariert",
    en: "Durations in days, comma-separated",
  },
  "workspace.benchmark.from": { de: "Zeitraum von", en: "Period from" },
  "workspace.benchmark.to": { de: "Zeitraum bis", en: "Period to" },
  "workspace.benchmark.submit": { de: "Anonymisiert übermitteln", en: "Submit anonymously" },
  "workspace.benchmark.groups": { de: "Vergleichsgruppen", en: "Comparison groups" },
  "workspace.benchmark.empty": {
  ...
  "workspace.datev.type": { de: "Typ", en: "Type" },
  "workspace.datev.invoices": { de: "Rechnungen", en: "Invoices" },
  "workspace.datev.bookings": { de: "Buchungen", en: "Bookings" },
  "workspace.datev.master": { de: "Stammdaten", en: "Master data" },
  "workspace.datev.from": { de: "Von", en: "From" },
  "workspace.datev.to": { de: "Bis", en: "To" },
  "workspace.datev.number": { de: "Rechnungsnummer", en: "Invoice number" },
  "workspace.datev.date": { de: "Rechnungsdatum", en: "Invoice date" },
  "workspace.datev.client": { de: "Mandant", en: "Client" },
  "workspace.datev.net": { de: "Netto", en: "Net" },
  "workspace.datev.tax": { de: "USt. %", en: "VAT %" },
  "workspace.datev.records": { de: "Datensätze", en: "records" },
  "workspace.benchmark.success": { de: "Erfolg", en: "success" },
  "workspace.benchmark.days": { de: "Tage Median", en: "median days" },
  "workspace.benchmark.firms": { de: "Kanzleien", en: "firms" },
  "workspace.white.title": { de: "White-Label PWA", en: "White-label PWA" },
  "workspace.white.description": {
    de: "Mandantenportal mit Kanzleinamen, Logo und Farben ausliefern",
    en: "Deliver the client portal with your firm name, logo and colors",
  },
  "workspace.white.firm": { de: "Kanzleiname", en: "Firm name" },
  "workspace.white.short": { de: "Kurzname", en: "Short name" },
  "workspace.white.description_label": { de: "Beschreibung", en: "Description" },
  "workspace.white.logo": { de: "Logo-URL", en: "Logo URL" },
  "workspace.white.start": { de: "Start-URL", en: "Start URL" },
  "workspace.white.accent": { de: "Akzentfarbe", en: "Accent color" },
  "workspace.white.background": { de: "Hintergrund", en: "Background" },
  "workspace.white.save": { de: "Branding speichern", en: "Save branding" },
  "workspace.white.open": { de: "Mandantenportal öffnen", en: "Open client portal" },
  "workspace.white.logo_alt": { de: "Kanzleilogo", en: "Firm logo" },
  "workspace.white.fallback": { de: "Ihre Kanzlei", en: "Your firm" },
  "workspace.bulk.title": { de: "Massenakten", en: "Bulk cases" },
  "workspace.bulk.description": {
    de: "CSV prüfen, als Portfolio gruppieren und kontrolliert importieren",
    en: "Validate CSV data, group it as a portfolio and import it safely",
  },
  "workspace.bulk.import": { de: "CSV-Import", en: "CSV import" },
  "workspace.bulk.valid": { de: "gültige Zeilen", en: "valid rows" },
  "workspace.bulk.preview": { de: "Vorschau", en: "Preview" },
  "workspace.bulk.case": { de: "Az.", en: "Case no." },
  "workspace.bulk.client": { de: "Mandant", en: "Client" },
  "workspace.bulk.matter": { de: "Gegenstand", en: "Matter" },
  "workspace.bulk.portfolio": { de: "Portfolio", en: "Portfolio" },
  "workspace.bulk.submit_prefix": { de: "Diese", en: "Import these" },
  "workspace.bulk.submit_suffix": { de: "Akten importieren", en: "cases" },
  ...
  "trust.empty": { de: "Noch keine Treuhandkonten angelegt.", en: "No trust accounts yet." },
  "trust.search": { de: "Konten durchsuchen…", en: "Search accounts…" },
  "trust.account_name": { de: "Kontobezeichnung", en: "Account Name" },
  "trust.account_number": { de: "Kontonummer", en: "Account Number" },
  "trust.bank_name": { de: "Bank", en: "Bank" },
  "trust.iban": { de: "IBAN", en: "IBAN" },
  "trust.bic": { de: "BIC", en: "BIC" },
  "trust.currency": { de: "Währung", en: "Currency" },
  "trust.opening_balance": { de: "Eröffnungssaldo", en: "Opening Balance" },
  "trust.current_balance": { de: "Aktueller Saldo", en: "Current Balance" },
  "trust.matter": { de: "Akte", en: "Matter" },
  "trust.client": { de: "Mandant", en: "Client" },
  "trust.status_active": { de: "Aktiv", en: "Active" },
  ...
  "trust.tx_deposit": { de: "Einzahlung", en: "Deposit" },
  "trust.tx_withdrawal": { de: "Auszahlung", en: "Withdrawal" },
  "trust.tx_transfer": { de: "Umbuchung", en: "Transfer" },
  "trust.tx_fee": { de: "Gebühr", en: "Fee" },
  "trust.tx_interest": { de: "Zinsen", en: "Interest" },
  "trust.tx_adjustment": { de: "Korrektur", en: "Adjustment" },
  "trust.tx_amount": { de: "Betrag", en: "Amount" },
  "trust.tx_date": { de: "Datum", en: "Date" },
  "trust.tx_description": { de: "Beschreibung", en: "Description" },
  "trust.tx_reference": { de: "Referenz", en: "Reference" },
  "trust.save": { de: "Speichern", en: "Save" },
  "trust.cancel": { de: "Abbrechen", en: "Cancel" },
  "trust.delete": { de: "Löschen", en: "Delete" },
  "trust.delete_confirm": { de: "Konto wirklich löschen?", en: "Really delete this account?" },
  "trust.export_csv": { de: "CSV exportieren", en: "Export CSV" },
  "trust.quarterly_report": { de: "Quartalsbericht", en: "Quarterly report" },
  ...
  "analytics.empty": {
    de: "Noch keine Verfahrensergebnisse erfasst.",
    en: "No case outcomes recorded yet.",
  },
  "analytics.search": { de: "Suchen…", en: "Search…" },
  "analytics.kpi_total": { de: "Verfahren gesamt", en: "Total cases" },
  "analytics.kpi_winrate": { de: "Erfolgsquote", en: "Win rate" },
  "analytics.kpi_duration": { de: "Ø Dauer (Tage)", en: "Avg duration (days)" },
  "analytics.kpi_hours": { de: "Ø Stunden", en: "Avg hours" },
  "analytics.kpi_dispute": { de: "Streitwert gesamt", en: "Total in dispute" },
  "analytics.kpi_awarded": { de: "Zugesprochen gesamt", en: "Total awarded" },
  "analytics.case_title": { de: "Aktenbezeichnung", en: "Case title" },
  "analytics.case_number": { de: "Aktenzeichen", en: "Case number" },
  "analytics.court": { de: "Gericht", en: "Court" },
  "analytics.court_level": { de: "Gerichtsbarkeit", en: "Jurisdiction level" },
  "analytics.judge": { de: "Richter:in", en: "Judge" },
  "analytics.procedure_type": { de: "Verfahrensart", en: "Procedure type" },
  "analytics.outcome": { de: "Ergebnis", en: "Outcome" },
  "analytics.amount_in_dispute": { de: "Streitwert", en: "Amount in dispute" },
  "analytics.amount_awarded": { de: "Zugesprochen", en: "Amount awarded" },
  "analytics.start_date": { de: "Beginn", en: "Start date" },
  "analytics.end_date": { de: "Ende", en: "End date" },
  "analytics.duration": { de: "Dauer (Tage)", en: "Duration (days)" },
  "analytics.lawyer_hours": { de: "Anwaltsstunden", en: "Lawyer hours" },
  "analytics.notes": { de: "Notizen", en: "Notes" },
  "analytics.outcome_won": { de: "Gewonnen", en: "Won" },
  "analytics.outcome_lost": { de: "Verloren", en: "Lost" },
  "analytics.outcome_settled": { de: "Vergleich", en: "Settled" },
  "analytics.outcome_partial": { de: "Teilweise", en: "Partial" },
  "analytics.outcome_withdrawn": { de: "Zurückgenommen", en: "Withdrawn" },
  "analytics.outcome_pending": { de: "Anhängig", en: "Pending" },
  "analytics.proc_zivil": { de: "Zivilrecht", en: "Civil" },
  "analytics.proc_straf": { de: "Strafrecht", en: "Criminal" },
  "analytics.proc_verwaltungs": { de: "Verwaltungsrecht", en: "Administrative" },
  "analytics.proc_finanz": { de: "Finanzrecht", en: "Tax" },
  "analytics.proc_arbeits": { de: "Arbeitsrecht", en: "Labor" },
  "analytics.proc_sozial": { de: "Sozialrecht", en: "Social" },
  "analytics.proc_familie": { de: "Familienrecht", en: "Family" },
  "analytics.court_amtsgericht": { de: "Amtsgericht", en: "Local Court" },
  "analytics.court_landesgericht": { de: "Landesgericht", en: "Regional Court" },
  "analytics.court_oberlandesgericht": { de: "Oberlandesgericht", en: "Higher Regional Court" },
  "analytics.court_bundesgericht": { de: "Bundesgericht", en: "Federal Court" },
  "analytics.court_verwaltungsgericht": { de: "Verwaltungsgericht", en: "Administrative Court" },
  "analytics.court_finanzgericht": { de: "Finanzgericht", en: "Tax Court" },
  "analytics.court_arbeitsgericht": { de: "Arbeitsgericht", en: "Labor Court" },
  "analytics.court_sozialgericht": { de: "Sozialgericht", en: "Social Court" },
  "analytics.top_courts": { de: "Top Gerichte", en: "Top Courts" },
  "analytics.top_judges": { de: "Top Richter:innen", en: "Top Judges" },
  "analytics.outcome_distribution": { de: "Ergebnisverteilung", en: "Outcome Distribution" },
  "analytics.procedure_distribution": { de: "Verfahrensarten", en: "Procedure Types" },
  "analytics.save": { de: "Speichern", en: "Save" },
  "analytics.cancel": { de: "Abbrechen", en: "Cancel" },
  "analytics.delete": { de: "Löschen", en: "Delete" },
  "analytics.delete_confirm": { de: "Eintrag wirklich löschen?", en: "Really delete this entry?" },
  "analytics.export_csv": { de: "CSV exportieren", en: "Export CSV" },
  "analytics.success_saved": { de: "Gespeichert", en: "Saved" },
  "analytics.success_created": { de: "Ergebnis erfasst", en: "Outcome recorded" },
  "analytics.success_deleted": { de: "Gelöscht", en: "Deleted" },
  "analytics.filter_court": { de: "Alle Gerichte", en: "All courts" },
  "analytics.filter_outcome": { de: "Alle Ergebnisse", en: "All outcomes" },
  "analytics.filter_procedure": { de: "Alle Verfahrensarten", en: "All procedure types" },
  // ── End of Litigation Analytics ──────────────────────────────────────
  ...
  "templates.toast_delete_failed": { de: "Löschen fehlgeschlagen", en: "Delete failed" },
  ...
  "signature.quick_email": { de: "E-Mail", en: "Email" },
  ...
  "judgements.copy": { de: "Kopieren", en: "Copy" },
  "judgements.loading": { de: "Lädt…", en: "Loading…" },
  "judgements.error_prefix": { de: "Fehler:", en: "Error:" },
  "judgements.notice_title": { de: "Hinweis zur Datenaktualität", en: "Data freshness notice" },
  "judgements.notice_body": {
    de: "Öffentliche Rechtsprechungsdatenbanken aktualisieren sich täglich. Der Konnektor führt ein Delta-Sync durch — bereits vorhandene Urteile werden nicht dupliziert. Für produktive Nutzung empfehlen wir einen täglichen Cron-Job:",
    en: "Public case law databases update daily. The connector performs a delta sync — existing rulings are not duplicated. For production use, we recommend a daily cron job:",
  },
  ...
  "docreq.toast_created": { de: "Dokumentanfrage erstellt", en: "Document request created" },
  "docreq.toast_create_failed": { de: "Erstellung fehlgeschlagen", en: "Creation failed" },
  "docreq.toast_update_failed": { de: "Aktualisierung fehlgeschlagen", en: "Update failed" },
  ...
  "casesdetail.restore_open": { de: "Als Offen wiederherstellen", en: "Restore as Open" },
  "casesdetail.as_dormant": { de: "als Ruhend", en: "as Dormant" },
  "casesdetail.tab_unavailable": {
    de: "Dieser Tab ist nicht verfügbar.",
    en: "This tab is not available.",
  },

  // ── Matter header strings ──
  "matterheader.deadlines": { de: "Fristen", en: "Deadlines" },
  "matterheader.tasks": { de: "Aufgaben", en: "Tasks" },
  "matterheader.docs": { de: "Doku", en: "Docs" },
  "matterheader.hours": { de: "Std", en: "Hours" },
  ...
  "matterheader.client_portal": { de: "Mandantenportal", en: "Client Portal" },
  "matterheader.archived": { de: "Archiviert", en: "Archived" },
  "matterswitcher.switch": { de: "Akte wechseln", en: "Switch matter" },
  "matterswitcher.matters": { de: "Akten", en: "Matters" },
  "matterswitcher.search": { de: "Akten durchsuchen…", en: "Search matters…" },
  "matterswitcher.pinned": { de: "Angeheftet", en: "Pinned" },
  "matterswitcher.recent": { de: "Zuletzt", en: "Recent" },
  "matterswitcher.all": { de: "Alle Akten", en: "All matters" },
  "matterswitcher.unpin": { de: "Loslösen", en: "Unpin" },
  "matterswitcher.pin": { de: "Anheften", en: "Pin" },
  "matterswitcher.no_results": { de: "Keine Akten gefunden", en: "No matters found" },
  "matterswitcher.no_recent": { de: "Keine zuletzt verwendeten Akten", en: "No recent matters" },
  "contactstab.linked": { de: "Verknüpft", en: "Linked" },
  "contactstab.edit": { de: "Bearbeiten", en: "Edit" },
  "contactstab.case_contacts": { de: "Aktenkontakte", en: "Case Contacts" },
  "contactstab.case_contacts_desc": {
    de: "Mit dieser Akte verknüpfte Kontakte und alle verfügbaren Kontakte.",
    en: "Contacts linked to this case and all available contacts.",
  },
  "contactstab.add_contact": { de: "Kontakt hinzufügen", en: "Add Contact" },
  "contactstab.linked_to_case": { de: "Mit dieser Akte verknüpft", en: "Linked to this case" },
  "contactstab.all_contacts": { de: "Alle Kontakte", en: "All contacts" },
  "contactstab.manage_all": { de: "Alle Kontakte verwalten →", en: "Manage all contacts →" },
  "billingtab.advanced": { de: "Erweitert", en: "Advanced" },
  "billingtab.no_time_entries": { de: "Noch keine Zeiteinträge.", en: "No time entries yet." },
  "billingtab.no_expenses": { de: "Keine Auslagen erfasst.", en: "No expenses recorded." },
  "billingtab.unbilled_summary": { de: "Nicht abgerechnet", en: "Unbilled Summary" },
  "billingtab.time": { de: "Zeit", en: "time" },
  "billingtab.expenses": { de: "Auslagen", en: "expenses" },
  "billingtab.create_invoice": { de: "Rechnung erstellen", en: "Create Invoice" },
  "billingtab.invoice_link": { de: "Rechnung", en: "Invoice" },
  "billingtab.unbill": { de: "Abrechnung zurücknehmen", en: "Unbill" },
  "billingtab.unbill_confirm": {
    de: "Abrechnung wirklich zurücknehmen? Der Zeiteintrag wird wieder als nicht abgerechnet markiert.",
    en: "Really unbill this entry? It will be marked as unbilled again.",
  },
  "billingtab.unbilled_ok": { de: "Abrechnung zurückgenommen", en: "Entry unbilled" },
  "billingtab.unbill_failed": {
    de: "Zurücknehmen fehlgeschlagen",
    en: "Unbill failed",
  },
  "billingtab.linked_time_entries": {
    de: "Enthaltene Zeiteinträge",
    en: "Included Time Entries",
  },
  "billingtab.linked_expenses": {
    de: "Enthaltene Auslagen",
    en: "Included Expenses",
  },
  "billingtab.no_linked_entries": {
    de: "Keine verknüpften Einträge",
    en: "No linked entries",
  },
  "strategytab.semantic_contradictions": {
    de: "Semantische Widersprüche",
    en: "Semantic Contradictions",
  },
  "strategytab.last_probe": { de: "Letzter Scan:", en: "Last probe:" },
  "strategytab.field_contradictions": {
    de: "Feld-Ebene Widersprüche",
  ...
  "docstab.extraction_password": {
    de: "Passwort nötig — neu hochladen",
  ...
  "evalgate.blocking": { de: "blockierend", en: "blocking" },
  "evalgate.evaluated": { de: "Ausgewertet", en: "Evaluated" },
  "tax.returns.create_another": { de: "Weitere anlegen", en: "Create another" },
  "tax.returns.placeholder_client_name": { de: "Mandantenname", en: "Client name" },
  "tax.returns.label_due_date": { de: "Frist", en: "Due Date" },
  "tax.returns.modal_desc_short": {
    de: "Neue Steuererklärung schnell anlegen",
    en: "Create a new tax return quickly",
  },
  "tax.returns.show_advanced": { de: "Erweitert einblenden", en: "Show advanced" },
  "tax.returns.hide_advanced": { de: "Erweitert ausblenden", en: "Hide advanced" },
  "tax.findings.no_findings": {
    de: "Keine Feststellungen dokumentiert",
    en: "No findings recorded",
  },
  "tax.findings.count": { de: "Feststellungen", en: "findings" },
  "tax.findings.accepted": { de: "akzeptiert", en: "accepted" },
  "tax.findings.add_finding": { de: "Feststellung hinzufügen", en: "Add Finding" },
  "tax.findings.issue": { de: "Feststellung", en: "Issue" },
  "tax.findings.amount": { de: "Betrag", en: "Amount" },
  "tax.findings.status": { de: "Status", en: "Status" },
  "tax.findings.issue_desc": { de: "Feststellungsbeschreibung", en: "Issue Description" },
  "tax.findings.additional_tax": { de: "Nachzahlung (€)", en: "Additional Tax (€)" },
  "tax.findings.cancel": { de: "Abbrechen", en: "Cancel" },
  "tax.findings.add": { de: "Hinzufügen", en: "Add" },
  "tax.client.fiscal_year": { de: "Wirtschaftsjahr", en: "Fiscal Year" },
  "tax.client.industry": { de: "Branche", en: "Industry" },
  "tax.client.open_returns": { de: "Offene Erklärungen", en: "Open Returns" },
  "tax.client.open_assessments": { de: "Offene Bescheide", en: "Open Assessments" },
  "tax.client.open_audits": { de: "Offene Prüfungen", en: "Open Audits" },
  "tax.client.total_assessed": { de: "Festgesetzt gesamt", en: "Total Assessed" },
  "elster.review": { de: "Zur Prüfung", en: "Review" },
  "elster.back": { de: "Zurück", en: "Back" },
  "elster.continue": { de: "Weiter", en: "Continue" },
  "elster.ready": { de: "Bereit zur Übermittlung an ELSTER", en: "Ready to submit to ELSTER" },
  "commstab.all": { de: "Alle", en: "All" },
  "commstab.email": { de: "E-Mail", en: "Email" },
  ...
  "aitab.quick_actions": { de: "Schnellaktionen:", en: "Quick actions:" },
  "contract.placeholder_name": { de: "Vertragsbezeichnung", en: "Contract name" },
  "contract.placeholder_parties": {
    de: "z.B. Käufer A — Verkäufer B",
    en: "e.g. Buyer A — Seller B",
  },
  "contract.placeholder_text": { de: "Vertragstext hier einfügen…", en: "Insert contract text…" },
  "caseqc.placeholder_file_no": { de: "z.B. 2026-001", en: "e.g. 2026-001" },
  "caseqc.placeholder_area": { de: "z.B. Mietrecht", en: "e.g. Rental law" },
  "caseqc.placeholder_subject": { de: "z.B. Wohnraummiete", en: "e.g. Residential lease" },
  "sigqc.placeholder_title": {
    de: "z.B. Mandatsvereinbarung GmbH",
    en: "e.g. Mandate agreement GmbH",
  },
  "mattertab.more": { de: "Mehr", en: "More" },
  "overviewtab.more": { de: "Mehr", en: "More" },
  "tax.deadline_timeline.none": { de: "Keine Fristen", en: "No deadlines" },
  "copilot.loading": { de: "Laden…", en: "Loading…" },
  "seo.unit_text": { de: "pro Nutzer und Monat", en: "per seat per month" },
  "seo.service_type": { de: "KI-Kanzleisoftware", en: "AI legal software" },
  ...
  "reports.duration_days": { de: "Tage", en: "days" },
  "reports.total_jobs": { de: "Gesamt", en: "Total" },
  "reports.success_rate": { de: "Erfolgsrate", en: "Success Rate" },
  ...
  "email.compose_title": { de: "E-Mail aus Akte senden", en: "Send email from case" },
  "email.to": { de: "An", en: "To" },
  "email.subject": { de: "Betreff", en: "Subject" },
  "email.body": { de: "Nachricht", en: "Message" },
  "email.body_placeholder": { de: "Sehr geehrte/r…", en: "Dear Sir/Madam…" },
  ...
  "mattertab.phone_notes": { de: "Telefon", en: "Phone" },
  "mattertab.notes_title": { de: "Notizen", en: "Notes" },
  "mattertab.notes_add": { de: "Notiz hinzufügen", en: "Add Note" },
  "mattertab.notes_title_label": { de: "Titel", en: "Title" },
  "mattertab.notes_content_label": { de: "Inhalt", en: "Content" },
  "mattertab.notes_empty": { de: "Keine Notizen vorhanden", en: "No notes yet" },
  "mattertab.notes_created": { de: "Notiz erstellt", en: "Note created" },
  "mattertab.notes_deleted": { de: "Notiz gelöscht", en: "Note deleted" },
  "mattertab.notes_pin": { de: "Anpinnen", en: "Pin" },
  "mattertab.notes_unpin": { de: "Lösen", en: "Unpin" },
  "mattertab.phone_title": { de: "Telefonnotizen", en: "Phone Notes" },
  "mattertab.phone_add": { de: "Telefonnotiz hinzufügen", en: "Add Phone Note" },
  "mattertab.phone_empty": { de: "Keine Telefonnotizen vorhanden", en: "No phone notes yet" },
  "mattertab.phone_caller": { de: "Anrufer", en: "Caller" },
  "mattertab.phone_subject": { de: "Betreff", en: "Subject" },
  "mattertab.phone_notes_label": { de: "Notizen", en: "Notes" },
  "mattertab.phone_results": { de: "Ergebnisse", en: "Results" },
  "mattertab.phone_followup": { de: "Folgeaktion", en: "Follow-up action" },
  "mattertab.phone_created": { de: "Telefonnotiz erstellt", en: "Phone note created" },
  "mattertab.phone_deleted": { de: "Telefonnotiz gelöscht", en: "Phone note deleted" },
  "mattertab.phone_track_time": { de: "Zeit erfassen", en: "Track time" },
  "mattertab.phone_time_tracked": { de: "Zeiterfassung erstellt", en: "Time entry created" },
  "mattertab.hearing_checklist": { de: "Verhandlungs-Checkliste", en: "Hearing Checklist" },
  "mattertab.hearing_checklist_empty": { de: "Keine Checkliste vorhanden", en: "No checklist yet" },
  "mattertab.hearing_checklist_add": { de: "Checkliste erstellen", en: "Create checklist" },
  "mattertab.hearing_checklist_saved": { de: "Checkliste gespeichert", en: "Checklist saved" },
  "mattertab.handover": { de: "Akten-Übergabe", en: "Case Handover" },
  "mattertab.handover_recipient": { de: "Empfänger", en: "Recipient" },
  "mattertab.handover_note": { de: "Übergabe-Notiz", en: "Handover note" },
  "mattertab.handover_urgency": { de: "Dringlichkeit", en: "Urgency" },
  "mattertab.handover_submit": { de: "Übergabe initiieren", en: "Initiate handover" },
  "mattertab.handover_created": { de: "Übergabe erstellt", en: "Handover created" },
  "mattertab.handover_empty": { de: "Keine Übergaben", en: "No handovers" },
  "mattertab.client_meeting": { de: "Mandantengespräch", en: "Client Meeting" },
  "mattertab.client_meeting_prepare": { de: "Gespräch vorbereiten", en: "Prepare meeting" },
  "mattertab.client_meeting_agenda": { de: "Agenda", en: "Agenda" },
  "mattertab.client_meeting_notes": { de: "Notizen", en: "Notes" },
  "mattertab.client_meeting_actions": { de: "Folgeaktionen", en: "Action items" },
  "mattertab.client_meeting_saved": { de: "Gespräch gespeichert", en: "Meeting saved" },
  "mattertab.client_meeting_empty": {
    de: "Keine Gespräche dokumentiert",
    en: "No meetings documented",
  },
  "mattertab.hearing_followup": { de: "Termin-Nachbereitung", en: "Hearing Follow-up" },
  "mattertab.hearing_followup_add": { de: "Hinzufügen", en: "Add" },
  "mattertab.hearing_followup_hearing": { de: "Termin", en: "Hearing" },
  "mattertab.hearing_followup_date": { de: "Datum", en: "Date" },
  "mattertab.hearing_followup_outcome": { de: "Ergebnis", en: "Outcome" },
  "mattertab.hearing_followup_empty": {
    de: "Keine Termin-Nachbereitungen vorhanden",
    en: "No hearing follow-ups yet",
  },
  "mattertab.hearing_followup_created": { de: "Nachbereitung erstellt", en: "Follow-up created" },
  "mattertab.hearing_followup_placeholder_hearing": {
    de: "z.B. Verhandlung am LG München",
    en: "e.g. Hearing at LG Munich",
  },
  "mattertab.hearing_followup_placeholder_outcome": {
    de: "z.B. Urteil, Vertagt, Vergleich",
    en: "e.g. Ruling, adjourned, settlement",
  },
  "mattertab.checklist_custom_placeholder": {
    de: "Eigene Position hinzufügen…",
    en: "Add custom item…",
  },
  "mattertab.client_meeting_placeholder": {
    de: "Gespräch mit Mandant…",
    en: "Meeting with client…",
  },
  "mattertab.urgency_low": { de: "Niedrig", en: "Low" },
  "mattertab.urgency_medium": { de: "Mittel", en: "Medium" },
  "mattertab.urgency_high": { de: "Hoch", en: "High" },
  "mattertab.phone_time_title": { de: "Telefon mit {caller}", en: "Phone call with {caller}" },
  "mattertab.phone_time_desc": { de: "Telefon: {subject}", en: "Phone: {subject}" },
  "team_meeting.title": { de: "Team-Besprechung", en: "Team Meeting" },
  "team_meeting.desc": {
    de: "Wöchentliche Agenda mit Auto-Generierung aus Fristen und Wiedervorlagen",
    en: "Weekly agenda with auto-generation from deadlines and follow-ups",
  },
  "team_meeting.generate": { de: "Agenda generieren", en: "Generate agenda" },
  "team_meeting.generate_success": { de: "Agenda generiert", en: "Agenda generated" },
  "team_meeting.new": { de: "Neue Besprechung", en: "New meeting" },
  "team_meeting.empty_title": { de: "Keine Besprechungen", en: "No meetings" },
  "team_meeting.empty_desc": {
    de: "Generieren Sie eine Agenda aus aktuellen Fristen und Wiedervorlagen.",
    en: "Generate an agenda from current deadlines and follow-ups.",
  },
  "team_meeting.item_deadline": { de: "Frist: {title}", en: "Deadline: {title}" },
  ...
  "absence.employee": { de: "Abwesender Mitarbeiter", en: "Absent employee" },
  "absence.email": { de: "E-Mail", en: "Email" },
  "absence.delegate": { de: "Vertreter", en: "Delegate" },
  "absence.delegate_email": { de: "Vertreter E-Mail", en: "Delegate email" },
  "absence.from": { de: "Von", en: "From" },
  "absence.to": { de: "Bis", en: "To" },
  "absence.reason": { de: "Grund", en: "Reason" },
  "absence.reason_placeholder": {
    de: "Urlaub, Krankheit, Fortbildung…",
    en: "Vacation, illness, training…",
  },
  "absence.notes": { de: "Notizen", en: "Notes" },
  "absence.notes_placeholder": {
    de: "Zusätzliche Informationen für den Vertreter…",
    en: "Additional information for the delegate…",
  },
  "absence.save": { de: "Abwesenheit speichern", en: "Save absence" },
  "absence.empty_title": { de: "Keine Abwesenheiten geplant", en: "No absences planned" },
  "absence.empty_desc": {
    de: "Planen Sie eine Abwesenheit, um Fristen automatisch weiterzuleiten.",
  ...
  "absence.err_load": { de: "Fehler beim Laden", en: "Error loading" },
  "absence.err_required": {
    de: "Bitte alle Pflichtfelder ausfüllen",
    en: "Please fill in all required fields",
  },
  "absence.created": { de: "Abwesenheit erstellt", en: "Absence created" },
  "absence.status_planned": { de: "Geplant", en: "Planned" },
  ...
  "contracts.party_two": { de: "Partei 2", en: "Party 2" },
  "contracts.select_contact": { de: "Kontakt auswählen", en: "Select contact" },
  "widget.search_placeholder": { de: "Widgets suchen…", en: "Search widgets…" },
  "widget.period_label": { de: "Zeitraum", en: "Time range" },
  "widget.period_today": { de: "Heute", en: "Today" },
  "widget.period_week": { de: "Diese Woche", en: "This week" },
  "widget.period_all": { de: "Alle", en: "All" },
  "inv.preview_title": { de: "Rechnungsvorschau", en: "Invoice preview" },
  "inv.preview_client": { de: "Kunde", en: "Client" },
  "inv.preview_positions": { de: "Positionen", en: "Line items" },
  "inv.preview_subtotal": { de: "Zwischensumme", en: "Subtotal" },
  "inv.preview_vat": { de: "USt.", en: "VAT" },
  "inv.preview_total": { de: "Gesamtbetrag", en: "Total" },
  ...
  "docusign.add_signer": { de: "Hinzufügen", en: "Add" },
  ...
  "portal.access_denied": { de: "Zugriff nicht möglich", en: "Access Denied" },
  "portal.contact_firm": {
    de: "Bei Fragen wenden Sie sich bitte an Ihre Kanzlei.",
    en: "Please contact your law firm if you have questions.",
  },
  "portal.link_expired": {
    de: "Dieser Link ist abgelaufen oder ungültig. Bitte kontaktieren Sie Ihren Anwalt.",
    en: "This link has expired or is invalid. Please contact your lawyer.",
  },
  "portal.access_forbidden": { de: "Zugriff verweigert.", en: "Access denied." },
  ...
  "portal.link_renewal_required": {
    de: "Dieser Portal-Link muss erneuert werden. Bitte kontaktieren Sie Ihre Kanzlei.",
    en: "This portal link needs to be renewed. Please contact your law firm.",
  },
  "portal.case_load_failed": {
    de: "Akte konnte nicht geladen werden.",
    en: "Case could not be loaded.",
  },
  "portal.case_not_enabled": {
    de: "Diese Akte ist derzeit nicht für das Mandantenportal freigegeben.",
    en: "This case is not currently enabled for the client portal.",
  },
  "portal.header_title": { de: "Mandanten-Portal", en: "Client Portal" },
  "portal.header_subtitle": {
    de: "Übersicht über Ihre Akte",
    en: "Overview of your case",
  },
  "portal.status.open": { de: "Offen", en: "Open" },
  "portal.status.pending": { de: "Anhängig", en: "Pending" },
  "portal.status.settled": { de: "Erledigt", en: "Settled" },
  "portal.status.won": { de: "Gewonnen", en: "Won" },
  "portal.status.lost": { de: "Verloren", en: "Lost" },
  "portal.status.appealed": { de: "Berufung", en: "Appealed" },
  "portal.status.dormant": { de: "Ruhend", en: "Dormant" },
  "portal.client_label": { de: "Mandant:", en: "Client:" },
  "portal.opponent_label": { de: "Gegner:", en: "Opponent:" },
  "portal.court_label": { de: "Gericht:", en: "Court:" },
  "portal.facts_title": { de: "Sachverhalt", en: "Facts" },
  ...
  "portal.uploading": { de: "Lädt…", en: "Uploading…" },
  "portal.documents_title": { de: "Dokumente", en: "Documents" },
  "portal.document_default": { de: "Dokument", en: "Document" },
  "portal.download": { de: "Herunterladen →", en: "Download →" },
  "portal.doc_password_label": {
    de: "Dokumentkennwort (nur falls geschützt)",
    en: "Document password (only if protected)",
  },
  "portal.doc_password_placeholder": {
    de: "Wird nicht gespeichert",
    en: "Will not be stored",
  },
  "portal.no_documents": {
    de: "Noch keine Dokumente hinterlegt.",
  ...
  "portal.upload_success": {
    ...
    en: "Document uploaded and submitted to the case.",
  },
  "portal.messages_title": {
    de: "Nachrichten an Ihre Kanzlei",
    en: "Messages to your law firm",
  },
  "portal.no_messages": {
    de: "Noch keine Nachrichten. Schreiben Sie Ihrer Kanzlei unten.",
    en: "No messages yet. Write to your law firm below.",
  },
  "portal.message_placeholder": {
    de: "Nachricht an Ihre Kanzlei…",
    en: "Message to your law firm…",
  },
  ...
  "portal.chat_empty": {
    ...
    en: "Ask a question about your case…",
  },
  "portal.chat_placeholder": {
    de: "Frage eingeben…",
  ...
  "portal.footer": {
    ...
    en: "This view is for you only. Please do not share the link.",
  },
  "portal.lang_toggle": { de: "EN", en: "DE" },
  ...
  "claim.active_cases": { de: "Aktive Fälle", en: "Active Cases" },
  "claim.paid": { de: "Bezahlt", en: "Paid" },
  "claim.create_title": { de: "Neue Forderung anlegen", en: "Create New Claim" },
  "claim.case_slug": { de: "Akten-Slug", en: "Case Slug" },
  "claim.claim_number": { de: "Forderungsnummer", en: "Claim Number" },
  "claim.claimant": { de: "Gläubiger", en: "Claimant" },
  "claim.debtor": { de: "Schuldner", en: "Debtor" },
  "claim.debtor_address": { de: "Schuldner-Adresse", en: "Debtor Address" },
  "claim.principal": { de: "Hauptforderung (€)", en: "Principal (€)" },
  "claim.interest": { de: "Zinsen (€)", en: "Interest (€)" },
  "claim.costs": { de: "Kosten (€)", en: "Costs (€)" },
  "claim.interest_from": { de: "Zinslauf ab", en: "Interest From" },
  "claim.due_date": { de: "Fälligkeit", en: "Due Date" },
  "claim.court": { de: "Gericht", en: "Court" },
  "claim.create_btn": { de: "Anlegen", en: "Create" },
  ...
  "claim.empty": { de: "Noch keine Forderungen erfasst.", en: "No claims recorded yet." },
  "claim.total_claim": { de: "von", en: "of" },
  "claim.principal_label": { de: "Haupt", en: "Principal" },
  "claim.interest_label": { de: "Zinsen", en: "Interest" },
  "claim.costs_label": { de: "Kosten", en: "Costs" },
  "claim.paid_label": { de: "Bezahlt", en: "Paid" },
  "claim.record_payment": { de: "Zahlung verbuchen", en: "Record Payment" },
  "claim.err_load": { de: "Fehler beim Laden", en: "Failed to load" },
  ...
  "fee.new": { de: "Neue Vereinbarung", en: "New Agreement" },
  "fee.create_title": { de: "Neue Honorarvereinbarung", en: "New Fee Agreement" },
  "fee.model": { de: "Modell", en: "Model" },
  ...
  "fee.empty": { de: "Noch keine Honorarvereinbarungen vorhanden.", en: "No fee agreements yet." },
  "fee.utilization": { de: "Budget-Auslastung", en: "Budget Utilization" },
  "fee.err_load": { de: "Fehler beim Laden", en: "Failed to load" },
  "fee.err_create": { de: "Erstellung fehlgeschlagen", en: "Creation failed" },
  "fee.ok_create": { de: "Vereinbarung erstellt", en: "Agreement created" },
  "fee.err_slug": { de: "Akten-Slug erforderlich", en: "Case slug required" },
  ...
  "redteam.new": { de: "Neue Analyse", en: "New Analysis" },
  "redteam.case_slug": { de: "Akten-Slug", en: "Case Slug" },
  "redteam.legal_area": { de: "Rechtsgebiet", en: "Practice Area" },
  "redteam.context": { de: "Fallkontext", en: "Case Context" },
  "redteam.draft": { de: "Entwurf-Text", en: "Draft Text" },
  "redteam.submit": { de: "Analyse starten", en: "Start Analysis" },
  "redteam.analyzing": { de: "Analysiere...", en: "Analyzing..." },
  "redteam.empty": {
    de: "Noch keine Red-Team-Analysen vorhanden.",
    en: "No red-team analyses yet.",
  },
  "redteam.risk": { de: "Risiko", en: "Risk" },
  "redteam.err_load": { de: "Fehler beim Laden", en: "Failed to load" },
  "redteam.err_required": {
    de: "Bitte alle Pflichtfelder ausfüllen",
    en: "Please fill all required fields",
  },
  "redteam.err_analyze": { de: "Analyse fehlgeschlagen", en: "Analysis failed" },
  "redteam.ok_analyze": { de: "Red-Team-Analyse erstellt", en: "Red-team analysis created" },

  "court_an.title": { de: "Entscheider-Analytics", en: "Court Analytics" },
  "court_an.description": {
    de: "Gerichtsentscheidungen aggregiert — Verfahrensdauer, Erfolgsquoten, Zitierhäufigkeit",
    en: "Court decisions aggregated — duration, success rates, citation frequency",
  },
  "court_an.empty": {
    de: "Keine Analytics-Daten verfügbar. Urteile-Sync zuerst ausführen.",
    en: "No analytics data available. Run judgements sync first.",
  },
  "court_an.decisions": { de: "Entscheidungen", en: "Decisions" },
  "court_an.duration": { de: "Ø Verfahrensdauer", en: "Avg Duration" },
  "court_an.plaintiff_wins": { de: "Klägererfolge", en: "Plaintiff Wins" },
  "court_an.defendant_wins": { de: "Beklagtenerfolge", en: "Defendant Wins" },
  "court_an.citations": { de: "Zitierhäufigkeit", en: "Citation Frequency" },
  "court_an.top_areas": { de: "Top Rechtsgebiete", en: "Top Practice Areas" },
  "court_an.err_load": { de: "Fehler beim Laden", en: "Failed to load" },

  "interview.title": { de: "Dokumenten-Interviews", en: "Document Interviews" },
  "interview.description": {
    de: "Geführte Mandantenfragebögen für automatisches Document Assembly",
    en: "Guided client questionnaires for automated document assembly",
  },
  "interview.new": { de: "Neues Interview", en: "New Interview" },
  "interview.create_title": { de: "Neues Interview erstellen", en: "Create New Interview" },
  "interview.title_label": { de: "Titel", en: "Title" },
  "interview.template_slug": { de: "Template-Slug", en: "Template Slug" },
  "interview.description_label": { de: "Beschreibung", en: "Description" },
  "interview.output_format": { de: "Ausgabeformat", en: "Output Format" },
  "interview.save": { de: "Speichern", en: "Save" },
  "interview.cancel": { de: "Abbrechen", en: "Cancel" },
  "interview.empty": { de: "Noch keine Interviews definiert.", en: "No interviews defined yet." },
  ...
  "interview.ok_create": { de: "Interview erstellt", en: "Interview created" },

  "booking.title": { de: "Online-Terminbuchung", en: "Online Booking" },
  "booking.description": {
    de: "Verfügbare Beratungsslots verwalten — Mandanten buchen selbstständig",
    en: "Manage available consultation slots — clients book independently",
  },
  "booking.config": { de: "Slot-Konfiguration", en: "Slot Configuration" },
  "booking.date": { de: "Datum", en: "Date" },
  "booking.from": { de: "Von", en: "From" },
  "booking.to": { de: "Bis", en: "To" },
  "booking.duration": { de: "Slot-Dauer (Min)", en: "Slot Duration (min)" },
  "booking.empty": { de: "Keine Slots verfügbar.", en: "No slots available." },
  "booking.booked": { de: "Belegt", en: "Booked" },
  "booking.free": { de: "Frei", en: "Free" },
  ...
  "dictation.new": { de: "Diktat", en: "Dictation" },
  "dictation.create_title": { de: "Neues Diktat", en: "New Dictation" },
  "dictation.lawyer": { de: "Anwalt", en: "Lawyer" },
  "dictation.email": { de: "E-Mail", en: "Email" },
  "dictation.case": { de: "Akte", en: "Case" },
  "dictation.duration_sec": { de: "Dauer (Sekunden)", en: "Duration (seconds)" },
  "dictation.save": { de: "Speichern", en: "Save" },
  "dictation.empty": { de: "Keine Diktate", en: "No dictations" },
  "dictation.empty_hint": {
    de: "Erfassen Sie Diktate für Transkription und Ablage.",
    en: "Record dictations for transcription and filing.",
  },
  "dictation.pending": {
    de: "Diktat(e) warten auf Korrektur.",
    en: "dictation(s) awaiting correction.",
  },
  "dictation.err_load": { de: "Fehler beim Laden", en: "Failed to load" },
  ...
  "kyc.err_load": { de: "Fehler beim Laden", en: "Failed to load" },

  "fao.title": { de: "FAO-Tracking", en: "FAO Tracking" },
  "fao.description": {
    de: "Fortbildungsstunden und Nachweise pro Fachanwaltstitel",
    en: "Continuing education hours and evidence per specialist title",
  },
  "fao.err_load": { de: "Fehler beim Laden", en: "Failed to load" },
  "fao.err_save": { de: "Fehler beim Speichern", en: "Failed to save" },
  "fao.missing_fields": { de: "Pflichtfelder fehlen", en: "Required fields missing" },
  "fao.created": { de: "Fortbildung erfasst", en: "Education entry created" },
  "fao.add": { de: "Fortbildung", en: "Add Education" },
  "fao.create_title": { de: "Fortbildung erfassen", en: "Add Education Entry" },
  "fao.save": { de: "Speichern", en: "Save" },
  "fao.lawyer": { de: "Anwalt", en: "Lawyer" },
  "fao.email": { de: "E-Mail", en: "Email" },
  "fao.specialist_title": { de: "Fachanwaltsbezeichnung", en: "Specialist Title" },
  "fao.specialist_placeholder": {
    de: "Fachanwalt für Familienrecht",
    en: "Specialist Lawyer for Family Law",
  },
  "fao.date": { de: "Datum", en: "Date" },
  "fao.hours": { de: "Stunden", en: "Hours" },
  "fao.provider": { de: "Veranstalter", en: "Provider" },
  "fao.topic": { de: "Thema", en: "Topic" },
  "fao.year_progress": { de: "Stunden", en: "hours" },
  "fao.fulfilled": { de: "Erfüllt", en: "Fulfilled" },
  "fao.hours_open": { de: "h offen", en: "h remaining" },
  "fao.empty_title": { de: "Keine Fortbildungen erfasst", en: "No education entries recorded" },
  "fao.empty_desc": {
    de: "Erfassen Sie Fortbildungen für das § 15 FAO-Tracking.",
    en: "Record continuing education for § 15 FAO tracking.",
  },
  "fao.verified": { de: "Verifiziert", en: "Verified" },
  "fao.rejected": { de: "Abgelehnt", en: "Rejected" },
  "fao.pending": { de: "Ausstehend", en: "Pending" },
  "fao.export_pdf": { de: "PDF exportieren", en: "Export PDF" },
  "fao.warning_title": {
    de: "Fortbildungsstunden drohen zu unterschreiten",
    en: "Continuing education hours at risk",
  },
  "fao.warning_desc": {
    de: "Sie haben noch {remaining} Stunden offen. Die Frist endet am 31. Dezember.",
    en: "You still have {remaining} hours remaining. The deadline ends December 31st.",
  },
  "fao.section_fao": {
    de: "§ 15 FAO — {hours} Stunden pro Jahr und Fachanwaltsbezeichnung",
    en: "§ 15 FAO — {hours} hours per year and specialist title",
  },

  "poa.title": { de: "Vollmachten", en: "Powers of Attorney" },
  "poa.description": {
    de: "Geltung und Ablauf von Vollmachten verwalten",
  ...
  "comments.title": { de: "Kommentierungen", en: "Commentaries" },
  "comments.description": {
    de: "Anmerkungen und Erläuterungen zu Normen und Urteilen",
    en: "Annotations and commentary on statutes and case law",
  },
  "comments.err_load": { de: "Fehler beim Laden", en: "Failed to load" },

  "judgements_db.title": { de: "Urteils-Datenbank", en: "Judgements Database" },
  "judgements_db.description": {
    de: "Volltext-Suche und Filterung in der Judikatur-Datenbank",
    en: "Full-text search and filtering in the case law database",
  },
  "judgements_db.err_load": { de: "Fehler beim Laden", en: "Failed to load" },

  "shared.title": { de: "Geteilte Bereiche", en: "Shared Spaces" },
  "shared.description": {
    de: "Gemeinsame Arbeitsbereiche für Teams und Mandanten",
  ...
  "shared.title_placeholder": {
    ...
    en: "e.g. Cooperation Müller & Partner",
  },
  "shared.label_desc": { de: "Beschreibung (optional)", en: "Description (optional)" },
  "shared.desc_placeholder": {
    de: "Kurze Beschreibung des Zwecks dieses Spaces",
    en: "Brief description of this space's purpose",
  },
  "shared.cancel": { de: "Abbrechen", en: "Cancel" },
  "shared.create": { de: "Erstellen", en: "Create" },
  "shared.creating": { de: "Wird erstellt…", en: "Creating…" },

  "deep_analysis.title": { de: "Tiefenanalyse", en: "Deep Analysis" },
  "deep_analysis.description": {
    de: "Detaillierte KI-Analyse von Dokumenten und Sachverhalten",
    en: "Detailed AI analysis of documents and facts",
  },
  "deep_analysis.err_load": { de: "Fehler beim Laden", en: "Failed to load" },

  "autonomous.title": { de: "Autopilot", en: "Autopilot" },
  "autonomous.description": {
    de: "Autonome KI-Aufgaben mit Budget-Cap und Approval-Gating",
    en: "Autonomous AI tasks with budget cap and approval gating",
  },
  ...
  "chat_page.err_load": { de: "Fehler beim Laden", en: "Failed to load" },
  ...
  "monitoring_engine.err_load": { de: "Fehler beim Laden", en: "Failed to load" },

  "rs_analytics.title": { de: "Rechtsprechungs-Analytics", en: "Case Law Analytics" },
  "rs_analytics.description": {
    de: "Statistische Analyse der Rechtsprechung",
    en: "Statistical analysis of case law",
  },
  "rs_analytics.err_load": { de: "Fehler beim Laden", en: "Failed to load" },
  ...
  "kanzlei_tools.title": { de: "Kanzlei-Werkzeuge", en: "Firm Tools" },
  "kanzlei_tools.description": {
    de: "Fachrechner, Register, Integrationen und Compliance an einem Ort",
    en: "Calculators, registers, integrations and compliance in one place",
  },
  ...
  "practice.followup.description": {
    de: "Interne Erinnerung ohne gesetzliche Frist anlegen.",
    en: "Create an internal reminder without a statutory deadline.",
  },
  "practice.followup.page_description": {
    de: "Interne Erinnerungen getrennt von gesetzlichen Fristen verwalten.",
    en: "Manage internal reminders separately from statutory deadlines.",
  },
  "practice.followup.label": { de: "Beschreibung", en: "Description" },
  "practice.followup.created": { de: "Wiedervorlage erstellt", en: "Follow-up created" },
  "practice.followup.empty": { de: "Keine Wiedervorlagen vorhanden", en: "No follow-ups yet" },
  "practice.followup.complete": { de: "Als erledigt markieren", en: "Mark as completed" },
  "practice.followup.reopen": { de: "Wieder öffnen", en: "Reopen" },
  "practice.phone.title": { de: "Telefon-Notiz", en: "Phone note" },
  "practice.phone.description": {
    de: "Gespräch, Ergebnis und Folgeaktion strukturiert dokumentieren.",
    en: "Document the call, outcome and follow-up action.",
  },
  "practice.phone.caller": { de: "Anrufer", en: "Caller" },
  "practice.phone.subject": { de: "Betreff", en: "Subject" },
  "practice.phone.notes": { de: "Notizen", en: "Notes" },
  "practice.phone.results": { de: "Ergebnisse", en: "Outcomes" },
  ...
  "today.appointments": { de: "Termine", en: "Appointments" },
  "today.empty": { de: "Heute nichts offen", en: "Nothing due today" },
  "today.error": {
  ...
  "weekly.deadlines": { de: "Alle Fristen geprüft", en: "All deadlines reviewed" },
  "weekly.followups": { de: "Wiedervorlagen bearbeitet", en: "Follow-ups processed" },
  ...
  "controlling.period_month": { de: "Monat", en: "Month" },
  "controlling.period_quarter": { de: "Quartal", en: "Quarter" },
  ...
  "controlling.kpi_total_hours": { de: "Gesamtstunden", en: "Total hours" },
  "controlling.kpi_total_revenue": { de: "Gesamtumsatz", en: "Total revenue" },
  "controlling.kpi_avg_rate": { de: "Ø Stundensatz", en: "Avg hourly rate" },
  "controlling.col_lawyer": { de: "Anwalt", en: "Lawyer" },
  "controlling.col_cases": { de: "Akten", en: "Cases" },
  "controlling.col_hours": { de: "Stunden", en: "Hours" },
  "controlling.col_billable": { de: "Abrechenbar", en: "Billable" },
  "controlling.col_utilization": { de: "Auslastung", en: "Utilization" },
  "controlling.col_revenue": { de: "Umsatz", en: "Revenue" },
  ...
  "opponents.stat_most_frequent": { de: "Häufigster Gegner", en: "Most frequent opponent" },
  "opponents.stat_total_cases": { de: "Gesamt-Akten", en: "Total cases" },
  "opponents.stat_wins": { de: "Gewonnen", en: "Won" },
  "opponents.retry": { de: "Erneut versuchen", en: "Try again" },
  "opponents.search_placeholder": { de: "Gegner suchen…", en: "Search opponents…" },
  "opponents.search_aria": { de: "Gegner suchen", en: "Search opponents" },
  "opponents.search_clear": { de: "Suche löschen", en: "Clear search" },
  "opponents.empty_title": {
    de: "Noch keine Gegner in den Akten erfasst.",
  ...
  "opponents.cases_count": { de: "Akten", en: "Cases" },
  "opponents.win_rate": { de: "Siegquote", en: "Win rate" },
  "opponents.lost": { de: "Verloren", en: "Lost" },
  "opponents.settled": { de: "Erledigt", en: "Settled" },
  "opponents.legal_areas": { de: "Rechtsgebiete", en: "Legal areas" },
  "opponents.case_list": { de: "Akten", en: "Cases" },

  // ── Common shared strings ──
  "common.optional": { de: "optional", en: "optional" },

  // ── Time tracking page strings ──
  "time.cancel": { de: "Abbrechen", en: "Cancel" },
  "time.save": { de: "Speichern", en: "Save" },
  "time.saving": { de: "Speichern...", en: "Saving..." },
  "time.delete": { de: "Löschen", en: "Delete" },
  "time.deleting": { de: "Löschen...", en: "Deleting..." },
  "time.delete_title": { de: "Zeiteintrag löschen", en: "Delete time entry" },
  "time.delete_confirm": {
    de: "Möchten Sie den Eintrag wirklich löschen? Diese Aktion kann nicht rückgängig gemacht werden.",
    en: "Do you really want to delete this entry? This action cannot be undone.",
  },
  "time.edit_title": { de: "Zeiteintrag bearbeiten", en: "Edit time entry" },
  "time.billable": { de: "Abrechenbar", en: "Billable" },
  "time.yes": { de: "Ja", en: "Yes" },
  "time.no": { de: "Nein", en: "No" },

  // ── Memory settings page strings ──
  "memory.err_load": { de: "Fehler beim Laden", en: "Failed to load" },
  "memory.err_search": { de: "Suche fehlgeschlagen", en: "Search failed" },
  "memory.pinned": { de: "Angepinnt", en: "Pinned" },
  "memory.unpinned": { de: "Losgelöst", en: "Unpinned" },
  "memory.err_pin": { de: "Fehler", en: "Error" },
  "memory.deleted": { de: "Gelöscht", en: "Deleted" },
  "memory.err_delete": { de: "Fehler beim Löschen", en: "Failed to delete" },
  "memory.saved": { de: "Erinnerung gespeichert", en: "Memory saved" },
  "memory.err_save": { de: "Fehler beim Speichern", en: "Failed to save" },
  ...
  "memory.type_fact": { de: "Fakt", en: "Fact" },
  "memory.type_topic": { de: "Thema", en: "Topic" },
  ...
  "memory.key_label": { de: "Schlüssel", en: "Key" },
  "memory.key_placeholder": { de: "z.B. antwortstil", en: "e.g. response_style" },
  "memory.value_label": { de: "Wert", en: "Value" },
  "memory.value_placeholder": { de: "z.B. Immer kurze Antworten", en: "e.g. Always short answers" },
  "memory.save_btn": { de: "Speichern", en: "Save" },
  "memory.new_btn": { de: "Neue Erinnerung", en: "New memory" },
  ...
  // ── Webhooks settings page strings ──
  "webhooks.title": { de: "Webhooks", en: "Webhooks" },
  "webhooks.new": { de: "Neuer Webhook", en: "New webhook" },
  "webhooks.register_title": { de: "Webhook registrieren", en: "Register webhook" },
  "webhooks.err_load": { de: "Fehler beim Laden", en: "Failed to load" },
  "webhooks.err_save": { de: "Fehler beim Speichern", en: "Failed to save" },
  "webhooks.err_delete": { de: "Fehler beim Löschen", en: "Failed to delete" },
  "webhooks.err_required": {
    de: "URL, Events und Secret erforderlich",
    en: "URL, events and secret required",
  },
  "webhooks.saved": { de: "Webhook registriert", en: "Webhook registered" },
  "webhooks.deleted": { de: "Webhook gelöscht", en: "Webhook deleted" },
  "webhooks.save": { de: "Speichern", en: "Save" },
  "webhooks.cancel": { de: "Abbrechen", en: "Cancel" },
  "webhooks.url_label": { de: "URL *", en: "URL *" },
  "webhooks.events_label": { de: "Events *", en: "Events *" },
  "webhooks.secret_label": { de: "Secret *", en: "Secret *" },
  "webhooks.secret_placeholder": {
    de: "Webhook-Secret (min. 16 Zeichen)",
    en: "Webhook secret (min. 16 characters)",
  },
  "webhooks.desc_label": { de: "Beschreibung", en: "Description" },
  "webhooks.desc_placeholder": { de: "Optional", en: "Optional" },
  "webhooks.empty": { de: "Keine Webhooks registriert.", en: "No webhooks registered." },
  ...
  "ethical_wall.user_placeholder": {
    de: "E-Mail oder User-ID eingeben…",
    en: "Enter email or user ID…",
  },
  "ethical_wall.add": { de: "Hinzufügen", en: "Add" },
  "ethical_wall.empty": { de: "Keine blockierten Benutzer.", en: "No blocked users." },
  "ethical_wall.changes": { de: "Änderungen", en: "Changes" },

  // ── Notifications page strings ──
  "notifications.title": { de: "Benachrichtigungen", en: "Notifications" },
  "notifications.desc": {
    de: "Alle Ihre Benachrichtigungen an einem Ort",
    en: "All your notifications in one place",
  },
  "notifications.mark_all_read": { de: "Alle gelesen", en: "Mark all read" },
  "notifications.delete_read": { de: "Gelesene löschen", en: "Delete read" },
  "notifications.all_marked": { de: "Alle als gelesen markiert", en: "All marked as read" },
  "notifications.tab_all": { de: "Alle", en: "All" },
  "notifications.tab_unread": { de: "Ungelesen", en: "Unread" },
  "notifications.unread": { de: "Ungelesen", en: "Unread" },
  "notifications.aria_mark_read": { de: "Als gelesen markieren", en: "Mark as read" },
  "notifications.aria_delete": { de: "Löschen", en: "Delete" },
  "notifications.tab_read": { de: "Gelesen", en: "Read" },
  "notifications.total": { de: "Gesamt", en: "Total" },
  "notifications.error": { de: "Fehler", en: "Error" },
  "notifications.loading": { de: "Laden...", en: "Loading..." },
  "notifications.empty_title": { de: "Keine Benachrichtigungen", en: "No notifications" },
  "notifications.empty_unread": {
    de: "Sie haben keine ungelesenen Benachrichtigungen.",
    en: "You have no unread notifications.",
  },
  "notifications.empty_read": {
    de: "Sie haben keine gelesenen Benachrichtigungen.",
    en: "You have no read notifications.",
  },
  "notifications.empty_all": {
    de: "Es gibt keine Benachrichtigungen.",
    en: "There are no notifications.",
  },
  "notifications.search_placeholder": { de: "Suche...", en: "Search..." },
  "notifications.deleted": { de: "Benachrichtigung gelöscht", en: "Notification deleted" },
  "notifications.deleted_read": {
    de: "gelesene Benachrichtigungen gelöscht",
    en: "read notifications deleted",
  },
  "notifications.filtered": { de: "Gefiltert", en: "Filtered" },
  "notifications.filter": { de: "Filter", en: "Filter" },
  "notifications.all_types": { de: "Alle Typen", en: "All types" },

  // ── Brain detail page strings ──
  "brain.save": { de: "Speichern", en: "Save" },
  "brain.cancel": { de: "Abbrechen", en: "Cancel" },

  // ── Litigation Analytics strings ──
  "litigation.entry_created": { de: "Eintrag erstellt", en: "Entry created" },
  "litigation.entry_deleted": { de: "Eintrag gelöscht", en: "Entry deleted" },
  "litigation.create_failed": { de: "Erstellen fehlgeschlagen", en: "Failed to create" },
  ...
  "upload.original_not_saved": {
    de: "Originaldatei nicht gespeichert",
    en: "Original file not saved",
  },
  "upload.no_text_extracted": {
    de: "Kein durchsuchbarer Text extrahiert; Originaldatei wurde gespeichert.",
    en: "No searchable text extracted; original file was saved.",
  },
  "upload.partial_extraction": {
    de: "Dokument wurde nur teilweise extrahiert.",
    en: "Document was only partially extracted.",
  },
  "upload.saved_no_pipeline": {
    de: "Dokument gespeichert, automatische Analyse konnte aber nicht eingeplant werden.",
    en: "Document saved, but automatic analysis could not be scheduled.",
  },
  "upload.processing_failed": {
    de: "Dokumentverarbeitung fehlgeschlagen.",
    en: "Document processing failed.",
  },
  "upload.password_placeholder": {
    de: "Nur für passwortgeschützte PDF-/Office-Dateien",
    en: "Only for password-protected PDF/Office files",
  },
  "upload.auto_detect": { de: "Automatisch erkennen", en: "Auto-detect" },
  "upload.auto_classify": { de: "Automatisch klassifizieren", en: "Auto-classify" },
  "upload.dl_from_storage": {
    de: "Datei wird vom Storage heruntergeladen",
    en: "File downloading from storage",
  },
  "upload.verifying_checksum": { de: "Prüfsumme wird verifiziert", en: "Verifying checksum" },
  "upload.virus_scan": { de: "Virenscan wird durchgeführt", en: "Virus scan running" },
  "upload.extracting_indexing": {
    de: "Inhalt wird extrahiert und indexiert",
    en: "Content being extracted and indexed",
  },
  "upload.server_processing": {
    de: "Datei übertragen · Server prüft, speichert und indexiert",
    en: "File transferred · Server checks, stores and indexes",
  },

  // ── Version History page strings ──
  "vhist.err_load": {
    de: "Versionshistorie konnte nicht geladen werden.",
    en: "Version history could not be loaded.",
  },
  ...
  "vhist.desc": {
    de: "Änderungshistorie einer Brain-Page — Audit-Trail mit Versionierung",
  ...
  "vhist.case_create": { de: "Erstellt", en: "Created" },
  ...
  // ── Signature page strings ──
  "sig.err_load": {
    de: "Signatur-Anfragen konnten nicht geladen werden.",
    en: "Signature requests could not be loaded.",
  },
  "sig.ext_sent": {
    de: "Als extern versendet markiert. Der tatsächliche Versand erfolgt im Signatur-Provider.",
    en: "Marked as sent externally. Actual sending occurs in the signature provider.",
  },
  "sig.err_status": {
    de: "Status konnte nicht gespeichert werden.",
    en: "Status could not be saved.",
  ...
  "kanzlei.firm_name": { de: "Kanzleiname", en: "Firm name" },
  "kanzlei.street": { de: "Straße", en: "Street" },
  "kanzlei.city": { de: "Ort", en: "City" },
  "kanzlei.phone": { de: "Telefon", en: "Phone" },
  "kanzlei.website": { de: "Webseite", en: "Website" },
  "kanzlei.tax_id": { de: "Steuernummer", en: "Tax number" },
  "kanzlei.bank": { de: "Bank", en: "Bank" },
  "kanzlei.logo_url": { de: "Logo-URL (optional)", en: "Logo URL (optional)" },
  "kanzlei.region_label": { de: "Kanton", en: "Canton" },
  "kanzlei.region_label_de": { de: "Bundesland", en: "State" },

  // ── Settings page (billing/invoice) strings ──
  "settings.invoice_footer_default": {
    de: "Bitte überweisen Sie den Betrag unter Angabe der Rechnungsnummer.",
    en: "Please transfer the amount quoting the invoice number.",
  },
  "settings.firm_name_placeholder": {
    de: "Muster Rechtsanwälte Partnerschaft mbB",
    en: "Mustermann Law Firm Partnership LLC",
  },
  "settings.signatory_placeholder": {
    de: "Dr. Max Mustermann, Rechtsanwalt",
    en: "Dr. Max Mustermann, Attorney",
  },
  ...
  "settings.small_business_desc": {
    de: "Keine USt-Ausweisung auf Rechnungen — relevant für E-Rechnung",
    en: "No VAT on invoices — relevant for e-invoicing",
  },
  ...
  // ── Translate page language labels ──
  "translate.lang_de": { de: "Deutsch", en: "German" },
  "translate.lang_en": { de: "Englisch", en: "English" },
  "translate.lang_fr": { de: "Französisch", en: "French" },
  "translate.lang_it": { de: "Italienisch", en: "Italian" },
  "translate.lang_es": { de: "Spanisch", en: "Spanish" },
  "translate.lang_nl": { de: "Niederländisch", en: "Dutch" },
  "translate.lang_pl": { de: "Polnisch", en: "Polish" },
  "translate.lang_tr": { de: "Türkisch", en: "Turkish" },
  "translate.lang_ru": { de: "Russisch", en: "Russian" },
  ...
  "calexport.desc": {
    de: "Fristen & Termine als iCal (.ics)",
    en: "Deadlines & appointments as iCal (.ics)",
  },
  ...
  // ── Contracts ──
  "contracts.aria_analysis": { de: "Analyse", en: "Analysis" },
  "contracts.aria_redline": { de: "Redline", en: "Redline" },
  "contracts.ph_title": { de: "Titel", en: "Title" },
  "contracts.ph_parties": { de: "Parteien", en: "Parties" },
  "contracts.ph_type": { de: "Vertragstyp", en: "Contract type" },
  "contracts.ph_text": { de: "Vertragstext", en: "Contract text" },
  ...
  // ── Settings/SCIM ──
  "settings.scim.ph_token": {
    de: "In .env als SCIM_BEARER_TOKENS (orgId:token) konfiguriert",
    en: "Configured in .env as SCIM_BEARER_TOKENS (orgId:token)",
  },

  // ── Settings/RCIID ──
  "settings.rciid.ph_hmac": { de: "HMAC-SHA256 Secret", en: "HMAC-SHA256 Secret" },

  // ── Settings/Security ──
  "settings.security.ph_password": { de: "Passwort", en: "Password" },

  // ── Settings page extras ──
  "settings.ph_rak_register": { de: "RAK / Register", en: "Bar association / Register" },

  // ── Drafting ──
  "drafting.ph_name": { de: "Name", en: "Name" },

  // ── Absences ──
  "absence.ph_name": { de: "Max Mustermann", en: "John Doe" },
  "absence.ph_representative": { de: "Anna Schmidt", en: "Jane Smith" },

  // ── Red Team ──
  "redteam.ph_summary": { de: "Kurze Zusammenfassung des Falls...", en: "Brief case summary..." },
  "redteam.ph_pleading": { de: "Schriftsatz hier einfügen...", en: "Paste pleading here..." },

  // ── Contacts ──
  "contacts.ph_leitweg": {
    de: "Leitweg-ID für XRechnung (öffentlich-rechtlich)",
    en: "Routing ID for XRechnung (public sector)",
  },

  // ── Cases/New ──
  "cases.new.ph_opponent_name": {
    de: "Name des weiteren Gegners",
    en: "Name of additional opponent",
  },
  "cases.new.ph_liability": {
  ...
  "docreq.ph_message": { de: "Nachrichtenentwurf", en: "Message draft" },
  "docreq.ph_search": { de: "Dokumentenanfrage suchen…", en: "Search document requests…" },
  "templates.ph_desc": {
    de: "Kurze Beschreibung der Vorlage",
    en: "Brief description of the template",
  },
  "templates.ph_body": {
    de: "Vorlagen-Text mit {{variablen}}…",
    en: "Template text with {{variables}}…",
  },
  "litigation.ph_parties": { de: "Muster ./. Beispiel", en: "Mustermann v. Example" },
  "fibu.ph_search": {
    de: "Rechnungsnummer, Aktenzeichen...",
    en: "Invoice number, file reference...",
  },
  "fibu.ph_invoice": { de: "Rechnung RE-2026-001", en: "Invoice INV-2026-001" },
  "crypto.ph_case_name": { de: "Mustermann vs. Betrüger", en: "Mustermann v. Fraudster" },
  "crypto.ph_client": { de: "Mandant Mustermann", en: "Client Mustermann" },
  "crypto.ph_suspicion": {
    de: "Verdacht auf Krypto-Betrug via Phishing...",
    en: "Suspected crypto fraud via phishing...",
  },
  "crypto.ph_label": { de: "Label", en: "Label" },
  "crypto.ph_text": {
    de: "Fügen Sie hier den Text aus Fall-Dokumenten ein...",
    en: "Paste text from case documents here...",
  },
  "trust.ph_account": { de: "Anderkonto Müller", en: "Trust account Müller" },
  "trust.ph_bank": { de: "Commerzbank", en: "Commerzbank" },
  "onboarding.ph_bank": { de: "Bank Austria", en: "Bank Austria" },
  "whatsapp.tmpl.ph_body": {
...
// ── Locale replacement maps for key dashboard UI strings ───────────────────
// Non-DACH locales fall back to EN, then apply replacements for translated strings.
// Strings not in the map remain in English (acceptable for product UI).

const IT_DASH_REPLACEMENTS: Record<string, string> = {
  // Section titles
  "Firm Cockpit": "Cockpit Studio",
  "Clients & Parties": "Clienti & Parti",
  "Inbox & Deadlines": "Inbox & Scadenze",
  "Documents & Drafting": "Documenti & Redazione",
  "Research & Knowledge": "Ricerca & Conoscenza",
  "Billing & Compliance": "Fatturazione & Compliance",
  ...
  Graph: "Grafo",
  Upload: "Upload",
  "RAG Eval": "Valutazione RAG",
  "Portfolio Insights": "Portfolio Insights",
  "Deep Analysis": "Analisi Profonda",
  "Adoption Analytics": "Analytics Adozione",
  Analytics: "Analytics",
  ...
  Statutes: "Norme",
  "Judgements Sync": "Sync Sentenze",
  "Conflict Check": "Controllo Conflitti",
  "Bulk Review": "Revisione Massiva",
  "Obligation Tracking": "Tracking Obblighi",
  ...
  "Legal Sources": "Fonti Legali",
  // Nav items — drafts & billing
  Drafting: "Redazione",
  "Cost Calculator": "Calcolatore Costi",
  Invoices: "Fatture",
  "DATEV Export": "Export DATEV",
  "e-Signature": "e-Firma",
  // Nav items — data & integration
  ...
  Calendar: "Calendario",
  "Retention Rules": "Regole Conservazione",
  Anonymization: "Anonimizzazione",
  "Word Add-in": "Word Add-in",
  "Process Documentation": "Documentazione Processi",
  "Data Export": "Export Dati",
  // Nav items — industries
  ...
  // Nav items — tax
  Clients: "Clienti",
  "Tax Returns & Assessments": "Dichiarazioni & Accertamenti",
  "Tax Returns": "Dichiarazioni",
  Assessments: "Accertamenti",
  "Tax Audit": "Auditoria Fiscale",
  ...
  "Audit Log": "Log Audit",
  "API Keys": "Chiavi API",
  "Plan & Subscription": "Piano & Abbonamento",
  Mobile: "Mobile",
  Onboarding: "Onboarding",
  "Experience & Profile": "Esperienza & Profilo",
  ...
  Offline: "Offline",
  "Checking…": "Verifica…",
  "Filter navigation…": "Filtra navigazione…",
...
const ES_DASH_REPLACEMENTS: Record<string, string> = {
  "Firm Cockpit": "Cockpit del Bufete",
  "Clients & Parties": "Clientes & Partes",
  "Inbox & Deadlines": "Bandeja & Plazos",
  "Documents & Drafting": "Documentos & Redacción",
  "Research & Knowledge": "Investigación & Conocimiento",
  "Billing & Compliance": "Facturación & Compliance",
  Billing: "Facturación",
  Compliance: "Compliance",
  ...
  Statutes: "Estatutos",
  "Judgements Sync": "Sync Sentencias",
  "Conflict Check": "Control de Conflictos",
  "Bulk Review": "Revisión Masiva",
  "Obligation Tracking": "Tracking de Obligaciones",
  ...
  Calendar: "Calendario",
  "Retention Rules": "Reglas de Conservación",
  ...
  Tax: "Fiscal",
  Clients: "Clientes",
  "Tax Returns & Assessments": "Declaraciones & Liquidaciones",
  "Tax Returns": "Declaraciones",
  Assessments: "Liquidaciones",
  ...
  "API Keys": "Claves API",
  "Plan & Subscription": "Plan & Suscripción",
  Onboarding: "Onboarding",
  "Experience & Profile": "Experiencia & Perfil",
  Settings: "Ajustes",
  Firm: "Bufete",
  Security: "Seguridad",
...
const PL_DASH_REPLACEMENTS: Record<string, string> = {
  "Firm Cockpit": "Cockpit Kancelarii",
  "Clients & Parties": "Klienci & Strony",
  "Inbox & Deadlines": "Skrzynka & Terminy",
  "Documents & Drafting": "Dokumenty & Redakcja",
  "Research & Knowledge": "Badania & Wiedza",
  "Billing & Compliance": "Fakturowanie & Compliance",
  ...
  Graph: "Graf",
  Upload: "Upload",
  "RAG Eval": "Ewaluacja RAG",
  "Portfolio Insights": "Portfolio Insights",
  "Deep Analysis": "Głęboka Analiza",
  "Adoption Analytics": "Analytics Adopcji",
  Analytics: "Analytics",
  "Shared Spaces": "Współdzielone Przestrzenie",
  Cases: "Sprawy",
  Contacts: "Kontakty",
  Contracts: "Umowy",
  Documents: "Dokumenty",
  ...
  Statutes: "Ustawy",
  "Judgements Sync": "Sync Orzeczeń",
  "Conflict Check": "Sprawdzenie Konfliktów",
  "Bulk Review": "Przegląd Masowy",
  "Obligation Tracking": "Tracking Zobowiązań",
  "Case Scanner": "Skaner Spraw",
  "Clause Library": "Biblioteka Klauzul",
  Templates: "Szablony",
  Litigation: "Postępowanie",
  "Version History": "Historia Wersji",
  Monitoring: "Monitoring",
  "Legal Sources": "Źródła Prawne",
  Drafting: "Redakcja",
  "Cost Calculator": "Kalkulator Kosztów",
  Invoices: "Faktury",
  "DATEV Export": "Export DATEV",
  ...
  Intake: "Przyjęcie",
  "Document Requests": "Żądania Dokumentów",
  "Firm Import": "Import Kancelarii",
  "Email Import": "Import Email",
  Calendar: "Kalendarz",
  "Retention Rules": "Regły Retencji",
  ...
  Tax: "Podatkowe",
  Clients: "Klienci",
  "Tax Returns & Assessments": "Zeznania & Decyzje",
  "Tax Returns": "Zeznania",
  Assessments: "Decyzje",
  "Tax Audit": "Audyt Podatkowy",
  "Tax Deadlines": "Terminy Podatkowe",
  Team: "Zespół",
  Controlling: "Controlling",
  "Audit Log": "Log Audytu",
  "API Keys": "Klucze API",
  "Plan & Subscription": "Plan & Subskrypcja",
  Onboarding: "Onboarding",
  "Experience & Profile": "Doświadczenie & Profil",
  Settings: "Ustawienia",
  Firm: "Kancelaria",
  ...
  "Filter navigation…": "Filtruj nawigację…",
...
const FR_DASH_REPLACEMENTS: Record<string, string> = {
  "Firm Cockpit": "Cockpit Cabinet",
  "Clients & Parties": "Clients & Parties",
  "Inbox & Deadlines": "Boîte & Délais",
  "Documents & Drafting": "Documents & Rédaction",
  "Research & Knowledge": "Recherche & Connaissance",
  "Billing & Compliance": "Facturation & Compliance",
  Billing: "Facturation",
  Compliance: "Compliance",
  ...
  Statutes: "Statuts",
  "Judgements Sync": "Sync Jurisprudence",
  "Conflict Check": "Contrôle des Conflits",
  "Bulk Review": "Revue en Masse",
  "Obligation Tracking": "Tracking des Obligations",
  ...
  Calendar: "Calendrier",
  "Retention Rules": "Règles de Conservation",
  Anonymization: "Anonymisation",
  "Process Documentation": "Documentation des Processus",
  ...
  Tax: "Fiscal",
  Clients: "Clients",
  "Tax Returns & Assessments": "Déclarations & Avis",
  "Tax Returns": "Déclarations",
  Assessments: "Avis",
  "Tax Audit": "Audit Fiscal",
  "Tax Deadlines": "Délais Fiscaux",
  Team: "Équipe",
  Controlling: "Controlling",
  "Audit Log": "Log d'Audit",
  "API Keys": "Clés API",
  "Plan & Subscription": "Plan & Abonnement",
  Onboarding: "Onboarding",
  "Experience & Profile": "Expérience & Profil",
  Settings: "Paramètres",
  Firm: "Cabinet",
  Security: "Sécurité",
...
const NL_DASH_REPLACEMENTS: Record<string, string> = {
  "Firm Cockpit": "Kantoor-Cockpit",
  "Clients & Parties": "Cliënten & Partijen",
  "Inbox & Deadlines": "Inbox & Termijnen",
  "Documents & Drafting": "Documenten & Concepten",
  "Research & Knowledge": "Onderzoek & Kennis",
  "Billing & Compliance": "Facturering & Compliance",
  Billing: "Facturering",
  Compliance: "Compliance",
  ...
  Graph: "Graaf",
  Upload: "Upload",
  "RAG Eval": "RAG-Evaluatie",
  "Portfolio Insights": "Portfolio Insights",
  "Deep Analysis": "Diepe Analyse",
  "Adoption Analytics": "Analytics Adoptie",
  Analytics: "Analytics",
  ...
  Deadlines: "Termijnen",
  Opponents: "Tegenpartijen",
  "Client Portal": "Cliëntportaal",
  "Legal Research": "Juridisch Onderzoek",
  "Document Analysis": "Document-Analyse",
  "Precedent Search": "Precedent-Zoekfunctie",
  Translation: "Vertaling",
  "Case Law": "Jurisprudentie",
  Statutes: "Statuten",
  "Judgements Sync": "Sync Uitspraken",
  "Conflict Check": "Belangenconflict-Controle",
  "Bulk Review": "Bulk-Review",
  "Obligation Tracking": "Tracking Verplichtingen",
  "Case Scanner": "Zaak-Scanner",
  "Clause Library": "Clausule-Bibliotheek",
  Templates: "Sjablonen",
  Litigation: "Litigie",
  "Version History": "Versiegeschiedenis",
  Monitoring: "Monitoring",
  "Legal Sources": "Juridische Bronnen",
  Drafting: "Redactie",
  "Cost Calculator": "Kosten-Calculator",
  Invoices: "Facturen",
  "DATEV Export": "DATEV-Export",
  "e-Signature": "e-Handtekening",
  ...
  Tax: "Belasting",
  Clients: "Cliënten",
  "Tax Returns & Assessments": "Aangiften & Beschikkingen",
  "Tax Returns": "Aangiften",
  Assessments: "Beschikkingen",
  ...
  "Plan & Subscription": "Plan & Abonnement",
  Onboarding: "Onboarding",
  "Experience & Profile": "Ervaring & Profiel",
  ...
  "Filter navigation…": "Navigatie filteren…",
...
const _DASH_REPLACEMENTS: Partial<Record<Lang, Record<string, string>>> = {
  it: IT_DASH_REPLACEMENTS,
  es: ES_DASH_REPLACEMENTS,
  pl: PL_DASH_REPLACEMENTS,
  fr: FR_DASH_REPLACEMENTS,
  nl: NL_DASH_REPLACEMENTS,
};

export function createT(lang: Lang) {
  const replacements = _DASH_REPLACEMENTS[lang];
  return (key: DashboardKey): string => {
    const entry = D[key];
    if (!entry) return key;
    // DACH locales: use locale-specific or fall back to DE
    if (lang === "de" || lang === "at" || lang === "ch") {
      return (entry as Record<string, string>)[lang] ?? entry.de;
    }
    // EN: use EN directly
    if (lang === "en") return entry.en;
    // IT/ES/PL/FR/NL: use locale-specific if available, else EN with replacements
    const localized = (entry as Record<string, string>)[lang];
    if (localized) return localized;
    const enVal = entry.en;
    if (replacements && replacements[enVal]) return replacements[enVal];
    return enVal;
  };
}
