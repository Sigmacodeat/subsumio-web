        ...
        {items.map((item, i) => {
          ...
          return (
            <StaggerItem key={item.q}>
              <div
                className={`overflow-hidden rounded-xl border transition-[background-color,border-color,color,box-shadow,transform,opacity] duration-[var(--ds-duration-normal)] motion-reduce:transition-none ${
                  isOpen
