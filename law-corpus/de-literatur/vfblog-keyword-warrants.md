---
title: Verfassungsblog — ‘Keyword Warrants’ Make Every Search A Risk
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/keyword-warrants/
license: >-
...
Sadly, the pushback is piecemeal. For example, the legislation on geofence warrants wouldn’t apply to keyword warrants like those used in the R. Kelly case. The reason why: we didn’t know this type of search was taking place. In this way, we see the constant constitutional catch up for those pushing back against new search tools in the United States. In the absence of a more fundamental shift in Constitutional jurisprudence or unpresented privacy legislation, police will continue to have a free hand to concoct ever more invasive ways to harvest our digital data, operating with a free hand as lawmakers and the public struggle to keep up.
