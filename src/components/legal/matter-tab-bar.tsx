    ...
    <div className="sticky top-[var(--matter-header-height,0px)] z-20 flex items-center gap-1 border-b border-[color:var(--ds-border)] bg-[color:var(--ds-surface)] px-2 py-1.5 md:px-4">
      ...
      <div className="relative ml-auto" ref={moreRef}>
        <button
          ...
          className={cn(
            "flex items-center gap-1.5 rounded-lg px-2.5 py-1.5 text-xs font-medium transition-[background-color,border-color,color] focus-visible:ring-2 focus-visible:ring-[color:var(--brand-primary)] focus-visible:outline-none active:scale-[0.99] motion-reduce:transition-none md:text-sm",
