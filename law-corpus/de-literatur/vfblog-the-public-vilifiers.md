---
title: Verfassungsblog — The Public Vilifiers
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/the-public-vilifiers/
license: >-
  CC BY-SA 4.0 (Standard-Lizenz des Verfassungsblogs; einzelne Beiträge können
  abweichen). Namensnennung + Share-Alike erforderlich.
content_hash: "7f7c7ef884c14022"
---
...
Zur Verstärkung des wissenschaftlichen Personals des Instituts für die Transformation des Energiesystems suchen wir zum nächstmöglichen Zeitpunkt, befristet bis zum 31.07.2025, eine/n

Wissenschaftliche/-r Mitarbeiter/-in

für den Bereich Energiewenderecht (m/w/d)

(Vergütung bis zu TV-L E13 / Vollzeit, Teilzeit möglich)

Im Rahmen des vom BMWK geförderten Reallabors Westküste100 beschäftigen Sie sich mit der Weiterentwicklung des Wasserstoffwirtschaftsrechts. Details zu Aufgaben, Anforderungen und Bewerbung (bis zum 18.12.2023) finden Sie hier.

++++++++++++++++++++++++

The regulation of artificial intelligence in Europe through the AI Act is about to cross the finish line, but Germany, France and Italy, in line with BigTech interest, are pushing to water it down. JASCHA BAREIS describes what is at stake. MAXIMILIAN WAGNER explains why committing BigTech to material values instead of regulating it is not a solution.
