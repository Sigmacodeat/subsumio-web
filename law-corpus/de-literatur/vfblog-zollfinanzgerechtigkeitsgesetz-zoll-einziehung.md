---
title: Verfassungsblog — Mut ohne Konsequenz
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/zollfinanzgerechtigkeitsgesetz-zoll-einziehung/
license: >-
...
- Bannung der (Anscheins-)Gefahr: Die Aufklärung der Legalherkunft gelingt, der Betroffene erhält Sichergestelltes zurück.

- Selbstanzeige: Der Betroffene räumt (ohne weitere Angaben) die Unklarheit (!) der Herkunft ein und der Vermögenswert fällt ins Eigentum des Bundes. Als Anreiz sieht der Entwurf ein straf- und ordnungswidrigkeitenrechtliches Verwertungsverbot sowie die Möglichkeit einer behördlichen Zusage vor, auf weitere Sachverhaltsermittlung zu verzichten.

- Gerichtliches Verfahren: Bleibt die Herkunft auch nach Verfahrensdurchführung unklar, beantragt der Zoll gerichtliche Einziehung. Nach § 52j Abs. 1 ZollKrimBG-E ordnet das Verwaltungsgericht die Einziehung an, wenn es „der freien Überzeugung ist, dass der Vermögensgegenstand nicht rechtmäßiger Herkunft ist“; anderenfalls wird die Sache zurückgegeben.

- Übergang ins Strafverfahren: Das aVES ist subsidiär. Ergibt sich im Verfahrensverlauf der Anfangsverdacht einer Straftat (namentlich Geldwäsche), findet ein Strafverfahren statt, das die aVES-Fortführung sperrt.
