      ...
      >
        ...
        <div className="flex items-center gap-2 border-t border-amber-200/50 px-3 py-2 dark:border-amber-900/50">
          <button
            ...
            className="flex items-center gap-1 rounded-md bg-amber-600 px-2.5 py-1 text-xs font-medium text-white transition-[background-color,border-color,color] hover:bg-amber-700 focus-visible:ring-2 focus-visible:ring-amber-500 focus-visible:outline-none motion-reduce:transition-none"
          >
            <Check size={12} />
            {t("chat.tool.confirm")}
          </button>
          <button
            ...
            className="flex items-center gap-1 rounded-md px-2.5 py-1 text-xs font-medium text-amber-700 transition-[background-color,border-color,color] hover:bg-amber-100 focus-visible:ring-2 focus-visible:ring-amber-500 focus-visible:outline-none motion-reduce:transition-none dark:text-amber-300 dark:hover:bg-amber-900/30"
          >
            <X size={12} />
            {t("chat.tool.cancel")}
          </button>
      ...
      >
        ...
        {onRetry && (
          <button
            ...
            className="flex items-center gap-1 rounded-md bg-red-600 px-2 py-0.5 text-xs font-medium text-white transition-[background-color,border-color,color] hover:bg-red-700 focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:outline-none motion-reduce:transition-none"
          >
            <RotateCw size={11} />
            {t("chat.tool.retry")}
          </button>
  ...
  return (
    <div className="overflow-hidden rounded-lg border border-[color:var(--ds-border)] bg-[color:var(--ds-surface-2)]">
          ...
          {(display.items! as Array<{ label: string; value?: string; href?: string }>).map(
            (item, idx) => (
              <button
                ...
                disabled={!item.href}
                className={cn(
                  "flex w-full items-center gap-2 px-3 py-1.5 text-left transition-[background-color,border-color,color] motion-reduce:transition-none",
      ...
      {display.kind === "navigation" && display.href && !hasItems && (
        <button
          onClick={() => onNavigate(display.href)}
          className="flex w-full items-center justify-between px-3 py-2 text-xs font-medium text-[color:var(--brand-primary)] transition-[background-color,border-color,color] hover:bg-[color:var(--ds-hover)] motion-reduce:transition-none"
        >
    ...
    >
      <div className="flex items-start gap-2.5">
        ...
        {item.href && (
          <button
            onClick={() => onNavigate(item.href)}
            className="inline-flex shrink-0 items-center gap-1 rounded-md border border-[color:var(--ds-border)] bg-[color:var(--ds-surface)] px-2 py-1 text-[10px] font-medium text-[color:var(--brand-primary)] transition-[background-color,border-color,color] hover:bg-[color:var(--ds-hover)] motion-reduce:transition-none"
          >
      ...
      <div className="flex items-start gap-2">
        ...
        <div className="flex shrink-0 flex-col gap-1">
          ...
          {item.href && (
            <button
              onClick={() => onNavigate(item.href)}
              className="inline-flex items-center gap-1 rounded-md border border-[color:var(--ds-border)] bg-[color:var(--ds-surface)] px-2 py-1 text-[10px] font-medium text-[color:var(--brand-primary)] transition-[background-color,border-color,color] hover:bg-[color:var(--ds-hover)] motion-reduce:transition-none"
            >
              <ExternalLink size={10} />
