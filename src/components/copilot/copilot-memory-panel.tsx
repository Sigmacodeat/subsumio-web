    ...
    <div className="space-y-2">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-1 rounded-md px-1.5 py-0.5 text-[10px] text-[color:var(--ds-text-muted)] transition-[background-color,border-color,color] hover:text-[color:var(--ds-text)] active:scale-[0.99] motion-reduce:transition-none"
          ...
          {memories.map((m) => {
            ...
            return (
              <div
                key={m.id}
                className={cn(
                  "group rounded-lg border p-2 transition-[background-color,border-color,color] motion-reduce:transition-none",
                  m.pinned
