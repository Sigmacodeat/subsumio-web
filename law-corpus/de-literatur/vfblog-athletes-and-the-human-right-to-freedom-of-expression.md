---
title: Verfassungsblog — Athletes and the Human Right to Freedom of Expression
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: >-
  https://verfassungsblog.de/athletes-and-the-human-right-to-freedom-of-expression/
license: >-
...
## The Horizontal Applicatio

## 

## n of Human Rights to Private Entities

Only States are parties to human rights treaties and can be directly held accountable for a violation of human rights in an international court. This, however, does not mean that human rights evaporate in relations between private individuals. Private parties can be held accountable for human rights violations in front of domestic courts that are the primary arms for the enforcement of IHRL. If national courts fail to remedy the violations, the State could be internationally responsible (ILC Articles on State Responsibility, art. 8 and commentaries).
...
Yet, I do believe that the complexity of sports itself as a social phenomenon and sensitivities in and around it might justify a narrower interpretation of FoE in sports in comparison with other areas. Therefore, a revised version of Rule 50 that rectifies the weaknesses discussed in this article and still defines a narrower scope for FoE in sports in comparison with other public or private areas might have a chance of surviving a legal challenge.
