    ...
    <div className="mx-0 w-full space-y-6 p-4 md:p-6 lg:p-8">
      ...
      <div className="grid gap-4 md:grid-cols-4">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <FileBox className="h-4 w-4 text-[color:var(--ds-text-muted)]" />
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <HardDrive className="h-4 w-4 text-[color:var(--ds-text-muted)]" />
          </CardHeader>
          <CardContent>
      ...
      <Card>
        ...
        <CardContent className="p-0">
          {isLoading ? (
            <div className="p-8 text-center text-[color:var(--ds-text-muted)]">Laden...</div>
          ) : backups.length > 0 ? (
