      ...
      {nativeFeatures.pushNotification && (
        ...
        >
          ...
          <button
            ...
            className="shrink-0 rounded-md p-0.5 text-[color:var(--ds-text-subtle)] transition-[color,transform] duration-[var(--ds-duration-fast)] hover:text-[color:var(--ds-text)] focus-visible:ring-2 focus-visible:ring-[color:var(--brand-primary)] focus-visible:outline-none active:scale-[0.97] motion-reduce:transition-none"
