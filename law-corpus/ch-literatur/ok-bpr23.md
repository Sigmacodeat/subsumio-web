---
title: Onlinekommentar — Art. 23 BPR
type: literatur
genre: kommentar
jurisdiction: ch
...
authors:
  - Stefan Wyler
citation: >-
  Stefan Wyler, Kommentierung zu Art. 23 BPR, in: Andreas Glaser/Nadja Braun
...
source_url: https://onlinekommentar.ch/de/kommentare/bpr23
license: >-
...
1 Der erste Satz der Bestimmung über die Bezeichnung der Wahlvorschläge wurde redaktionell nur leicht verändert aus dem Bundesgesetz über die Wahl des Nationalrates von 1919 übernommen.BBl 1919 I S. 262. In der Revision des BPR von 2002 wurde Artikel 23 BPR ergänzt mit der Regelung, wonach eine Gruppierung mit mehreren verbundenen Wahlvorschlägen eine Stammliste bezeichnen muss.AS 2002 3193; BBl 2001 S. 6401. 
...
3 Die Kantone kennen in ihrem Parlamentswahlrecht identische oder vergleichbare Vorschriften betreffend die Bezeichnung der Wahlvorschläge.Als Beispiele für viele § 89 Abs. 3 Gesetz des Kantons Zürich vom 1.9.2003 über die politischen Rechte (GPR/ZH, SG 161); Art. 65 Abs. 1 Gesetz des Kantons Bern vom 5.6.2012 über die politischen Rechte (PRG/BE, SG 141.1); Art. 33 Abs. 1 Gesetz des Kantons St. Gallen vom 5.12.2018 über Wahlen und Abstimmungen (WAG/SG, SG 125.3); § 4 Abs. 3 Gesetz des Kantons Aargau vom 8.3.1988 über die Wahl des Grossen Rates (Grossratswahlgesetz/AG, SG 152.100); Art. 60 Abs. 2 Loi du canton de Vaud du 5.10.2021 sur l’exercice des droits politiques (LEDP/VD, SG 160.01). Kantone, die Listenverbindungen zulassen, kennen für Gruppierungen, die mehrere Wahlvorschläge einreichen, ähnliche Vorschriften bezüglich der Bezeichnung von Stammlisten.Beispielsweise Art. 65 Abs. 2 und 3 PRG/BE, Art. 43 Abs. 1 WAG/SG. 

## III. Bezeichnung des Wahlvorschlags

4 Jeder Wahlvorschlag muss eine Bezeichnung tragen, die ihn von allen anderen Wahlvorschlägen klar unterscheidet. Diese dient insbesondere der Information der Wahlberechtigten. Die Wahlberechtigten müssen wissen, welche Liste sie vor sich haben. Regelmässig verlangen die Wahlbehörden neben dem kompletten Namen des Wahlvorschlags auch ein Kürzel bzw. eine Kurzbezeichnung.Z. B. Regierungsratsbeschluss BE NRW 2023, Ziffer 2.1.1 (Das Listenkürzel darf – inklusive Leerschläge – maximal 10 Zeichen aufweisen.), Anleitung zum Wahlvorschlag AG NRW 2023, Ziffer 4 A (Kurzbezeichnung von max. 8 Zeichen). 
...
8 Eine Unterlistenverbindung eingehen können die Listen gleicher Bezeichnung gemäss Artikel 31 Absatz 1bis nur, wenn sie sich einzig durch einen Zusatz zur Kennzeichnung des Geschlechts, der Flügel einer Gruppierung, der Region oder des Alters unterscheidenc Absatz 2 VPR.">So auch Artikel 8c Absatz 2 VPR. (vgl. dazu die Ausführungen in OK-Wyler, Art. 31 BPR).
...
12 In der Praxis werden in den Kantonen die Vorgaben der identischen Elemente in der Hauptbezeichnung bzw. für unterverbundene Listen der Listen gleicher Bezeichnung unterschiedlich streng gehandhabt. Während in einigen Kantonen strikte darauf geachtet wird, dass jedem dieser Wahlvorschläge stets eine gleichlautende Bezeichnung bzw. ein gleiches Kürzel vorangestellt wirdBeispiel NRW 2023 Kanton Zürich: Die Mitte / Die Mitte – Frauen / Die Mitte - Die Junge Mitte Nord-Ost/ Die Mitte Wirtschaft und Gesellschaft AWG usw (vgl. Bericht BR NRW 2023, S. 12)., lassen es andere Kantone genügen, wenn das identische Element/die gleiche Bezeichnung an irgendeiner Stelle in der Bezeichnung des Wahlvorschlags oder lediglich im Anhang in einer Klammer auftauchtBeispiel NRW 2023 Kanton Luzern:  Die Mitte / Die Junge Mitte a / Klimaschutz (Die Mitte) / Christlich-Soziale (Die Mitte) usw. (Bericht BR NRW 2023, S. 123). Weniger streng sind mehrere Kantone insbesondere bei Jungparteien: Listen der JUSO oder der Jungfreisinnigen werden in vielen Kantonen als Teillisten der Mutterparteien SP und FDP betrachtet und auch zu Unterlistenverbindungen mit diesen zugelassen, auch wenn streng genommen keine Listen mit «identischen Elementen in der Hauptbezeichnung» bzw. «Listen gleicher Bezeichnung» auszumachen sindSo bei den Nationalratswahlen 2023 in den Kantonen BE, LU, SZ, FR, SO, BS, BL, SH, TG, VS.. Dies entspricht nicht mehr dem Wortlaut der Bestimmungen, führt aber auch nicht zu einer Irreführung der Wählerschaft, da dieser bekannt sein dürfte, dass die JUSO zur SP und die Jungfreisinnigen zur FDP gehören.

13 Die Bezeichnung des Wahlvorschlags kann nach der Einreichung beim Kanton nicht mehr geändert werden, es sei denn sie gibt zu Verwechslungen Anlass.Kreisschreiben BR NRW 2023, Ziffer 7.4.2. In einem solchen Fall setzt die Wahlbehörde im Rahmen der Mängelbehebung im Bereinigungsverfahrens gemäss Artikel 29 BPR der Vertretung des Wahlvorschlags eine Frist, innert welcher die Bezeichnung geändert werden muss.
