---
title: Verfassungsblog — Opposing an Idle Federal Government
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/opposing-an-idle-federal-government/
license: >-
...
The Federal Supreme Court guaranteed the means for nationwide policies of vaccination in case the federal government remains inactive or slow in its response to the pandemic. The only caveat here is that the court continues to sustain a kind of superiority of its members towards the rest of the population. At the same time it guaranteed the vaccination, the court asked a foundation that produces the vaccines to reserve of doses for its 7.000 judges and public servants – an act blatantly contrary to the 1988 Constitution equality norms.
