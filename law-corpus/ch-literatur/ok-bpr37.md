---
title: Onlinekommentar — Art. 37 BPR
type: literatur
genre: kommentar
jurisdiction: ch
...
authors:
  - Andreas Glaser
citation: >-
  Andreas Glaser, Kommentierung zu Art. 37 BPR, in: Andreas Glaser/Nadja Braun
...
source_url: https://onlinekommentar.ch/de/kommentare/bpr37
license: >-
...
2 Art. 37 Abs. 1 BPR war in ähnlicher Form bereits im Bundesratsentwurf zum NWG 1919 zu finden, wobei noch schlicht von «Listenstimmen» die Rede war.Botschaft 1918, S. 145. Das Parlament hat in Art. 14 Abs. 1 NWG 1919 den Begriff der «Zusatzstimmen» eingeführt.Antrag Grünenfelder, AB 1918 NR S. 505. In der Sache ging es darum, unvollständig ausgefüllten Wahlzetteln zu voller Gültigkeit zu verhelfen, indem die leeren Linien in der Regel «gezählt werden».Botschaft 1918, S. 133. Dadurch sollten vor allem kleine Parteien in Kantonen mit zahlreichen zu vergebenden Sitzen vor dem faktischen Zwang bewahrt werden, stets volle Listen einreichen zu müssen, um nicht von vornherein zahlreiche Stimmen einzubüssen. Der Bundesrat hatte die Regelung auch deshalb vorgeschlagen, weil er die – später vom Parlament beschlossene – Möglichkeit des Kumulierens noch abgelehnt hatte. Mit leicht geänderter Formulierung gelangte die Bestimmung in Art. 37 Abs. 1 BPR und erfuhr seitdem keine Änderung.

3 Art. 37 Abs. 3 BPR geht auf den ersten Teilsatz von Art. 14 Abs. 3 NWG 1919 zurück. Die ganze Bestimmung lautete: «Namen, welche auf keiner Liste stehen, fallen ausser Betracht; die auf sie gefallenen Stimmen werden jedoch als Zusatzstimmen gezählt, wenn der Wahlzettel eine Listenbezeichnung trägt».Botschaft 1918, S. 145. Die Formulierung war im Vergleich zum Entwurf des Bundesrates aufgrund des erfolgreichen Antrages Grünenfelder geändert worden.Antrag Grünenfelder, AB 1918 NR S. 505. Die Bestimmung wurde in das BPR übernommen. 2007 wurde ein Teil des Artikels im Zuge einer formellen Bereinigung gestrichen («…die auf sie entfallenden Stimmen werden jedoch als Zusatzstimmen gezählt, wenn der Wahlzettel eine Listenbezeichnung oder Ordnungsnummer trägt; fehlt eine solche, zählen diese Stimmen nicht (leere Stimmen)».), da es sich inhaltlich um eine Wiederholung von Art. 37 Abs. 1 Satz 2 gehandelt habe.Botschaft 2007, S. 6149.

4 Art. 37 Abs. 2 BPR, der die Konstellation von «Sammellisten» regelt, war im Entwurf des Bundesrates für das BPR bewusst nicht vorgesehen. Der Bundesrat war zum Schluss gelangt, «dass von der Zulassung von Sammellisten und einer entsprechenden Bestimmung abzusehen sei».Botschaft 1975, S. 1325. Das Phänomen der Sammellisten trat bei den Nationalratswahlen 1971 im Kanton Bern auf. Die BGB/SVP des Kantons Bern hatte eine ihrer Landesteillisten als sogenannte Sammelliste bestimmen lassen. Wo Unklarheit bezüglich der Zuteilung einer Liste – und damit der Zusatzstimmen – zu einem bestimmten geographischen Gebiet bestand, sollten die Zusatzstimmen jener Liste zugerechnet werden, die als «Sammelliste» galt. Der Bundesrat wollte ein solches Vorgehen nicht legalisieren, vielmehr sollten die Wählenden präzise Angaben machen. Ausserdem liessen sich Schwierigkeiten bei der Zuordnung oft durch «vernünftige Interpretation» lösen.Botschaft 1975, S. 1340. Im Nationalrat obsiegte jedoch ein abweichender Antrag (Antrag Akeret), der im Wesentlichen die heutige Regelung forderte.Antrag Akeret, AB 1976 NR S. 41 f. Das Hauptargument war, dass eine klare Regelung Interpretationsschwierigkeiten von vornherein verhindere.Antrag Akeret, AB 1976 NR S. 41. Das Regelungsziel bestand darin, «leere Zusatzstimmen jener Regionalliste zuzurechnen, die dem Wählerwillen am ehesten entspricht, also jener Regionalliste, die in seinem Wohngebiet eingereicht worden ist»Antrag Akeret, AB 1976 NR S. 41.. Der Ständerat stimmte dem Antrag ohne weitere Diskussion zu.AB 1976 SR S. 528.

5 Art. 37 Abs. 4 BPR kennt keinen Vorläufer im NWG 1919. Er geht auf den Entwurf des Bundesrates für das BPR zurück und sollte eine eindeutige Interpretationsregel bei widersprüchlichen Angaben der Wählerin oder des Wählers aufstellen.Botschaft 1975, S. 1340.

6 Der Erlass von Art. 37 Abs. 2bis Satz 1 BPR im Jahr 1994 war eine mittelbare Auswirkung der Regelung zu den Unterlistenverbindungen in Art. 31 Abs. 1bis BPR. Da der Bundesrat Unterlistenverbindungen nicht zulassen wollte,OK-Wyler, Art. 31 BPR N. 2. schlug er auch keine Regelung für daraus folgende Stimmenverwertungen im Fall leerer Linien vor. Nachdem das Parlament jedoch Unterlistenverbindungen über die von Art. 37 Abs. 2 BPR erfasste Konstellation von Unterlisten mit Bezug zu einer Region hinaus zugelassen hatte, resultierte daraus Regelungsbedarf hinsichtlich der Frage, wie bei Unterlisten mit Zusatz zur Kennzeichnung des Geschlechts, der Flügel einer Gruppierung oder des Alters mit leeren Linien im Hinblick auf potenzielle Zusatzstimmen zu verfahren ist. Die zuständige Kommission des Nationalrates beantragte vor diesem Hintergrund die heute geltende Regelung, die vom Plenum angenommen wurde.AB 1993 NR S. 2488. Eine Diskussion fand nicht mehr statt, obwohl zwei Minderheitsanträge vorlagen. Dies ist damit zu erklären, dass die Frage mit der Ausgangsfrage der Unterlistenverbindungen bereits vorentschieden war.

7 Art. 37 Abs. 2bis Satz 2 BPR aus dem Jahr 2002 ist wiederum die Folge der gleichzeitig erlassenen Regelung in Art. 23 Satz 2 BPR. Gruppierungen, welche Wahlvorschläge mit identischen Elementen in der Hauptbezeichnung einreichen und diese miteinander verbinden wollen, bezeichnen einen der Wahlvorschläge als Stammliste. Auf diese Stammliste nimmt Satz 2 Bezug, indem ihr im Zweifel die leeren Linien als Zusatzstimmen zugerechnet werden. Die Vorschrift «garantiert die präzise Rechtsfolge der Bezeichnung einer Liste als Stammliste bei mehreren Listen gleichen Hauptnamens».Botschaft 2001, S. 6413.
...
11 Verfassungsrechtlich ist die Regelung insgesamt vertretbar. Als massgebendes Kriterium für die Zurechnung leerer Linien an bestimmte Listen definiert Art. 37 BPR die auf dem betreffenden Wahlzettel angegebene Listenbezeichnung oder Ordnungsnummer (Abs. 1, Abs. 2bis Satz 1).Siehe bereits Votum Calame, AB 1919 VI NR S. 540: «La volonté de l'électeur de donner tous ses suffrages à la liste, c'est à dire de profiter des suffrages complémentaires doit cependant être manifestée. Elle le sera automatiquement par la désignation du parti en tête de la liste, par exemple liste radicale, liste libérale, liste socialiste, etc.». Im Falle eines Widerspruches gilt die Listenbezeichnung (Abs. 4). In der Logik eines naturgemäss von Parteien geprägten Proporzwahlsystems ist diese Anknüpfung nachvollziehbar. Eine Wählerin oder ein Wähler, die oder der eine mit entsprechendem Vordruck versehene Parteiliste verwendet, wird – jedenfalls bei einer als zulässig anzusehenden pauschalisierenden Betrachtung – grundsätzlich damit einverstanden sein, dass nicht an bestimmte kandidierende Personen vergebene Stimmen letztlich der gewählten Partei zukommen. Dies ist wohl auch anzunehmen, wenn die Zurechnung vermittelt durch das Instrument der Stammliste (Art. 23 BPR) erfolgt. Unproblematisch ist die Rechtfertigung insbesondere in Fällen, in denen die Liste von vornherein – trotz möglicher Vorkumulierung – weniger kandidierende Personen aufweist, als Sitze zu vergeben sind. Auch besteht die Möglichkeit, leere und damit nicht zählende Stimmen abzugeben, indem die Listenbezeichnung gestrichen oder ein Wahlzettel ohne Vordruck verwendet und keine Bezeichnung angebracht wird. Schliesslich ist es bei einem Irrtum bezüglich der Listennummer der gewählten Partei gut nachvollziehbar, die den Wählerinnen und Wählern viel vertrauteren Parteibezeichnungen als massgeblich zu erklären (Abs. 4) und nicht gleichsam der mutmasslich zufällig verwendeten Ordnungsnummer den Vorrang zu geben.
...
15 Das Instrument der Zusatzstimmen existiert analog zur Ausgestaltung im Bund in zahlreichen Kantonen. Dies gilt sowohl für Kantone mit isolierten Wahlen in den einzelnen Wahlkreisen als auch für Kantone mit Doppelproporz. Im Kanton St. Gallen findet sich eine in weiten Teilen identische Vorschrift wie im Bund.Art. 95 des Gesetzes des Kantons St. Gallen vom 5.12.2018 über Wahlen und Abstimmungen (WAG/SG; sGS 125.3). Auch die Kantone BernArt. 82 des Gesetzes des Kantons Bern vom 5.6.2012 über die politischen Rechte (PRG/BE; BSG 141.1). und Solothurn§ 96 des Gesetzes des Kantons Solothurn vom 22.9.1996 über die politischen Rechte (GpR/SO; BGS 113.111). kennen vergleichbare Bestimmungen. Mangels Listen- und Unterlistenverbindung im Rahmen des Doppelproporzes ist die jeweilige Regelung der Zusatzstimmen in den betreffenden Kantonen wesentlich schlanker als im Bund. Sie beschränkt sich darauf, die leeren Linien der auf dem Wahlzettel aufgeführten Partei als Zusatzstimmen zuzurechnen.§ 99 des Gesetzes des Kantons Zürich vom 1.9.2003 über die politischen Reche (GPR/ZH; LS 161.); § 43 Abs. 2 des Gesetzes des Kantons Zug vom 28.9.2006 über die Wahlen und Abstimmungen (WAG/ZG; BGS 131.2); ausführlicher hingegen Art. 151 des Gesetzes des Kantons Wallis vom 13.5.2004 über die politischen Rechte (kGPR/VS; SGS 160.1).
...
24 Die Bestimmung erleichtert es den Parteien, in grossflächigen Kantonen auf die Bezirke oder Stadt und Landschaft bezogene Regionallisten aufzustellen, und auf diese Weise «eine angemessene gleichmässige Vertretung der verschiedenen Regionen zu sichern und ein engeres persönliches Verhältnis des Kandidaten zu seinem Wahlvolk zu gewährleisten».AB 1976 NR S. 42. Andernfalls bestünde nämlich je nach Interpretation durch das Wahlbüro die Gefahr, dass die leeren Linien wegen fehlender Bezeichnung gemäss Art. 37 Abs. 1 Satz 2 BPR als leere Stimmen nicht zählen würden. Wenn sie wie in den übrigen Fällen eine Stammliste bezeichnen müssten, wäre dies für die Parteien ebenfalls nicht attraktiv, da sie gleichsam einer Region ein Vorrecht auf die Zusatzstimmen einräumen müssten.

25 Mit der stetigen Zunahme der regionalen Teillisten (1971: 22; 2003: 12; 2015: 41; 2019: 64; 2023: 72)https://www.bfs.admin.ch/bfs/de/home/aktuell/neue-veroeffentlichungen.assetdetail.27546294.html, besucht am 20.10.2023.">Nationalratswahlen: Teillisten der Parteien, abrufbar unter https://www.bfs.admin.ch/bfs/de/home/aktuell/neue-veroeffentlichungen.assetdetail.27546294.html, besucht am 20.10.2023. könnten sich verstärkt praktische Abgrenzungsfragen stellen. Unproblematisch ist die Zuordnung, wenn die Listen an eingrenzbare Gebietseinheiten anknüpfen, wie 2023 bei den Listen der Mitte im Kanton Aargau mit den Zusätzen «Für den Bezirk Baden», «Für Brugg und das Zurzibiet», «Für den Bezirk Zofingen» usw. oder bei den Listen der Grünliberalen im Kanton Thurgau mit den Zusätzen «Bezirk Arbon», «Bezirk Münchwilen» usw. und den Listen der Mitte im Kanton Solothurn mit Zusätzen wie «Dorneck-Thierstein» oder «Thal-Gäu».
...
31 Die Bedeutung von Abs. 3 geht allerdings über die blosse Streichung von Namen nicht kandidierender Personen hinaus. Die Streichung hat zur Folge, dass leere Linien entstehen, die nach den Regeln der Abs. 1, 2 und 2bis in Zusatzstimmen umgewandelt werden. Was aus dem Gesetzestext nur mittelbar ersichtlich ist, brachten die Berichterstatter der zuständigen Kommission des Nationalrates in den Beratungen zum NWG 1919 im Plenum auf den Punkt. So hiess es im Nationalrat auf Deutsch: «Wenn irgend ein anderer Name auf den Wahlzettel gesetzt wird, so wird er gestrichen, und es wird die Linie als Zusatzstimme gezählt».Votum Sträuli, AB 1918 NR S. 539. Auf Französisch lautete die Erklärung folgendermassen: «Cependant, les suffrages nominatifs ainsi annulés valent comme […] suffrages complémentaires, lorsque le bulletin de vote porte la dénomination d'une liste».Votum Calame, AB 1918 NR S. 540.

32 Die 2008 im Zuge der «formellen Bereinigung des Bundesrechts» gestrichenen Sätze 2 und 3 stellten zwar formal betrachtet eine entbehrliche Wiederholung von Art. 37 Abs. 1 BPR dar,Zutreffend BBl 2007 6121, 6149. sie verdeutlichten aber die ganze Tragweite der Regelung. In Anbetracht der Komplexität des Regelungsgeflechts und der daraus resultierenden Rechtswirkungen sowie der damit verbundenen politischen Komponente wäre es hilfreich, wenn das Gesetz nach wie vor statuieren würde: «…die auf sie entfallenden Stimmen werden jedoch als Zusatzstimmen gezählt, wenn der Wahlzettel eine Listenbezeichnung oder Ordnungsnummer trägt; [nur wenn] eine solche [fehlt], zählen diese Stimmen nicht (leere Stimmen)».Kursive Formulierungen durch Verf. hinzugefügt.
