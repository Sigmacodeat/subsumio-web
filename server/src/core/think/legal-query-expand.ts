...
const LEGAL_SYNONYMS: LegalSynonym[] = [
  ...
  {
    colloquial: "unterhalt",
    legal: ["Unterhalt", "Unterhaltspflicht", "Alimente", "Unterhaltsanspruch"],
  },
  // AT Corporate law (GmbHG, AktG)
  {
    colloquial: "gmbh",
    legal: ["Gesellschaft mit beschränkter Haftung", "GmbH", "Gesellschaftsrecht"],
  },
  {
    colloquial: "geschäftsführer",
    legal: ["Geschäftsführer", "Organ", "Vertretung", "Geschäftsführung"],
  },
  {
    colloquial: "mindesteinlage",
    legal: ["Mindesteinlage", "Stammeinlage", "Einlage", "Gesellschaftsanteil"],
  },
  {
    colloquial: "einlage",
    legal: ["Einlage", "Stammeinlage", "Mindesteinlage", "Gesellschaftsanteil"],
  },
  {
    colloquial: "aktiengesellschaft",
    legal: ["Aktiengesellschaft", "AktG", "Grundkapital", "Aktionär"],
  },
  ...
  {
    colloquial: "gesellschaftsrecht",
    legal: ["Gesellschaftsrecht", "Gesellschaft", "Juristische Person"],
  },
  // AT Insolvency law (IO)
  { colloquial: "insolvenz", legal: ["Insolvenz", "Insolvenzverfahren", "Konkurs", "Sanierung"] },
  {
    colloquial: "insolvenzverfahren",
    legal: ["Insolvenzverfahren", "Konkursverfahren", "Sanierungsverfahren"],
  },
  {
    colloquial: "sanierungsplan",
    legal: ["Sanierungsplan", "Sanierungsverfahren", "Zwangsausgleich", "Schuldner", "Gläubiger"],
  },
  ...
  {
    colloquial: "einzelunternehmer",
    legal: ["Einzelunternehmer", "Einzelunternehmen", "Unternehmer"],
  },
  {
    colloquial: "rechnungslegung",
    legal: ["Rechnungslegung", "Buchführung", "Jahresabschluss", "Rechnungsabschluss"],
  },
  ...
  {
    colloquial: "zurückbehaltungsrecht",
    legal: ["Zurückbehaltungsrecht", "Zurückbehaltung", "Retentionsrecht"],
  },
  { colloquial: "zurückbehaltung", legal: ["Zurückbehaltung", "Zurückbehaltungsrecht"] },
  // AT Procedural law (ZPO, AuStrG)
  {
    colloquial: "zuständigkeit",
    legal: ["Zuständigkeit", "Gerichtsstand", "sachliche Zuständigkeit", "örtliche Zuständigkeit"],
  },
  { colloquial: "gerichtsstand", legal: ["Gerichtsstand", "Zuständigkeit", "Gericht"] },
  {
    colloquial: "klageschrift",
    legal: ["Klage", "Klagsbegehren", "Klageschrift", "vorbereitender Schriftsatz"],
  },
  { colloquial: "klage", legal: ["Klage", "Klagsbegehren", "Klageschrift"] },
  {
    colloquial: "berufung",
    legal: ["Berufung", "Rechtsmittel", "Berufungsschrift", "Berufungsfrist"],
  },
  ...
  {
    colloquial: "gewerbebetrieb",
    legal: ["Gewerbebetrieb", "Einkünfte aus Gewerbebetrieb", "Betriebseinnahmen"],
  },
  ...
  {
    colloquial: "verjährung",
    legal: ["Verjährung", "Ersitzung", "Fristablauf", "Verjährungsfrist"],
  },
  { colloquial: "verjährungsfrist", legal: ["Verjährungsfrist", "Verjährung", "Frist"] },
  // AT Civil law specifics (ABGB)
  {
    colloquial: "gewährleistung",
    legal: ["Gewährleistung", "Gewährspflicht", "Sachgewährleistung", "Verbürgung"],
  },
  { colloquial: "gewähr", legal: ["Gewährleistung", "Gewährspflicht", "Verbürgung"] },
  {
    colloquial: "willensübereinstimmung",
    legal: [
  ...
  {
    colloquial: "formvorschriften",
    legal: ["Form", "Formvorschrift", "Formgültigkeit", "Formmangel"],
  },
  {
    colloquial: "liegenschaft",
    legal: ["Liegenschaft", "Grundstück", "Immobilie", "unbewegliche Sache"],
  },
  { colloquial: "kaufvertrag", legal: ["Kauf", "Kaufvertrag", "Kaufgegenstand", "Übergabe"] },
  {
    colloquial: "wohnungseigentum",
    legal: ["Wohnungseigentum", "Wohnung", "Nutzwert", "Wohnungseigentumsgesetz"],
  },
  ...
  {
    colloquial: "schwerer diebstahl",
    legal: ["schwerer Diebstahl", "Diebstahl", "Einbruch", "Waffen"],
  },
  { colloquial: "betrug", legal: ["Betrug", "Täuschung", "Vermögensschaden"] },
  {
    colloquial: "körperverletzung",
    legal: ["Körperverletzung", "Verletzung", "Gesundheitsschädigung"],
  },
  ...
  {
    colloquial: "schadenersatzanspruch",
    legal: ["Schadenersatz", "Schadenersatzanspruch", "Ersatzpflicht"],
  },
  {
    colloquial: "obsiegt",
    legal: ["obsiegen", "Obsiegen", "vollständig unterliegend", "Kostentragung", "unterliegen"],
  },
  ...
  {
    colloquial: "karenz",
    legal: ["Karenz", "Karenzzeit", "Elternkarenz", "Väter-Karenzgesetz", "VkgG", "Karenzurlaub"],
  },
  {
    colloquial: "karenzzeit",
    legal: ["Karenz", "Karenzzeit", "Elternkarenz", "VkgG", "Karenzurlaub"],
  },
  { colloquial: "elternkarenz", legal: ["Karenz", "Elternkarenz", "VkgG", "Karenzurlaub"] },
  {
    colloquial: "mutterschutz",
    legal: [
      "Mutterschutz",
      "Mutterschutzgesetz",
      "MSchG",
  ...
  {
    colloquial: "schutzfrist",
    legal: ["Schutzfrist", "Mutterschutz", "MSchG", "Beschäftigungsverbot"],
  },
  {
    colloquial: "urlaubsentgelt",
    legal: [
      "Urlaubsentgelt",
      "Urlaubsgeld",
      "Urlaub",
  ...
  {
    colloquial: "urlaub",
    legal: ["Urlaub", "Urlaubsentgelt", "Urlaubsgeld", "Jahresurlaub", "Erholungsurlaub"],
  },
  {
    colloquial: "abfertigung",
    legal: ["Abfertigung", "Abfertigungsanspruch", "BUAG", "Dienstverhältnis"],
  },
  {
    colloquial: "entlassung",
    legal: ["Entlassung", "ungerechtfertigte Entlassung", "Dienstbeendigung", "ANVG", "ArbVG"],
  },
  {
    colloquial: "ungerechtfertigte",
    legal: ["ungerechtfertigte Entlassung", "Entlassung", "ANVG", "ArbVG", "Dienstbeendigung"],
  },
  // AT Admin law (AVG, VwGVG)
  {
    colloquial: "bescheid",
    legal: ["Bescheid", "Verwaltungsverfahren", "AVG", "Bescheiderlassung", "Verwaltungsakt"],
  },
  {
    colloquial: "verwaltungsgericht",
    legal: ["Verwaltungsgericht", "VwGVG", "Verwaltungsgerichtsbarkeit", "Verwaltungsgerichtshof"],
  },
  {
    colloquial: "verwaltungsverfahren",
    legal: [
  ...
  {
    colloquial: "parteienstellung",
    legal: ["Parteienstellung", "Partei", "Beteiligter", "Verfahrenspartei", "AVG"],
  },
  {
    colloquial: "partei",
    legal: ["Partei", "Parteienstellung", "Beteiligter", "Verfahrenspartei"],
  },
  {
    colloquial: "rechtsschutz",
    legal: ["Rechtsschutz", "Beschwerde", "Rechtsmittel", "VwGVG", "Verwaltungsgericht"],
  },
  { colloquial: "antrag", legal: ["Antrag", "Antragstellung", "Sachantrag", "Frist", "AVG"] },
  // AT Competition law (KartG)
  {
    colloquial: "zusammenschlusskontrolle",
    legal: [
  ...
  {
    colloquial: "zusammenschluss",
    legal: ["Zusammenschluss", "Zusammenschlusskontrolle", "Fusionskontrolle", "KartG"],
  },
  {
    colloquial: "fusionskontrolle",
    legal: ["Fusionskontrolle", "Zusammenschlusskontrolle", "KartG", "Zusammenschluss"],
  },
  {
    colloquial: "kartellrecht",
    legal: ["Kartellrecht", "Kartellgesetz", "KartG", "Wettbewerbsrecht", "Marktbeherrschung"],
  },
  {
    colloquial: "marktbeherrschend",
    legal: [
      "Marktbeherrschung",
  ...
  {
    colloquial: "missbrauch",
    legal: ["Missbrauch", "Marktbeherrschung", "Marktbeherrschende Stellung", "KartG"],
  },
  {
    colloquial: "wettbewerbsrecht",
    legal: ["Wettbewerbsrecht", "Kartellrecht", "KartG", "Wettbewerb"],
  },
  // AT Trade law (GewO)
  {
    colloquial: "gewerbeberechtigung",
    legal: ["Gewerbeberechtigung", "Gewerbe", "Gewerbeordnung", "GewO", "Gewerbeinhaber"],
  },
  {
    colloquial: "gewerbeerteilung",
    legal: ["Gewerbeerteilung", "Gewerbeberechtigung", "Gewerbe", "GewO", "Befähigungsnachweis"],
  },
  {
    colloquial: "gewerbeuntersagung",
    legal: ["Gewerbeuntersagung", "Gewerbeentzug", "Gewerbe", "GewO", "Untersagung"],
  },
  ...
  {
    colloquial: "personenbezogene",
    legal: ["personenbezogene Daten", "Datenverarbeitung", "DSG", "Datenschutz"],
  },
  {
    colloquial: "datenverarbeitung",
    legal: ["Datenverarbeitung", "Verwendung", "Daten", "DSG", "personenbezogene Daten"],
  },
  {
    colloquial: "betroffenenrechte",
    legal: ["Betroffener", "Auskunftsrecht", "Auskunft", "Richtigstellung", "Löschung", "DSG"],
  },
  {
    colloquial: "betroffener",
    legal: ["Betroffener", "Betroffenenrechte", "Auskunftsrecht", "DSG"],
  },
  {
    colloquial: "betroffene",
    legal: ["Betroffener", "Betroffenenrechte", "Auskunftsrecht", "Auskunft", "DSG"],
  },
  { colloquial: "auskunftsrecht", legal: ["Auskunftsrecht", "Auskunft", "Betroffener", "DSG"] },
  {
    colloquial: "verarbeitung",
    legal: ["Verarbeitung", "Verwendung", "Datenverarbeitung", "DSG", "personenbezogene Daten"],
  },
  // AT Social law (ASVG)
  {
    colloquial: "krankenversicherung",
    legal: [
      "Krankenversicherung",
  ...
  {
    colloquial: "krankenversicherungsschutz",
    legal: ["Krankenversicherungsschutz", "Krankenversicherung", "ASVG", "Leistung"],
  },
  {
    colloquial: "pensionsanspruch",
    legal: [
      "Pensionsanspruch",
      "Pension",
  ...
  {
    colloquial: "pensionsversicherung",
    legal: ["Pensionsversicherung", "Pension", "ASVG", "Pensionsanspruch"],
  },
  {
    colloquial: "pension",
    legal: ["Pension", "Pensionsanspruch", "Pensionsversicherung", "ASVG", "Alterspension"],
  },
  {
    colloquial: "sozialversicherung",
    legal: ["Sozialversicherung", "ASVG", "Krankenversicherung", "Pensionsversicherung"],
  },
  // AT Asylum law (AsylG)
  {
    colloquial: "asyl",
  ...
  {
    colloquial: "asylwerber",
    legal: ["Asylwerber", "Asyl", "Asylverfahren", "AsylG", "Flüchtling"],
  },
  {
    colloquial: "asylverfahren",
    legal: ["Asylverfahren", "Asyl", "Asylwerber", "AsylG", "Verfahren"],
  },
  { colloquial: "asylantrag", legal: ["Asylantrag", "Asyl", "Asylwerber", "AsylG", "Antrag"] },
  // AT Jurisdiction (JN)
  {
    colloquial: "örtlich zuständig",
    legal: [
  ...
  {
    colloquial: "wohnitz",
    legal: ["Wohnsitz", "allgemeiner Gerichtsstand", "Gerichtsstand", "JN"],
  },
];
...
export function expandLegalQuery(query: string): string {
  ...
  for (const syn of LEGAL_SYNONYMS) {
    ...
    const pattern = new RegExp(
      `(?:^|\\s)${escapeRegex(syn.colloquial)}(?:[esn]?[\\s?!.,;:]|$|(?=[A-Z]))`,
      "i"
    );
