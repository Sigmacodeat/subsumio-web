---
title: Verfassungsblog — When Judges Fall Silent
type: literatur
genre: aufsatz
jurisdiction: de
...
source_url: https://verfassungsblog.de/when-judges-fall-silent/
license: >-
  CC BY-SA 4.0 (Standard-Lizenz des Verfassungsblogs; einzelne Beiträge können
  abweichen). Namensnennung + Share-Alike erforderlich.
content_hash: "87eb941327731b65"
---
...
In Berlin, the green carpet becomes a little greyer. Last year, Bündnis 90/Die Grünen were accused of redrawing a constituency to their advantage. Although gerrymandering is still rare here, legal standards should be sharpened, argues FABIAN BUNSCHUH (GER).
...
The CJEU should also do some rethinking, argue KATARZYNA SZEPELAK and MACIEJ KUŁAK (ENG): the Court prevents NGOs from bringing public-interest litigation. But the treaties allow a different interpretation, according to the authors.
