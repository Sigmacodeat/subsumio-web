...
export const D = {
  ...
  "nav.section.clients_comm": { de: "Mandanten & Kommunikation", en: "Clients & Communication" },
  ...
  "widget.cross_timeline": { de: "Akten-Querschnitt", en: "Cross-Case Timeline" },
  "widget.cross_timeline_desc": {
    de: "Vereinheitlichte Timeline aller Akten — Fristen, Reviews, Signaturen der nächsten 7 Tage",
    en: "Unified timeline across all cases — deadlines, reviews, signatures for the next 7 days",
  },
  ...
  "widget.confidence_score": { de: "Pipeline-Confidence", en: "Pipeline Confidence" },
  "widget.confidence_score_desc": {
    de: "Confidence-Scores aller Akten mit Pipeline-Status — Ensemble-Critic-Qualitätsbewertung",
    en: "Confidence scores across all cases with pipeline status — ensemble critic quality assessment",
  },
  "widget.silent_failures": { de: "Stille Fehler", en: "Silent Failures" },
