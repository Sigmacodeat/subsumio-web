        ...
        {CARDS.map((card) => {
          ...
          return (
            <Link
              key={card.href}
              href={card.href}
              className={`group flex items-start gap-4 rounded-xl border ${card.border} bg-[color:var(--ds-surface)] p-5 transition-[border-color,background-color,box-shadow,transform] duration-[var(--ds-duration-normal)] hover:-translate-y-0.5 hover:shadow-lg focus-visible:ring-2 focus-visible:ring-[color:var(--brand-primary)] focus-visible:outline-none motion-reduce:transition-none`}
            >
              <div
