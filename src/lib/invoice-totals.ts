...
/**
 * Hourly rate from the firm settings ("190", "187,50", "1.234,50", "187.50").
 * Returns null when no usable rate is configured — callers must not invent one.
 */
export function parseHourlyRate(value: string | number | null | undefined): number | null {
  ...
  // Austrian notation: "." groups thousands, "," is the decimal separator.
