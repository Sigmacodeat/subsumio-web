...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/subsumio/whatsapp", languages: { en: "/subsumio/whatsapp", de: "/de/subsumio/whatsapp" } },
};
...
export default function Page() {
  return (
    <>
      ...
      <JsonLd data={breadcrumbLd([{ name: "Subsumio", url: "/subsumio" }, { name: "WhatsApp copilot", url: "/subsumio/whatsapp" }])} />
